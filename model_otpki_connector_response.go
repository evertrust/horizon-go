...
var _ MappedNullable = &OTPKIConnectorResponse{}
...
type OTPKIConnectorResponse struct {
	...
	SanEmailMap NullableString `json:"sanEmailMap,omitempty"`
	UidMap NullableString `json:"uidMap,omitempty"`
	Zone NullableString `json:"zone,omitempty"`
	// The name of the label where the zone value is stored on an enrolled certificate
	ZoneLabel NullableString `json:"zoneLabel,omitempty"`
...
func (o *OTPKIConnectorResponse) GetSanEmailMap() string {
	if o == nil || IsNil(o.SanEmailMap.Get()) {
		var ret string
		return ret
	}
...
func (o *OTPKIConnectorResponse) GetZoneLabel() string {
	if o == nil || IsNil(o.ZoneLabel.Get()) {
		var ret string
		return ret
	}

...
var _ MappedNullable = &TrustChainAnchorResponse{}
...
func (o *TrustChainAnchorResponse) GetSubordinates() []TrustChainAnchor {
	if o == nil || IsNil(o.Subordinates) {
		var ret []TrustChainAnchor
		return ret
	}
...
// SetSubordinates gets a reference to the given []TrustChainAnchor and assigns it to the Subordinates field.

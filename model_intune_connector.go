...
var _ MappedNullable = &IntuneConnector{}
...
type IntuneConnector struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the App ID and Key to authenticate on Intune
	Credentials string `json:"credentials"`
	IntuneResourceUrl NullableString `json:"intuneResourceUrl,omitempty"`
	OsQueryString NullableString `json:"osQueryString,omitempty"`
...
func NewIntuneConnector(type_ string, name string, throttleDuration string, throttleParallelism int64, tenant string, credentials string, legacyRevocationMode bool) *IntuneConnector {
...
func (o *IntuneConnector) GetIntuneResourceUrl() string {
	if o == nil || IsNil(o.IntuneResourceUrl.Get()) {
		var ret string
		return ret
	}
...
func (o *IntuneConnector) GetOsQueryString() string {
	if o == nil || IsNil(o.OsQueryString.Get()) {
		var ret string
		return ret
	}

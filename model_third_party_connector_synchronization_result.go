...
var _ MappedNullable = &ThirdPartyConnectorSynchronizationResult{}
...
type ThirdPartyConnectorSynchronizationResult struct {
	EnrollSuccess NullableInt64 `json:"enroll_success,omitempty"`
	EnrollFailure NullableInt64 `json:"enroll_failure,omitempty"`
	RenewSuccess NullableInt64 `json:"renew_success,omitempty"`
	RenewFailure NullableInt64 `json:"renew_failure,omitempty"`
	RevokeSuccess NullableInt64 `json:"revoke_success,omitempty"`
	RevokeFailure NullableInt64 `json:"revoke_failure,omitempty"`
...
func (o *ThirdPartyConnectorSynchronizationResult) GetEnrollSuccess() int64 {
	if o == nil || IsNil(o.EnrollSuccess.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyConnectorSynchronizationResult) GetEnrollFailure() int64 {
	if o == nil || IsNil(o.EnrollFailure.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyConnectorSynchronizationResult) GetRenewSuccess() int64 {
	if o == nil || IsNil(o.RenewSuccess.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyConnectorSynchronizationResult) GetRenewFailure() int64 {
	if o == nil || IsNil(o.RenewFailure.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyConnectorSynchronizationResult) GetRevokeSuccess() int64 {
	if o == nil || IsNil(o.RevokeSuccess.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyConnectorSynchronizationResult) GetRevokeFailure() int64 {
	if o == nil || IsNil(o.RevokeFailure.Get()) {
		var ret int64
		return ret
	}

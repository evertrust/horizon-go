...
// checks if the WebRAEnrollRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRAEnrollRequestOnTemplate{}
...
type _WebRAEnrollRequestOnTemplate WebRAEnrollRequestOnTemplate
...
func (o *WebRAEnrollRequestOnTemplate) SetProfileNil() {
	o.Profile.Set(nil)
}
...
func (o *WebRAEnrollRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRAEnrollRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRAEnrollRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o *WebRAEnrollRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAEnrollRequestOnTemplate := _WebRAEnrollRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRAEnrollRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRAEnrollRequestOnTemplate(varWebRAEnrollRequestOnTemplate)
...
type NullableWebRAEnrollRequestOnTemplate struct {
	value *WebRAEnrollRequestOnTemplate
	isSet bool
}

func (v NullableWebRAEnrollRequestOnTemplate) Get() *WebRAEnrollRequestOnTemplate {
	return v.value
}

func (v *NullableWebRAEnrollRequestOnTemplate) Set(val *WebRAEnrollRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAEnrollRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAEnrollRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAEnrollRequestOnTemplate(val *WebRAEnrollRequestOnTemplate) *NullableWebRAEnrollRequestOnTemplate {
	return &NullableWebRAEnrollRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRAEnrollRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAEnrollRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ MappedNullable = &JamfConnectorResponse{}
...
type JamfConnectorResponse struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the account to authenticate on JAMF

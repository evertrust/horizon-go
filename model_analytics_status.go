...
// checks if the AnalyticsStatus type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AnalyticsStatus{}
...
type AnalyticsStatus struct {
	...
	MaxLastModification NullableInt64 `json:"maxLastModification,omitempty"`
	// If an error happened during the synchronization process
	Error NullableString `json:"error,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _AnalyticsStatus AnalyticsStatus
...
func (o *AnalyticsStatus) GetMaxLastModification() int64 {
	if o == nil || IsNil(o.MaxLastModification.Get()) {
		var ret int64
		return ret
	}
...
func (o *AnalyticsStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varAnalyticsStatus := _AnalyticsStatus{}

	err = json.Unmarshal(data, &varAnalyticsStatus)

	if err != nil {
		return err
	}

	*o = AnalyticsStatus(varAnalyticsStatus)
...
type NullableAnalyticsStatus struct {
	value *AnalyticsStatus
	isSet bool
}

func (v NullableAnalyticsStatus) Get() *AnalyticsStatus {
	return v.value
}

func (v *NullableAnalyticsStatus) Set(val *AnalyticsStatus) {
	v.value = val
	v.isSet = true
}

func (v NullableAnalyticsStatus) IsSet() bool {
	return v.isSet
}

func (v *NullableAnalyticsStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnalyticsStatus(val *AnalyticsStatus) *NullableAnalyticsStatus {
	return &NullableAnalyticsStatus{value: val, isSet: true}
}

func (v NullableAnalyticsStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnalyticsStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true

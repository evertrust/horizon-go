...
`func NewThirdPartyScheduledTask(connector string, dryRun bool, enroll bool, module string, profile string, revoke bool, type_ string, cron string, enabled bool, ) *ThirdPartyScheduledTask`

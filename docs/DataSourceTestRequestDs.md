...
`func (o *DataSourceTestRequestDs) GetNotFoundHttpCodes() []int64`

GetNotFoundHttpCodes returns the NotFoundHttpCodes field if non-nil, zero value otherwise.

### GetNotFoundHttpCodesOk

`func (o *DataSourceTestRequestDs) GetNotFoundHttpCodesOk() (*[]int64, bool)`
...
`func (o *DataSourceTestRequestDs) SetNotFoundHttpCodes(v []int64)`

SetNotFoundHttpCodes sets NotFoundHttpCodes field to given value.

### HasNotFoundHttpCodes

`func (o *DataSourceTestRequestDs) HasNotFoundHttpCodes() bool`

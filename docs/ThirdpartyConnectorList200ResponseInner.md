...
`func (o *ThirdpartyConnectorList200ResponseInner) GetAzureTenant() string`

GetAzureTenant returns the AzureTenant field if non-nil, zero value otherwise.

### GetAzureTenantOk

`func (o *ThirdpartyConnectorList200ResponseInner) GetAzureTenantOk() (*string, bool)`
...
`func (o *ThirdpartyConnectorList200ResponseInner) SetAzureTenant(v string)`

SetAzureTenant sets AzureTenant field to given value.

### HasAzureTenant

`func (o *ThirdpartyConnectorList200ResponseInner) HasAzureTenant() bool`

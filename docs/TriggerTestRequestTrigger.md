...
`func (o *TriggerTestRequestTrigger) GetLicenceUsagePercent() int64`

GetLicenceUsagePercent returns the LicenceUsagePercent field if non-nil, zero value otherwise.

### GetLicenceUsagePercentOk

`func (o *TriggerTestRequestTrigger) GetLicenceUsagePercentOk() (*int64, bool)`

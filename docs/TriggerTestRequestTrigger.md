...
`func NewTriggerTestRequestTrigger(type_ string, emailTemplate EmailTemplate, name string, events []string, webhookTemplate WebhookTemplate, sequence []map[string]interface{}, ) *TriggerTestRequestTrigger`

...
------------ | ------------- | ------------- | -------------
**Aias** | Pointer to [**CFCertificateResponseAias**](CFCertificateResponseAias.md) |  | [optional] 
**AuthorityKeyIdentifier** | Pointer to **string** | The certificate AKI | [optional] 
**BasicConstraints** | Pointer to [**CFCertificateResponseBasicConstraints**](CFCertificateResponseBasicConstraints.md) |  | [optional] 
...
**Policies** | Pointer to [**[]CFCertificateResponsePoliciesInner**](CFCertificateResponsePoliciesInner.md) |  | [optional] 
...
**UnsupportedExtensions** | Pointer to [**[]CFCertificateResponseUnsupportedExtensionsInner**](CFCertificateResponseUnsupportedExtensionsInner.md) |  | [optional] 

...
`func NewDatasourceUpdateRequest(lookup string, name string, timeout string, type_ string, baseDn string, credentials string, filter string, hostname string, secure bool, authenticationType string, expectedHttpCodes []int64, method string, url string, ) *DatasourceUpdateRequest`
...
`func (o *DatasourceUpdateRequest) GetNotFoundHttpCodes() []int64`

GetNotFoundHttpCodes returns the NotFoundHttpCodes field if non-nil, zero value otherwise.

### GetNotFoundHttpCodesOk

`func (o *DatasourceUpdateRequest) GetNotFoundHttpCodesOk() (*[]int64, bool)`
...
`func (o *DatasourceUpdateRequest) SetNotFoundHttpCodes(v []int64)`

SetNotFoundHttpCodes sets NotFoundHttpCodes field to given value.

### HasNotFoundHttpCodes

`func (o *DatasourceUpdateRequest) HasNotFoundHttpCodes() bool`

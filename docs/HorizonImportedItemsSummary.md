...
------------ | ------------- | ------------- | -------------
**Automations** | Pointer to **[]string** |  | [optional] 
**Cas** | Pointer to **[]string** |  | [optional] 
**Datasources** | Pointer to **[]string** |  | [optional] 
**DiscoveryCampaigns** | Pointer to **[]string** |  | [optional] 
**Executions** | Pointer to **[]string** |  | [optional] 
**ForestMappings** | Pointer to **[]string** |  | [optional] 
**Labels** | Pointer to **[]string** |  | [optional] 
**Notifications** | Pointer to **[]string** |  | [optional] 
**PasswordPolicies** | Pointer to **[]string** |  | [optional] 
**PkiConnectors** | Pointer to **[]string** |  | [optional] 
**PkiQueues** | Pointer to **[]string** |  | [optional] 
**Profiles** | Pointer to **[]string** |  | [optional] 
**Proxies** | Pointer to **[]string** |  | [optional] 
**Reports** | Pointer to **[]string** |  | [optional] 
**Roles** | Pointer to **[]string** |  | [optional] 
**ScimProfiles** | Pointer to **[]string** |  | [optional] 
**Teams** | Pointer to **[]string** |  | [optional] 
**ThirdParties** | Pointer to **[]string** |  | [optional] 
**Triggers** | Pointer to **[]string** |  | [optional] 

## Methods

### NewHorizonImportedItemsSummary
...
### NewHorizonImportedItemsSummaryWithDefaults

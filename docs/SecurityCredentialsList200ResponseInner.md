...
`func NewSecurityCredentialsList200ResponseInner(expires NullableInt64, type_ string, store SecretStoreResponse, id string, name string, login string, password SecretString, secret SecretString, ) *SecurityCredentialsList200ResponseInner`

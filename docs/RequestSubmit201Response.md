...
`func NewRequestSubmit201Response(certificate NullableCertificate, module string, template ScepEnrollRequestTemplate, workflow string, id string, holderId string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus, ) *RequestSubmit201Response`

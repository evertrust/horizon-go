...
`func NewRequestGet200Response(module string, workflow string, template ScepEnrollRequestTemplate, certificate NullableCertificate, id string, status RequestStatus, profile string, registrationDate int64, lastModificationDate int64, removeAt int64, holderId string, ) *RequestGet200Response`

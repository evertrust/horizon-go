...
`func NewAcmeEnrollConnector(name string, type_ string, endPoint string, timeout NullableString, accountKeyType string, dnsChallengeProvider DnsChallengeProviders, ) *AcmeEnrollConnector`

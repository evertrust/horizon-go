...
`func NewTriggerList200ResponseInner(id string, emailTemplate EmailTemplate, type_ string, events []TriggerEvent, name string, webhookTemplate WebhookTemplate, sequence []map[string]interface{}, connector string, ) *TriggerList200ResponseInner`
...
`func (o *TriggerList200ResponseInner) GetEvents() []TriggerEvent`

GetEvents returns the Events field if non-nil, zero value otherwise.

### GetEventsOk

`func (o *TriggerList200ResponseInner) GetEventsOk() (*[]TriggerEvent, bool)`
...
`func (o *TriggerList200ResponseInner) SetEvents(v []TriggerEvent)`

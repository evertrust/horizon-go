...
`func (o *SchedulerTaskAddRequest) GetCompressCsv() bool`

GetCompressCsv returns the CompressCsv field if non-nil, zero value otherwise.

### GetCompressCsvOk

`func (o *SchedulerTaskAddRequest) GetCompressCsvOk() (*bool, bool)`
...
`func (o *SchedulerTaskAddRequest) SetCompressCsv(v bool)`

SetCompressCsv sets CompressCsv field to given value.

### HasCompressCsv

`func (o *SchedulerTaskAddRequest) HasCompressCsv() bool`

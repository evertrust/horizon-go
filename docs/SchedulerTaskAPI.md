...
func main() {
	scheduledTasks := openapiclient.ScheduledTasks{AttachmentReportScheduledTask: openapiclient.NewAttachmentReportScheduledTask("ReportType_example", "From_example", "HqlType_example", false, []openapiclient.ReportRecipient{*openapiclient.NewReportRecipient("Type_example")}, "Title_example", "Type_example", "Cron_example", false, "Name_example")} // ScheduledTasks | Scheduled task to register
...
func main() {
	scheduledTasks := openapiclient.ScheduledTasks{AttachmentReportScheduledTask: openapiclient.NewAttachmentReportScheduledTask("ReportType_example", "From_example", "HqlType_example", false, []openapiclient.ReportRecipient{*openapiclient.NewReportRecipient("Type_example")}, "Title_example", "Type_example", "Cron_example", false, "Name_example")} // ScheduledTasks | Scheduled task to update

...
`func (o *EstProfileResponse) GetTermsOfService() string`

GetTermsOfService returns the TermsOfService field if non-nil, zero value otherwise.

### GetTermsOfServiceOk

`func (o *EstProfileResponse) GetTermsOfServiceOk() (*string, bool)`
...
`func (o *EstProfileResponse) SetTermsOfService(v string)`

SetTermsOfService sets TermsOfService field to given value.

### HasTermsOfService

`func (o *EstProfileResponse) HasTermsOfService() bool`
...
`func (o *EstProfileResponse) SetThirdPartyDiscoverySyncNil(b bool)`

...
`func NewCertificateAuthority(name string, trustedForClientAuthentication bool, trustedForServerAuthentication bool, outdatedRevocationStatusPolicy string, public bool, ) *CertificateAuthority`

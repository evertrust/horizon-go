...
`func NewTriggerUpdateRequest(emailTemplate EmailTemplate, type_ string, events []string, name string, webhookTemplate WebhookTemplate, sequence []map[string]interface{}, connector string, ) *TriggerUpdateRequest`
...
`func (o *TriggerUpdateRequest) GetLicenceUsagePercent() int64`

GetLicenceUsagePercent returns the LicenceUsagePercent field if non-nil, zero value otherwise.

### GetLicenceUsagePercentOk

`func (o *TriggerUpdateRequest) GetLicenceUsagePercentOk() (*int64, bool)`

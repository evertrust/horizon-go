...
// SecurityRoleUpdate401Response struct for SecurityRoleUpdate401Response
type SecurityRoleUpdate401Response struct {
...
func (dst *SecurityRoleUpdate401Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(SecurityRoleUpdate401Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SecurityRoleUpdate401Response) MarshalJSON() ([]byte, error) {
...
type NullableSecurityRoleUpdate401Response struct {
	value *SecurityRoleUpdate401Response
	isSet bool
}

func (v NullableSecurityRoleUpdate401Response) Get() *SecurityRoleUpdate401Response {
	return v.value
}

func (v *NullableSecurityRoleUpdate401Response) Set(val *SecurityRoleUpdate401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityRoleUpdate401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityRoleUpdate401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityRoleUpdate401Response(val *SecurityRoleUpdate401Response) *NullableSecurityRoleUpdate401Response {
	return &NullableSecurityRoleUpdate401Response{value: val, isSet: true}
}

func (v NullableSecurityRoleUpdate401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityRoleUpdate401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

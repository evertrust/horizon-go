...
var _ MappedNullable = &LDAPDataSourceResultResponse{}
...
type LDAPDataSourceResultResponse struct {
	...
	ComputedDN NullableString `json:"computedDN,omitempty"`
	// Filter that was requested on the LDAP server
	ComputedFilter NullableString `json:"computedFilter,omitempty"`
...
func (o *LDAPDataSourceResultResponse) GetComputedDN() string {
	if o == nil || IsNil(o.ComputedDN.Get()) {
		var ret string
		return ret
	}
...
func (o *LDAPDataSourceResultResponse) GetComputedFilter() string {
	if o == nil || IsNil(o.ComputedFilter.Get()) {
		var ret string
		return ret
	}

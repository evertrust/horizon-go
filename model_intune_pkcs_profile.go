...
// checks if the IntunePKCSProfile type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &IntunePKCSProfile{}

// IntunePKCSProfile struct for IntunePKCSProfile
type IntunePKCSProfile struct {
...
func (o *IntunePKCSProfile) SetConstraintsNil() {
...
func (o *IntunePKCSProfile) SetMaxCertificatePerHolderPolicyNil() {
...
func (o *IntunePKCSProfile) SetTriggersNil() {
	o.Triggers.Set(nil)
}
...
func (o *IntunePKCSProfile) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IntunePKCSProfile) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntunePKCSProfile) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}
...
func (o *IntunePKCSProfile) SetCertificateTemplateNil() {
...
func (o IntunePKCSProfile) MarshalJSON() ([]byte, error) {
...
func (o IntunePKCSProfile) ToMap() (map[string]interface{}, error) {
...
func (o *IntunePKCSProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varIntunePKCSProfile := _IntunePKCSProfile{}

	err = json.Unmarshal(data, &varIntunePKCSProfile)

	if err != nil {
		return err
	}

	*o = IntunePKCSProfile(varIntunePKCSProfile)
...
type NullableIntunePKCSProfile struct {
	value *IntunePKCSProfile
	isSet bool
}

func (v NullableIntunePKCSProfile) Get() *IntunePKCSProfile {
	return v.value
}

func (v *NullableIntunePKCSProfile) Set(val *IntunePKCSProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableIntunePKCSProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableIntunePKCSProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntunePKCSProfile(val *IntunePKCSProfile) *NullableIntunePKCSProfile {
	return &NullableIntunePKCSProfile{value: val, isSet: true}
}

func (v NullableIntunePKCSProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntunePKCSProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

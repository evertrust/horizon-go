...
var _ MappedNullable = &GCMConnectorResponse{}
...
type GCMConnectorResponse struct {
	...
	// Name of the `raw` [credentials](#tag/api.security.credentials) containing User Account credentials.
	Credentials string `json:"credentials"`
	TagKey NullableString `json:"tagKey,omitempty"`

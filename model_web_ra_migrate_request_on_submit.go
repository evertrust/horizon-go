...
// checks if the WebRAMigrateRequestOnSubmit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRAMigrateRequestOnSubmit{}

// WebRAMigrateRequestOnSubmit struct for WebRAMigrateRequestOnSubmit
type WebRAMigrateRequestOnSubmit struct {
...
type _WebRAMigrateRequestOnSubmit WebRAMigrateRequestOnSubmit
...
func (o *WebRAMigrateRequestOnSubmit) SetCertificateIdNil() {
...
func (o *WebRAMigrateRequestOnSubmit) SetCertificatePemNil() {
...
func (o *WebRAMigrateRequestOnSubmit) SetRequesterCommentNil() {
...
func (o *WebRAMigrateRequestOnSubmit) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAMigrateRequestOnSubmit) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnSubmit) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnSubmit := _WebRAMigrateRequestOnSubmit{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnSubmit)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnSubmit(varWebRAMigrateRequestOnSubmit)
...
type NullableWebRAMigrateRequestOnSubmit struct {
	value *WebRAMigrateRequestOnSubmit
	isSet bool
}

func (v NullableWebRAMigrateRequestOnSubmit) Get() *WebRAMigrateRequestOnSubmit {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnSubmit) Set(val *WebRAMigrateRequestOnSubmit) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnSubmit) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnSubmit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnSubmit(val *WebRAMigrateRequestOnSubmit) *NullableWebRAMigrateRequestOnSubmit {
	return &NullableWebRAMigrateRequestOnSubmit{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnSubmit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnSubmit) UnmarshalJSON(src []byte) error {
	v.isSet = true

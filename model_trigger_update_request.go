...
func (dst *TriggerUpdateRequest) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.AWSTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.AzureKeyVaultTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.F5AS3Trigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.F5ClientTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.GCMTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.IntunePKCSTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.LDAPTrigger)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.REST)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebhookNotification)
	if err == nil {

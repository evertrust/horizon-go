...
var _ MappedNullable = &DigiCertConnector{}
...
type DigiCertConnector struct {
	...
	// Name of the `raw` [credentials](#tag/api.security.credentials) containing the API key to authenticate on the PKI
	ApiCredentials string `json:"apiCredentials"`
	OrganizationId int64 `json:"organizationId"`
	CaCertId NullableString `json:"caCertId,omitempty"`
	...
	SkipApproval NullableBool `json:"skipApproval,omitempty"`
...
func NewDigiCertConnector(name string, type_ string, apiCredentials string, organizationId int64) *DigiCertConnector {
...
func (o *DigiCertConnector) HasBaseUrl() bool {
	if o != nil && !IsNil(o.BaseUrl) {
		return true
	}
...
func (o *DigiCertConnector) GetSkipApproval() bool {
	if o == nil || IsNil(o.SkipApproval.Get()) {
		var ret bool
		return ret
	}
...
func (o *DigiCertConnector) GetCustomConnectorDataMappingOk() (*map[string]string, bool) {
	if o == nil || IsNil(o.CustomConnectorDataMapping) {
		return nil, false
	}

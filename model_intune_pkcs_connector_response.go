...
var _ MappedNullable = &IntunePKCSConnectorResponse{}
...
type IntunePKCSConnectorResponse struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the App ID and Key to authenticate on Intune PKCS
	Credentials string `json:"credentials"`
	PubKey string `json:"pubKey"`
	KeyName string `json:"keyName"`
	ProviderName NullableString `json:"providerName,omitempty"`
	IntendedPurpose NullableString `json:"intendedPurpose,omitempty"`
	SearchFilter NullableString `json:"searchFilter,omitempty"`
...
func (o *IntunePKCSConnectorResponse) GetIntendedPurpose() string {
	if o == nil || IsNil(o.IntendedPurpose.Get()) {
		var ret string
		return ret
	}
...
func (o *IntunePKCSConnectorResponse) GetSearchFilter() string {
	if o == nil || IsNil(o.SearchFilter.Get()) {
		var ret string
		return ret
	}

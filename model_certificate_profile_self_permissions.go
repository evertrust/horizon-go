...
var _ MappedNullable = &CertificateProfileSelfPermissions{}
...
type CertificateProfileSelfPermissions struct {
	SelfRecover NullableBool `json:"selfRecover,omitempty"`
	SelfUpdate NullableBool `json:"selfUpdate,omitempty"`
	SelfRevoke NullableBool `json:"selfRevoke,omitempty"`
	SelfRenew NullableBool `json:"selfRenew,omitempty"`
	SelfPopRenew NullableBool `json:"selfPopRenew,omitempty"`
	SelfPopRevoke NullableBool `json:"selfPopRevoke,omitempty"`
	SelfPopUpdate NullableBool `json:"selfPopUpdate,omitempty"`
...
func NewCertificateProfileSelfPermissions() *CertificateProfileSelfPermissions {
	...
	this.SelfRecover = *NewNullableBool(&selfRecover)
	var selfUpdate bool = false
	this.SelfUpdate = *NewNullableBool(&selfUpdate)
	var selfRevoke bool = false
	this.SelfRevoke = *NewNullableBool(&selfRevoke)
	var selfRenew bool = false
	this.SelfRenew = *NewNullableBool(&selfRenew)
	var selfPopRenew bool = false
	this.SelfPopRenew = *NewNullableBool(&selfPopRenew)
	var selfPopRevoke bool = false
	this.SelfPopRevoke = *NewNullableBool(&selfPopRevoke)
	var selfPopUpdate bool = false
	this.SelfPopUpdate = *NewNullableBool(&selfPopUpdate)
	return &this
}
...
func (o *CertificateProfileSelfPermissions) GetSelfRecover() bool {
	if o == nil || IsNil(o.SelfRecover.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfUpdate() bool {
	if o == nil || IsNil(o.SelfUpdate.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfRevoke() bool {
	if o == nil || IsNil(o.SelfRevoke.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfRenew() bool {
	if o == nil || IsNil(o.SelfRenew.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfPopRenew() bool {
	if o == nil || IsNil(o.SelfPopRenew.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfPopRevoke() bool {
	if o == nil || IsNil(o.SelfPopRevoke.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateProfileSelfPermissions) GetSelfPopUpdate() bool {
	if o == nil || IsNil(o.SelfPopUpdate.Get()) {
		var ret bool
		return ret
	}

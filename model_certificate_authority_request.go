...
var _ MappedNullable = &CertificateAuthorityRequest{}
...
func NewCertificateAuthorityRequest(name string, trustedForClientAuthentication bool, trustedForServerAuthentication bool, outdatedRevocationStatusPolicy string, public bool) *CertificateAuthorityRequest {
...
func (o *CertificateAuthorityRequest) HasCertificate() bool {
	if o != nil && !IsNil(o.Certificate) {
		return true
	}

...
// checks if the WebRAMigrateRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRAMigrateRequestOnTemplate{}

// WebRAMigrateRequestOnTemplate struct for WebRAMigrateRequestOnTemplate
type WebRAMigrateRequestOnTemplate struct {
...
type _WebRAMigrateRequestOnTemplate WebRAMigrateRequestOnTemplate
...
func (o *WebRAMigrateRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRAMigrateRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRAMigrateRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestOnTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnTemplate := _WebRAMigrateRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnTemplate(varWebRAMigrateRequestOnTemplate)
...
type NullableWebRAMigrateRequestOnTemplate struct {
	value *WebRAMigrateRequestOnTemplate
	isSet bool
}

func (v NullableWebRAMigrateRequestOnTemplate) Get() *WebRAMigrateRequestOnTemplate {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnTemplate) Set(val *WebRAMigrateRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnTemplate(val *WebRAMigrateRequestOnTemplate) *NullableWebRAMigrateRequestOnTemplate {
	return &NullableWebRAMigrateRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ MappedNullable = &PrincipalInfoResponse{}
...
type PrincipalInfoResponse struct {
	...
	LastAuthentication NullableInt64 `json:"lastAuthentication,omitempty"`
	// The last modification date of the principal (UNIX Timestamp in milliseconds)
	LastModification NullableInt64 `json:"lastModification,omitempty"`
...
func (o *PrincipalInfoResponse) GetLastAuthentication() int64 {
	if o == nil || IsNil(o.LastAuthentication.Get()) {
		var ret int64
		return ret
	}
...
func (o *PrincipalInfoResponse) GetLastModification() int64 {
	if o == nil || IsNil(o.LastModification.Get()) {
		var ret int64
		return ret
	}

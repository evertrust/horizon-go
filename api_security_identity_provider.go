...
type SecurityIdentityProviderAPISecurityIdentityProviderAddRequest struct {
	...
	securityIdentityProviderAddRequest *SecurityIdentityProviderAddRequest
}

// The identity provider to register
func (r SecurityIdentityProviderAPISecurityIdentityProviderAddRequest) SecurityIdentityProviderAddRequest(securityIdentityProviderAddRequest SecurityIdentityProviderAddRequest) SecurityIdentityProviderAPISecurityIdentityProviderAddRequest {
	r.securityIdentityProviderAddRequest = &securityIdentityProviderAddRequest
	return r
}

func (r SecurityIdentityProviderAPISecurityIdentityProviderAddRequest) Execute() (*SecurityIdentityProviderAdd201Response, *http.Response, error) {
...
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderAddExecute(r SecurityIdentityProviderAPISecurityIdentityProviderAddRequest) (*SecurityIdentityProviderAdd201Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SecurityIdentityProviderAdd201Response
	)
	...
	if r.securityIdentityProviderAddRequest == nil {
		return localVarReturnValue, nil, reportError("securityIdentityProviderAddRequest is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityIdentityProviderAdd400Response
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v SecurityIdentityProviderAdd403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v SecurityIdentityProviderList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderDeleteExecute(r SecurityIdentityProviderAPISecurityIdentityProviderDeleteRequest) (*http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityIdentityProviderDelete400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v SecurityIdentityProviderUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
...
func (r SecurityIdentityProviderAPISecurityIdentityProviderEnabledRequest) Execute() ([]EnabledIdentityProviderResponse, *http.Response, error) {
...
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderEnabledExecute(r SecurityIdentityProviderAPISecurityIdentityProviderEnabledRequest) ([]EnabledIdentityProviderResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []EnabledIdentityProviderResponse
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v SecurityIdentityProviderEnabled500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r SecurityIdentityProviderAPISecurityIdentityProviderGetRequest) Execute() (*SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
...
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderGetExecute(r SecurityIdentityProviderAPISecurityIdentityProviderGetRequest) (*SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SecurityIdentityProviderList200ResponseInner
	)
...
func (r SecurityIdentityProviderAPISecurityIdentityProviderListRequest) Execute() ([]SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []SecurityIdentityProviderList200ResponseInner
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderListExecute(r SecurityIdentityProviderAPISecurityIdentityProviderListRequest) ([]SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type SecurityIdentityProviderAPISecurityIdentityProviderSearchRequest struct {
	ctx context.Context
	ApiService *SecurityIdentityProviderAPIService
	principalInfoSearchRequest *PrincipalInfoSearchRequest
}

// The principal search request
func (r SecurityIdentityProviderAPISecurityIdentityProviderSearchRequest) PrincipalInfoSearchRequest(principalInfoSearchRequest PrincipalInfoSearchRequest) SecurityIdentityProviderAPISecurityIdentityProviderSearchRequest {
	r.principalInfoSearchRequest = &principalInfoSearchRequest
	return r
}

func (r SecurityIdentityProviderAPISecurityIdentityProviderSearchRequest) Execute() ([]PrincipalInfoSearchResultResponse, *http.Response, error) {
...
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderSearchExecute(r SecurityIdentityProviderAPISecurityIdentityProviderSearchRequest) ([]PrincipalInfoSearchResultResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  []PrincipalInfoSearchResultResponse
	)
	...
	if r.principalInfoSearchRequest == nil {
		return localVarReturnValue, nil, reportError("principalInfoSearchRequest is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityIdentityProviderSearch400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type SecurityIdentityProviderAPISecurityIdentityProviderUpdateRequest struct {
	ctx context.Context
	ApiService *SecurityIdentityProviderAPIService
	securityIdentityProviderUpdateRequest *SecurityIdentityProviderUpdateRequest
}

// Identity provider to update
func (r SecurityIdentityProviderAPISecurityIdentityProviderUpdateRequest) SecurityIdentityProviderUpdateRequest(securityIdentityProviderUpdateRequest SecurityIdentityProviderUpdateRequest) SecurityIdentityProviderAPISecurityIdentityProviderUpdateRequest {
	r.securityIdentityProviderUpdateRequest = &securityIdentityProviderUpdateRequest
	return r
}

func (r SecurityIdentityProviderAPISecurityIdentityProviderUpdateRequest) Execute() (*SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return SecurityIdentityProviderList200ResponseInner
func (a *SecurityIdentityProviderAPIService) SecurityIdentityProviderUpdateExecute(r SecurityIdentityProviderAPISecurityIdentityProviderUpdateRequest) (*SecurityIdentityProviderList200ResponseInner, *http.Response, error) {
	var (
	...
	if r.securityIdentityProviderUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("securityIdentityProviderUpdateRequest is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityIdentityProviderUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

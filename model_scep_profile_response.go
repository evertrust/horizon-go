...
var _ MappedNullable = &ScepProfileResponse{}
...
type ScepProfileResponse struct {
	...
	PostPKIOperation NullableBool `json:"postPKIOperation,omitempty"`
	...
	PasswordPolicy NullableString `json:"passwordPolicy,omitempty"`
...
func (o *ScepProfileResponse) GetPostPKIOperation() bool {
	if o == nil || IsNil(o.PostPKIOperation.Get()) {
		var ret bool
		return ret
	}
...
func (o *ScepProfileResponse) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ScepProfileResponse) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScepProfileResponse) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}

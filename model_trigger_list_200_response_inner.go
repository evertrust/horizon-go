...
func (dst *TriggerList200ResponseInner) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.AWSTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.AzureKeyVaultTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.EmailNotificationResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.F5AS3TriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.F5ClientTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.GCMTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.IntunePKCSTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.LDAPTriggerResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.RESTResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebhookNotificationResponse)
	if err == nil {

...
// checks if the ADCSConnector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ADCSConnector{}

// ADCSConnector struct for ADCSConnector
type ADCSConnector struct {
	Name string `json:"name"`
	Type string `json:"type"`
	EndPoint string `json:"endPoint"`
	Profile string `json:"profile"`
	// Name of the `password` [credentials](#tag/api.security.credentials) to use for technical account on the PKI
	LoginCredentials string `json:"loginCredentials"`
	// Name of the `certificate` [credentials](#tag/api.security.credentials) to use to enroll on the PKI
...
type _ADCSConnector ADCSConnector
...
func (o *ADCSConnector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *ADCSConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *ADCSConnector) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o ADCSConnector) MarshalJSON() ([]byte, error) {
...
func (o ADCSConnector) ToMap() (map[string]interface{}, error) {
...
func (o *ADCSConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varADCSConnector := _ADCSConnector{}

	err = json.Unmarshal(data, &varADCSConnector)

	if err != nil {
		return err
	}

	*o = ADCSConnector(varADCSConnector)
...
type NullableADCSConnector struct {
	value *ADCSConnector
	isSet bool
}

func (v NullableADCSConnector) Get() *ADCSConnector {
	return v.value
}

func (v *NullableADCSConnector) Set(val *ADCSConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableADCSConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableADCSConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableADCSConnector(val *ADCSConnector) *NullableADCSConnector {
	return &NullableADCSConnector{value: val, isSet: true}
}

func (v NullableADCSConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableADCSConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the RequestBaseResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestBaseResponse{}
...
type _RequestBaseResponse RequestBaseResponse
...
func (o *RequestBaseResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *RequestBaseResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o RequestBaseResponse) ToMap() (map[string]interface{}, error) {
...
func (o *RequestBaseResponse) UnmarshalJSON(data []byte) (err error) {
	varRequestBaseResponse := _RequestBaseResponse{}

	err = json.Unmarshal(data, &varRequestBaseResponse)

	if err != nil {
		return err
	}

	*o = RequestBaseResponse(varRequestBaseResponse)
...
type NullableRequestBaseResponse struct {
	value *RequestBaseResponse
	isSet bool
}

func (v NullableRequestBaseResponse) Get() *RequestBaseResponse {
	return v.value
}

func (v *NullableRequestBaseResponse) Set(val *RequestBaseResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestBaseResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestBaseResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestBaseResponse(val *RequestBaseResponse) *NullableRequestBaseResponse {
	return &NullableRequestBaseResponse{value: val, isSet: true}
}

func (v NullableRequestBaseResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestBaseResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

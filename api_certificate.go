...
func (r CertificateAPICertificateGetPemRequest) Execute() (*models.Certificate, *http.Response, error) {
...
//
// Deprecated
func (a *CertificateAPIService) CertificateGetPemExecute(r CertificateAPICertificateGetPemRequest) (*models.Certificate, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *models.Certificate
	)

...
type CertificateAPICertificateAggregateRequest struct {
	...
	certificateAggregateQuery *CertificateAggregateQuery
	enableAnalytics *bool
}

// The certificate aggregation query
func (r CertificateAPICertificateAggregateRequest) CertificateAggregateQuery(certificateAggregateQuery CertificateAggregateQuery) CertificateAPICertificateAggregateRequest {
...
func (r CertificateAPICertificateAggregateRequest) Execute() (*CertificateAggregateResultResponse, *http.Response, error) {
...
func (a *CertificateAPIService) CertificateAggregateExecute(r CertificateAPICertificateAggregateRequest) (*CertificateAggregateResultResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CertificateAggregateResultResponse
	)
	...
	if r.certificateAggregateQuery == nil {
		return localVarReturnValue, nil, reportError("certificateAggregateQuery is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v CertificateAggregate400Response
...
func (a *CertificateAPIService) CertificateCsvExecute(r CertificateAPICertificateCsvRequest) (*http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v CertificateCsv400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
...
func (r CertificateAPICertificateDictionaryRequest) Execute() (*CertificateSearchDictionaryResponse, *http.Response, error) {
...
func (a *CertificateAPIService) CertificateDictionaryExecute(r CertificateAPICertificateDictionaryRequest) (*CertificateSearchDictionaryResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CertificateSearchDictionaryResponse
	)
...
func (r CertificateAPICertificateGetIdRequest) Execute() (*CertificateWithPermissionsResponse, *http.Response, error) {
...
// Execute executes the request
//  @return CertificateWithPermissionsResponse
func (a *CertificateAPIService) CertificateGetIdExecute(r CertificateAPICertificateGetIdRequest) (*CertificateWithPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v CertificateGetId404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r CertificateAPICertificateGetPemRequest) Execute() (*CertificateResponse, *http.Response, error) {
...
func (a *CertificateAPIService) CertificateGetPemExecute(r CertificateAPICertificateGetPemRequest) (*CertificateResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CertificateAPICertificateListRequest) Execute() ([]CertificateWithPermissionsResponse, *http.Response, error) {
...
// Execute executes the request
//  @return []CertificateWithPermissionsResponse
func (a *CertificateAPIService) CertificateListExecute(r CertificateAPICertificateListRequest) ([]CertificateWithPermissionsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r CertificateAPICertificateRunRequest) Execute() (*CertificateWithPermissionsResponse, *http.Response, error) {
...
// Execute executes the request
//  @return CertificateWithPermissionsResponse
func (a *CertificateAPIService) CertificateRunExecute(r CertificateAPICertificateRunRequest) (*CertificateWithPermissionsResponse, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v CertificateRun404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r CertificateAPICertificateSearchRequest) Execute() (*CertificateSearchResultsResponse, *http.Response, error) {
...
func (a *CertificateAPIService) CertificateSearchExecute(r CertificateAPICertificateSearchRequest) (*CertificateSearchResultsResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *CertificateSearchResultsResponse
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v CertificateSearch400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

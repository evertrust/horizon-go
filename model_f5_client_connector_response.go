...
var _ MappedNullable = &F5ClientConnectorResponse{}
...
type F5ClientConnectorResponse struct {
	...
	SslParent NullableString `json:"sslParent,omitempty"`
	Prefix NullableString `json:"prefix,omitempty"`
	CipherGroup NullableString `json:"cipherGroup,omitempty"`
...
func (o *F5ClientConnectorResponse) GetSslParent() string {
	if o == nil || IsNil(o.SslParent.Get()) {
		var ret string
		return ret
	}
...
func (o *F5ClientConnectorResponse) GetCipherGroup() string {
	if o == nil || IsNil(o.CipherGroup.Get()) {
		var ret string
		return ret
	}

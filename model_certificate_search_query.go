...
// checks if the CertificateSearchQuery type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CertificateSearchQuery{}

// CertificateSearchQuery struct for CertificateSearchQuery
...
type _CertificateSearchQuery CertificateSearchQuery
...
func NewCertificateSearchQuery() *CertificateSearchQuery {
	...
	this.PageIndex = *NewNullableInt64(&pageIndex)
	var pageSize int64 = 50
	this.PageSize = *NewNullableInt64(&pageSize)
	var withCount bool = false
	this.WithCount = *NewNullableBool(&withCount)
	return &this
}
...
func (o *CertificateSearchQuery) SetQueryNil() {
	o.Query.Set(nil)
}
...
func (o *CertificateSearchQuery) SetPageIndexNil() {
	o.PageIndex.Set(nil)
}
...
func (o *CertificateSearchQuery) SetPageSizeNil() {
	o.PageSize.Set(nil)
}
...
func (o *CertificateSearchQuery) SetWithCountNil() {
	o.WithCount.Set(nil)
}
...
func (o CertificateSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o CertificateSearchQuery) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateSearchQuery) UnmarshalJSON(data []byte) (err error) {
	varCertificateSearchQuery := _CertificateSearchQuery{}

	err = json.Unmarshal(data, &varCertificateSearchQuery)

	if err != nil {
		return err
	}

	*o = CertificateSearchQuery(varCertificateSearchQuery)
...
type NullableCertificateSearchQuery struct {
	value *CertificateSearchQuery
	isSet bool
}

func (v NullableCertificateSearchQuery) Get() *CertificateSearchQuery {
	return v.value
}

func (v *NullableCertificateSearchQuery) Set(val *CertificateSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateSearchQuery(val *CertificateSearchQuery) *NullableCertificateSearchQuery {
	return &NullableCertificateSearchQuery{value: val, isSet: true}
}

func (v NullableCertificateSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true

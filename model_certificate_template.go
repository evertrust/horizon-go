...
var _ MappedNullable = &CertificateTemplate{}
...
func (o *CertificateTemplate) GetOwnerPolicy() OwnerPolicy {
	if o == nil || IsNil(o.OwnerPolicy.Get()) {
		var ret OwnerPolicy
		return ret
	}
...
func (o *CertificateTemplate) GetTeamPolicy() TeamPolicy {
	if o == nil || IsNil(o.TeamPolicy.Get()) {
		var ret TeamPolicy
		return ret
	}
...
func (o *CertificateTemplate) GetMetadataPoliciesOk() ([]MetadataPolicy, bool) {
	if o == nil || IsNil(o.MetadataPolicies) {
		return nil, false
	}
...
func (o *CertificateTemplate) GetContactEmailPolicy() ContactEmailPolicy {
	if o == nil || IsNil(o.ContactEmailPolicy.Get()) {

...
// checks if the LDAPDatasource type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &LDAPDatasource{}

// LDAPDatasource struct for LDAPDatasource
type LDAPDatasource struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) to use for LDAP Authentication
	...
	DisableHostnameValidation NullableBool `json:"disableHostnameValidation,omitempty"`
	// LDAP Base DN
...
type _LDAPDatasource LDAPDatasource
...
func NewLDAPDatasource(type_ string, name string, credentials string, hostname string, timeout string, secure bool, baseDn string, filter string) *LDAPDatasource {
	...
	this.DisableHostnameValidation = *NewNullableBool(&disableHostnameValidation)
	this.BaseDn = baseDn
	this.Filter = filter
	return &this
}
...
func (o *LDAPDatasource) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *LDAPDatasource) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *LDAPDatasource) GetDisableHostnameValidation() bool {
	if o == nil || IsNil(o.DisableHostnameValidation.Get()) {
		var ret bool
		return ret
	}
...
func (o *LDAPDatasource) SetDisableHostnameValidationNil() {
...
func (o LDAPDatasource) MarshalJSON() ([]byte, error) {
...
func (o LDAPDatasource) ToMap() (map[string]interface{}, error) {
...
func (o *LDAPDatasource) UnmarshalJSON(data []byte) (err error) {
	...
	varLDAPDatasource := _LDAPDatasource{}

	err = json.Unmarshal(data, &varLDAPDatasource)

	if err != nil {
		return err
	}

	*o = LDAPDatasource(varLDAPDatasource)
...
type NullableLDAPDatasource struct {
	value *LDAPDatasource
	isSet bool
}

func (v NullableLDAPDatasource) Get() *LDAPDatasource {
	return v.value
}

func (v *NullableLDAPDatasource) Set(val *LDAPDatasource) {
	v.value = val
	v.isSet = true
}

func (v NullableLDAPDatasource) IsSet() bool {
	return v.isSet
}

func (v *NullableLDAPDatasource) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLDAPDatasource(val *LDAPDatasource) *NullableLDAPDatasource {
	return &NullableLDAPDatasource{value: val, isSet: true}
}

func (v NullableLDAPDatasource) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLDAPDatasource) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EJBCAConnector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &EJBCAConnector{}

// EJBCAConnector struct for EJBCAConnector
type EJBCAConnector struct {
	Name string `json:"name"`
	Type string `json:"type"`
	EndPoint string `json:"endPoint"`
	Profile string `json:"profile"`
	CaName string `json:"caName"`
	EeProfile NullableString `json:"eeProfile,omitempty"`
...
type _EJBCAConnector EJBCAConnector
...
func (o *EJBCAConnector) GetEeProfile() string {
	if o == nil || IsNil(o.EeProfile.Get()) {
		var ret string
		return ret
	}
...
func (o *EJBCAConnector) SetEeProfileNil() {
	o.EeProfile.Set(nil)
}
...
func (o *EJBCAConnector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *EJBCAConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *EJBCAConnector) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o EJBCAConnector) MarshalJSON() ([]byte, error) {
...
func (o EJBCAConnector) ToMap() (map[string]interface{}, error) {
...
func (o *EJBCAConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varEJBCAConnector := _EJBCAConnector{}

	err = json.Unmarshal(data, &varEJBCAConnector)

	if err != nil {
		return err
	}

	*o = EJBCAConnector(varEJBCAConnector)
...
type NullableEJBCAConnector struct {
	value *EJBCAConnector
	isSet bool
}

func (v NullableEJBCAConnector) Get() *EJBCAConnector {
	return v.value
}

func (v *NullableEJBCAConnector) Set(val *EJBCAConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableEJBCAConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableEJBCAConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEJBCAConnector(val *EJBCAConnector) *NullableEJBCAConnector {
	return &NullableEJBCAConnector{value: val, isSet: true}
}

func (v NullableEJBCAConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEJBCAConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

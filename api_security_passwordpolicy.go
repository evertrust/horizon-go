...
/*
PasswordPolicyAdd Create a password policy
...
func (a *SecurityPasswordpolicyAPIService) PasswordPolicyAddExecute(r SecurityPasswordpolicyAPIPasswordPolicyAddRequest) (*models.PasswordPolicyResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/security/passwordpolicies"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.PasswordPolicyAdd400Response
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v models.PasswordPolicyList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r SecurityPasswordpolicyAPIPasswordPolicyDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.PasswordPolicyDeleteExecute(r)
}

/*
PasswordPolicyDelete Delete a password policy
...
func (a *SecurityPasswordpolicyAPIService) PasswordPolicyDeleteExecute(r SecurityPasswordpolicyAPIPasswordPolicyDeleteRequest) (*http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/security/passwordpolicies/{name}"
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.PasswordPolicyDelete400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v models.PasswordPolicyUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
...
func (r SecurityPasswordpolicyAPIPasswordPolicyGenerateRequest) Execute() (string, *http.Response, error) {
	return r.ApiService.PasswordPolicyGenerateExecute(r)
}

/*
PasswordPolicyGenerate Generate a password with a password policy
...
func (a *SecurityPasswordpolicyAPIService) PasswordPolicyGenerateExecute(r SecurityPasswordpolicyAPIPasswordPolicyGenerateRequest) (string, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/security/passwordpolicies/{name}/generate"
	localVarPath = strings.Replace(localVarPath, "{"+"name"+"}", url.PathEscape(parameterValueToString(r.name, "name")), -1)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v models.PasswordPolicyGenerate500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
PasswordPolicyGet Retrieve a password policy
...
/*
PasswordPolicyList List password policies
...
/*
PasswordPolicyUpdate Update a password policy
...
func (a *SecurityPasswordpolicyAPIService) PasswordPolicyUpdateExecute(r SecurityPasswordpolicyAPIPasswordPolicyUpdateRequest) (*models.PasswordPolicyResponse, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.PasswordPolicyUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

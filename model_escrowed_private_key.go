...
var _ MappedNullable = &EscrowedPrivateKey{}

// EscrowedPrivateKey struct for EscrowedPrivateKey
type EscrowedPrivateKey struct {
	HorizonKey string `json:"horizonKey"`
	Value NullableString `json:"value,omitempty"`
	VaultKey NullableString `json:"vaultKey,omitempty"`
	Transient NullableBool `json:"transient,omitempty"`
...
func (o *EscrowedPrivateKey) GetTransient() bool {
	if o == nil || IsNil(o.Transient.Get()) {
		var ret bool
		return ret
	}

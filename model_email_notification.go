...
type EmailNotification struct {
	...
	IfPkcs12 NullableBool `json:"ifPkcs12,omitempty"`
	// Attach the certificate in PEM format if available
	AttachPemCertificate NullableBool `json:"attachPemCertificate,omitempty"`
	// Attach the certificate and its trust chain (bundle) in PEM format if available
	AttachPemBundle NullableBool `json:"attachPemBundle,omitempty"`
	// Attach the certificate in DER format if available
	AttachDerCertificate NullableBool `json:"attachDerCertificate,omitempty"`
	// Attach the certificate in PKCS7 format if available
	AttachPkcs7 NullableBool `json:"attachPkcs7,omitempty"`
	// Attach the certificate and its trust chain (bundle) in PKCS7 format if available
	AttachPkcs7Bundle NullableBool `json:"attachPkcs7Bundle,omitempty"`
	// Attach the certificate in PKCS#12 format if available
	AttachPkcs12 NullableBool `json:"attachPkcs12,omitempty"`
...
func (o *EmailNotification) GetAttachPemCertificate() bool {
	if o == nil || IsNil(o.AttachPemCertificate.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) GetAttachPemBundle() bool {
	if o == nil || IsNil(o.AttachPemBundle.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) GetAttachDerCertificate() bool {
	if o == nil || IsNil(o.AttachDerCertificate.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) GetAttachPkcs7() bool {
	if o == nil || IsNil(o.AttachPkcs7.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) GetAttachPkcs7Bundle() bool {
	if o == nil || IsNil(o.AttachPkcs7Bundle.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) GetAttachPkcs12() bool {
	if o == nil || IsNil(o.AttachPkcs12.Get()) {
		var ret bool
		return ret
	}
...
func (o *EmailNotification) SetLicenseUsagePercentNil() {

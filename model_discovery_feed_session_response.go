...
var _ MappedNullable = &DiscoveryFeedSessionResponse{}
...
type DiscoveryFeedSessionResponse struct {
	...
	EventOnSuccess NullableBool `json:"eventOnSuccess,omitempty"`
	// Whether to generate an event on warning (defaults to the campaign setting)
	EventOnWarning NullableBool `json:"eventOnWarning,omitempty"`
	// Whether to generate an event on failure (defaults to the campaign setting)
	EventOnFailure NullableBool `json:"eventOnFailure,omitempty"`
...
func (o *DiscoveryFeedSessionResponse) GetEventOnSuccess() bool {
	if o == nil || IsNil(o.EventOnSuccess.Get()) {
		var ret bool
		return ret
	}
...
func (o *DiscoveryFeedSessionResponse) GetEventOnWarning() bool {
	if o == nil || IsNil(o.EventOnWarning.Get()) {
		var ret bool
		return ret
	}
...
func (o *DiscoveryFeedSessionResponse) GetEventOnFailure() bool {
	if o == nil || IsNil(o.EventOnFailure.Get()) {
		var ret bool
		return ret
	}

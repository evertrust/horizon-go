...
// checks if the WebRARecoverRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRARecoverRequestOnTemplate{}

// WebRARecoverRequestOnTemplate struct for WebRARecoverRequestOnTemplate
type WebRARecoverRequestOnTemplate struct {
	...
	// Used to pre-fill the template field with the certificate values.
	CertificatePem NullableString `json:"certificatePem,omitempty"`
	// The request module
...
type _WebRARecoverRequestOnTemplate WebRARecoverRequestOnTemplate
...
func (o *WebRARecoverRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRARecoverRequestOnTemplate) GetCertificatePem() string {
	if o == nil || IsNil(o.CertificatePem.Get()) {
		var ret string
		return ret
	}
...
func (o *WebRARecoverRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRARecoverRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o WebRARecoverRequestOnTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARecoverRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARecoverRequestOnTemplate := _WebRARecoverRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRARecoverRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRARecoverRequestOnTemplate(varWebRARecoverRequestOnTemplate)
...
type NullableWebRARecoverRequestOnTemplate struct {
	value *WebRARecoverRequestOnTemplate
	isSet bool
}

func (v NullableWebRARecoverRequestOnTemplate) Get() *WebRARecoverRequestOnTemplate {
	return v.value
}

func (v *NullableWebRARecoverRequestOnTemplate) Set(val *WebRARecoverRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARecoverRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARecoverRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARecoverRequestOnTemplate(val *WebRARecoverRequestOnTemplate) *NullableWebRARecoverRequestOnTemplate {
	return &NullableWebRARecoverRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRARecoverRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARecoverRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

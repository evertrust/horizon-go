...
// checks if the WcceProfileResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WcceProfileResponse{}

// WcceProfileResponse struct for WcceProfileResponse
type WcceProfileResponse struct {
	// Object internal ID
	Id string `json:"_id"`
	...
	ExchangeCertificate NullableString `json:"exchangeCertificate,omitempty"`
	// Representation of a datasource execution flow
	DsFlow []DataSourceFlowEntry `json:"dsFlow,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _WcceProfileResponse WcceProfileResponse

// NewWcceProfileResponse instantiates a new WcceProfileResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewWcceProfileResponse(id string, module string, name string, enabled bool, pkiConnector string, authorizationLevels CertificateProfileAuthorizationLevels, requestsPolicy RequestsPolicy, selfPermissions CertificateProfileSelfPermissions, cryptoPolicy CertificateProfileCryptoPolicy) *WcceProfileResponse {
	this := WcceProfileResponse{}
	this.Id = id
	this.Module = module
	this.Name = name
...
func (o *WcceProfileResponse) SetConstraintsNil() {
...
func (o *WcceProfileResponse) SetMaxCertificatePerHolderPolicyNil() {
...
func (o *WcceProfileResponse) SetTriggersNil() {
	o.Triggers.Set(nil)
}
...
func (o *WcceProfileResponse) SetCertificateTemplateNil() {
...
func (o *WcceProfileResponse) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WcceProfileResponse) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WcceProfileResponse) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}
...
func (o *WcceProfileResponse) GetExchangeCertificate() string {
	if o == nil || IsNil(o.ExchangeCertificate.Get()) {
		var ret string
		return ret
	}
...
func (o *WcceProfileResponse) SetExchangeCertificateNil() {
...
func (o WcceProfileResponse) MarshalJSON() ([]byte, error) {
...
func (o WcceProfileResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WcceProfileResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWcceProfileResponse := _WcceProfileResponse{}

	err = json.Unmarshal(data, &varWcceProfileResponse)

	if err != nil {
		return err
	}

	*o = WcceProfileResponse(varWcceProfileResponse)
...
type NullableWcceProfileResponse struct {
	value *WcceProfileResponse
	isSet bool
}

func (v NullableWcceProfileResponse) Get() *WcceProfileResponse {
	return v.value
}

func (v *NullableWcceProfileResponse) Set(val *WcceProfileResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWcceProfileResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWcceProfileResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWcceProfileResponse(val *WcceProfileResponse) *NullableWcceProfileResponse {
	return &NullableWcceProfileResponse{value: val, isSet: true}
}

func (v NullableWcceProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWcceProfileResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

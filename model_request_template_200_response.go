...
func (dst *RequestTemplate200Response) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.EstEnrollRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.ScepEnrollRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAEnrollRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAImportRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAMigrateRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARecoverRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARenewRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARevokeRequestOnTemplateResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAUpdateRequestOnTemplateResponse)
	if err == nil {

...
var _ MappedNullable = &StreamConnectorResponse{}
...
type StreamConnectorResponse struct {
	...
	Ca string `json:"ca"`
	// Name of the `password` [credentials](#tag/api.security.credentials) to use to authenticate on the PKI
	LoginCredentials NullableString `json:"loginCredentials,omitempty"`
...
func (o *StreamConnectorResponse) GetLoginCredentials() string {
	if o == nil || IsNil(o.LoginCredentials.Get()) {
		var ret string
		return ret
	}

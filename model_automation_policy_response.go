...
var _ MappedNullable = &AutomationPolicyResponse{}
...
type AutomationPolicyResponse struct {
	...
	ExecutionPolicy NullableString `json:"executionPolicy,omitempty"`
...
func (o *AutomationPolicyResponse) GetExecutionPolicy() string {
	if o == nil || IsNil(o.ExecutionPolicy.Get()) {
		var ret string
		return ret
	}

...
// checks if the TrustChainAnchor type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &TrustChainAnchor{}
...
type _TrustChainAnchor TrustChainAnchor
...
func (o TrustChainAnchor) MarshalJSON() ([]byte, error) {
...
func (o *TrustChainAnchor) UnmarshalJSON(data []byte) (err error) {
	...
	varTrustChainAnchor := _TrustChainAnchor{}

	err = json.Unmarshal(data, &varTrustChainAnchor)

	if err != nil {
		return err
	}

	*o = TrustChainAnchor(varTrustChainAnchor)
...
type NullableTrustChainAnchor struct {
	value *TrustChainAnchor
	isSet bool
}

func (v NullableTrustChainAnchor) Get() *TrustChainAnchor {
	return v.value
}

func (v *NullableTrustChainAnchor) Set(val *TrustChainAnchor) {
	v.value = val
	v.isSet = true
}

func (v NullableTrustChainAnchor) IsSet() bool {
	return v.isSet
}

func (v *NullableTrustChainAnchor) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrustChainAnchor(val *TrustChainAnchor) *NullableTrustChainAnchor {
	return &NullableTrustChainAnchor{value: val, isSet: true}
}

func (v NullableTrustChainAnchor) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrustChainAnchor) UnmarshalJSON(src []byte) error {
	v.isSet = true

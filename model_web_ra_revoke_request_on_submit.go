...
// checks if the WebRARevokeRequestOnSubmit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRARevokeRequestOnSubmit{}

// WebRARevokeRequestOnSubmit struct for WebRARevokeRequestOnSubmit
type WebRARevokeRequestOnSubmit struct {
...
type _WebRARevokeRequestOnSubmit WebRARevokeRequestOnSubmit
...
func (o *WebRARevokeRequestOnSubmit) SetCertificateIdNil() {
...
func (o *WebRARevokeRequestOnSubmit) SetCertificatePemNil() {
...
func (o *WebRARevokeRequestOnSubmit) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRARevokeRequestOnSubmit) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARevokeRequestOnSubmit) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARevokeRequestOnSubmit := _WebRARevokeRequestOnSubmit{}

	err = json.Unmarshal(data, &varWebRARevokeRequestOnSubmit)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestOnSubmit(varWebRARevokeRequestOnSubmit)
...
type NullableWebRARevokeRequestOnSubmit struct {
	value *WebRARevokeRequestOnSubmit
	isSet bool
}

func (v NullableWebRARevokeRequestOnSubmit) Get() *WebRARevokeRequestOnSubmit {
	return v.value
}

func (v *NullableWebRARevokeRequestOnSubmit) Set(val *WebRARevokeRequestOnSubmit) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestOnSubmit) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestOnSubmit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestOnSubmit(val *WebRARevokeRequestOnSubmit) *NullableWebRARevokeRequestOnSubmit {
	return &NullableWebRARevokeRequestOnSubmit{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestOnSubmit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestOnSubmit) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
func (dst *RequestSubmit201Response) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.EstEnrollRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.ScepEnrollRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAEnrollRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAImportRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAMigrateRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARecoverRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARenewRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARevokeRequestOnSubmitResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAUpdateRequestOnSubmitResponse)
	if err == nil {

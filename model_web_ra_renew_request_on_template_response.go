...
// checks if the WebRARenewRequestOnTemplateResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRARenewRequestOnTemplateResponse{}
...
type _WebRARenewRequestOnTemplateResponse WebRARenewRequestOnTemplateResponse
...
func NewWebRARenewRequestOnTemplateResponse(workflow string, module string, template WebRARenewRequestTemplateResponse) *WebRARenewRequestOnTemplateResponse {
...
func (o *WebRARenewRequestOnTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARenewRequestOnTemplateResponse := _WebRARenewRequestOnTemplateResponse{}

	err = json.Unmarshal(data, &varWebRARenewRequestOnTemplateResponse)

	if err != nil {
		return err
	}

	*o = WebRARenewRequestOnTemplateResponse(varWebRARenewRequestOnTemplateResponse)
...
type NullableWebRARenewRequestOnTemplateResponse struct {
	value *WebRARenewRequestOnTemplateResponse
	isSet bool
}

func (v NullableWebRARenewRequestOnTemplateResponse) Get() *WebRARenewRequestOnTemplateResponse {
	return v.value
}

func (v *NullableWebRARenewRequestOnTemplateResponse) Set(val *WebRARenewRequestOnTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARenewRequestOnTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARenewRequestOnTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARenewRequestOnTemplateResponse(val *WebRARenewRequestOnTemplateResponse) *NullableWebRARenewRequestOnTemplateResponse {
	return &NullableWebRARenewRequestOnTemplateResponse{value: val, isSet: true}
}

func (v NullableWebRARenewRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARenewRequestOnTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

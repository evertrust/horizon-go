...
type DiscoveryCampaignAPIDiscoveryCampaignAddRequest struct {
	...
	discoveryCampaign *DiscoveryCampaign
}

// Discovery campaign to register
func (r DiscoveryCampaignAPIDiscoveryCampaignAddRequest) DiscoveryCampaign(discoveryCampaign DiscoveryCampaign) DiscoveryCampaignAPIDiscoveryCampaignAddRequest {
	r.discoveryCampaign = &discoveryCampaign
	return r
}

func (r DiscoveryCampaignAPIDiscoveryCampaignAddRequest) Execute() (*DiscoveryCampaignResponse, *http.Response, error) {
...
func (a *DiscoveryCampaignAPIService) DiscoveryCampaignAddExecute(r DiscoveryCampaignAPIDiscoveryCampaignAddRequest) (*DiscoveryCampaignResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *DiscoveryCampaignResponse
	)
	...
	if r.discoveryCampaign == nil {
		return localVarReturnValue, nil, reportError("discoveryCampaign is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v DiscoveryCampaignAdd400Response
		...
		if localVarHTTPResponse.StatusCode == 403 {
			var v DiscoveryCampaignAdd403Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v DiscoveryCampaignList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r DiscoveryCampaignAPIDiscoveryCampaignGetRequest) Execute() (*DiscoveryCampaignResponse, *http.Response, error) {
...
// Execute executes the request
//  @return DiscoveryCampaignResponse
func (a *DiscoveryCampaignAPIService) DiscoveryCampaignGetExecute(r DiscoveryCampaignAPIDiscoveryCampaignGetRequest) (*DiscoveryCampaignResponse, *http.Response, error) {
	var (
...
func (r DiscoveryCampaignAPIDiscoveryCampaignListRequest) Execute() ([]DiscoveryCampaignResponse, *http.Response, error) {
...
// Execute executes the request
//  @return []DiscoveryCampaignResponse
func (a *DiscoveryCampaignAPIService) DiscoveryCampaignListExecute(r DiscoveryCampaignAPIDiscoveryCampaignListRequest) ([]DiscoveryCampaignResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r DiscoveryCampaignAPIDiscoveryCampaignUpdateRequest) DiscoveryCampaign(discoveryCampaign DiscoveryCampaign) DiscoveryCampaignAPIDiscoveryCampaignUpdateRequest {
	r.discoveryCampaign = &discoveryCampaign
	return r
}

func (r DiscoveryCampaignAPIDiscoveryCampaignUpdateRequest) Execute() (*DiscoveryCampaignResponse, *http.Response, error) {
...
// Execute executes the request
//  @return DiscoveryCampaignResponse
func (a *DiscoveryCampaignAPIService) DiscoveryCampaignUpdateExecute(r DiscoveryCampaignAPIDiscoveryCampaignUpdateRequest) (*DiscoveryCampaignResponse, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v DiscoveryCampaignUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

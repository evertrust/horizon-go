...
func (dst *RequestSubmitRequest) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.EstEnrollRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.ScepEnrollRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAEnrollRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAImportRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAMigrateRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARecoverRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARenewRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARevokeRequestOnSubmit)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAUpdateRequestOnSubmit)
	if err == nil {

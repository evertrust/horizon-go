...
var _ MappedNullable = &CertificatePermissions{}
...
type CertificatePermissions struct {
	...
	Enroll NullableBool `json:"enroll,omitempty"`
	// Whether the principal is authorized to request re-enrollment of this certificate
	RequestEnroll NullableBool `json:"requestEnroll,omitempty"`
	...
	Recover NullableBool `json:"recover,omitempty"`
	// Whether the principal is authorized to request recovery of this certificate
	RequestRecover NullableBool `json:"requestRecover,omitempty"`
	...
	Renew NullableBool `json:"renew,omitempty"`
	// Whether the principal is authorized to request renewal of this certificate
	RequestRenew NullableBool `json:"requestRenew,omitempty"`

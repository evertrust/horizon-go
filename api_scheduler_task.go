...
type SchedulerTaskAPISchedulerTaskAddRequest struct {
	...
	schedulerTaskAddRequest *SchedulerTaskAddRequest
}

// Scheduled task to register
func (r SchedulerTaskAPISchedulerTaskAddRequest) SchedulerTaskAddRequest(schedulerTaskAddRequest SchedulerTaskAddRequest) SchedulerTaskAPISchedulerTaskAddRequest {
	r.schedulerTaskAddRequest = &schedulerTaskAddRequest
	return r
}

func (r SchedulerTaskAPISchedulerTaskAddRequest) Execute() (*SchedulerTaskList200ResponseInner, *http.Response, error) {
...
func (a *SchedulerTaskAPIService) SchedulerTaskAddExecute(r SchedulerTaskAPISchedulerTaskAddRequest) (*SchedulerTaskList200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SchedulerTaskList200ResponseInner
	)
	...
	if r.schedulerTaskAddRequest == nil {
		return localVarReturnValue, nil, reportError("schedulerTaskAddRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.schedulerTaskAddRequest
	if r.ctx != nil {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SchedulerTaskAdd400Response
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v SchedulerTaskUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v SchedulerTaskList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r SchedulerTaskAPISchedulerTaskGetRequest) Execute() (*SchedulerTaskList200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return SchedulerTaskList200ResponseInner
func (a *SchedulerTaskAPIService) SchedulerTaskGetExecute(r SchedulerTaskAPISchedulerTaskGetRequest) (*SchedulerTaskList200ResponseInner, *http.Response, error) {
	var (
...
func (r SchedulerTaskAPISchedulerTaskListRequest) Execute() ([]SchedulerTaskList200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []SchedulerTaskList200ResponseInner
func (a *SchedulerTaskAPIService) SchedulerTaskListExecute(r SchedulerTaskAPISchedulerTaskListRequest) ([]SchedulerTaskList200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SchedulerTaskList400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
type SchedulerTaskAPISchedulerTaskUpdateRequest struct {
	ctx context.Context
	ApiService *SchedulerTaskAPIService
	schedulerTaskUpdateRequest *SchedulerTaskUpdateRequest
}

// Scheduled task to update
func (r SchedulerTaskAPISchedulerTaskUpdateRequest) SchedulerTaskUpdateRequest(schedulerTaskUpdateRequest SchedulerTaskUpdateRequest) SchedulerTaskAPISchedulerTaskUpdateRequest {
	r.schedulerTaskUpdateRequest = &schedulerTaskUpdateRequest
	return r
}

func (r SchedulerTaskAPISchedulerTaskUpdateRequest) Execute() (*SchedulerTaskUpdate200Response, *http.Response, error) {
...
func (a *SchedulerTaskAPIService) SchedulerTaskUpdateExecute(r SchedulerTaskAPISchedulerTaskUpdateRequest) (*SchedulerTaskUpdate200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPut
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *SchedulerTaskUpdate200Response
	)
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.schedulerTaskUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("schedulerTaskUpdateRequest is required and must be specified")
	}
	...
	// body params
	localVarPostBody = r.schedulerTaskUpdateRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {

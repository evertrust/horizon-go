...
var _ MappedNullable = &JamfProfileResponse{}
...
func (o *JamfProfileResponse) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *JamfProfileResponse) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *JamfProfileResponse) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}

...
// SecurityIdentityLocalUpdate401Response struct for SecurityIdentityLocalUpdate401Response
type SecurityIdentityLocalUpdate401Response struct {
...
func (dst *SecurityIdentityLocalUpdate401Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(SecurityIdentityLocalUpdate401Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SecurityIdentityLocalUpdate401Response) MarshalJSON() ([]byte, error) {
...
type NullableSecurityIdentityLocalUpdate401Response struct {
	value *SecurityIdentityLocalUpdate401Response
	isSet bool
}

func (v NullableSecurityIdentityLocalUpdate401Response) Get() *SecurityIdentityLocalUpdate401Response {
	return v.value
}

func (v *NullableSecurityIdentityLocalUpdate401Response) Set(val *SecurityIdentityLocalUpdate401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityIdentityLocalUpdate401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityIdentityLocalUpdate401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityIdentityLocalUpdate401Response(val *SecurityIdentityLocalUpdate401Response) *NullableSecurityIdentityLocalUpdate401Response {
	return &NullableSecurityIdentityLocalUpdate401Response{value: val, isSet: true}
}

func (v NullableSecurityIdentityLocalUpdate401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityIdentityLocalUpdate401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

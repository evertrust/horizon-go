...
var _ MappedNullable = &MetaPKIConnector{}
...
type MetaPKIConnector struct {
	...
	Workflow NullableString `json:"workflow"`
	ProfilCle NullableString `json:"profilCle"`
	...
	FormPorteurName NullableString `json:"formPorteurName,omitempty"`
	// Name of the `certificate` [credentials](#tag/api.security.credentials) to use to authenticate on the PKI
	AuthenticationCredentials NullableString `json:"authenticationCredentials,omitempty"`
...
func NewMetaPKIConnector(name string, type_ string, endPoint string, endPointIssuingCA string, profile string, workflow NullableString, profilCle NullableString) *MetaPKIConnector {
...
func (o *MetaPKIConnector) GetFormPorteurName() string {
	if o == nil || IsNil(o.FormPorteurName.Get()) {
		var ret string
		return ret
	}
...
func (o *MetaPKIConnector) GetAuthenticationCredentials() string {
	if o == nil || IsNil(o.AuthenticationCredentials.Get()) {
		var ret string
		return ret
	}

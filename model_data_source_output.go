...
var _ MappedNullable = &DataSourceOutput{}
...
type DataSourceOutput struct {
	...
	Multi NullableBool `json:"multi,omitempty"`
...
func NewDataSourceOutput(key string) *DataSourceOutput {
	...
	this.Multi = *NewNullableBool(&multi)
	var selected bool = true
	this.Selected = *NewNullableBool(&selected)
	return &this
}

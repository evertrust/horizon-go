...
// If true, include the Terms of Service entry configured on the profile in the response. Only applies to WebRA, EST and SCEP enroll requests.
func (r RequestAPIRequestTemplateRequest) TermsOfService(termsOfService bool) RequestAPIRequestTemplateRequest {
...
func (a *RequestAPIService) RequestTemplateExecute(r RequestAPIRequestTemplateRequest) (*models.RequestTemplate200Response, *http.Response, error) {
	...
	if r.termsOfService != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "termsOfService", r.termsOfService, "form", "")
	} else {
		var defaultValue bool = false
		r.termsOfService = &defaultValue
	}
	// to determine the Content-Type header
	localVarHTTPContentTypes := []string{"application/json"}

...
func (dst *RequestGet200Response) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.EstEnrollRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.ScepEnrollRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAEnrollRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAImportRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAMigrateRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARecoverRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARenewRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARevokeRequestOnApproveResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAUpdateRequestOnApproveResponse)
	if err == nil {

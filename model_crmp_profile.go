...
var _ MappedNullable = &CrmpProfile{}
...
type CrmpProfile struct {
	...
	DataFieldIdentifier NullableString `json:"dataFieldIdentifier,omitempty" validate:"regexp=(rfc822name|othername_upn|mail|uid|cn|label\\\\..+)"`
...
func (o *CrmpProfile) GetDataFieldIdentifier() string {
	if o == nil || IsNil(o.DataFieldIdentifier.Get()) {
		var ret string
		return ret
	}

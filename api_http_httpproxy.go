...
func (r HttpHttpproxyAPIHttpproxyAddRequest) HttpProxy(httpProxy HttpProxy) HttpHttpproxyAPIHttpproxyAddRequest {
	r.httpProxy = &httpProxy
	return r
}

func (r HttpHttpproxyAPIHttpproxyAddRequest) Execute() (*HttpProxyResponse, *http.Response, error) {
...
func (a *HttpHttpproxyAPIService) HttpproxyAddExecute(r HttpHttpproxyAPIHttpproxyAddRequest) (*HttpProxyResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *HttpProxyResponse
	)
	...
	if r.httpProxy == nil {
		return localVarReturnValue, nil, reportError("httpProxy is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v HttpproxyList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *HttpHttpproxyAPIService) HttpproxyDeleteExecute(r HttpHttpproxyAPIHttpproxyDeleteRequest) (*http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v HttpproxyDelete400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v HttpproxyUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
...
func (r HttpHttpproxyAPIHttpproxyGetRequest) Execute() (*HttpProxyResponse, *http.Response, error) {
...
// Execute executes the request
//  @return HttpProxyResponse
func (a *HttpHttpproxyAPIService) HttpproxyGetExecute(r HttpHttpproxyAPIHttpproxyGetRequest) (*HttpProxyResponse, *http.Response, error) {
	var (
...
func (r HttpHttpproxyAPIHttpproxyListRequest) Execute() ([]HttpProxyResponse, *http.Response, error) {
...
// Execute executes the request
//  @return []HttpProxyResponse
func (a *HttpHttpproxyAPIService) HttpproxyListExecute(r HttpHttpproxyAPIHttpproxyListRequest) ([]HttpProxyResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r HttpHttpproxyAPIHttpproxyUpdateRequest) HttpProxy(httpProxy HttpProxy) HttpHttpproxyAPIHttpproxyUpdateRequest {
	r.httpProxy = &httpProxy
	return r
}

func (r HttpHttpproxyAPIHttpproxyUpdateRequest) Execute() (*HttpProxyResponse, *http.Response, error) {
...
// Execute executes the request
//  @return HttpProxyResponse
func (a *HttpHttpproxyAPIService) HttpproxyUpdateExecute(r HttpHttpproxyAPIHttpproxyUpdateRequest) (*HttpProxyResponse, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v HttpproxyUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

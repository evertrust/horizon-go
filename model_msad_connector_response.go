...
var _ MappedNullable = &MSADConnectorResponse{}
...
type MSADConnectorResponse struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the DN and password to authenticate on Active Directory

...
// checks if the FortiManagerTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &FortiManagerTrigger{}

// FortiManagerTrigger struct for FortiManagerTrigger
type FortiManagerTrigger struct {
...
type _FortiManagerTrigger FortiManagerTrigger
...
func (o *FortiManagerTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o FortiManagerTrigger) MarshalJSON() ([]byte, error) {
...
func (o FortiManagerTrigger) ToMap() (map[string]interface{}, error) {
...
func (o *FortiManagerTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varFortiManagerTrigger := _FortiManagerTrigger{}

	err = json.Unmarshal(data, &varFortiManagerTrigger)

	if err != nil {
		return err
	}

	*o = FortiManagerTrigger(varFortiManagerTrigger)
...
type NullableFortiManagerTrigger struct {
	value *FortiManagerTrigger
	isSet bool
}

func (v NullableFortiManagerTrigger) Get() *FortiManagerTrigger {
	return v.value
}

func (v *NullableFortiManagerTrigger) Set(val *FortiManagerTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableFortiManagerTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableFortiManagerTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFortiManagerTrigger(val *FortiManagerTrigger) *NullableFortiManagerTrigger {
	return &NullableFortiManagerTrigger{value: val, isSet: true}
}

func (v NullableFortiManagerTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFortiManagerTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

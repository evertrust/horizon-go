...
// checks if the WebRARecoverRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARecoverRequestOnApproveResponse{}

// WebRARecoverRequestOnApproveResponse struct for WebRARecoverRequestOnApproveResponse
type WebRARecoverRequestOnApproveResponse struct {
...
type _WebRARecoverRequestOnApproveResponse WebRARecoverRequestOnApproveResponse
...
func NewWebRARecoverRequestOnApproveResponse(module string, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRARecoverRequestOnApproveResponse {
	this := WebRARecoverRequestOnApproveResponse{}
	this.Module = module
...
func (o *WebRARecoverRequestOnApproveResponse) SetCertificateNil() {
...
func (o *WebRARecoverRequestOnApproveResponse) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetPkcs12Nil() {
	o.Pkcs12.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *WebRARecoverRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRARecoverRequestOnApproveResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRARecoverRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRARecoverRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRARecoverRequestOnApproveResponse) SetRequesterCommentNil() {
...
func (o *WebRARecoverRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRARecoverRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRARecoverRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARecoverRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARecoverRequestOnApproveResponse := _WebRARecoverRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varWebRARecoverRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = WebRARecoverRequestOnApproveResponse(varWebRARecoverRequestOnApproveResponse)
...
type NullableWebRARecoverRequestOnApproveResponse struct {
	value *WebRARecoverRequestOnApproveResponse
	isSet bool
}

func (v NullableWebRARecoverRequestOnApproveResponse) Get() *WebRARecoverRequestOnApproveResponse {
	return v.value
}

func (v *NullableWebRARecoverRequestOnApproveResponse) Set(val *WebRARecoverRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARecoverRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARecoverRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARecoverRequestOnApproveResponse(val *WebRARecoverRequestOnApproveResponse) *NullableWebRARecoverRequestOnApproveResponse {
	return &NullableWebRARecoverRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableWebRARecoverRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARecoverRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

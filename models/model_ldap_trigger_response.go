...
// checks if the LDAPTriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LDAPTriggerResponse{}

// LDAPTriggerResponse struct for LDAPTriggerResponse
type LDAPTriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _LDAPTriggerResponse LDAPTriggerResponse

// NewLDAPTriggerResponse instantiates a new LDAPTriggerResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLDAPTriggerResponse(id string, connector string, events []TriggerEvent, name string, type_ string) *LDAPTriggerResponse {
	this := LDAPTriggerResponse{}
	this.Id = id
...
func (o *LDAPTriggerResponse) GetEvents() []TriggerEvent {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *LDAPTriggerResponse) GetEventsOk() ([]TriggerEvent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LDAPTriggerResponse) SetEvents(v []TriggerEvent) {
	o.Events = v
}
...
func (o *LDAPTriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o LDAPTriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o LDAPTriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *LDAPTriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLDAPTriggerResponse := _LDAPTriggerResponse{}

	err = json.Unmarshal(data, &varLDAPTriggerResponse)

	if err != nil {
		return err
	}

	*o = LDAPTriggerResponse(varLDAPTriggerResponse)
...
type NullableLDAPTriggerResponse struct {
	value *LDAPTriggerResponse
	isSet bool
}

func (v NullableLDAPTriggerResponse) Get() *LDAPTriggerResponse {
	return v.value
}

func (v *NullableLDAPTriggerResponse) Set(val *LDAPTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLDAPTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLDAPTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLDAPTriggerResponse(val *LDAPTriggerResponse) *NullableLDAPTriggerResponse {
	return &NullableLDAPTriggerResponse{value: val, isSet: true}
}

func (v NullableLDAPTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLDAPTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

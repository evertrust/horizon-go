...
// checks if the EfficientIpProvisionerConfig type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EfficientIpProvisionerConfig{}

// EfficientIpProvisionerConfig struct for EfficientIpProvisionerConfig
type EfficientIpProvisionerConfig struct {
...
type _EfficientIpProvisionerConfig EfficientIpProvisionerConfig
...
func NewEfficientIpProvisionerConfig(credentials string, dnsName string, endpoint string, name string, ttl utils.NullableString, type_ string) *EfficientIpProvisionerConfig {
	this := EfficientIpProvisionerConfig{}
...
func (o *EfficientIpProvisionerConfig) SetDelegationZoneNil() {
...
func (o *EfficientIpProvisionerConfig) SetDnsViewNil() {
	o.DnsView.Set(nil)
}
...
func (o *EfficientIpProvisionerConfig) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *EfficientIpProvisionerConfig) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o EfficientIpProvisionerConfig) MarshalJSON() ([]byte, error) {
...
func (o EfficientIpProvisionerConfig) ToMap() (map[string]interface{}, error) {
...
func (o *EfficientIpProvisionerConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varEfficientIpProvisionerConfig := _EfficientIpProvisionerConfig{}

	err = json.Unmarshal(data, &varEfficientIpProvisionerConfig)

	if err != nil {
		return err
	}

	*o = EfficientIpProvisionerConfig(varEfficientIpProvisionerConfig)
...
type NullableEfficientIpProvisionerConfig struct {
	value *EfficientIpProvisionerConfig
	isSet bool
}

func (v NullableEfficientIpProvisionerConfig) Get() *EfficientIpProvisionerConfig {
	return v.value
}

func (v *NullableEfficientIpProvisionerConfig) Set(val *EfficientIpProvisionerConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableEfficientIpProvisionerConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableEfficientIpProvisionerConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEfficientIpProvisionerConfig(val *EfficientIpProvisionerConfig) *NullableEfficientIpProvisionerConfig {
	return &NullableEfficientIpProvisionerConfig{value: val, isSet: true}
}

func (v NullableEfficientIpProvisionerConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEfficientIpProvisionerConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true

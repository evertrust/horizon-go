...
// checks if the WcceProfile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WcceProfile{}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WcceProfile) GetThirdPartyDiscoverySyncOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WcceProfile) HasThirdPartyDiscoverySync() bool {
...
func (o *WcceProfile) SetThirdPartyDiscoverySync(v bool) {
...
func (o *WcceProfile) SetThirdPartyDiscoverySyncNil() {
...
func (o *WcceProfile) UnsetThirdPartyDiscoverySync() {
...
func (o *WcceProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varWcceProfile := _WcceProfile{}

	err = json.Unmarshal(data, &varWcceProfile)

	if err != nil {
		return err
	}

	*o = WcceProfile(varWcceProfile)
...
type NullableWcceProfile struct {
	value *WcceProfile
	isSet bool
}

func (v NullableWcceProfile) Get() *WcceProfile {
	return v.value
}

func (v *NullableWcceProfile) Set(val *WcceProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableWcceProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableWcceProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWcceProfile(val *WcceProfile) *NullableWcceProfile {
	return &NullableWcceProfile{value: val, isSet: true}
}

func (v NullableWcceProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWcceProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

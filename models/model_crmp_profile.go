...
// checks if the CrmpProfile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CrmpProfile{}
...
func (o *CrmpProfile) GetThirdPartyDiscoverySync() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CrmpProfile) GetThirdPartyDiscoverySyncOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CrmpProfile) HasThirdPartyDiscoverySync() bool {
...
func (o *CrmpProfile) SetThirdPartyDiscoverySync(v bool) {
...
func (o *CrmpProfile) SetThirdPartyDiscoverySyncNil() {
...
func (o *CrmpProfile) UnsetThirdPartyDiscoverySync() {
...
func (o *CrmpProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varCrmpProfile := _CrmpProfile{}

	err = json.Unmarshal(data, &varCrmpProfile)

	if err != nil {
		return err
	}

	*o = CrmpProfile(varCrmpProfile)
...
type NullableCrmpProfile struct {
	value *CrmpProfile
	isSet bool
}

func (v NullableCrmpProfile) Get() *CrmpProfile {
	return v.value
}

func (v *NullableCrmpProfile) Set(val *CrmpProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableCrmpProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableCrmpProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCrmpProfile(val *CrmpProfile) *NullableCrmpProfile {
	return &NullableCrmpProfile{value: val, isSet: true}
}

func (v NullableCrmpProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCrmpProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

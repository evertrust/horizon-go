...
var _ utils.MappedNullable = &ThirdPartyItem{}
...
type ThirdPartyItem struct {
	...
	RemoveDate           utils.NullableInt64 `json:"removeDate,omitempty"`
...
func (o *ThirdPartyItem) GetPushDate() int64 {
	if o == nil || utils.IsNil(o.PushDate.Get()) {
		var ret int64
		return ret
	}
...
func (o *ThirdPartyItem) GetRemoveDate() int64 {
	if o == nil || utils.IsNil(o.RemoveDate.Get()) {
		var ret int64
		return ret
	}

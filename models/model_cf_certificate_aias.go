...
// checks if the CFCertificateAias type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CFCertificateAias{}
...
type _CFCertificateAias CFCertificateAias

// NewCFCertificateAias instantiates a new CFCertificateAias object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewCFCertificateAias() *CFCertificateAias {
...
func (o *CFCertificateAias) UnmarshalJSON(data []byte) (err error) {
	varCFCertificateAias := _CFCertificateAias{}

	err = json.Unmarshal(data, &varCFCertificateAias)

	if err != nil {
		return err
	}

	*o = CFCertificateAias(varCFCertificateAias)
...
type NullableCFCertificateAias struct {
	value *CFCertificateAias
	isSet bool
}

func (v NullableCFCertificateAias) Get() *CFCertificateAias {
	return v.value
}

func (v *NullableCFCertificateAias) Set(val *CFCertificateAias) {
	v.value = val
	v.isSet = true
}

func (v NullableCFCertificateAias) IsSet() bool {
	return v.isSet
}

func (v *NullableCFCertificateAias) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCFCertificateAias(val *CFCertificateAias) *NullableCFCertificateAias {
	return &NullableCFCertificateAias{value: val, isSet: true}
}

func (v NullableCFCertificateAias) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCFCertificateAias) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EstEnrollRequestOnTemplateResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestOnTemplateResponse{}
...
type _EstEnrollRequestOnTemplateResponse EstEnrollRequestOnTemplateResponse
...
func (o EstEnrollRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
...
func (o *EstEnrollRequestOnTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnrollRequestOnTemplateResponse := _EstEnrollRequestOnTemplateResponse{}

	err = json.Unmarshal(data, &varEstEnrollRequestOnTemplateResponse)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestOnTemplateResponse(varEstEnrollRequestOnTemplateResponse)
...
type NullableEstEnrollRequestOnTemplateResponse struct {
	value *EstEnrollRequestOnTemplateResponse
	isSet bool
}

func (v NullableEstEnrollRequestOnTemplateResponse) Get() *EstEnrollRequestOnTemplateResponse {
	return v.value
}

func (v *NullableEstEnrollRequestOnTemplateResponse) Set(val *EstEnrollRequestOnTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestOnTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestOnTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestOnTemplateResponse(val *EstEnrollRequestOnTemplateResponse) *NullableEstEnrollRequestOnTemplateResponse {
	return &NullableEstEnrollRequestOnTemplateResponse{value: val, isSet: true}
}

func (v NullableEstEnrollRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestOnTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

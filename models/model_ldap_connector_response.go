...
// checks if the LDAPConnectorResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LDAPConnectorResponse{}

// LDAPConnectorResponse struct for LDAPConnectorResponse
...
type _LDAPConnectorResponse LDAPConnectorResponse

// NewLDAPConnectorResponse instantiates a new LDAPConnectorResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLDAPConnectorResponse(id string, baseDn string, certificateAttribute string, credentials string, hostname string, name string, throttleDuration string, type_ string, userIdentifierAttribute string) *LDAPConnectorResponse {
	this := LDAPConnectorResponse{}
	this.Id = id
	this.BaseDn = baseDn
...
func (o *LDAPConnectorResponse) SetCertAttrNil() {
	o.CertAttr.Set(nil)
}
...
func (o *LDAPConnectorResponse) SetFilterNil() {
	o.Filter.Set(nil)
}
...
func (o *LDAPConnectorResponse) SetFollowReferralsNil() {
...
func (o *LDAPConnectorResponse) SetMaxStoredCertificatePerHolderNil() {
...
func (o *LDAPConnectorResponse) SetPortNil() {
	o.Port.Set(nil)
}
...
func (o *LDAPConnectorResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *LDAPConnectorResponse) GetThrottleParallelism() int64 {
	if o == nil || utils.IsNil(o.ThrottleParallelism) {
		var ret int64
		return ret
	}
...
func (o *LDAPConnectorResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *LDAPConnectorResponse) GetTlsInsecure() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *LDAPConnectorResponse) GetTlsInsecureOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LDAPConnectorResponse) HasTlsInsecure() bool {
...
func (o LDAPConnectorResponse) MarshalJSON() ([]byte, error) {
...
func (o LDAPConnectorResponse) ToMap() (map[string]interface{}, error) {
...
func (o *LDAPConnectorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLDAPConnectorResponse := _LDAPConnectorResponse{}

	err = json.Unmarshal(data, &varLDAPConnectorResponse)

	if err != nil {
		return err
	}

	*o = LDAPConnectorResponse(varLDAPConnectorResponse)
...
type NullableLDAPConnectorResponse struct {
	value *LDAPConnectorResponse
	isSet bool
}

func (v NullableLDAPConnectorResponse) Get() *LDAPConnectorResponse {
	return v.value
}

func (v *NullableLDAPConnectorResponse) Set(val *LDAPConnectorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLDAPConnectorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLDAPConnectorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLDAPConnectorResponse(val *LDAPConnectorResponse) *NullableLDAPConnectorResponse {
	return &NullableLDAPConnectorResponse{value: val, isSet: true}
}

func (v NullableLDAPConnectorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLDAPConnectorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

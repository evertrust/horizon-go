...
// checks if the CertificateArchive type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateArchive{}
...
type _CertificateArchive CertificateArchive
...
func (o *CertificateArchive) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateArchive := _CertificateArchive{}

	err = json.Unmarshal(data, &varCertificateArchive)

	if err != nil {
		return err
	}

	*o = CertificateArchive(varCertificateArchive)

...
// checks if the WebraRevoke004 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebraRevoke004{}

// WebraRevoke004 Certificate does not exist
type WebraRevoke004 struct {
...
type _WebraRevoke004 WebraRevoke004
...
func (o *WebraRevoke004) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o WebraRevoke004) MarshalJSON() ([]byte, error) {
...
func (o WebraRevoke004) ToMap() (map[string]interface{}, error) {
...
func (o *WebraRevoke004) UnmarshalJSON(data []byte) (err error) {
	...
	varWebraRevoke004 := _WebraRevoke004{}

	err = json.Unmarshal(data, &varWebraRevoke004)

	if err != nil {
		return err
	}

	*o = WebraRevoke004(varWebraRevoke004)
...
type NullableWebraRevoke004 struct {
	value *WebraRevoke004
	isSet bool
}

func (v NullableWebraRevoke004) Get() *WebraRevoke004 {
	return v.value
}

func (v *NullableWebraRevoke004) Set(val *WebraRevoke004) {
	v.value = val
	v.isSet = true
}

func (v NullableWebraRevoke004) IsSet() bool {
	return v.isSet
}

func (v *NullableWebraRevoke004) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebraRevoke004(val *WebraRevoke004) *NullableWebraRevoke004 {
	return &NullableWebraRevoke004{value: val, isSet: true}
}

func (v NullableWebraRevoke004) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebraRevoke004) UnmarshalJSON(src []byte) error {
	v.isSet = true

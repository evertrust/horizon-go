...
// checks if the GlobalSignMsslDCVProviderConfigResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GlobalSignMsslDCVProviderConfigResponse{}

// GlobalSignMsslDCVProviderConfigResponse struct for GlobalSignMsslDCVProviderConfigResponse
type GlobalSignMsslDCVProviderConfigResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _GlobalSignMsslDCVProviderConfigResponse GlobalSignMsslDCVProviderConfigResponse
...
func NewGlobalSignMsslDCVProviderConfigResponse(id string, credentials string, defaultEmail string, defaultPhone string, endpoint string, name string, profile string, timeout utils.NullableString, type_ string) *GlobalSignMsslDCVProviderConfigResponse {
	this := GlobalSignMsslDCVProviderConfigResponse{}
	this.Id = id
...
func (o GlobalSignMsslDCVProviderConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o GlobalSignMsslDCVProviderConfigResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GlobalSignMsslDCVProviderConfigResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGlobalSignMsslDCVProviderConfigResponse := _GlobalSignMsslDCVProviderConfigResponse{}

	err = json.Unmarshal(data, &varGlobalSignMsslDCVProviderConfigResponse)

	if err != nil {
		return err
	}

	*o = GlobalSignMsslDCVProviderConfigResponse(varGlobalSignMsslDCVProviderConfigResponse)
...
type NullableGlobalSignMsslDCVProviderConfigResponse struct {
	value *GlobalSignMsslDCVProviderConfigResponse
	isSet bool
}

func (v NullableGlobalSignMsslDCVProviderConfigResponse) Get() *GlobalSignMsslDCVProviderConfigResponse {
	return v.value
}

func (v *NullableGlobalSignMsslDCVProviderConfigResponse) Set(val *GlobalSignMsslDCVProviderConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGlobalSignMsslDCVProviderConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGlobalSignMsslDCVProviderConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGlobalSignMsslDCVProviderConfigResponse(val *GlobalSignMsslDCVProviderConfigResponse) *NullableGlobalSignMsslDCVProviderConfigResponse {
	return &NullableGlobalSignMsslDCVProviderConfigResponse{value: val, isSet: true}
}

func (v NullableGlobalSignMsslDCVProviderConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGlobalSignMsslDCVProviderConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

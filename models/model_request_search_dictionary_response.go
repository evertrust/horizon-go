...
// checks if the RequestSearchDictionaryResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestSearchDictionaryResponse{}
...
type _RequestSearchDictionaryResponse RequestSearchDictionaryResponse
...
func (o *RequestSearchDictionaryResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSearchDictionaryResponse := _RequestSearchDictionaryResponse{}

	err = json.Unmarshal(data, &varRequestSearchDictionaryResponse)

	if err != nil {
		return err
	}

	*o = RequestSearchDictionaryResponse(varRequestSearchDictionaryResponse)
...
type NullableRequestSearchDictionaryResponse struct {
	value *RequestSearchDictionaryResponse
	isSet bool
}

func (v NullableRequestSearchDictionaryResponse) Get() *RequestSearchDictionaryResponse {
	return v.value
}

func (v *NullableRequestSearchDictionaryResponse) Set(val *RequestSearchDictionaryResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSearchDictionaryResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSearchDictionaryResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSearchDictionaryResponse(val *RequestSearchDictionaryResponse) *NullableRequestSearchDictionaryResponse {
	return &NullableRequestSearchDictionaryResponse{value: val, isSet: true}
}

func (v NullableRequestSearchDictionaryResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSearchDictionaryResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRAUpdateRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAUpdateRequestOnApproveResponse{}

// WebRAUpdateRequestOnApproveResponse struct for WebRAUpdateRequestOnApproveResponse
type WebRAUpdateRequestOnApproveResponse struct {
...
type _WebRAUpdateRequestOnApproveResponse WebRAUpdateRequestOnApproveResponse
...
func NewWebRAUpdateRequestOnApproveResponse(module string, template WebRAUpdateRequestTemplate, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRAUpdateRequestOnApproveResponse {
	this := WebRAUpdateRequestOnApproveResponse{}
	this.Module = module
...
func (o *WebRAUpdateRequestOnApproveResponse) SetCertificateNil() {
...
func (o *WebRAUpdateRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAUpdateRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *WebRAUpdateRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRAUpdateRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRAUpdateRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAUpdateRequestOnApproveResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAUpdateRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAUpdateRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRAUpdateRequestOnApproveResponse) SetRequesterCommentNil() {
...
func (o *WebRAUpdateRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRAUpdateRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAUpdateRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAUpdateRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAUpdateRequestOnApproveResponse := _WebRAUpdateRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varWebRAUpdateRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = WebRAUpdateRequestOnApproveResponse(varWebRAUpdateRequestOnApproveResponse)
...
type NullableWebRAUpdateRequestOnApproveResponse struct {
	value *WebRAUpdateRequestOnApproveResponse
	isSet bool
}

func (v NullableWebRAUpdateRequestOnApproveResponse) Get() *WebRAUpdateRequestOnApproveResponse {
	return v.value
}

func (v *NullableWebRAUpdateRequestOnApproveResponse) Set(val *WebRAUpdateRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAUpdateRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAUpdateRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAUpdateRequestOnApproveResponse(val *WebRAUpdateRequestOnApproveResponse) *NullableWebRAUpdateRequestOnApproveResponse {
	return &NullableWebRAUpdateRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableWebRAUpdateRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAUpdateRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

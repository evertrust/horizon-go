...
type TriggerUpdateRequest struct {
	...
	FortiGateTrigger     *FortiGateTrigger
	FortiManagerTrigger  *FortiManagerTrigger
	GCMTrigger           *GCMTrigger
	IntunePKCSTrigger    *IntunePKCSTrigger
	LDAPTrigger          *LDAPTrigger
	NetscalerTrigger     *NetscalerTrigger
	PanOSFirewallTrigger *PanOSFirewallTrigger
	PanoramaTrigger      *PanoramaTrigger
	REST                 *REST
...
// FortiGateTriggerAsTriggerUpdateRequest is a convenience function that returns FortiGateTrigger wrapped in TriggerUpdateRequest
func FortiGateTriggerAsTriggerUpdateRequest(v *FortiGateTrigger) TriggerUpdateRequest {
	return TriggerUpdateRequest{
		FortiGateTrigger: v,
	}
}

// FortiManagerTriggerAsTriggerUpdateRequest is a convenience function that returns FortiManagerTrigger wrapped in TriggerUpdateRequest
func FortiManagerTriggerAsTriggerUpdateRequest(v *FortiManagerTrigger) TriggerUpdateRequest {
	return TriggerUpdateRequest{
		FortiManagerTrigger: v,
	}
}
...
// NetscalerTriggerAsTriggerUpdateRequest is a convenience function that returns NetscalerTrigger wrapped in TriggerUpdateRequest
func NetscalerTriggerAsTriggerUpdateRequest(v *NetscalerTrigger) TriggerUpdateRequest {
	return TriggerUpdateRequest{
		NetscalerTrigger: v,
	}
}

// PanOSFirewallTriggerAsTriggerUpdateRequest is a convenience function that returns PanOSFirewallTrigger wrapped in TriggerUpdateRequest
func PanOSFirewallTriggerAsTriggerUpdateRequest(v *PanOSFirewallTrigger) TriggerUpdateRequest {
	return TriggerUpdateRequest{
		PanOSFirewallTrigger: v,
	}
}

// PanoramaTriggerAsTriggerUpdateRequest is a convenience function that returns PanoramaTrigger wrapped in TriggerUpdateRequest
func PanoramaTriggerAsTriggerUpdateRequest(v *PanoramaTrigger) TriggerUpdateRequest {
	return TriggerUpdateRequest{
		PanoramaTrigger: v,
	}
}
...
func (dst *TriggerUpdateRequest) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into FortiGateTrigger
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiGateTrigger)
	if err == nil {
		jsonFortiGateTrigger, _ := json.Marshal(dst.FortiGateTrigger)
		if string(jsonFortiGateTrigger) == "{}" { // empty struct
			dst.FortiGateTrigger = nil
		} else {
			_ = validator.Validate(dst.FortiGateTrigger)
			match++
		}
	} else {
		dst.FortiGateTrigger = nil
	...
	// try to unmarshal data into FortiManagerTrigger
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiManagerTrigger)
	if err == nil {
		jsonFortiManagerTrigger, _ := json.Marshal(dst.FortiManagerTrigger)
		if string(jsonFortiManagerTrigger) == "{}" { // empty struct
			dst.FortiManagerTrigger = nil
		} else {
			_ = validator.Validate(dst.FortiManagerTrigger)
			match++
		}
	} else {
		dst.FortiManagerTrigger = nil
	...
	// try to unmarshal data into NetscalerTrigger
	err = utils.NewStrictDecoder(data).Decode(&dst.NetscalerTrigger)
	if err == nil {
		jsonNetscalerTrigger, _ := json.Marshal(dst.NetscalerTrigger)
		if string(jsonNetscalerTrigger) == "{}" { // empty struct
			dst.NetscalerTrigger = nil
		} else {
			_ = validator.Validate(dst.NetscalerTrigger)
			match++
		}
	} else {
		dst.NetscalerTrigger = nil
	...
	// try to unmarshal data into PanOSFirewallTrigger
	err = utils.NewStrictDecoder(data).Decode(&dst.PanOSFirewallTrigger)
	if err == nil {
		jsonPanOSFirewallTrigger, _ := json.Marshal(dst.PanOSFirewallTrigger)
		if string(jsonPanOSFirewallTrigger) == "{}" { // empty struct
			dst.PanOSFirewallTrigger = nil
		} else {
			_ = validator.Validate(dst.PanOSFirewallTrigger)
			match++
		}
	} else {
		dst.PanOSFirewallTrigger = nil
	...
	// try to unmarshal data into PanoramaTrigger
	err = utils.NewStrictDecoder(data).Decode(&dst.PanoramaTrigger)
	if err == nil {
		jsonPanoramaTrigger, _ := json.Marshal(dst.PanoramaTrigger)
		if string(jsonPanoramaTrigger) == "{}" { // empty struct
			dst.PanoramaTrigger = nil
		} else {
			_ = validator.Validate(dst.PanoramaTrigger)
			match++
		}
	} else {
		dst.PanoramaTrigger = nil
...
func (src TriggerUpdateRequest) MarshalJSON() ([]byte, error) {
	...
	if src.FortiGateTrigger != nil {
		return json.Marshal(&src.FortiGateTrigger)
	}

	if src.FortiManagerTrigger != nil {
		return json.Marshal(&src.FortiManagerTrigger)
	}
	...
	if src.NetscalerTrigger != nil {
		return json.Marshal(&src.NetscalerTrigger)
	}

	if src.PanOSFirewallTrigger != nil {
		return json.Marshal(&src.PanOSFirewallTrigger)
	}

	if src.PanoramaTrigger != nil {
		return json.Marshal(&src.PanoramaTrigger)
	}
...
func (obj *TriggerUpdateRequest) GetActualInstance() interface{} {
	...
	if obj.FortiGateTrigger != nil {
		return obj.FortiGateTrigger
	}

	if obj.FortiManagerTrigger != nil {
		return obj.FortiManagerTrigger
	}
	...
	if obj.NetscalerTrigger != nil {
		return obj.NetscalerTrigger
	}

	if obj.PanOSFirewallTrigger != nil {
		return obj.PanOSFirewallTrigger
	}

	if obj.PanoramaTrigger != nil {
		return obj.PanoramaTrigger
	}

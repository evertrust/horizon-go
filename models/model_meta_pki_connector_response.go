...
func NewMetaPKIConnectorResponse(id string, endPoint string, endPointIssuingCA string, name string, profilCle utils.NullableString, profile string, type_ string, workflow utils.NullableString) *MetaPKIConnectorResponse {

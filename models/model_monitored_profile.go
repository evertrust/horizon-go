...
// checks if the MonitoredProfile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &MonitoredProfile{}

// MonitoredProfile struct for MonitoredProfile
...
type _MonitoredProfile MonitoredProfile

// NewMonitoredProfile instantiates a new MonitoredProfile object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewMonitoredProfile(authorizationLevels CertificateProfileAuthorizationLevels, cryptoPolicy MonitoredCertificateProfileCryptoPolicy, enabled bool, module string, name string, requestsPolicy RequestsPolicy, selfPermissions CertificateProfileSelfPermissions) *MonitoredProfile {
	this := MonitoredProfile{}
...
func (o *MonitoredProfile) SetCertificateTemplateNil() {
...
func (o *MonitoredProfile) SetTriggersNil() {
	o.Triggers.Set(nil)
}
...
func (o MonitoredProfile) MarshalJSON() ([]byte, error) {
...
func (o MonitoredProfile) ToMap() (map[string]interface{}, error) {
...
func (o *MonitoredProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varMonitoredProfile := _MonitoredProfile{}

	err = json.Unmarshal(data, &varMonitoredProfile)

	if err != nil {
		return err
	}

	*o = MonitoredProfile(varMonitoredProfile)
...
type NullableMonitoredProfile struct {
	value *MonitoredProfile
	isSet bool
}

func (v NullableMonitoredProfile) Get() *MonitoredProfile {
	return v.value
}

func (v *NullableMonitoredProfile) Set(val *MonitoredProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableMonitoredProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableMonitoredProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMonitoredProfile(val *MonitoredProfile) *NullableMonitoredProfile {
	return &NullableMonitoredProfile{value: val, isSet: true}
}

func (v NullableMonitoredProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMonitoredProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

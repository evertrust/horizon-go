...
// checks if the FortiGateConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &FortiGateConnector{}

// FortiGateConnector struct for FortiGateConnector
type FortiGateConnector struct {
...
type _FortiGateConnector FortiGateConnector
...
func (o *FortiGateConnector) SetCertificateCredentialsNil() {
...
func (o *FortiGateConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *FortiGateConnector) SetTlsInsecureNil() {
...
func (o *FortiGateConnector) SetVdomNil() {
	o.Vdom.Set(nil)
}
...
func (o FortiGateConnector) MarshalJSON() ([]byte, error) {
...
func (o FortiGateConnector) ToMap() (map[string]interface{}, error) {
...
func (o *FortiGateConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varFortiGateConnector := _FortiGateConnector{}

	err = json.Unmarshal(data, &varFortiGateConnector)

	if err != nil {
		return err
	}

	*o = FortiGateConnector(varFortiGateConnector)
...
type NullableFortiGateConnector struct {
	value *FortiGateConnector
	isSet bool
}

func (v NullableFortiGateConnector) Get() *FortiGateConnector {
	return v.value
}

func (v *NullableFortiGateConnector) Set(val *FortiGateConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableFortiGateConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableFortiGateConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFortiGateConnector(val *FortiGateConnector) *NullableFortiGateConnector {
	return &NullableFortiGateConnector{value: val, isSet: true}
}

func (v NullableFortiGateConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFortiGateConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

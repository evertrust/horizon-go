...
// checks if the Team003 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Team003{}

// Team003 Team not found
type Team003 struct {
...
func (o Team003) MarshalJSON() ([]byte, error) {
...
func (o Team003) ToMap() (map[string]interface{}, error) {
...
func (o *Team003) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTeam003)

	if err != nil {
		return err
	}

	*o = Team003(varTeam003)
...
type NullableTeam003 struct {
	value *Team003
	isSet bool
}

func (v NullableTeam003) Get() *Team003 {
	return v.value
}

func (v *NullableTeam003) Set(val *Team003) {
	v.value = val
	v.isSet = true
}

func (v NullableTeam003) IsSet() bool {
	return v.isSet
}

func (v *NullableTeam003) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeam003(val *Team003) *NullableTeam003 {
	return &NullableTeam003{value: val, isSet: true}
}

func (v NullableTeam003) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeam003) UnmarshalJSON(src []byte) error {
	v.isSet = true

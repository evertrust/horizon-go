...
// checks if the CertificateSearch400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateSearch400ResponseOneOf{}

// CertificateSearch400ResponseOneOf struct for CertificateSearch400ResponseOneOf
type CertificateSearch400ResponseOneOf struct {
...
type _CertificateSearch400ResponseOneOf CertificateSearch400ResponseOneOf
...
func NewCertificateSearch400ResponseOneOf(error_ string, message string, title string, status float32) *CertificateSearch400ResponseOneOf {
	this := CertificateSearch400ResponseOneOf{}
	this.Error = error_
...
func (o *CertificateSearch400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CertificateSearch400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o CertificateSearch400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateSearch400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateSearch400ResponseOneOf := _CertificateSearch400ResponseOneOf{}

	err = json.Unmarshal(data, &varCertificateSearch400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = CertificateSearch400ResponseOneOf(varCertificateSearch400ResponseOneOf)
...
type NullableCertificateSearch400ResponseOneOf struct {
	value *CertificateSearch400ResponseOneOf
	isSet bool
}

func (v NullableCertificateSearch400ResponseOneOf) Get() *CertificateSearch400ResponseOneOf {
	return v.value
}

func (v *NullableCertificateSearch400ResponseOneOf) Set(val *CertificateSearch400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateSearch400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateSearch400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateSearch400ResponseOneOf(val *CertificateSearch400ResponseOneOf) *NullableCertificateSearch400ResponseOneOf {
	return &NullableCertificateSearch400ResponseOneOf{value: val, isSet: true}
}

func (v NullableCertificateSearch400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateSearch400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

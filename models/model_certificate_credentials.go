...
var _ utils.MappedNullable = &CertificateCredentials{}
...
func (o *CertificateCredentials) SetDescriptionNil() {
...
func (o *CertificateCredentials) SetExpiresNil() {
	o.Expires.Set(nil)
}
...
func (o *CertificateCredentials) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCertificateCredentials)

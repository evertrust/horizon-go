...
// checks if the ScepEnrollRequestOnApprove type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScepEnrollRequestOnApprove{}

// ScepEnrollRequestOnApprove struct for ScepEnrollRequestOnApprove
type ScepEnrollRequestOnApprove struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _ScepEnrollRequestOnApprove ScepEnrollRequestOnApprove

// NewScepEnrollRequestOnApprove instantiates a new ScepEnrollRequestOnApprove object
...
// NewScepEnrollRequestOnApproveWithDefaults instantiates a new ScepEnrollRequestOnApprove object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScepEnrollRequestOnApproveWithDefaults() *ScepEnrollRequestOnApprove {
	this := ScepEnrollRequestOnApprove{}
	var dryRun bool = false
	this.DryRun = *utils.NewNullableBool(&dryRun)
	return &this
...
func (o *ScepEnrollRequestOnApprove) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScepEnrollRequestOnApprove) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScepEnrollRequestOnApprove) SetId(v string) {
	o.Id = v
}
...
func (o *ScepEnrollRequestOnApprove) GetApproverComment() string {
...
func (o *ScepEnrollRequestOnApprove) GetApproverCommentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScepEnrollRequestOnApprove) HasApproverComment() bool {
...
func (o *ScepEnrollRequestOnApprove) SetApproverComment(v string) {
	o.ApproverComment.Set(&v)
}

// SetApproverCommentNil sets the value for ApproverComment to be an explicit nil
func (o *ScepEnrollRequestOnApprove) SetApproverCommentNil() {
...
func (o *ScepEnrollRequestOnApprove) UnsetApproverComment() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ScepEnrollRequestOnApprove) GetDryRunOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScepEnrollRequestOnApprove) HasDryRun() bool {
...
func (o *ScepEnrollRequestOnApprove) SetDryRun(v bool) {
	o.DryRun.Set(&v)
}

// SetDryRunNil sets the value for DryRun to be an explicit nil
func (o *ScepEnrollRequestOnApprove) SetDryRunNil() {
	o.DryRun.Set(nil)
}

// UnsetDryRun ensures that no value is present for DryRun, not even an explicit nil
func (o *ScepEnrollRequestOnApprove) UnsetDryRun() {
	o.DryRun.Unset()
}
...
func (o ScepEnrollRequestOnApprove) ToMap() (map[string]interface{}, error) {
...
func (o *ScepEnrollRequestOnApprove) UnmarshalJSON(data []byte) (err error) {
	...
	varScepEnrollRequestOnApprove := _ScepEnrollRequestOnApprove{}

	err = json.Unmarshal(data, &varScepEnrollRequestOnApprove)

	if err != nil {
		return err
	}

	*o = ScepEnrollRequestOnApprove(varScepEnrollRequestOnApprove)
...
type NullableScepEnrollRequestOnApprove struct {
	value *ScepEnrollRequestOnApprove
	isSet bool
}

func (v NullableScepEnrollRequestOnApprove) Get() *ScepEnrollRequestOnApprove {
	return v.value
}

func (v *NullableScepEnrollRequestOnApprove) Set(val *ScepEnrollRequestOnApprove) {
	v.value = val
	v.isSet = true
}

func (v NullableScepEnrollRequestOnApprove) IsSet() bool {
	return v.isSet
}

func (v *NullableScepEnrollRequestOnApprove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScepEnrollRequestOnApprove(val *ScepEnrollRequestOnApprove) *NullableScepEnrollRequestOnApprove {
	return &NullableScepEnrollRequestOnApprove{value: val, isSet: true}
}

func (v NullableScepEnrollRequestOnApprove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScepEnrollRequestOnApprove) UnmarshalJSON(src []byte) error {
	v.isSet = true

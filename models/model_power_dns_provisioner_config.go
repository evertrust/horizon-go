...
// checks if the PowerDNSProvisionerConfig type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PowerDNSProvisionerConfig{}

// PowerDNSProvisionerConfig struct for PowerDNSProvisionerConfig
type PowerDNSProvisionerConfig struct {
...
type _PowerDNSProvisionerConfig PowerDNSProvisionerConfig

// NewPowerDNSProvisionerConfig instantiates a new PowerDNSProvisionerConfig object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewPowerDNSProvisionerConfig(credentials string, endpoint string, name string, ttl utils.NullableString, type_ string) *PowerDNSProvisionerConfig {
	this := PowerDNSProvisionerConfig{}
...
func (o *PowerDNSProvisionerConfig) SetDelegationZoneNil() {
...
func (o *PowerDNSProvisionerConfig) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *PowerDNSProvisionerConfig) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o PowerDNSProvisionerConfig) MarshalJSON() ([]byte, error) {
...
func (o PowerDNSProvisionerConfig) ToMap() (map[string]interface{}, error) {
...
func (o *PowerDNSProvisionerConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varPowerDNSProvisionerConfig := _PowerDNSProvisionerConfig{}

	err = json.Unmarshal(data, &varPowerDNSProvisionerConfig)

	if err != nil {
		return err
	}

	*o = PowerDNSProvisionerConfig(varPowerDNSProvisionerConfig)
...
type NullablePowerDNSProvisionerConfig struct {
	value *PowerDNSProvisionerConfig
	isSet bool
}

func (v NullablePowerDNSProvisionerConfig) Get() *PowerDNSProvisionerConfig {
	return v.value
}

func (v *NullablePowerDNSProvisionerConfig) Set(val *PowerDNSProvisionerConfig) {
	v.value = val
	v.isSet = true
}

func (v NullablePowerDNSProvisionerConfig) IsSet() bool {
	return v.isSet
}

func (v *NullablePowerDNSProvisionerConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePowerDNSProvisionerConfig(val *PowerDNSProvisionerConfig) *NullablePowerDNSProvisionerConfig {
	return &NullablePowerDNSProvisionerConfig{value: val, isSet: true}
}

func (v NullablePowerDNSProvisionerConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePowerDNSProvisionerConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true

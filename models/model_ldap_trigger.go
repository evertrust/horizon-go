...
// checks if the LDAPTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LDAPTrigger{}

// LDAPTrigger struct for LDAPTrigger
type LDAPTrigger struct {
...
type _LDAPTrigger LDAPTrigger

// NewLDAPTrigger instantiates a new LDAPTrigger object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLDAPTrigger(name string, type_ string, connector string) *LDAPTrigger {
	this := LDAPTrigger{}
	this.Name = name
	this.Type = type_
...
func (o *LDAPTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o LDAPTrigger) MarshalJSON() ([]byte, error) {
...
func (o LDAPTrigger) ToMap() (map[string]interface{}, error) {
...
func (o *LDAPTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varLDAPTrigger := _LDAPTrigger{}

	err = json.Unmarshal(data, &varLDAPTrigger)

	if err != nil {
		return err
	}

	*o = LDAPTrigger(varLDAPTrigger)
...
type NullableLDAPTrigger struct {
	value *LDAPTrigger
	isSet bool
}

func (v NullableLDAPTrigger) Get() *LDAPTrigger {
	return v.value
}

func (v *NullableLDAPTrigger) Set(val *LDAPTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableLDAPTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableLDAPTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLDAPTrigger(val *LDAPTrigger) *NullableLDAPTrigger {
	return &NullableLDAPTrigger{value: val, isSet: true}
}

func (v NullableLDAPTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLDAPTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ utils.MappedNullable = &CertificateMetadata{}
...
func NewCertificateMetadata(key string, value string) *CertificateMetadata {
...
func (o *CertificateMetadata) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CertificateMetadata) GetKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Key, true
...
func (o *CertificateMetadata) SetKey(v string) {
	o.Key = v
}

// GetValue returns the Value field value
func (o *CertificateMetadata) GetValue() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CertificateMetadata) GetValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *CertificateMetadata) SetValue(v string) {
	o.Value = v
}
...
func (o *CertificateMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varCertificateMetadata)

...
// checks if the WebRAMigrateRequestOnApprove type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAMigrateRequestOnApprove{}

// WebRAMigrateRequestOnApprove struct for WebRAMigrateRequestOnApprove
type WebRAMigrateRequestOnApprove struct {
	// Object internal ID
	Id string `json:"_id"`
	...
	Template *WebRAMigrateRequestTemplate `json:"template,omitempty"`
	// What this request will do. For a migration request, this is always `migrate`
	Workflow             string `json:"workflow"`
	AdditionalProperties map[string]interface{}
}

type _WebRAMigrateRequestOnApprove WebRAMigrateRequestOnApprove
...
func NewWebRAMigrateRequestOnApprove(id string, module string, workflow string) *WebRAMigrateRequestOnApprove {
	this := WebRAMigrateRequestOnApprove{}
...
func (o *WebRAMigrateRequestOnApprove) SetApproverCommentNil() {
...
func (o *WebRAMigrateRequestOnApprove) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
// SetTemplate gets a reference to the given WebRAMigrateRequestTemplate and assigns it to the Template field.
...
func (o WebRAMigrateRequestOnApprove) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestOnApprove) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnApprove) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnApprove := _WebRAMigrateRequestOnApprove{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnApprove)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnApprove(varWebRAMigrateRequestOnApprove)
...
type NullableWebRAMigrateRequestOnApprove struct {
	value *WebRAMigrateRequestOnApprove
	isSet bool
}

func (v NullableWebRAMigrateRequestOnApprove) Get() *WebRAMigrateRequestOnApprove {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnApprove) Set(val *WebRAMigrateRequestOnApprove) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnApprove) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnApprove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnApprove(val *WebRAMigrateRequestOnApprove) *NullableWebRAMigrateRequestOnApprove {
	return &NullableWebRAMigrateRequestOnApprove{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnApprove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnApprove) UnmarshalJSON(src []byte) error {
	v.isSet = true

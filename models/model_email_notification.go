...
var _ utils.MappedNullable = &EmailNotification{}
...
type EmailNotification struct {
	...
	LicenceUsagePercent utils.NullableInt64 `json:"licenceUsagePercent,omitempty"`
...
func (o *EmailNotification) SetAttachDerCertificateNil() {
...
func (o *EmailNotification) SetAttachPemBundleNil() {
...
func (o *EmailNotification) SetAttachPemCertificateNil() {
...
func (o *EmailNotification) SetAttachPkcs7Nil() {
...
func (o *EmailNotification) SetAttachPkcs7BundleNil() {
...
func (o *EmailNotification) SetAttachPkcs12Nil() {
...
func (o *EmailNotification) SetIfPkcs12Nil() {
	o.IfPkcs12.Set(nil)
}
...
// GetLicenceUsagePercent returns the LicenceUsagePercent field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EmailNotification) GetLicenceUsagePercent() int64 {
	if o == nil || utils.IsNil(o.LicenceUsagePercent.Get()) {
		var ret int64
		return ret
	}
	return *o.LicenceUsagePercent.Get()
}

// GetLicenceUsagePercentOk returns a tuple with the LicenceUsagePercent field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetLicenceUsagePercent gets a reference to the given NullableInt64 and assigns it to the LicenceUsagePercent field.
func (o *EmailNotification) SetLicenceUsagePercent(v int64) {
	o.LicenceUsagePercent.Set(&v)
}

// SetLicenceUsagePercentNil sets the value for LicenceUsagePercent to be an explicit nil
func (o *EmailNotification) SetLicenceUsagePercentNil() {
	o.LicenceUsagePercent.Set(nil)
}
...
func (o *EmailNotification) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *EmailNotification) SetRunOnRenewedNil() {
...
func (o *EmailNotification) SetRunPeriodNil() {
	o.RunPeriod.Set(nil)
}
...
func (o EmailNotification) ToMap() (map[string]interface{}, error) {
	...
	if o.LicenceUsagePercent.IsSet() {
		toSerialize["licenceUsagePercent"] = o.LicenceUsagePercent.Get()
	}
...
func (o *EmailNotification) UnmarshalJSON(data []byte) (err error) {
	...
	*o = EmailNotification(varEmailNotification)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "licenceUsagePercent")

...
var _ utils.MappedNullable = &CachedCRLInfosResponse{}
...
func NewCachedCRLInfosResponse(ca string, size int64) *CachedCRLInfosResponse {
...
func (o *CachedCRLInfosResponse) GetIssuerDn() string {
	if o == nil || utils.IsNil(o.IssuerDn.Get()) {
		var ret string
		return ret
	}
...
func (o *CachedCRLInfosResponse) GetLastRefresh() int64 {
	if o == nil || utils.IsNil(o.LastRefresh.Get()) {
		var ret int64
		return ret
	}
...
func (o *CachedCRLInfosResponse) GetNextRefresh() int64 {
	if o == nil || utils.IsNil(o.NextRefresh.Get()) {
		var ret int64
		return ret
	}

...
// checks if the EabUpdateRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EabUpdateRequest{}

// EabUpdateRequest struct for EabUpdateRequest
type EabUpdateRequest struct {
	AllowedProfiles      []string                `json:"allowedProfiles,omitempty"`
	Description          *string                 `json:"description,omitempty"`
	EabPolicy            *string                 `json:"eabPolicy,omitempty"`
...
type _EabUpdateRequest EabUpdateRequest
...
// GetEabPolicy returns the EabPolicy field value if set, zero value otherwise.
func (o *EabUpdateRequest) GetEabPolicy() string {
	if o == nil || utils.IsNil(o.EabPolicy) {
		var ret string
		return ret
	}
	return *o.EabPolicy
...
// GetEabPolicyOk returns a tuple with the EabPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
// SetEabPolicy gets a reference to the given string and assigns it to the EabPolicy field.
...
func (o EabUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o EabUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EabUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEabUpdateRequest := _EabUpdateRequest{}

	err = json.Unmarshal(data, &varEabUpdateRequest)

	if err != nil {
		return err
	}

	*o = EabUpdateRequest(varEabUpdateRequest)
...
type NullableEabUpdateRequest struct {
	value *EabUpdateRequest
	isSet bool
}

func (v NullableEabUpdateRequest) Get() *EabUpdateRequest {
	return v.value
}

func (v *NullableEabUpdateRequest) Set(val *EabUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEabUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEabUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEabUpdateRequest(val *EabUpdateRequest) *NullableEabUpdateRequest {
	return &NullableEabUpdateRequest{value: val, isSet: true}
}

func (v NullableEabUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEabUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

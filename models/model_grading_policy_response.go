...
// checks if the GradingPolicyResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GradingPolicyResponse{}

// GradingPolicyResponse struct for GradingPolicyResponse
type GradingPolicyResponse struct {
	// Object internal ID
	Id                   string                   `json:"_id"`
...
type _GradingPolicyResponse GradingPolicyResponse
...
func (o GradingPolicyResponse) MarshalJSON() ([]byte, error) {
...
func (o GradingPolicyResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GradingPolicyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGradingPolicyResponse := _GradingPolicyResponse{}

	err = json.Unmarshal(data, &varGradingPolicyResponse)

	if err != nil {
		return err
	}

	*o = GradingPolicyResponse(varGradingPolicyResponse)
...
type NullableGradingPolicyResponse struct {
	value *GradingPolicyResponse
	isSet bool
}

func (v NullableGradingPolicyResponse) Get() *GradingPolicyResponse {
	return v.value
}

func (v *NullableGradingPolicyResponse) Set(val *GradingPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGradingPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGradingPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGradingPolicyResponse(val *GradingPolicyResponse) *NullableGradingPolicyResponse {
	return &NullableGradingPolicyResponse{value: val, isSet: true}
}

func (v NullableGradingPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGradingPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

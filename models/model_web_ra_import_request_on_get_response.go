...
// checks if the WebRAImportRequestOnGetResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestOnGetResponse{}

// WebRAImportRequestOnGetResponse struct for WebRAImportRequestOnGetResponse
type WebRAImportRequestOnGetResponse struct {
	...
	Template *WebRAImportRequestTemplateResponse `json:"template,omitempty"`
...
type _WebRAImportRequestOnGetResponse WebRAImportRequestOnGetResponse
...
func NewWebRAImportRequestOnGetResponse(certificate NullableCertificate, module Module, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRAImportRequestOnGetResponse {
	this := WebRAImportRequestOnGetResponse{}
...
func (o *WebRAImportRequestOnGetResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRAImportRequestOnGetResponse) GetTemplate() WebRAImportRequestTemplateResponse {
	if o == nil || utils.IsNil(o.Template) {
		var ret WebRAImportRequestTemplateResponse
		return ret
	}
	return *o.Template
}
...
// SetTemplate gets a reference to the given WebRAImportRequestTemplateResponse and assigns it to the Template field.
...
func (o *WebRAImportRequestOnGetResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAImportRequestOnGetResponse) SetApproverCommentNil() {
...
func (o *WebRAImportRequestOnGetResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRAImportRequestOnGetResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAImportRequestOnGetResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAImportRequestOnGetResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAImportRequestOnGetResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRAImportRequestOnGetResponse) SetRequesterCommentNil() {
...
func (o *WebRAImportRequestOnGetResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRAImportRequestOnGetResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAImportRequestOnGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAImportRequestOnGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAImportRequestOnGetResponse := _WebRAImportRequestOnGetResponse{}

	err = json.Unmarshal(data, &varWebRAImportRequestOnGetResponse)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestOnGetResponse(varWebRAImportRequestOnGetResponse)
...
type NullableWebRAImportRequestOnGetResponse struct {
	value *WebRAImportRequestOnGetResponse
	isSet bool
}

func (v NullableWebRAImportRequestOnGetResponse) Get() *WebRAImportRequestOnGetResponse {
	return v.value
}

func (v *NullableWebRAImportRequestOnGetResponse) Set(val *WebRAImportRequestOnGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestOnGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestOnGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestOnGetResponse(val *WebRAImportRequestOnGetResponse) *NullableWebRAImportRequestOnGetResponse {
	return &NullableWebRAImportRequestOnGetResponse{value: val, isSet: true}
}

func (v NullableWebRAImportRequestOnGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestOnGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EstEnrollRequestOnSubmitResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestOnSubmitResponse{}

// EstEnrollRequestOnSubmitResponse struct for EstEnrollRequestOnSubmitResponse
type EstEnrollRequestOnSubmitResponse struct {
...
type _EstEnrollRequestOnSubmitResponse EstEnrollRequestOnSubmitResponse
...
func NewEstEnrollRequestOnSubmitResponse(module string, workflow string, id string, status RequestStatus, profile string, registrationDate int64, lastModificationDate int64, removeAt int64) *EstEnrollRequestOnSubmitResponse {
	this := EstEnrollRequestOnSubmitResponse{}
	this.Id = id
	this.Module = module
...
func (o *EstEnrollRequestOnSubmitResponse) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmitResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmitResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmitResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmitResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmitResponse) SetRequesterCommentNil() {
...
func (o *EstEnrollRequestOnSubmitResponse) SetApproverCommentNil() {
...
func (o *EstEnrollRequestOnSubmitResponse) SetGlobalHolderIdCountNil() {
...
func (o *EstEnrollRequestOnSubmitResponse) SetProfileHolderIdCountNil() {
...
func (o *EstEnrollRequestOnSubmitResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o EstEnrollRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestOnSubmitResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestOnSubmitResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnrollRequestOnSubmitResponse := _EstEnrollRequestOnSubmitResponse{}

	err = json.Unmarshal(data, &varEstEnrollRequestOnSubmitResponse)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestOnSubmitResponse(varEstEnrollRequestOnSubmitResponse)
...
type NullableEstEnrollRequestOnSubmitResponse struct {
	value *EstEnrollRequestOnSubmitResponse
	isSet bool
}

func (v NullableEstEnrollRequestOnSubmitResponse) Get() *EstEnrollRequestOnSubmitResponse {
	return v.value
}

func (v *NullableEstEnrollRequestOnSubmitResponse) Set(val *EstEnrollRequestOnSubmitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestOnSubmitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestOnSubmitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestOnSubmitResponse(val *EstEnrollRequestOnSubmitResponse) *NullableEstEnrollRequestOnSubmitResponse {
	return &NullableEstEnrollRequestOnSubmitResponse{value: val, isSet: true}
}

func (v NullableEstEnrollRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestOnSubmitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

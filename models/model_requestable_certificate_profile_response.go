...
// checks if the RequestableCertificateProfileResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestableCertificateProfileResponse{}
...
type _RequestableCertificateProfileResponse RequestableCertificateProfileResponse
...
func (o *RequestableCertificateProfileResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestableCertificateProfileResponse := _RequestableCertificateProfileResponse{}

	err = json.Unmarshal(data, &varRequestableCertificateProfileResponse)

	if err != nil {
		return err
	}

	*o = RequestableCertificateProfileResponse(varRequestableCertificateProfileResponse)
...
type NullableRequestableCertificateProfileResponse struct {
	value *RequestableCertificateProfileResponse
	isSet bool
}

func (v NullableRequestableCertificateProfileResponse) Get() *RequestableCertificateProfileResponse {
	return v.value
}

func (v *NullableRequestableCertificateProfileResponse) Set(val *RequestableCertificateProfileResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestableCertificateProfileResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestableCertificateProfileResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestableCertificateProfileResponse(val *RequestableCertificateProfileResponse) *NullableRequestableCertificateProfileResponse {
	return &NullableRequestableCertificateProfileResponse{value: val, isSet: true}
}

func (v NullableRequestableCertificateProfileResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestableCertificateProfileResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

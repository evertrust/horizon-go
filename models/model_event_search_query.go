...
// checks if the EventSearchQuery type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EventSearchQuery{}
...
type _EventSearchQuery EventSearchQuery
...
func (o *EventSearchQuery) SetPageIndexNil() {
	o.PageIndex.Set(nil)
}
...
func (o *EventSearchQuery) SetPageSizeNil() {
	o.PageSize.Set(nil)
}
...
func (o *EventSearchQuery) SetWithCountNil() {
	o.WithCount.Set(nil)
}
...
func (o EventSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o *EventSearchQuery) UnmarshalJSON(data []byte) (err error) {
	varEventSearchQuery := _EventSearchQuery{}

	err = json.Unmarshal(data, &varEventSearchQuery)

	if err != nil {
		return err
	}

	*o = EventSearchQuery(varEventSearchQuery)
...
type NullableEventSearchQuery struct {
	value *EventSearchQuery
	isSet bool
}

func (v NullableEventSearchQuery) Get() *EventSearchQuery {
	return v.value
}

func (v *NullableEventSearchQuery) Set(val *EventSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableEventSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableEventSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEventSearchQuery(val *EventSearchQuery) *NullableEventSearchQuery {
	return &NullableEventSearchQuery{value: val, isSet: true}
}

func (v NullableEventSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEventSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true

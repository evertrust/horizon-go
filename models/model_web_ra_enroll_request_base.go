...
// checks if the WebRAEnrollRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAEnrollRequestBase{}

// WebRAEnrollRequestBase struct for WebRAEnrollRequestBase
type WebRAEnrollRequestBase struct {
...
type _WebRAEnrollRequestBase WebRAEnrollRequestBase
...
func (o *WebRAEnrollRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAEnrollRequestBase) MarshalJSON() ([]byte, error) {
...
func (o WebRAEnrollRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAEnrollRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRAEnrollRequestBase := _WebRAEnrollRequestBase{}

	err = json.Unmarshal(data, &varWebRAEnrollRequestBase)

	if err != nil {
		return err
	}

	*o = WebRAEnrollRequestBase(varWebRAEnrollRequestBase)
...
type NullableWebRAEnrollRequestBase struct {
	value *WebRAEnrollRequestBase
	isSet bool
}

func (v NullableWebRAEnrollRequestBase) Get() *WebRAEnrollRequestBase {
	return v.value
}

func (v *NullableWebRAEnrollRequestBase) Set(val *WebRAEnrollRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAEnrollRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAEnrollRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAEnrollRequestBase(val *WebRAEnrollRequestBase) *NullableWebRAEnrollRequestBase {
	return &NullableWebRAEnrollRequestBase{value: val, isSet: true}
}

func (v NullableWebRAEnrollRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAEnrollRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

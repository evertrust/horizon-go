...
func (o *WebRAUpdateRequestTemplateResponse) GetAutoRenew() CertificateAutoRenewElementResponse {
...
func (o *WebRAUpdateRequestTemplateResponse) GetAutoRenewOk() (*CertificateAutoRenewElementResponse, bool) {
	if o == nil || utils.IsNil(o.AutoRenew) {
		return nil, false
	}
...
func (o *WebRAUpdateRequestTemplateResponse) HasAutoRenew() bool {
	if o != nil && !utils.IsNil(o.AutoRenew) {
		return true
	}
...
func (o *WebRAUpdateRequestTemplateResponse) SetAutoRenew(v CertificateAutoRenewElementResponse) {
	o.AutoRenew = &v
}

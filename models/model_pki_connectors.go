...
// ADCSConnectorAsPKIConnectors is a convenience function that returns ADCSConnector wrapped in PKIConnectors
func ADCSConnectorAsPKIConnectors(v *ADCSConnector) PKIConnectors {
...
// EntrustConnectorAsPKIConnectors is a convenience function that returns EntrustConnector wrapped in PKIConnectors
func EntrustConnectorAsPKIConnectors(v *EntrustConnector) PKIConnectors {
	return PKIConnectors{
		EntrustConnector: v,
	}
}
...
func (dst *PKIConnectors) UnmarshalJSON(data []byte) error {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.ADCSConnector)
	if err == nil {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.EntrustConnector)
	if err == nil {

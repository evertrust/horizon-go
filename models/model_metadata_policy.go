...
// checks if the MetadataPolicy type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &MetadataPolicy{}
...
type _MetadataPolicy MetadataPolicy
...
func (o *MetadataPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varMetadataPolicy := _MetadataPolicy{}

	err = json.Unmarshal(data, &varMetadataPolicy)

	if err != nil {
		return err
	}

	*o = MetadataPolicy(varMetadataPolicy)
...
type NullableMetadataPolicy struct {
	value *MetadataPolicy
	isSet bool
}

func (v NullableMetadataPolicy) Get() *MetadataPolicy {
	return v.value
}

func (v *NullableMetadataPolicy) Set(val *MetadataPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableMetadataPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableMetadataPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableMetadataPolicy(val *MetadataPolicy) *NullableMetadataPolicy {
	return &NullableMetadataPolicy{value: val, isSet: true}
}

func (v NullableMetadataPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableMetadataPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// SecurityIdentityLocalList401Response struct for SecurityIdentityLocalList401Response
type SecurityIdentityLocalList401Response struct {
...
func (dst *SecurityIdentityLocalList401Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(SecurityIdentityLocalList401Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SecurityIdentityLocalList401Response) MarshalJSON() ([]byte, error) {
...
type NullableSecurityIdentityLocalList401Response struct {
	value *SecurityIdentityLocalList401Response
	isSet bool
}

func (v NullableSecurityIdentityLocalList401Response) Get() *SecurityIdentityLocalList401Response {
	return v.value
}

func (v *NullableSecurityIdentityLocalList401Response) Set(val *SecurityIdentityLocalList401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityIdentityLocalList401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityIdentityLocalList401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityIdentityLocalList401Response(val *SecurityIdentityLocalList401Response) *NullableSecurityIdentityLocalList401Response {
	return &NullableSecurityIdentityLocalList401Response{value: val, isSet: true}
}

func (v NullableSecurityIdentityLocalList401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityIdentityLocalList401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

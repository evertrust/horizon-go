...
// checks if the SecPI003 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecPI003{}

// SecPI003 Principal Info not found
type SecPI003 struct {
...
func (o SecPI003) MarshalJSON() ([]byte, error) {
...
func (o SecPI003) ToMap() (map[string]interface{}, error) {
...
func (o *SecPI003) UnmarshalJSON(data []byte) (err error) {
	...
	varSecPI003 := _SecPI003{}

	err = json.Unmarshal(data, &varSecPI003)

	if err != nil {
		return err
	}

	*o = SecPI003(varSecPI003)
...
type NullableSecPI003 struct {
	value *SecPI003
	isSet bool
}

func (v NullableSecPI003) Get() *SecPI003 {
	return v.value
}

func (v *NullableSecPI003) Set(val *SecPI003) {
	v.value = val
	v.isSet = true
}

func (v NullableSecPI003) IsSet() bool {
	return v.isSet
}

func (v *NullableSecPI003) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecPI003(val *SecPI003) *NullableSecPI003 {
	return &NullableSecPI003{value: val, isSet: true}
}

func (v NullableSecPI003) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecPI003) UnmarshalJSON(src []byte) error {
	v.isSet = true

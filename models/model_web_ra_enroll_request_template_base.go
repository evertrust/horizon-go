...
// checks if the WebRAEnrollRequestTemplateBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAEnrollRequestTemplateBase{}
...
type _WebRAEnrollRequestTemplateBase WebRAEnrollRequestTemplateBase
...
func NewWebRAEnrollRequestTemplateBase() *WebRAEnrollRequestTemplateBase {
	this := WebRAEnrollRequestTemplateBase{}
	return &this
}
...
func (o *WebRAEnrollRequestTemplateBase) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *WebRAEnrollRequestTemplateBase) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o *WebRAEnrollRequestTemplateBase) UnmarshalJSON(data []byte) (err error) {
	varWebRAEnrollRequestTemplateBase := _WebRAEnrollRequestTemplateBase{}

	err = json.Unmarshal(data, &varWebRAEnrollRequestTemplateBase)

	if err != nil {
		return err
	}

	*o = WebRAEnrollRequestTemplateBase(varWebRAEnrollRequestTemplateBase)
...
type NullableWebRAEnrollRequestTemplateBase struct {
	value *WebRAEnrollRequestTemplateBase
	isSet bool
}

func (v NullableWebRAEnrollRequestTemplateBase) Get() *WebRAEnrollRequestTemplateBase {
	return v.value
}

func (v *NullableWebRAEnrollRequestTemplateBase) Set(val *WebRAEnrollRequestTemplateBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAEnrollRequestTemplateBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAEnrollRequestTemplateBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAEnrollRequestTemplateBase(val *WebRAEnrollRequestTemplateBase) *NullableWebRAEnrollRequestTemplateBase {
	return &NullableWebRAEnrollRequestTemplateBase{value: val, isSet: true}
}

func (v NullableWebRAEnrollRequestTemplateBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAEnrollRequestTemplateBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

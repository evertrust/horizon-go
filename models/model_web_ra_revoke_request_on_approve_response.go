...
// checks if the WebRARevokeRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARevokeRequestOnApproveResponse{}

// WebRARevokeRequestOnApproveResponse struct for WebRARevokeRequestOnApproveResponse
type WebRARevokeRequestOnApproveResponse struct {
...
type _WebRARevokeRequestOnApproveResponse WebRARevokeRequestOnApproveResponse
...
func NewWebRARevokeRequestOnApproveResponse(module string, template WebRARevokeRequestTemplate, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRARevokeRequestOnApproveResponse {
	this := WebRARevokeRequestOnApproveResponse{}
	this.Module = module
...
func (o *WebRARevokeRequestOnApproveResponse) SetCertificateNil() {
...
func (o *WebRARevokeRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRARevokeRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *WebRARevokeRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRARevokeRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRARevokeRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRARevokeRequestOnApproveResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRARevokeRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRARevokeRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRARevokeRequestOnApproveResponse) SetRequesterCommentNil() {
...
func (o *WebRARevokeRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRARevokeRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRARevokeRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARevokeRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARevokeRequestOnApproveResponse := _WebRARevokeRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varWebRARevokeRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestOnApproveResponse(varWebRARevokeRequestOnApproveResponse)
...
type NullableWebRARevokeRequestOnApproveResponse struct {
	value *WebRARevokeRequestOnApproveResponse
	isSet bool
}

func (v NullableWebRARevokeRequestOnApproveResponse) Get() *WebRARevokeRequestOnApproveResponse {
	return v.value
}

func (v *NullableWebRARevokeRequestOnApproveResponse) Set(val *WebRARevokeRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestOnApproveResponse(val *WebRARevokeRequestOnApproveResponse) *NullableWebRARevokeRequestOnApproveResponse {
	return &NullableWebRARevokeRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

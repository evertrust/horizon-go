...
// checks if the SecAuth008 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecAuth008{}

// SecAuth008 Invalid redirect path
type SecAuth008 struct {
...
func (o *SecAuth008) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecAuth008) MarshalJSON() ([]byte, error) {
...
func (o SecAuth008) ToMap() (map[string]interface{}, error) {
...
func (o *SecAuth008) UnmarshalJSON(data []byte) (err error) {
	...
	varSecAuth008 := _SecAuth008{}

	err = json.Unmarshal(data, &varSecAuth008)

	if err != nil {
		return err
	}

	*o = SecAuth008(varSecAuth008)
...
type NullableSecAuth008 struct {
	value *SecAuth008
	isSet bool
}

func (v NullableSecAuth008) Get() *SecAuth008 {
	return v.value
}

func (v *NullableSecAuth008) Set(val *SecAuth008) {
	v.value = val
	v.isSet = true
}

func (v NullableSecAuth008) IsSet() bool {
	return v.isSet
}

func (v *NullableSecAuth008) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecAuth008(val *SecAuth008) *NullableSecAuth008 {
	return &NullableSecAuth008{value: val, isSet: true}
}

func (v NullableSecAuth008) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecAuth008) UnmarshalJSON(src []byte) error {
	v.isSet = true

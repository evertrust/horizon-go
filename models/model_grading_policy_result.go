...
// checks if the GradingPolicyResult type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GradingPolicyResult{}
...
type _GradingPolicyResult GradingPolicyResult
...
func (o *GradingPolicyResult) UnmarshalJSON(data []byte) (err error) {
	...
	varGradingPolicyResult := _GradingPolicyResult{}

	err = json.Unmarshal(data, &varGradingPolicyResult)

	if err != nil {
		return err
	}

	*o = GradingPolicyResult(varGradingPolicyResult)
...
type NullableGradingPolicyResult struct {
	value *GradingPolicyResult
	isSet bool
}

func (v NullableGradingPolicyResult) Get() *GradingPolicyResult {
	return v.value
}

func (v *NullableGradingPolicyResult) Set(val *GradingPolicyResult) {
	v.value = val
	v.isSet = true
}

func (v NullableGradingPolicyResult) IsSet() bool {
	return v.isSet
}

func (v *NullableGradingPolicyResult) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGradingPolicyResult(val *GradingPolicyResult) *NullableGradingPolicyResult {
	return &NullableGradingPolicyResult{value: val, isSet: true}
}

func (v NullableGradingPolicyResult) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGradingPolicyResult) UnmarshalJSON(src []byte) error {
	v.isSet = true

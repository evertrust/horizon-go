...
// checks if the CFCertificateUnsupportedExtensionsInner type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CFCertificateUnsupportedExtensionsInner{}
...
type _CFCertificateUnsupportedExtensionsInner CFCertificateUnsupportedExtensionsInner
...
func (o *CFCertificateUnsupportedExtensionsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varCFCertificateUnsupportedExtensionsInner := _CFCertificateUnsupportedExtensionsInner{}

	err = json.Unmarshal(data, &varCFCertificateUnsupportedExtensionsInner)

	if err != nil {
		return err
	}

	*o = CFCertificateUnsupportedExtensionsInner(varCFCertificateUnsupportedExtensionsInner)
...
type NullableCFCertificateUnsupportedExtensionsInner struct {
	value *CFCertificateUnsupportedExtensionsInner
	isSet bool
}

func (v NullableCFCertificateUnsupportedExtensionsInner) Get() *CFCertificateUnsupportedExtensionsInner {
	return v.value
}

func (v *NullableCFCertificateUnsupportedExtensionsInner) Set(val *CFCertificateUnsupportedExtensionsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCFCertificateUnsupportedExtensionsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCFCertificateUnsupportedExtensionsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCFCertificateUnsupportedExtensionsInner(val *CFCertificateUnsupportedExtensionsInner) *NullableCFCertificateUnsupportedExtensionsInner {
	return &NullableCFCertificateUnsupportedExtensionsInner{value: val, isSet: true}
}

func (v NullableCFCertificateUnsupportedExtensionsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCFCertificateUnsupportedExtensionsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRAImportRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestBase{}

// WebRAImportRequestBase struct for WebRAImportRequestBase
type WebRAImportRequestBase struct {
...
type _WebRAImportRequestBase WebRAImportRequestBase
...
func (o *WebRAImportRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAImportRequestBase) MarshalJSON() ([]byte, error) {
...
func (o WebRAImportRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAImportRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRAImportRequestBase := _WebRAImportRequestBase{}

	err = json.Unmarshal(data, &varWebRAImportRequestBase)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestBase(varWebRAImportRequestBase)
...
type NullableWebRAImportRequestBase struct {
	value *WebRAImportRequestBase
	isSet bool
}

func (v NullableWebRAImportRequestBase) Get() *WebRAImportRequestBase {
	return v.value
}

func (v *NullableWebRAImportRequestBase) Set(val *WebRAImportRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestBase(val *WebRAImportRequestBase) *NullableWebRAImportRequestBase {
	return &NullableWebRAImportRequestBase{value: val, isSet: true}
}

func (v NullableWebRAImportRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

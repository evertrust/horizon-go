...
// checks if the AutomationExecutionAdd400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AutomationExecutionAdd400ResponseOneOf{}

// AutomationExecutionAdd400ResponseOneOf struct for AutomationExecutionAdd400ResponseOneOf
type AutomationExecutionAdd400ResponseOneOf struct {
...
type _AutomationExecutionAdd400ResponseOneOf AutomationExecutionAdd400ResponseOneOf
...
func NewAutomationExecutionAdd400ResponseOneOf(status float32, error_ string, message string, title string) *AutomationExecutionAdd400ResponseOneOf {
	this := AutomationExecutionAdd400ResponseOneOf{}
	this.Error = error_
...
func (o *AutomationExecutionAdd400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o AutomationExecutionAdd400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o AutomationExecutionAdd400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *AutomationExecutionAdd400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varAutomationExecutionAdd400ResponseOneOf := _AutomationExecutionAdd400ResponseOneOf{}

	err = json.Unmarshal(data, &varAutomationExecutionAdd400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = AutomationExecutionAdd400ResponseOneOf(varAutomationExecutionAdd400ResponseOneOf)
...
type NullableAutomationExecutionAdd400ResponseOneOf struct {
	value *AutomationExecutionAdd400ResponseOneOf
	isSet bool
}

func (v NullableAutomationExecutionAdd400ResponseOneOf) Get() *AutomationExecutionAdd400ResponseOneOf {
	return v.value
}

func (v *NullableAutomationExecutionAdd400ResponseOneOf) Set(val *AutomationExecutionAdd400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableAutomationExecutionAdd400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableAutomationExecutionAdd400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutomationExecutionAdd400ResponseOneOf(val *AutomationExecutionAdd400ResponseOneOf) *NullableAutomationExecutionAdd400ResponseOneOf {
	return &NullableAutomationExecutionAdd400ResponseOneOf{value: val, isSet: true}
}

func (v NullableAutomationExecutionAdd400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutomationExecutionAdd400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the F5AS3Trigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &F5AS3Trigger{}

// F5AS3Trigger struct for F5AS3Trigger
type F5AS3Trigger struct {
...
type _F5AS3Trigger F5AS3Trigger

// NewF5AS3Trigger instantiates a new F5AS3Trigger object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewF5AS3Trigger(connector string, name string, type_ string) *F5AS3Trigger {
	this := F5AS3Trigger{}
...
func (o *F5AS3Trigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o F5AS3Trigger) MarshalJSON() ([]byte, error) {
...
func (o F5AS3Trigger) ToMap() (map[string]interface{}, error) {
...
func (o *F5AS3Trigger) UnmarshalJSON(data []byte) (err error) {
	...
	varF5AS3Trigger := _F5AS3Trigger{}

	err = json.Unmarshal(data, &varF5AS3Trigger)

	if err != nil {
		return err
	}

	*o = F5AS3Trigger(varF5AS3Trigger)
...
type NullableF5AS3Trigger struct {
	value *F5AS3Trigger
	isSet bool
}

func (v NullableF5AS3Trigger) Get() *F5AS3Trigger {
	return v.value
}

func (v *NullableF5AS3Trigger) Set(val *F5AS3Trigger) {
	v.value = val
	v.isSet = true
}

func (v NullableF5AS3Trigger) IsSet() bool {
	return v.isSet
}

func (v *NullableF5AS3Trigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableF5AS3Trigger(val *F5AS3Trigger) *NullableF5AS3Trigger {
	return &NullableF5AS3Trigger{value: val, isSet: true}
}

func (v NullableF5AS3Trigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableF5AS3Trigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

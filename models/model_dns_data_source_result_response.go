...
// checks if the DNSDataSourceResultResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DNSDataSourceResultResponse{}
...
type _DNSDataSourceResultResponse DNSDataSourceResultResponse
...
func (o *DNSDataSourceResultResponse) GetComputedLookupValues() []string {
	...
	return o.ComputedLookupValues
}

// GetComputedLookupValuesOk returns a tuple with the ComputedLookupValues field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DNSDataSourceResultResponse) GetComputedLookupValuesOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.ComputedLookupValues) {
		return nil, false
	}
	return o.ComputedLookupValues, true
}
...
// SetComputedLookupValues gets a reference to the given []string and assigns it to the ComputedLookupValues field.
...
func (o *DNSDataSourceResultResponse) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *DNSDataSourceResultResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDNSDataSourceResultResponse := _DNSDataSourceResultResponse{}

	err = json.Unmarshal(data, &varDNSDataSourceResultResponse)

	if err != nil {
		return err
	}

	*o = DNSDataSourceResultResponse(varDNSDataSourceResultResponse)
...
type NullableDNSDataSourceResultResponse struct {
	value *DNSDataSourceResultResponse
	isSet bool
}

func (v NullableDNSDataSourceResultResponse) Get() *DNSDataSourceResultResponse {
	return v.value
}

func (v *NullableDNSDataSourceResultResponse) Set(val *DNSDataSourceResultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDNSDataSourceResultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDNSDataSourceResultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDNSDataSourceResultResponse(val *DNSDataSourceResultResponse) *NullableDNSDataSourceResultResponse {
	return &NullableDNSDataSourceResultResponse{value: val, isSet: true}
}

func (v NullableDNSDataSourceResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDNSDataSourceResultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

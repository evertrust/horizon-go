...
// checks if the RequestSubmit500ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestSubmit500ResponseOneOf{}

// RequestSubmit500ResponseOneOf struct for RequestSubmit500ResponseOneOf
type RequestSubmit500ResponseOneOf struct {
...
type _RequestSubmit500ResponseOneOf RequestSubmit500ResponseOneOf
...
func NewRequestSubmit500ResponseOneOf(error_ string, message string, title string, status float32) *RequestSubmit500ResponseOneOf {
	this := RequestSubmit500ResponseOneOf{}
	this.Error = error_
...
func (o *RequestSubmit500ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestSubmit500ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o RequestSubmit500ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSubmit500ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSubmit500ResponseOneOf := _RequestSubmit500ResponseOneOf{}

	err = json.Unmarshal(data, &varRequestSubmit500ResponseOneOf)

	if err != nil {
		return err
	}

	*o = RequestSubmit500ResponseOneOf(varRequestSubmit500ResponseOneOf)
...
type NullableRequestSubmit500ResponseOneOf struct {
	value *RequestSubmit500ResponseOneOf
	isSet bool
}

func (v NullableRequestSubmit500ResponseOneOf) Get() *RequestSubmit500ResponseOneOf {
	return v.value
}

func (v *NullableRequestSubmit500ResponseOneOf) Set(val *RequestSubmit500ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSubmit500ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSubmit500ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSubmit500ResponseOneOf(val *RequestSubmit500ResponseOneOf) *NullableRequestSubmit500ResponseOneOf {
	return &NullableRequestSubmit500ResponseOneOf{value: val, isSet: true}
}

func (v NullableRequestSubmit500ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSubmit500ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

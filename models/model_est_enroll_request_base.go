...
// checks if the EstEnrollRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestBase{}

// EstEnrollRequestBase struct for EstEnrollRequestBase
type EstEnrollRequestBase struct {
...
type _EstEnrollRequestBase EstEnrollRequestBase
...
func (o *EstEnrollRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o EstEnrollRequestBase) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestBase) UnmarshalJSON(data []byte) (err error) {
	varEstEnrollRequestBase := _EstEnrollRequestBase{}

	err = json.Unmarshal(data, &varEstEnrollRequestBase)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestBase(varEstEnrollRequestBase)
...
type NullableEstEnrollRequestBase struct {
	value *EstEnrollRequestBase
	isSet bool
}

func (v NullableEstEnrollRequestBase) Get() *EstEnrollRequestBase {
	return v.value
}

func (v *NullableEstEnrollRequestBase) Set(val *EstEnrollRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestBase(val *EstEnrollRequestBase) *NullableEstEnrollRequestBase {
	return &NullableEstEnrollRequestBase{value: val, isSet: true}
}

func (v NullableEstEnrollRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the AutomationPolicy001 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AutomationPolicy001{}

// AutomationPolicy001 Unexpected error
type AutomationPolicy001 struct {
...
type _AutomationPolicy001 AutomationPolicy001
...
func (o *AutomationPolicy001) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o AutomationPolicy001) MarshalJSON() ([]byte, error) {
...
func (o AutomationPolicy001) ToMap() (map[string]interface{}, error) {
...
func (o *AutomationPolicy001) UnmarshalJSON(data []byte) (err error) {
	...
	varAutomationPolicy001 := _AutomationPolicy001{}

	err = json.Unmarshal(data, &varAutomationPolicy001)

	if err != nil {
		return err
	}

	*o = AutomationPolicy001(varAutomationPolicy001)
...
type NullableAutomationPolicy001 struct {
	value *AutomationPolicy001
	isSet bool
}

func (v NullableAutomationPolicy001) Get() *AutomationPolicy001 {
	return v.value
}

func (v *NullableAutomationPolicy001) Set(val *AutomationPolicy001) {
	v.value = val
	v.isSet = true
}

func (v NullableAutomationPolicy001) IsSet() bool {
	return v.isSet
}

func (v *NullableAutomationPolicy001) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutomationPolicy001(val *AutomationPolicy001) *NullableAutomationPolicy001 {
	return &NullableAutomationPolicy001{value: val, isSet: true}
}

func (v NullableAutomationPolicy001) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutomationPolicy001) UnmarshalJSON(src []byte) error {
	v.isSet = true

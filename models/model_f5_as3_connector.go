...
var _ utils.MappedNullable = &F5AS3Connector{}
...
func NewF5AS3Connector(credentials string, hostname string, name string, throttleDuration string, throttleParallelism int64, type_ string) *F5AS3Connector {
	this := F5AS3Connector{}
...
func (o *F5AS3Connector) SetTlsInsecureNil() {
...
func (o *F5AS3Connector) SetWithChainNil() {
	o.WithChain.Set(nil)
}

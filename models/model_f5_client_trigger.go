...
// checks if the F5ClientTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &F5ClientTrigger{}
...
type _F5ClientTrigger F5ClientTrigger
...
func (o *F5ClientTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *F5ClientTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varF5ClientTrigger := _F5ClientTrigger{}

	err = json.Unmarshal(data, &varF5ClientTrigger)

	if err != nil {
		return err
	}

	*o = F5ClientTrigger(varF5ClientTrigger)
...
type NullableF5ClientTrigger struct {
	value *F5ClientTrigger
	isSet bool
}

func (v NullableF5ClientTrigger) Get() *F5ClientTrigger {
	return v.value
}

func (v *NullableF5ClientTrigger) Set(val *F5ClientTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableF5ClientTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableF5ClientTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableF5ClientTrigger(val *F5ClientTrigger) *NullableF5ClientTrigger {
	return &NullableF5ClientTrigger{value: val, isSet: true}
}

func (v NullableF5ClientTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableF5ClientTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

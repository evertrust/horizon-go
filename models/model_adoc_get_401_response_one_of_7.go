...
// checks if the AdocGet401ResponseOneOf7 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AdocGet401ResponseOneOf7{}

// AdocGet401ResponseOneOf7 struct for AdocGet401ResponseOneOf7
type AdocGet401ResponseOneOf7 struct {
...
type _AdocGet401ResponseOneOf7 AdocGet401ResponseOneOf7
...
func (o *AdocGet401ResponseOneOf7) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o AdocGet401ResponseOneOf7) MarshalJSON() ([]byte, error) {
...
func (o AdocGet401ResponseOneOf7) ToMap() (map[string]interface{}, error) {
...
func (o *AdocGet401ResponseOneOf7) UnmarshalJSON(data []byte) (err error) {
	...
	varAdocGet401ResponseOneOf7 := _AdocGet401ResponseOneOf7{}

	err = json.Unmarshal(data, &varAdocGet401ResponseOneOf7)

	if err != nil {
		return err
	}

	*o = AdocGet401ResponseOneOf7(varAdocGet401ResponseOneOf7)
...
type NullableAdocGet401ResponseOneOf7 struct {
	value *AdocGet401ResponseOneOf7
	isSet bool
}

func (v NullableAdocGet401ResponseOneOf7) Get() *AdocGet401ResponseOneOf7 {
	return v.value
}

func (v *NullableAdocGet401ResponseOneOf7) Set(val *AdocGet401ResponseOneOf7) {
	v.value = val
	v.isSet = true
}

func (v NullableAdocGet401ResponseOneOf7) IsSet() bool {
	return v.isSet
}

func (v *NullableAdocGet401ResponseOneOf7) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAdocGet401ResponseOneOf7(val *AdocGet401ResponseOneOf7) *NullableAdocGet401ResponseOneOf7 {
	return &NullableAdocGet401ResponseOneOf7{value: val, isSet: true}
}

func (v NullableAdocGet401ResponseOneOf7) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAdocGet401ResponseOneOf7) UnmarshalJSON(src []byte) error {
	v.isSet = true

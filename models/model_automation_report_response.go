...
// checks if the AutomationReportResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AutomationReportResponse{}
...
type _AutomationReportResponse AutomationReportResponse
...
func (o *AutomationReportResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAutomationReportResponse := _AutomationReportResponse{}

	err = json.Unmarshal(data, &varAutomationReportResponse)

	if err != nil {
		return err
	}

	*o = AutomationReportResponse(varAutomationReportResponse)
...
type NullableAutomationReportResponse struct {
	value *AutomationReportResponse
	isSet bool
}

func (v NullableAutomationReportResponse) Get() *AutomationReportResponse {
	return v.value
}

func (v *NullableAutomationReportResponse) Set(val *AutomationReportResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAutomationReportResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAutomationReportResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAutomationReportResponse(val *AutomationReportResponse) *NullableAutomationReportResponse {
	return &NullableAutomationReportResponse{value: val, isSet: true}
}

func (v NullableAutomationReportResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAutomationReportResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

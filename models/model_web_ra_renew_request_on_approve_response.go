...
func NewWebRARenewRequestOnApproveResponse(module string, workflow string, id string, status RequestStatus, profile string, registrationDate int64, lastModificationDate int64, removeAt int64, holderId string) *WebRARenewRequestOnApproveResponse {
...
func (o *WebRARenewRequestOnApproveResponse) GetTemplate() WebRARenewRequestTemplate {
...
// and a boolean to check if the value has been set.
func (o *WebRARenewRequestOnApproveResponse) GetTemplateOk() (*WebRARenewRequestTemplate, bool) {
	if o == nil || utils.IsNil(o.Template) {
		return nil, false
	}
...
func (o *WebRARenewRequestOnApproveResponse) SetTemplate(v WebRARenewRequestTemplate) {
	o.Template = &v
}

...
// checks if the PanOSFirewallConnectorResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PanOSFirewallConnectorResponse{}

// PanOSFirewallConnectorResponse struct for PanOSFirewallConnectorResponse
type PanOSFirewallConnectorResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _PanOSFirewallConnectorResponse PanOSFirewallConnectorResponse
...
func NewPanOSFirewallConnectorResponse(id string, credentials string, hostname string, jobRetryParameters RetryParameters, name string, prefix string, throttleDuration string, throttleParallelism int64, timeout string, type_ string) *PanOSFirewallConnectorResponse {
	this := PanOSFirewallConnectorResponse{}
	this.Id = id
...
func (o *PanOSFirewallConnectorResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *PanOSFirewallConnectorResponse) SetTlsInsecureNil() {
...
func (o *PanOSFirewallConnectorResponse) SetVsysNil() {
	o.Vsys.Set(nil)
}
...
func (o PanOSFirewallConnectorResponse) MarshalJSON() ([]byte, error) {
...
func (o PanOSFirewallConnectorResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PanOSFirewallConnectorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPanOSFirewallConnectorResponse := _PanOSFirewallConnectorResponse{}

	err = json.Unmarshal(data, &varPanOSFirewallConnectorResponse)

	if err != nil {
		return err
	}

	*o = PanOSFirewallConnectorResponse(varPanOSFirewallConnectorResponse)
...
type NullablePanOSFirewallConnectorResponse struct {
	value *PanOSFirewallConnectorResponse
	isSet bool
}

func (v NullablePanOSFirewallConnectorResponse) Get() *PanOSFirewallConnectorResponse {
	return v.value
}

func (v *NullablePanOSFirewallConnectorResponse) Set(val *PanOSFirewallConnectorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePanOSFirewallConnectorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePanOSFirewallConnectorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePanOSFirewallConnectorResponse(val *PanOSFirewallConnectorResponse) *NullablePanOSFirewallConnectorResponse {
	return &NullablePanOSFirewallConnectorResponse{value: val, isSet: true}
}

func (v NullablePanOSFirewallConnectorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePanOSFirewallConnectorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

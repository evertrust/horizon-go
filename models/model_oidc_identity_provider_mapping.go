...
type OidcIdentityProviderMapping struct {
	...
	// What principal fields are overridden when using OIDC mappings
...
func NewOidcIdentityProviderMapping() *OidcIdentityProviderMapping {
	...
	var synchronizationMode string = "roles_teams"
...
func (o *OidcIdentityProviderMapping) GetSynchronizationMode() string {
	if o == nil || utils.IsNil(o.SynchronizationMode) {
		var ret string
		return ret
	}
...
// SetSynchronizationMode gets a reference to the given string and assigns it to the SynchronizationMode field.
...
func (o OidcIdentityProviderMapping) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.SynchronizationMode) {
...
func (o *OidcIdentityProviderMapping) UnmarshalJSON(data []byte) (err error) {
	...
	*o = OidcIdentityProviderMapping(varOidcIdentityProviderMapping)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "synchronizationMode")

...
// checks if the DCVLifecycleEventSearchResults type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DCVLifecycleEventSearchResults{}

// DCVLifecycleEventSearchResults struct for DCVLifecycleEventSearchResults
type DCVLifecycleEventSearchResults struct {
	Count                utils.NullableInt64 `json:"count,omitempty"`
	HasMore              bool                `json:"hasMore"`
	PageIndex            int64               `json:"pageIndex"`
	PageSize             int64               `json:"pageSize"`
	Results              []DCVLifecycleEvent `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _DCVLifecycleEventSearchResults DCVLifecycleEventSearchResults
...
func NewDCVLifecycleEventSearchResults(hasMore bool, pageIndex int64, pageSize int64, results []DCVLifecycleEvent) *DCVLifecycleEventSearchResults {
	this := DCVLifecycleEventSearchResults{}
...
func (o *DCVLifecycleEventSearchResults) SetCountNil() {
	o.Count.Set(nil)
}
...
func (o DCVLifecycleEventSearchResults) MarshalJSON() ([]byte, error) {
...
func (o DCVLifecycleEventSearchResults) ToMap() (map[string]interface{}, error) {
...
func (o *DCVLifecycleEventSearchResults) UnmarshalJSON(data []byte) (err error) {
	...
	varDCVLifecycleEventSearchResults := _DCVLifecycleEventSearchResults{}

	err = json.Unmarshal(data, &varDCVLifecycleEventSearchResults)

	if err != nil {
		return err
	}

	*o = DCVLifecycleEventSearchResults(varDCVLifecycleEventSearchResults)
...
type NullableDCVLifecycleEventSearchResults struct {
	value *DCVLifecycleEventSearchResults
	isSet bool
}

func (v NullableDCVLifecycleEventSearchResults) Get() *DCVLifecycleEventSearchResults {
	return v.value
}

func (v *NullableDCVLifecycleEventSearchResults) Set(val *DCVLifecycleEventSearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableDCVLifecycleEventSearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableDCVLifecycleEventSearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDCVLifecycleEventSearchResults(val *DCVLifecycleEventSearchResults) *NullableDCVLifecycleEventSearchResults {
	return &NullableDCVLifecycleEventSearchResults{value: val, isSet: true}
}

func (v NullableDCVLifecycleEventSearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDCVLifecycleEventSearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true

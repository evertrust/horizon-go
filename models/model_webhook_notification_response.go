...
var _ utils.MappedNullable = &WebhookNotificationResponse{}
...
func (o *WebhookNotificationResponse) GetLicenceUsagePercent() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebhookNotificationResponse) GetLicenceUsagePercentOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebhookNotificationResponse) HasLicenceUsagePercent() bool {
...
func (o *WebhookNotificationResponse) SetLicenceUsagePercent(v int64) {
	o.LicenceUsagePercent.Set(&v)
}

// SetLicenceUsagePercentNil sets the value for LicenceUsagePercent to be an explicit nil
func (o *WebhookNotificationResponse) SetLicenceUsagePercentNil() {
...
func (o *WebhookNotificationResponse) UnsetLicenceUsagePercent() {

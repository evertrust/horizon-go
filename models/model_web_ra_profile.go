...
// checks if the WebRAProfile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAProfile{}

// WebRAProfile struct for WebRAProfile
type WebRAProfile struct {
...
type _WebRAProfile WebRAProfile
...
// GetAutoRenewalPolicy returns the AutoRenewalPolicy field value if set, zero value otherwise.
func (o *WebRAProfile) GetAutoRenewalPolicy() AutoRenewalPolicy {
	if o == nil || utils.IsNil(o.AutoRenewalPolicy) {
		var ret AutoRenewalPolicy
		return ret
	}
	return *o.AutoRenewalPolicy
}

// GetAutoRenewalPolicyOk returns a tuple with the AutoRenewalPolicy field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *WebRAProfile) GetAutoRenewalPolicyOk() (*AutoRenewalPolicy, bool) {
	if o == nil || utils.IsNil(o.AutoRenewalPolicy) {
		return nil, false
	}
	return o.AutoRenewalPolicy, true
}
...
// SetAutoRenewalPolicy gets a reference to the given AutoRenewalPolicy and assigns it to the AutoRenewalPolicy field.
func (o *WebRAProfile) SetAutoRenewalPolicy(v AutoRenewalPolicy) {
	o.AutoRenewalPolicy = &v
}
...
func (o *WebRAProfile) SetMaxCertificatePerHolderPolicyNil() {
...
func (o *WebRAProfile) SetRenewalPeriodNil() {
...
func (o *WebRAProfile) GetTermsOfService() string {
...
// and a boolean to check if the value has been set.
func (o *WebRAProfile) GetTermsOfServiceOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TermsOfService) {
		return nil, false
	}
...
func (o *WebRAProfile) HasTermsOfService() bool {
	if o != nil && !utils.IsNil(o.TermsOfService) {
		return true
	}
...
func (o *WebRAProfile) SetTermsOfService(v string) {
	o.TermsOfService = &v
}
...
func (o *WebRAProfile) SetThirdPartyDiscoverySyncNil() {
...
func (o *WebRAProfile) SetTriggersNil() {
	o.Triggers.Set(nil)
}
...
func (o *WebRAProfile) SetValidationRulesetNil() {
...
func (o WebRAProfile) MarshalJSON() ([]byte, error) {
...
func (o *WebRAProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAProfile := _WebRAProfile{}

	err = json.Unmarshal(data, &varWebRAProfile)

	if err != nil {
		return err
	}

	*o = WebRAProfile(varWebRAProfile)
...
type NullableWebRAProfile struct {
	value *WebRAProfile
	isSet bool
}

func (v NullableWebRAProfile) Get() *WebRAProfile {
	return v.value
}

func (v *NullableWebRAProfile) Set(val *WebRAProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAProfile(val *WebRAProfile) *NullableWebRAProfile {
	return &NullableWebRAProfile{value: val, isSet: true}
}

func (v NullableWebRAProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the CaUpdate400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CaUpdate400ResponseOneOf{}

// CaUpdate400ResponseOneOf struct for CaUpdate400ResponseOneOf
type CaUpdate400ResponseOneOf struct {
...
type _CaUpdate400ResponseOneOf CaUpdate400ResponseOneOf
...
func (o *CaUpdate400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CaUpdate400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o CaUpdate400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *CaUpdate400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varCaUpdate400ResponseOneOf := _CaUpdate400ResponseOneOf{}

	err = json.Unmarshal(data, &varCaUpdate400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = CaUpdate400ResponseOneOf(varCaUpdate400ResponseOneOf)
...
type NullableCaUpdate400ResponseOneOf struct {
	value *CaUpdate400ResponseOneOf
	isSet bool
}

func (v NullableCaUpdate400ResponseOneOf) Get() *CaUpdate400ResponseOneOf {
	return v.value
}

func (v *NullableCaUpdate400ResponseOneOf) Set(val *CaUpdate400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCaUpdate400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCaUpdate400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCaUpdate400ResponseOneOf(val *CaUpdate400ResponseOneOf) *NullableCaUpdate400ResponseOneOf {
	return &NullableCaUpdate400ResponseOneOf{value: val, isSet: true}
}

func (v NullableCaUpdate400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCaUpdate400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

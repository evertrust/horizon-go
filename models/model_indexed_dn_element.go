...
// checks if the IndexedDNElement type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &IndexedDNElement{}

// IndexedDNElement An element of a certificate's Distinguished Name
...
type _IndexedDNElement IndexedDNElement
...
func (o *IndexedDNElement) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o IndexedDNElement) MarshalJSON() ([]byte, error) {
...
func (o IndexedDNElement) ToMap() (map[string]interface{}, error) {
...
func (o *IndexedDNElement) UnmarshalJSON(data []byte) (err error) {
	...
	varIndexedDNElement := _IndexedDNElement{}

	err = json.Unmarshal(data, &varIndexedDNElement)

	if err != nil {
		return err
	}

	*o = IndexedDNElement(varIndexedDNElement)
...
type NullableIndexedDNElement struct {
	value *IndexedDNElement
	isSet bool
}

func (v NullableIndexedDNElement) Get() *IndexedDNElement {
	return v.value
}

func (v *NullableIndexedDNElement) Set(val *IndexedDNElement) {
	v.value = val
	v.isSet = true
}

func (v NullableIndexedDNElement) IsSet() bool {
	return v.isSet
}

func (v *NullableIndexedDNElement) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIndexedDNElement(val *IndexedDNElement) *NullableIndexedDNElement {
	return &NullableIndexedDNElement{value: val, isSet: true}
}

func (v NullableIndexedDNElement) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIndexedDNElement) UnmarshalJSON(src []byte) error {
	v.isSet = true

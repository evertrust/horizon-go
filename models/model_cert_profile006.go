...
// checks if the CertProfile006 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertProfile006{}

// CertProfile006 Referenced Certificate Profile
type CertProfile006 struct {
...
type _CertProfile006 CertProfile006
...
func (o *CertProfile006) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CertProfile006) MarshalJSON() ([]byte, error) {
...
func (o CertProfile006) ToMap() (map[string]interface{}, error) {
...
func (o *CertProfile006) UnmarshalJSON(data []byte) (err error) {
	...
	varCertProfile006 := _CertProfile006{}

	err = json.Unmarshal(data, &varCertProfile006)

	if err != nil {
		return err
	}

	*o = CertProfile006(varCertProfile006)
...
type NullableCertProfile006 struct {
	value *CertProfile006
	isSet bool
}

func (v NullableCertProfile006) Get() *CertProfile006 {
	return v.value
}

func (v *NullableCertProfile006) Set(val *CertProfile006) {
	v.value = val
	v.isSet = true
}

func (v NullableCertProfile006) IsSet() bool {
	return v.isSet
}

func (v *NullableCertProfile006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertProfile006(val *CertProfile006) *NullableCertProfile006 {
	return &NullableCertProfile006{value: val, isSet: true}
}

func (v NullableCertProfile006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertProfile006) UnmarshalJSON(src []byte) error {
	v.isSet = true

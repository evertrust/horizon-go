...
// checks if the WebRARevokeRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARevokeRequestBase{}

// WebRARevokeRequestBase struct for WebRARevokeRequestBase
type WebRARevokeRequestBase struct {
...
type _WebRARevokeRequestBase WebRARevokeRequestBase
...
func (o *WebRARevokeRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRARevokeRequestBase) MarshalJSON() ([]byte, error) {
...
func (o WebRARevokeRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARevokeRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRARevokeRequestBase := _WebRARevokeRequestBase{}

	err = json.Unmarshal(data, &varWebRARevokeRequestBase)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestBase(varWebRARevokeRequestBase)
...
type NullableWebRARevokeRequestBase struct {
	value *WebRARevokeRequestBase
	isSet bool
}

func (v NullableWebRARevokeRequestBase) Get() *WebRARevokeRequestBase {
	return v.value
}

func (v *NullableWebRARevokeRequestBase) Set(val *WebRARevokeRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestBase(val *WebRARevokeRequestBase) *NullableWebRARevokeRequestBase {
	return &NullableWebRARevokeRequestBase{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

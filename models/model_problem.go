...
var _ utils.MappedNullable = &Problem{}
...
func (o *Problem) GetSubProblems() []Problem {
	if o == nil || utils.IsNil(o.SubProblems) {
		var ret []Problem
		return ret
	}
...
// SetSubProblems gets a reference to the given []Problem and assigns it to the SubProblems field.
...
func (o *Problem) UnmarshalJSON(data []byte) (err error) {
	...
	*o = Problem(varProblem)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "subProblems")

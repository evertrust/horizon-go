...
// checks if the IntunePKCSTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &IntunePKCSTrigger{}
...
type _IntunePKCSTrigger IntunePKCSTrigger
...
func (o *IntunePKCSTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *IntunePKCSTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varIntunePKCSTrigger := _IntunePKCSTrigger{}

	err = json.Unmarshal(data, &varIntunePKCSTrigger)

	if err != nil {
		return err
	}

	*o = IntunePKCSTrigger(varIntunePKCSTrigger)
...
type NullableIntunePKCSTrigger struct {
	value *IntunePKCSTrigger
	isSet bool
}

func (v NullableIntunePKCSTrigger) Get() *IntunePKCSTrigger {
	return v.value
}

func (v *NullableIntunePKCSTrigger) Set(val *IntunePKCSTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableIntunePKCSTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableIntunePKCSTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIntunePKCSTrigger(val *IntunePKCSTrigger) *NullableIntunePKCSTrigger {
	return &NullableIntunePKCSTrigger{value: val, isSet: true}
}

func (v NullableIntunePKCSTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIntunePKCSTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

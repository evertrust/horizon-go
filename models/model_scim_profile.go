...
// checks if the ScimProfile type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScimProfile{}

// ScimProfile struct for ScimProfile
...
func (o *ScimProfile) SetDescriptionNil() {
...
func (o *ScimProfile) GetMailType() string {
	if o == nil || utils.IsNil(o.MailType.Get()) {
		var ret string
		return ret
	}
...
func (o *ScimProfile) SetMailTypeNil() {
	o.MailType.Set(nil)
}
...
func (o ScimProfile) MarshalJSON() ([]byte, error) {
...
func (o ScimProfile) ToMap() (map[string]interface{}, error) {
...
func (o *ScimProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varScimProfile := _ScimProfile{}

	err = json.Unmarshal(data, &varScimProfile)

	if err != nil {
		return err
	}

	*o = ScimProfile(varScimProfile)
...
type NullableScimProfile struct {
	value *ScimProfile
	isSet bool
}

func (v NullableScimProfile) Get() *ScimProfile {
	return v.value
}

func (v *NullableScimProfile) Set(val *ScimProfile) {
	v.value = val
	v.isSet = true
}

func (v NullableScimProfile) IsSet() bool {
	return v.isSet
}

func (v *NullableScimProfile) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScimProfile(val *ScimProfile) *NullableScimProfile {
	return &NullableScimProfile{value: val, isSet: true}
}

func (v NullableScimProfile) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScimProfile) UnmarshalJSON(src []byte) error {
	v.isSet = true

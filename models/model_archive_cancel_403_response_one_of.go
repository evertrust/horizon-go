...
// checks if the ArchiveCancel403ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ArchiveCancel403ResponseOneOf{}

// ArchiveCancel403ResponseOneOf struct for ArchiveCancel403ResponseOneOf
type ArchiveCancel403ResponseOneOf struct {
...
type _ArchiveCancel403ResponseOneOf ArchiveCancel403ResponseOneOf
...
func NewArchiveCancel403ResponseOneOf(status float32, error_ string, message string, title string) *ArchiveCancel403ResponseOneOf {
	this := ArchiveCancel403ResponseOneOf{}
	this.Error = error_
...
func (o *ArchiveCancel403ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ArchiveCancel403ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o ArchiveCancel403ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ArchiveCancel403ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varArchiveCancel403ResponseOneOf := _ArchiveCancel403ResponseOneOf{}

	err = json.Unmarshal(data, &varArchiveCancel403ResponseOneOf)

	if err != nil {
		return err
	}

	*o = ArchiveCancel403ResponseOneOf(varArchiveCancel403ResponseOneOf)
...
type NullableArchiveCancel403ResponseOneOf struct {
	value *ArchiveCancel403ResponseOneOf
	isSet bool
}

func (v NullableArchiveCancel403ResponseOneOf) Get() *ArchiveCancel403ResponseOneOf {
	return v.value
}

func (v *NullableArchiveCancel403ResponseOneOf) Set(val *ArchiveCancel403ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableArchiveCancel403ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableArchiveCancel403ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArchiveCancel403ResponseOneOf(val *ArchiveCancel403ResponseOneOf) *NullableArchiveCancel403ResponseOneOf {
	return &NullableArchiveCancel403ResponseOneOf{value: val, isSet: true}
}

func (v NullableArchiveCancel403ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArchiveCancel403ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the CloudflareDCVProvisionerConfigResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CloudflareDCVProvisionerConfigResponse{}

// CloudflareDCVProvisionerConfigResponse struct for CloudflareDCVProvisionerConfigResponse
type CloudflareDCVProvisionerConfigResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _CloudflareDCVProvisionerConfigResponse CloudflareDCVProvisionerConfigResponse
...
func NewCloudflareDCVProvisionerConfigResponse(id string, credentials string, endpoint string, name string, ttl utils.NullableString, type_ string, zoneIdMappings []ZoneIdMappings) *CloudflareDCVProvisionerConfigResponse {
	this := CloudflareDCVProvisionerConfigResponse{}
	this.Id = id
...
func (o *CloudflareDCVProvisionerConfigResponse) SetDelegationZoneNil() {
...
func (o *CloudflareDCVProvisionerConfigResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *CloudflareDCVProvisionerConfigResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o CloudflareDCVProvisionerConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o CloudflareDCVProvisionerConfigResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CloudflareDCVProvisionerConfigResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCloudflareDCVProvisionerConfigResponse := _CloudflareDCVProvisionerConfigResponse{}

	err = json.Unmarshal(data, &varCloudflareDCVProvisionerConfigResponse)

	if err != nil {
		return err
	}

	*o = CloudflareDCVProvisionerConfigResponse(varCloudflareDCVProvisionerConfigResponse)
...
type NullableCloudflareDCVProvisionerConfigResponse struct {
	value *CloudflareDCVProvisionerConfigResponse
	isSet bool
}

func (v NullableCloudflareDCVProvisionerConfigResponse) Get() *CloudflareDCVProvisionerConfigResponse {
	return v.value
}

func (v *NullableCloudflareDCVProvisionerConfigResponse) Set(val *CloudflareDCVProvisionerConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCloudflareDCVProvisionerConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCloudflareDCVProvisionerConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCloudflareDCVProvisionerConfigResponse(val *CloudflareDCVProvisionerConfigResponse) *NullableCloudflareDCVProvisionerConfigResponse {
	return &NullableCloudflareDCVProvisionerConfigResponse{value: val, isSet: true}
}

func (v NullableCloudflareDCVProvisionerConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCloudflareDCVProvisionerConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

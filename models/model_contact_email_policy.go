...
// checks if the ContactEmailPolicy type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ContactEmailPolicy{}
...
type _ContactEmailPolicy ContactEmailPolicy
...
func (o *ContactEmailPolicy) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o *ContactEmailPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varContactEmailPolicy := _ContactEmailPolicy{}

	err = json.Unmarshal(data, &varContactEmailPolicy)

	if err != nil {
		return err
	}

	*o = ContactEmailPolicy(varContactEmailPolicy)
...
type NullableContactEmailPolicy struct {
	value *ContactEmailPolicy
	isSet bool
}

func (v NullableContactEmailPolicy) Get() *ContactEmailPolicy {
	return v.value
}

func (v *NullableContactEmailPolicy) Set(val *ContactEmailPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableContactEmailPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableContactEmailPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableContactEmailPolicy(val *ContactEmailPolicy) *NullableContactEmailPolicy {
	return &NullableContactEmailPolicy{value: val, isSet: true}
}

func (v NullableContactEmailPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableContactEmailPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true

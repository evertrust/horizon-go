...
// checks if the EstInitParameters type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstInitParameters{}
...
type _EstInitParameters EstInitParameters
...
func (o *EstInitParameters) UnmarshalJSON(data []byte) (err error) {
	...
	varEstInitParameters := _EstInitParameters{}

	err = json.Unmarshal(data, &varEstInitParameters)

	if err != nil {
		return err
	}

	*o = EstInitParameters(varEstInitParameters)
...
type NullableEstInitParameters struct {
	value *EstInitParameters
	isSet bool
}

func (v NullableEstInitParameters) Get() *EstInitParameters {
	return v.value
}

func (v *NullableEstInitParameters) Set(val *EstInitParameters) {
	v.value = val
	v.isSet = true
}

func (v NullableEstInitParameters) IsSet() bool {
	return v.isSet
}

func (v *NullableEstInitParameters) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstInitParameters(val *EstInitParameters) *NullableEstInitParameters {
	return &NullableEstInitParameters{value: val, isSet: true}
}

func (v NullableEstInitParameters) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstInitParameters) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the Trig001 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Trig001{}

// Trig001 Unexpected Error
type Trig001 struct {
...
func (o Trig001) MarshalJSON() ([]byte, error) {
...
func (o Trig001) ToMap() (map[string]interface{}, error) {
...
func (o *Trig001) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varTrig001)

	if err != nil {
		return err
	}

	*o = Trig001(varTrig001)
...
type NullableTrig001 struct {
	value *Trig001
	isSet bool
}

func (v NullableTrig001) Get() *Trig001 {
	return v.value
}

func (v *NullableTrig001) Set(val *Trig001) {
	v.value = val
	v.isSet = true
}

func (v NullableTrig001) IsSet() bool {
	return v.isSet
}

func (v *NullableTrig001) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTrig001(val *Trig001) *NullableTrig001 {
	return &NullableTrig001{value: val, isSet: true}
}

func (v NullableTrig001) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTrig001) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ utils.MappedNullable = &EmailRecipient{}
...
func (o *EmailRecipient) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *EmailRecipient) GetLabel() string {
	if o == nil || utils.IsNil(o.Label.Get()) {
		var ret string
		return ret
	}
	return *o.Label.Get()
...
func (o *EmailRecipient) SetLabelNil() {
	o.Label.Set(nil)
}
...
func (o *EmailRecipient) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEmailRecipient)

...
// checks if the SecPI005 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecPI005{}

// SecPI005 Invalid Principal Info search query
type SecPI005 struct {
...
func (o SecPI005) MarshalJSON() ([]byte, error) {
...
func (o SecPI005) ToMap() (map[string]interface{}, error) {
...
func (o *SecPI005) UnmarshalJSON(data []byte) (err error) {
	...
	varSecPI005 := _SecPI005{}

	err = json.Unmarshal(data, &varSecPI005)

	if err != nil {
		return err
	}

	*o = SecPI005(varSecPI005)
...
type NullableSecPI005 struct {
	value *SecPI005
	isSet bool
}

func (v NullableSecPI005) Get() *SecPI005 {
	return v.value
}

func (v *NullableSecPI005) Set(val *SecPI005) {
	v.value = val
	v.isSet = true
}

func (v NullableSecPI005) IsSet() bool {
	return v.isSet
}

func (v *NullableSecPI005) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecPI005(val *SecPI005) *NullableSecPI005 {
	return &NullableSecPI005{value: val, isSet: true}
}

func (v NullableSecPI005) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecPI005) UnmarshalJSON(src []byte) error {
	v.isSet = true

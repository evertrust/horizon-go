...
// DataSourceType Type of the datasource
type DataSourceType string

// List of DataSourceType
const (
	DATASOURCETYPE_REST DataSourceType = "rest"
	DATASOURCETYPE_LDAP DataSourceType = "ldap"
	DATASOURCETYPE_DNS  DataSourceType = "dns"
)

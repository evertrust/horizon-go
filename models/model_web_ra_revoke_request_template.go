...
// checks if the WebRARevokeRequestTemplate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARevokeRequestTemplate{}

// WebRARevokeRequestTemplate struct for WebRARevokeRequestTemplate
type WebRARevokeRequestTemplate struct {
...
type _WebRARevokeRequestTemplate WebRARevokeRequestTemplate
...
func NewWebRARevokeRequestTemplate() *WebRARevokeRequestTemplate {
	this := WebRARevokeRequestTemplate{}
	return &this
}
...
func (o *WebRARevokeRequestTemplate) SetRevocationReasonNil() {
...
func (o WebRARevokeRequestTemplate) MarshalJSON() ([]byte, error) {
...
func (o WebRARevokeRequestTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARevokeRequestTemplate) UnmarshalJSON(data []byte) (err error) {
	varWebRARevokeRequestTemplate := _WebRARevokeRequestTemplate{}

	err = json.Unmarshal(data, &varWebRARevokeRequestTemplate)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestTemplate(varWebRARevokeRequestTemplate)
...
type NullableWebRARevokeRequestTemplate struct {
	value *WebRARevokeRequestTemplate
	isSet bool
}

func (v NullableWebRARevokeRequestTemplate) Get() *WebRARevokeRequestTemplate {
	return v.value
}

func (v *NullableWebRARevokeRequestTemplate) Set(val *WebRARevokeRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestTemplate(val *WebRARevokeRequestTemplate) *NullableWebRARevokeRequestTemplate {
	return &NullableWebRARevokeRequestTemplate{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

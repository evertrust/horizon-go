...
// checks if the RequestApprove500ResponseOneOf15 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestApprove500ResponseOneOf15{}

// RequestApprove500ResponseOneOf15 struct for RequestApprove500ResponseOneOf15
type RequestApprove500ResponseOneOf15 struct {
...
type _RequestApprove500ResponseOneOf15 RequestApprove500ResponseOneOf15
...
func NewRequestApprove500ResponseOneOf15(status float32, error_ string, message string, title string) *RequestApprove500ResponseOneOf15 {
	this := RequestApprove500ResponseOneOf15{}
	this.Error = error_
...
func (o *RequestApprove500ResponseOneOf15) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestApprove500ResponseOneOf15) MarshalJSON() ([]byte, error) {
...
func (o RequestApprove500ResponseOneOf15) ToMap() (map[string]interface{}, error) {
...
func (o *RequestApprove500ResponseOneOf15) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestApprove500ResponseOneOf15 := _RequestApprove500ResponseOneOf15{}

	err = json.Unmarshal(data, &varRequestApprove500ResponseOneOf15)

	if err != nil {
		return err
	}

	*o = RequestApprove500ResponseOneOf15(varRequestApprove500ResponseOneOf15)
...
type NullableRequestApprove500ResponseOneOf15 struct {
	value *RequestApprove500ResponseOneOf15
	isSet bool
}

func (v NullableRequestApprove500ResponseOneOf15) Get() *RequestApprove500ResponseOneOf15 {
	return v.value
}

func (v *NullableRequestApprove500ResponseOneOf15) Set(val *RequestApprove500ResponseOneOf15) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestApprove500ResponseOneOf15) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestApprove500ResponseOneOf15) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestApprove500ResponseOneOf15(val *RequestApprove500ResponseOneOf15) *NullableRequestApprove500ResponseOneOf15 {
	return &NullableRequestApprove500ResponseOneOf15{value: val, isSet: true}
}

func (v NullableRequestApprove500ResponseOneOf15) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestApprove500ResponseOneOf15) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the AWSTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AWSTrigger{}
...
func (o *AWSTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *AWSTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varAWSTrigger := _AWSTrigger{}

	err = json.Unmarshal(data, &varAWSTrigger)

	if err != nil {
		return err
	}

	*o = AWSTrigger(varAWSTrigger)
...
type NullableAWSTrigger struct {
	value *AWSTrigger
	isSet bool
}

func (v NullableAWSTrigger) Get() *AWSTrigger {
	return v.value
}

func (v *NullableAWSTrigger) Set(val *AWSTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableAWSTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableAWSTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAWSTrigger(val *AWSTrigger) *NullableAWSTrigger {
	return &NullableAWSTrigger{value: val, isSet: true}
}

func (v NullableAWSTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAWSTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

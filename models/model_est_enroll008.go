...
// checks if the EstEnroll008 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnroll008{}

// EstEnroll008 Missing pending EST Enrollment Request Template
type EstEnroll008 struct {
...
type _EstEnroll008 EstEnroll008
...
func (o *EstEnroll008) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o EstEnroll008) MarshalJSON() ([]byte, error) {
...
func (o EstEnroll008) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnroll008) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnroll008 := _EstEnroll008{}

	err = json.Unmarshal(data, &varEstEnroll008)

	if err != nil {
		return err
	}

	*o = EstEnroll008(varEstEnroll008)
...
type NullableEstEnroll008 struct {
	value *EstEnroll008
	isSet bool
}

func (v NullableEstEnroll008) Get() *EstEnroll008 {
	return v.value
}

func (v *NullableEstEnroll008) Set(val *EstEnroll008) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnroll008) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnroll008) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnroll008(val *EstEnroll008) *NullableEstEnroll008 {
	return &NullableEstEnroll008{value: val, isSet: true}
}

func (v NullableEstEnroll008) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnroll008) UnmarshalJSON(src []byte) error {
	v.isSet = true

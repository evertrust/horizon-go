...
// checks if the CertificateAuthorityResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateAuthorityResponse{}

// CertificateAuthorityResponse struct for CertificateAuthorityResponse
type CertificateAuthorityResponse struct {
	// Object internal ID
	Id              string                `json:"_id"`
	Certificate     CFCertificateResponse `json:"certificate"`
...
type _CertificateAuthorityResponse CertificateAuthorityResponse
...
func NewCertificateAuthorityResponse(id string, certificate CFCertificateResponse, name string, outdatedRevocationStatusPolicy string, public bool, trustedForClientAuthentication bool, trustedForServerAuthentication bool) *CertificateAuthorityResponse {
	this := CertificateAuthorityResponse{}
	this.Id = id
	...
	var emailMapping string = "{{certificate.san.rfc822name.1}}"
	this.EmailMapping = &emailMapping
	var identifierMapping string = "{{certificate.dn}}"
	this.IdentifierMapping = &identifierMapping
	var nameMapping string = "{{certificate.subject.cn.1}}"
...
func (o *CertificateAuthorityResponse) GetCertificate() CFCertificateResponse {
	if o == nil {
		var ret CFCertificateResponse
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CertificateAuthorityResponse) GetCertificateOk() (*CFCertificateResponse, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CertificateAuthorityResponse) SetCertificate(v CFCertificateResponse) {
	o.Certificate = v
}
...
func (o *CertificateAuthorityResponse) SetCacheTimeToIdleNil() {
...
func (o *CertificateAuthorityResponse) SetCrlUrlNil() {
	o.CrlUrl.Set(nil)
}
...
// GetEmailMapping returns the EmailMapping field value if set, zero value otherwise.
func (o *CertificateAuthorityResponse) GetEmailMapping() string {
	if o == nil || utils.IsNil(o.EmailMapping) {
		var ret string
		return ret
	}
	return *o.EmailMapping
}

// GetEmailMappingOk returns a tuple with the EmailMapping field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *CertificateAuthorityResponse) GetEmailMappingOk() (*string, bool) {
	if o == nil || utils.IsNil(o.EmailMapping) {
		return nil, false
	}
	return o.EmailMapping, true
}

// HasEmailMapping returns a boolean if a field has been set.
func (o *CertificateAuthorityResponse) HasEmailMapping() bool {
	if o != nil && !utils.IsNil(o.EmailMapping) {
		return true
	}
...
// SetEmailMapping gets a reference to the given string and assigns it to the EmailMapping field.
func (o *CertificateAuthorityResponse) SetEmailMapping(v string) {
	o.EmailMapping = &v
}

// GetIdentifierMapping returns the IdentifierMapping field value if set, zero value otherwise.
func (o *CertificateAuthorityResponse) GetIdentifierMapping() string {
...
// and a boolean to check if the value has been set.
func (o *CertificateAuthorityResponse) GetIdentifierMappingOk() (*string, bool) {
	if o == nil || utils.IsNil(o.IdentifierMapping) {
		return nil, false
	}
...
func (o *CertificateAuthorityResponse) HasIdentifierMapping() bool {
	if o != nil && !utils.IsNil(o.IdentifierMapping) {
		return true
	}
...
func (o *CertificateAuthorityResponse) SetIdentifierMapping(v string) {
...
func (o *CertificateAuthorityResponse) GetNameMapping() string {
	if o == nil || utils.IsNil(o.NameMapping) {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CertificateAuthorityResponse) GetNameMappingOk() (*string, bool) {
	if o == nil || utils.IsNil(o.NameMapping) {
		return nil, false
	}
...
func (o *CertificateAuthorityResponse) HasNameMapping() bool {
	if o != nil && !utils.IsNil(o.NameMapping) {
		return true
	}
...
func (o *CertificateAuthorityResponse) SetNameMapping(v string) {
	o.NameMapping = &v
}
...
func (o *CertificateAuthorityResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *CertificateAuthorityResponse) SetRefreshNil() {
	o.Refresh.Set(nil)
}
...
func (o *CertificateAuthorityResponse) SetResponderUrlNil() {
...
func (o *CertificateAuthorityResponse) SetSubjectKeyIdentifierNil() {
...
func (o *CertificateAuthorityResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o CertificateAuthorityResponse) MarshalJSON() ([]byte, error) {
...
func (o CertificateAuthorityResponse) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.EmailMapping) {
		toSerialize["emailMapping"] = o.EmailMapping
	}
	if !utils.IsNil(o.IdentifierMapping) {
		toSerialize["identifierMapping"] = o.IdentifierMapping
	}
	toSerialize["name"] = o.Name
	if !utils.IsNil(o.NameMapping) {
...
func (o *CertificateAuthorityResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateAuthorityResponse := _CertificateAuthorityResponse{}

	err = json.Unmarshal(data, &varCertificateAuthorityResponse)

	if err != nil {
		return err
	}

	*o = CertificateAuthorityResponse(varCertificateAuthorityResponse)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "emailMapping")
		delete(additionalProperties, "identifierMapping")
		delete(additionalProperties, "name")
		delete(additionalProperties, "nameMapping")
...
type NullableCertificateAuthorityResponse struct {
	value *CertificateAuthorityResponse
	isSet bool
}

func (v NullableCertificateAuthorityResponse) Get() *CertificateAuthorityResponse {
	return v.value
}

func (v *NullableCertificateAuthorityResponse) Set(val *CertificateAuthorityResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateAuthorityResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateAuthorityResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateAuthorityResponse(val *CertificateAuthorityResponse) *NullableCertificateAuthorityResponse {
	return &NullableCertificateAuthorityResponse{value: val, isSet: true}
}

func (v NullableCertificateAuthorityResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateAuthorityResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

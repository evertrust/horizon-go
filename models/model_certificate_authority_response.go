...
func NewCertificateAuthorityResponse(id string, certificate CFCertificate, name string, trustedForClientAuthentication bool, trustedForServerAuthentication bool, outdatedRevocationStatusPolicy string, public bool) *CertificateAuthorityResponse {

...
// checks if the CacheCrlGet404ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CacheCrlGet404ResponseOneOf{}

// CacheCrlGet404ResponseOneOf struct for CacheCrlGet404ResponseOneOf
type CacheCrlGet404ResponseOneOf struct {
...
type _CacheCrlGet404ResponseOneOf CacheCrlGet404ResponseOneOf
...
func NewCacheCrlGet404ResponseOneOf(status float32, error_ string, message string, title string) *CacheCrlGet404ResponseOneOf {
	this := CacheCrlGet404ResponseOneOf{}
	this.Error = error_
...
func (o *CacheCrlGet404ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CacheCrlGet404ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o CacheCrlGet404ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *CacheCrlGet404ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varCacheCrlGet404ResponseOneOf := _CacheCrlGet404ResponseOneOf{}

	err = json.Unmarshal(data, &varCacheCrlGet404ResponseOneOf)

	if err != nil {
		return err
	}

	*o = CacheCrlGet404ResponseOneOf(varCacheCrlGet404ResponseOneOf)
...
type NullableCacheCrlGet404ResponseOneOf struct {
	value *CacheCrlGet404ResponseOneOf
	isSet bool
}

func (v NullableCacheCrlGet404ResponseOneOf) Get() *CacheCrlGet404ResponseOneOf {
	return v.value
}

func (v *NullableCacheCrlGet404ResponseOneOf) Set(val *CacheCrlGet404ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableCacheCrlGet404ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableCacheCrlGet404ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCacheCrlGet404ResponseOneOf(val *CacheCrlGet404ResponseOneOf) *NullableCacheCrlGet404ResponseOneOf {
	return &NullableCacheCrlGet404ResponseOneOf{value: val, isSet: true}
}

func (v NullableCacheCrlGet404ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCacheCrlGet404ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the RequestApprove500ResponseOneOf21 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestApprove500ResponseOneOf21{}

// RequestApprove500ResponseOneOf21 struct for RequestApprove500ResponseOneOf21
type RequestApprove500ResponseOneOf21 struct {
...
type _RequestApprove500ResponseOneOf21 RequestApprove500ResponseOneOf21
...
func NewRequestApprove500ResponseOneOf21(status float32, error_ string, message string, title string) *RequestApprove500ResponseOneOf21 {
	this := RequestApprove500ResponseOneOf21{}
	this.Error = error_
...
func (o *RequestApprove500ResponseOneOf21) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestApprove500ResponseOneOf21) MarshalJSON() ([]byte, error) {
...
func (o RequestApprove500ResponseOneOf21) ToMap() (map[string]interface{}, error) {
...
func (o *RequestApprove500ResponseOneOf21) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestApprove500ResponseOneOf21 := _RequestApprove500ResponseOneOf21{}

	err = json.Unmarshal(data, &varRequestApprove500ResponseOneOf21)

	if err != nil {
		return err
	}

	*o = RequestApprove500ResponseOneOf21(varRequestApprove500ResponseOneOf21)
...
type NullableRequestApprove500ResponseOneOf21 struct {
	value *RequestApprove500ResponseOneOf21
	isSet bool
}

func (v NullableRequestApprove500ResponseOneOf21) Get() *RequestApprove500ResponseOneOf21 {
	return v.value
}

func (v *NullableRequestApprove500ResponseOneOf21) Set(val *RequestApprove500ResponseOneOf21) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestApprove500ResponseOneOf21) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestApprove500ResponseOneOf21) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestApprove500ResponseOneOf21(val *RequestApprove500ResponseOneOf21) *NullableRequestApprove500ResponseOneOf21 {
	return &NullableRequestApprove500ResponseOneOf21{value: val, isSet: true}
}

func (v NullableRequestApprove500ResponseOneOf21) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestApprove500ResponseOneOf21) UnmarshalJSON(src []byte) error {
	v.isSet = true

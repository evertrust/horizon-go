...
// checks if the ScepEnrollRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScepEnrollRequestBase{}

// ScepEnrollRequestBase struct for ScepEnrollRequestBase
type ScepEnrollRequestBase struct {
...
type _ScepEnrollRequestBase ScepEnrollRequestBase
...
func (o *ScepEnrollRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o ScepEnrollRequestBase) MarshalJSON() ([]byte, error) {
...
func (o ScepEnrollRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *ScepEnrollRequestBase) UnmarshalJSON(data []byte) (err error) {
	varScepEnrollRequestBase := _ScepEnrollRequestBase{}

	err = json.Unmarshal(data, &varScepEnrollRequestBase)

	if err != nil {
		return err
	}

	*o = ScepEnrollRequestBase(varScepEnrollRequestBase)
...
type NullableScepEnrollRequestBase struct {
	value *ScepEnrollRequestBase
	isSet bool
}

func (v NullableScepEnrollRequestBase) Get() *ScepEnrollRequestBase {
	return v.value
}

func (v *NullableScepEnrollRequestBase) Set(val *ScepEnrollRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableScepEnrollRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableScepEnrollRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScepEnrollRequestBase(val *ScepEnrollRequestBase) *NullableScepEnrollRequestBase {
	return &NullableScepEnrollRequestBase{value: val, isSet: true}
}

func (v NullableScepEnrollRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScepEnrollRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

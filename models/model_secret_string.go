...
var _ utils.MappedNullable = &SecretString{}
...
func (o *SecretString) SetValueNil() {
	o.Value.Set(nil)
}

// UnsetValue ensures that no value is present for Value, not even an explicit nil
func (o *SecretString) UnsetValue() {
	o.Value.Unset()
}
...
func (o *SecretString) UnmarshalJSON(data []byte) (err error) {
	varSecretString := _SecretString{}

	err = json.Unmarshal(data, &varSecretString)

...
// checks if the OrderAPISearch type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &OrderAPISearch{}

// OrderAPISearch struct for OrderAPISearch
type OrderAPISearch struct {
...
type _OrderAPISearch OrderAPISearch
...
func (o OrderAPISearch) MarshalJSON() ([]byte, error) {
...
func (o OrderAPISearch) ToMap() (map[string]interface{}, error) {
...
func (o *OrderAPISearch) UnmarshalJSON(data []byte) (err error) {
	varOrderAPISearch := _OrderAPISearch{}

	err = json.Unmarshal(data, &varOrderAPISearch)

	if err != nil {
		return err
	}

	*o = OrderAPISearch(varOrderAPISearch)
...
type NullableOrderAPISearch struct {
	value *OrderAPISearch
	isSet bool
}

func (v NullableOrderAPISearch) Get() *OrderAPISearch {
	return v.value
}

func (v *NullableOrderAPISearch) Set(val *OrderAPISearch) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderAPISearch) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderAPISearch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderAPISearch(val *OrderAPISearch) *NullableOrderAPISearch {
	return &NullableOrderAPISearch{value: val, isSet: true}
}

func (v NullableOrderAPISearch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderAPISearch) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRAMigrateRequestOnGetResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAMigrateRequestOnGetResponse{}

// WebRAMigrateRequestOnGetResponse struct for WebRAMigrateRequestOnGetResponse
type WebRAMigrateRequestOnGetResponse struct {
...
type _WebRAMigrateRequestOnGetResponse WebRAMigrateRequestOnGetResponse
...
func NewWebRAMigrateRequestOnGetResponse(module Module, profile interface{}, template WebRAMigrateRequestTemplateResponse, workflow string, id string, lastModificationDate int64, registrationDate int64, removeAt int64, status RequestStatus) *WebRAMigrateRequestOnGetResponse {
	this := WebRAMigrateRequestOnGetResponse{}
	this.Module = module
...
func (o *WebRAMigrateRequestOnGetResponse) SetCertificateNil() {
...
func (o *WebRAMigrateRequestOnGetResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRAMigrateRequestOnGetResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAMigrateRequestOnGetResponse) SetApproverCommentNil() {
...
func (o *WebRAMigrateRequestOnGetResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRAMigrateRequestOnGetResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnGetResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAMigrateRequestOnGetResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnGetResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRAMigrateRequestOnGetResponse) SetRequesterCommentNil() {
...
func (o *WebRAMigrateRequestOnGetResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRAMigrateRequestOnGetResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestOnGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnGetResponse := _WebRAMigrateRequestOnGetResponse{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnGetResponse)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnGetResponse(varWebRAMigrateRequestOnGetResponse)
...
type NullableWebRAMigrateRequestOnGetResponse struct {
	value *WebRAMigrateRequestOnGetResponse
	isSet bool
}

func (v NullableWebRAMigrateRequestOnGetResponse) Get() *WebRAMigrateRequestOnGetResponse {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnGetResponse) Set(val *WebRAMigrateRequestOnGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnGetResponse(val *WebRAMigrateRequestOnGetResponse) *NullableWebRAMigrateRequestOnGetResponse {
	return &NullableWebRAMigrateRequestOnGetResponse{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

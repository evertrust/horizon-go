...
var _ utils.MappedNullable = &PasswordCredentials{}
...
func NewPasswordCredentials(login string, password SecretString, type_ string, name string) *PasswordCredentials {

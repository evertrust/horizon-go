...
type Certificate struct {
	...
	// The X.509 data (subject, SANs, extensions) that was requested at enrollment time, as sent to the PKI. When present, it is replayed at renewal time instead of being deduced from the issued certificate. Absent on certificates enrolled before this data was captured, and on imported or discovered certificates

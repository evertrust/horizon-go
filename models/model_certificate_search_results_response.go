...
// checks if the CertificateSearchResultsResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateSearchResultsResponse{}
...
type _CertificateSearchResultsResponse CertificateSearchResultsResponse
...
func (o *CertificateSearchResultsResponse) SetCountNil() {
	o.Count.Set(nil)
}
...
func (o *CertificateSearchResultsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateSearchResultsResponse := _CertificateSearchResultsResponse{}

	err = json.Unmarshal(data, &varCertificateSearchResultsResponse)

	if err != nil {
		return err
	}

	*o = CertificateSearchResultsResponse(varCertificateSearchResultsResponse)
...
type NullableCertificateSearchResultsResponse struct {
	value *CertificateSearchResultsResponse
	isSet bool
}

func (v NullableCertificateSearchResultsResponse) Get() *CertificateSearchResultsResponse {
	return v.value
}

func (v *NullableCertificateSearchResultsResponse) Set(val *CertificateSearchResultsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateSearchResultsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateSearchResultsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateSearchResultsResponse(val *CertificateSearchResultsResponse) *NullableCertificateSearchResultsResponse {
	return &NullableCertificateSearchResultsResponse{value: val, isSet: true}
}

func (v NullableCertificateSearchResultsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateSearchResultsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

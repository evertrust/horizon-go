...
// checks if the WebRAMigrateRequestOnSubmitResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAMigrateRequestOnSubmitResponse{}

// WebRAMigrateRequestOnSubmitResponse struct for WebRAMigrateRequestOnSubmitResponse
type WebRAMigrateRequestOnSubmitResponse struct {
...
type _WebRAMigrateRequestOnSubmitResponse WebRAMigrateRequestOnSubmitResponse
...
func NewWebRAMigrateRequestOnSubmitResponse(module Module, profile string, template WebRAMigrateRequestTemplate, workflow string, id string, lastModificationDate int64, registrationDate int64, removeAt int64, status RequestStatus) *WebRAMigrateRequestOnSubmitResponse {
...
func NewWebRAMigrateRequestOnSubmitResponseWithDefaults() *WebRAMigrateRequestOnSubmitResponse {
	this := WebRAMigrateRequestOnSubmitResponse{}
	var dryRun bool = false
	this.DryRun = *utils.NewNullableBool(&dryRun)
	return &this
...
func (o *WebRAMigrateRequestOnSubmitResponse) GetCertificate() Certificate {
...
func (o *WebRAMigrateRequestOnSubmitResponse) GetCertificateOk() (*Certificate, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasCertificate() bool {
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetCertificate(v Certificate) {
	o.Certificate.Set(&v)
}

// SetCertificateNil sets the value for Certificate to be an explicit nil
func (o *WebRAMigrateRequestOnSubmitResponse) SetCertificateNil() {
	o.Certificate.Set(nil)
}

// UnsetCertificate ensures that no value is present for Certificate, not even an explicit nil
func (o *WebRAMigrateRequestOnSubmitResponse) UnsetCertificate() {
	o.Certificate.Unset()
}

// GetDryRun returns the DryRun field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAMigrateRequestOnSubmitResponse) GetDryRun() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAMigrateRequestOnSubmitResponse) GetDryRunOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasDryRun() bool {
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetDryRun(v bool) {
	o.DryRun.Set(&v)
}

// SetDryRunNil sets the value for DryRun to be an explicit nil
func (o *WebRAMigrateRequestOnSubmitResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
// and a boolean to check if the value has been set.
func (o *WebRAMigrateRequestOnSubmitResponse) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetId(v string) {
	o.Id = v
}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetApproverCommentNil() {
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
// and a boolean to check if the value has been set.
func (o *WebRAMigrateRequestOnSubmitResponse) GetDnOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Dn) {
		return nil, false
	}
	return o.Dn, true
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetDn(v string) {
	o.Dn = &v
}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnSubmitResponse) GetRequester() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAMigrateRequestOnSubmitResponse) GetRequesterOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasRequester() bool {
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetRequester(v string) {
	o.Requester.Set(&v)
}

// SetRequesterNil sets the value for Requester to be an explicit nil
func (o *WebRAMigrateRequestOnSubmitResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetRequesterCommentNil() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAMigrateRequestOnSubmitResponse) GetTeamOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasTeam() bool {
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetTeam(v string) {
	o.Team.Set(&v)
}

// SetTeamNil sets the value for Team to be an explicit nil
func (o *WebRAMigrateRequestOnSubmitResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAMigrateRequestOnSubmitResponse) GetTriggerResultsOk() ([]TriggerResult, bool) {
...
func (o *WebRAMigrateRequestOnSubmitResponse) HasTriggerResults() bool {
	if o != nil && !utils.IsNil(o.TriggerResults) {
		return true
	}
...
func (o *WebRAMigrateRequestOnSubmitResponse) SetTriggerResults(v []TriggerResult) {
	o.TriggerResults = v
}

func (o WebRAMigrateRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestOnSubmitResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnSubmitResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnSubmitResponse := _WebRAMigrateRequestOnSubmitResponse{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnSubmitResponse)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnSubmitResponse(varWebRAMigrateRequestOnSubmitResponse)
...
type NullableWebRAMigrateRequestOnSubmitResponse struct {
	value *WebRAMigrateRequestOnSubmitResponse
	isSet bool
}

func (v NullableWebRAMigrateRequestOnSubmitResponse) Get() *WebRAMigrateRequestOnSubmitResponse {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnSubmitResponse) Set(val *WebRAMigrateRequestOnSubmitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnSubmitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnSubmitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnSubmitResponse(val *WebRAMigrateRequestOnSubmitResponse) *NullableWebRAMigrateRequestOnSubmitResponse {
	return &NullableWebRAMigrateRequestOnSubmitResponse{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnSubmitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

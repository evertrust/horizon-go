...
// checks if the PrincipalInfoSearchRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PrincipalInfoSearchRequest{}
...
type _PrincipalInfoSearchRequest PrincipalInfoSearchRequest
...
func (o *PrincipalInfoSearchRequest) UnmarshalJSON(data []byte) (err error) {
	varPrincipalInfoSearchRequest := _PrincipalInfoSearchRequest{}

	err = json.Unmarshal(data, &varPrincipalInfoSearchRequest)

	if err != nil {
		return err
	}

	*o = PrincipalInfoSearchRequest(varPrincipalInfoSearchRequest)
...
type NullablePrincipalInfoSearchRequest struct {
	value *PrincipalInfoSearchRequest
	isSet bool
}

func (v NullablePrincipalInfoSearchRequest) Get() *PrincipalInfoSearchRequest {
	return v.value
}

func (v *NullablePrincipalInfoSearchRequest) Set(val *PrincipalInfoSearchRequest) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalInfoSearchRequest) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalInfoSearchRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalInfoSearchRequest(val *PrincipalInfoSearchRequest) *NullablePrincipalInfoSearchRequest {
	return &NullablePrincipalInfoSearchRequest{value: val, isSet: true}
}

func (v NullablePrincipalInfoSearchRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalInfoSearchRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

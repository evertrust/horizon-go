...
// checks if the EstEnrollRequestTemplateResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestTemplateResponse{}

// EstEnrollRequestTemplateResponse struct for EstEnrollRequestTemplateResponse
type EstEnrollRequestTemplateResponse struct {
	...
	// If the query parameter `termsOfService` was set to `true`, and the profile contains Terms Of Service, contains the contents of the terms of service
...
type _EstEnrollRequestTemplateResponse EstEnrollRequestTemplateResponse
...
func NewEstEnrollRequestTemplateResponse() *EstEnrollRequestTemplateResponse {
	this := EstEnrollRequestTemplateResponse{}
	return &this
}
...
// GetDnWhitelist returns the DnWhitelist field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *EstEnrollRequestTemplateResponse) GetDnWhitelist() bool {
	if o == nil || utils.IsNil(o.DnWhitelist.Get()) {
		var ret bool
		return ret
	}
	return *o.DnWhitelist.Get()
}

// GetDnWhitelistOk returns a tuple with the DnWhitelist field value if set, nil otherwise
...
// SetDnWhitelist gets a reference to the given NullableBool and assigns it to the DnWhitelist field.
...
func (o *EstEnrollRequestTemplateResponse) SetDnWhitelistNil() {
	o.DnWhitelist.Set(nil)
}
...
func (o *EstEnrollRequestTemplateResponse) GetTermsOfService() string {
...
// and a boolean to check if the value has been set.
func (o *EstEnrollRequestTemplateResponse) GetTermsOfServiceOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TermsOfService) {
		return nil, false
	}
...
func (o *EstEnrollRequestTemplateResponse) HasTermsOfService() bool {
	if o != nil && !utils.IsNil(o.TermsOfService) {
		return true
	}
...
func (o *EstEnrollRequestTemplateResponse) SetTermsOfService(v string) {
	o.TermsOfService = &v
}
...
func (o *EstEnrollRequestTemplateResponse) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *EstEnrollRequestTemplateResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o EstEnrollRequestTemplateResponse) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestTemplateResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	varEstEnrollRequestTemplateResponse := _EstEnrollRequestTemplateResponse{}

	err = json.Unmarshal(data, &varEstEnrollRequestTemplateResponse)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestTemplateResponse(varEstEnrollRequestTemplateResponse)
...
type NullableEstEnrollRequestTemplateResponse struct {
	value *EstEnrollRequestTemplateResponse
	isSet bool
}

func (v NullableEstEnrollRequestTemplateResponse) Get() *EstEnrollRequestTemplateResponse {
	return v.value
}

func (v *NullableEstEnrollRequestTemplateResponse) Set(val *EstEnrollRequestTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestTemplateResponse(val *EstEnrollRequestTemplateResponse) *NullableEstEnrollRequestTemplateResponse {
	return &NullableEstEnrollRequestTemplateResponse{value: val, isSet: true}
}

func (v NullableEstEnrollRequestTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

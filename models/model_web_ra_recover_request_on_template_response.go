...
// checks if the WebRARecoverRequestOnTemplateResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARecoverRequestOnTemplateResponse{}
...
type _WebRARecoverRequestOnTemplateResponse WebRARecoverRequestOnTemplateResponse
...
func (o *WebRARecoverRequestOnTemplateResponse) GetTemplate() WebRARecoverRequestTemplate {
	if o == nil {
		var ret WebRARecoverRequestTemplate
		return ret
	}
...
func (o *WebRARecoverRequestOnTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARecoverRequestOnTemplateResponse := _WebRARecoverRequestOnTemplateResponse{}

	err = json.Unmarshal(data, &varWebRARecoverRequestOnTemplateResponse)

	if err != nil {
		return err
	}

	*o = WebRARecoverRequestOnTemplateResponse(varWebRARecoverRequestOnTemplateResponse)
...
type NullableWebRARecoverRequestOnTemplateResponse struct {
	value *WebRARecoverRequestOnTemplateResponse
	isSet bool
}

func (v NullableWebRARecoverRequestOnTemplateResponse) Get() *WebRARecoverRequestOnTemplateResponse {
	return v.value
}

func (v *NullableWebRARecoverRequestOnTemplateResponse) Set(val *WebRARecoverRequestOnTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARecoverRequestOnTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARecoverRequestOnTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARecoverRequestOnTemplateResponse(val *WebRARecoverRequestOnTemplateResponse) *NullableWebRARecoverRequestOnTemplateResponse {
	return &NullableWebRARecoverRequestOnTemplateResponse{value: val, isSet: true}
}

func (v NullableWebRARecoverRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARecoverRequestOnTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the S3StorageBackendConfig type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &S3StorageBackendConfig{}

// S3StorageBackendConfig struct for S3StorageBackendConfig
type S3StorageBackendConfig struct {
...
type _S3StorageBackendConfig S3StorageBackendConfig

// NewS3StorageBackendConfig instantiates a new S3StorageBackendConfig object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewS3StorageBackendConfig(bucket string, forcePathStyle bool, name string, partBufferSize string, timeout utils.NullableString, type_ string) *S3StorageBackendConfig {
	this := S3StorageBackendConfig{}
	this.Bucket = bucket
...
func (o S3StorageBackendConfig) MarshalJSON() ([]byte, error) {
...
func (o S3StorageBackendConfig) ToMap() (map[string]interface{}, error) {
...
func (o *S3StorageBackendConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varS3StorageBackendConfig := _S3StorageBackendConfig{}

	err = json.Unmarshal(data, &varS3StorageBackendConfig)

	if err != nil {
		return err
	}

	*o = S3StorageBackendConfig(varS3StorageBackendConfig)
...
type NullableS3StorageBackendConfig struct {
	value *S3StorageBackendConfig
	isSet bool
}

func (v NullableS3StorageBackendConfig) Get() *S3StorageBackendConfig {
	return v.value
}

func (v *NullableS3StorageBackendConfig) Set(val *S3StorageBackendConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableS3StorageBackendConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableS3StorageBackendConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableS3StorageBackendConfig(val *S3StorageBackendConfig) *NullableS3StorageBackendConfig {
	return &NullableS3StorageBackendConfig{value: val, isSet: true}
}

func (v NullableS3StorageBackendConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableS3StorageBackendConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true

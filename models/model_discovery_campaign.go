...
// checks if the DiscoveryCampaign type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DiscoveryCampaign{}

// DiscoveryCampaign struct for DiscoveryCampaign
...
type _DiscoveryCampaign DiscoveryCampaign

// NewDiscoveryCampaign instantiates a new DiscoveryCampaign object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDiscoveryCampaign(name string, authorizationLevels DiscoveryCampaignAuthorizationLevels, eventOnSuccess bool, eventOnWarning bool, eventOnFailure bool, enabled bool) *DiscoveryCampaign {
	this := DiscoveryCampaign{}
	this.Name = name
...
func (o *DiscoveryCampaign) SetDescriptionNil() {
...
func (o DiscoveryCampaign) MarshalJSON() ([]byte, error) {
...
func (o DiscoveryCampaign) ToMap() (map[string]interface{}, error) {
...
func (o *DiscoveryCampaign) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscoveryCampaign := _DiscoveryCampaign{}

	err = json.Unmarshal(data, &varDiscoveryCampaign)

	if err != nil {
		return err
	}

	*o = DiscoveryCampaign(varDiscoveryCampaign)
...
type NullableDiscoveryCampaign struct {
	value *DiscoveryCampaign
	isSet bool
}

func (v NullableDiscoveryCampaign) Get() *DiscoveryCampaign {
	return v.value
}

func (v *NullableDiscoveryCampaign) Set(val *DiscoveryCampaign) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveryCampaign) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveryCampaign) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveryCampaign(val *DiscoveryCampaign) *NullableDiscoveryCampaign {
	return &NullableDiscoveryCampaign{value: val, isSet: true}
}

func (v NullableDiscoveryCampaign) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveryCampaign) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ThirdpartyConnectorDelete400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ThirdpartyConnectorDelete400ResponseOneOf{}

// ThirdpartyConnectorDelete400ResponseOneOf struct for ThirdpartyConnectorDelete400ResponseOneOf
type ThirdpartyConnectorDelete400ResponseOneOf struct {
...
type _ThirdpartyConnectorDelete400ResponseOneOf ThirdpartyConnectorDelete400ResponseOneOf
...
func NewThirdpartyConnectorDelete400ResponseOneOf(status float32, error_ string, message string, title string) *ThirdpartyConnectorDelete400ResponseOneOf {
	this := ThirdpartyConnectorDelete400ResponseOneOf{}
	this.Error = error_
...
func (o *ThirdpartyConnectorDelete400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ThirdpartyConnectorDelete400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o ThirdpartyConnectorDelete400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ThirdpartyConnectorDelete400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varThirdpartyConnectorDelete400ResponseOneOf := _ThirdpartyConnectorDelete400ResponseOneOf{}

	err = json.Unmarshal(data, &varThirdpartyConnectorDelete400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = ThirdpartyConnectorDelete400ResponseOneOf(varThirdpartyConnectorDelete400ResponseOneOf)
...
type NullableThirdpartyConnectorDelete400ResponseOneOf struct {
	value *ThirdpartyConnectorDelete400ResponseOneOf
	isSet bool
}

func (v NullableThirdpartyConnectorDelete400ResponseOneOf) Get() *ThirdpartyConnectorDelete400ResponseOneOf {
	return v.value
}

func (v *NullableThirdpartyConnectorDelete400ResponseOneOf) Set(val *ThirdpartyConnectorDelete400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableThirdpartyConnectorDelete400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableThirdpartyConnectorDelete400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableThirdpartyConnectorDelete400ResponseOneOf(val *ThirdpartyConnectorDelete400ResponseOneOf) *NullableThirdpartyConnectorDelete400ResponseOneOf {
	return &NullableThirdpartyConnectorDelete400ResponseOneOf{value: val, isSet: true}
}

func (v NullableThirdpartyConnectorDelete400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableThirdpartyConnectorDelete400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EstEnrollRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestOnApproveResponse{}

// EstEnrollRequestOnApproveResponse struct for EstEnrollRequestOnApproveResponse
type EstEnrollRequestOnApproveResponse struct {
...
type _EstEnrollRequestOnApproveResponse EstEnrollRequestOnApproveResponse
...
func NewEstEnrollRequestOnApproveResponse(module string, workflow string, id string, status RequestStatus, profile string, registrationDate int64, lastModificationDate int64, removeAt int64) *EstEnrollRequestOnApproveResponse {
	this := EstEnrollRequestOnApproveResponse{}
	this.Module = module
...
func (o *EstEnrollRequestOnApproveResponse) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *EstEnrollRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *EstEnrollRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o *EstEnrollRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *EstEnrollRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *EstEnrollRequestOnApproveResponse) SetRequesterCommentNil() {
...
func (o *EstEnrollRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *EstEnrollRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *EstEnrollRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *EstEnrollRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o EstEnrollRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnrollRequestOnApproveResponse := _EstEnrollRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varEstEnrollRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestOnApproveResponse(varEstEnrollRequestOnApproveResponse)
...
type NullableEstEnrollRequestOnApproveResponse struct {
	value *EstEnrollRequestOnApproveResponse
	isSet bool
}

func (v NullableEstEnrollRequestOnApproveResponse) Get() *EstEnrollRequestOnApproveResponse {
	return v.value
}

func (v *NullableEstEnrollRequestOnApproveResponse) Set(val *EstEnrollRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestOnApproveResponse(val *EstEnrollRequestOnApproveResponse) *NullableEstEnrollRequestOnApproveResponse {
	return &NullableEstEnrollRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableEstEnrollRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the CertificateAggregateResultResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateAggregateResultResponse{}
...
type _CertificateAggregateResultResponse CertificateAggregateResultResponse
...
func (o *CertificateAggregateResultResponse) SetCountNil() {
	o.Count.Set(nil)
}
...
func (o *CertificateAggregateResultResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateAggregateResultResponse := _CertificateAggregateResultResponse{}

	err = json.Unmarshal(data, &varCertificateAggregateResultResponse)

	if err != nil {
		return err
	}

	*o = CertificateAggregateResultResponse(varCertificateAggregateResultResponse)
...
type NullableCertificateAggregateResultResponse struct {
	value *CertificateAggregateResultResponse
	isSet bool
}

func (v NullableCertificateAggregateResultResponse) Get() *CertificateAggregateResultResponse {
	return v.value
}

func (v *NullableCertificateAggregateResultResponse) Set(val *CertificateAggregateResultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateAggregateResultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateAggregateResultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateAggregateResultResponse(val *CertificateAggregateResultResponse) *NullableCertificateAggregateResultResponse {
	return &NullableCertificateAggregateResultResponse{value: val, isSet: true}
}

func (v NullableCertificateAggregateResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateAggregateResultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

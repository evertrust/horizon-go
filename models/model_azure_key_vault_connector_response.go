...
// checks if the AzureKeyVaultConnectorResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AzureKeyVaultConnectorResponse{}

// AzureKeyVaultConnectorResponse struct for AzureKeyVaultConnectorResponse
type AzureKeyVaultConnectorResponse struct {
	// Object internal ID
	Id          string  `json:"_id"`
...
type _AzureKeyVaultConnectorResponse AzureKeyVaultConnectorResponse
...
func NewAzureKeyVaultConnectorResponse(id string, credentials string, name string, throttleDuration string, throttleParallelism int64, type_ string, vaultBaseUrl string) *AzureKeyVaultConnectorResponse {
	this := AzureKeyVaultConnectorResponse{}
	this.Id = id
...
func (o *AzureKeyVaultConnectorResponse) GetAzureTenant() string {
...
// and a boolean to check if the value has been set.
func (o *AzureKeyVaultConnectorResponse) GetAzureTenantOk() (*string, bool) {
	if o == nil || utils.IsNil(o.AzureTenant) {
		return nil, false
	}
...
func (o *AzureKeyVaultConnectorResponse) HasAzureTenant() bool {
	if o != nil && !utils.IsNil(o.AzureTenant) {
		return true
	}
...
func (o *AzureKeyVaultConnectorResponse) SetAzureTenant(v string) {
	o.AzureTenant = &v
}
...
func (o *AzureKeyVaultConnectorResponse) SetPrefixNil() {
	o.Prefix.Set(nil)
}
...
func (o *AzureKeyVaultConnectorResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *AzureKeyVaultConnectorResponse) SetRenewalPeriodNil() {
...
func (o *AzureKeyVaultConnectorResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o AzureKeyVaultConnectorResponse) MarshalJSON() ([]byte, error) {
...
func (o AzureKeyVaultConnectorResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AzureKeyVaultConnectorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureKeyVaultConnectorResponse := _AzureKeyVaultConnectorResponse{}

	err = json.Unmarshal(data, &varAzureKeyVaultConnectorResponse)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultConnectorResponse(varAzureKeyVaultConnectorResponse)
...
type NullableAzureKeyVaultConnectorResponse struct {
	value *AzureKeyVaultConnectorResponse
	isSet bool
}

func (v NullableAzureKeyVaultConnectorResponse) Get() *AzureKeyVaultConnectorResponse {
	return v.value
}

func (v *NullableAzureKeyVaultConnectorResponse) Set(val *AzureKeyVaultConnectorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureKeyVaultConnectorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureKeyVaultConnectorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureKeyVaultConnectorResponse(val *AzureKeyVaultConnectorResponse) *NullableAzureKeyVaultConnectorResponse {
	return &NullableAzureKeyVaultConnectorResponse{value: val, isSet: true}
}

func (v NullableAzureKeyVaultConnectorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureKeyVaultConnectorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

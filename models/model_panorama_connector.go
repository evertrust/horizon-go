...
// PanoramaConnector struct for PanoramaConnector
type PanoramaConnector struct {
	...
	SynchronizeDevices utils.NullableBool `json:"synchronizeDevices,omitempty"`
	...
	// Virtual system name when targeting a specific VSYS within a template. Requires 'template' to be set.
...
func NewPanoramaConnector(credentials string, hostname string, jobRetryParameters RetryParameters, name string, prefix string, throttleDuration string, throttleParallelism int64, timeout string, type_ string) *PanoramaConnector {
	...
	this.SynchronizeDevices = *utils.NewNullableBool(&synchronizeDevices)
...
func (o *PanoramaConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
// GetSynchronizeDevices returns the SynchronizeDevices field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *PanoramaConnector) GetSynchronizeDevices() bool {
	if o == nil || utils.IsNil(o.SynchronizeDevices.Get()) {
		var ret bool
		return ret
	}
	return *o.SynchronizeDevices.Get()
}
...
// SetSynchronizeDevices gets a reference to the given NullableBool and assigns it to the SynchronizeDevices field.
func (o *PanoramaConnector) SetSynchronizeDevices(v bool) {
	o.SynchronizeDevices.Set(&v)
}

// SetSynchronizeDevicesNil sets the value for SynchronizeDevices to be an explicit nil
func (o *PanoramaConnector) SetSynchronizeDevicesNil() {
	o.SynchronizeDevices.Set(nil)
}
...
func (o *PanoramaConnector) SetTemplateNil() {
	o.Template.Set(nil)
}
...
func (o *PanoramaConnector) SetTemplateStackNil() {
...
func (o *PanoramaConnector) SetTlsInsecureNil() {
...
func (o *PanoramaConnector) SetVsysNil() {
	o.Vsys.Set(nil)
}
...
func (o PanoramaConnector) ToMap() (map[string]interface{}, error) {
	...
	if o.SynchronizeDevices.IsSet() {
		toSerialize["synchronizeDevices"] = o.SynchronizeDevices.Get()
	}
	if o.Template.IsSet() {

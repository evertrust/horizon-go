...
// RequestCsv401Response struct for RequestCsv401Response
type RequestCsv401Response struct {
	AdocGet401ResponseOneOf1 *AdocGet401ResponseOneOf1
	AdocGet401ResponseOneOf8 *AdocGet401ResponseOneOf8
}

// Unmarshal JSON data into any of the pointers in the struct
func (dst *RequestCsv401Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(RequestCsv401Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src RequestCsv401Response) MarshalJSON() ([]byte, error) {
...
type NullableRequestCsv401Response struct {
	value *RequestCsv401Response
	isSet bool
}

func (v NullableRequestCsv401Response) Get() *RequestCsv401Response {
	return v.value
}

func (v *NullableRequestCsv401Response) Set(val *RequestCsv401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestCsv401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestCsv401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestCsv401Response(val *RequestCsv401Response) *NullableRequestCsv401Response {
	return &NullableRequestCsv401Response{value: val, isSet: true}
}

func (v NullableRequestCsv401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestCsv401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

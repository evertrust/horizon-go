...
// checks if the Acme004 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Acme004{}

// Acme004 Account does not exist
type Acme004 struct {
...
func (o Acme004) MarshalJSON() ([]byte, error) {
...
func (o Acme004) ToMap() (map[string]interface{}, error) {
...
func (o *Acme004) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varAcme004)

	if err != nil {
		return err
	}

	*o = Acme004(varAcme004)
...
type NullableAcme004 struct {
	value *Acme004
	isSet bool
}

func (v NullableAcme004) Get() *Acme004 {
	return v.value
}

func (v *NullableAcme004) Set(val *Acme004) {
	v.value = val
	v.isSet = true
}

func (v NullableAcme004) IsSet() bool {
	return v.isSet
}

func (v *NullableAcme004) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcme004(val *Acme004) *NullableAcme004 {
	return &NullableAcme004{value: val, isSet: true}
}

func (v NullableAcme004) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcme004) UnmarshalJSON(src []byte) error {
	v.isSet = true

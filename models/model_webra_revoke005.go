...
// checks if the WebraRevoke005 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebraRevoke005{}

// WebraRevoke005 Invalid certificate
type WebraRevoke005 struct {
...
type _WebraRevoke005 WebraRevoke005
...
func (o *WebraRevoke005) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o WebraRevoke005) MarshalJSON() ([]byte, error) {
...
func (o WebraRevoke005) ToMap() (map[string]interface{}, error) {
...
func (o *WebraRevoke005) UnmarshalJSON(data []byte) (err error) {
	...
	varWebraRevoke005 := _WebraRevoke005{}

	err = json.Unmarshal(data, &varWebraRevoke005)

	if err != nil {
		return err
	}

	*o = WebraRevoke005(varWebraRevoke005)
...
type NullableWebraRevoke005 struct {
	value *WebraRevoke005
	isSet bool
}

func (v NullableWebraRevoke005) Get() *WebraRevoke005 {
	return v.value
}

func (v *NullableWebraRevoke005) Set(val *WebraRevoke005) {
	v.value = val
	v.isSet = true
}

func (v NullableWebraRevoke005) IsSet() bool {
	return v.isSet
}

func (v *NullableWebraRevoke005) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebraRevoke005(val *WebraRevoke005) *NullableWebraRevoke005 {
	return &NullableWebraRevoke005{value: val, isSet: true}
}

func (v NullableWebraRevoke005) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebraRevoke005) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the DiscoveryInfo type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DiscoveryInfo{}

// DiscoveryInfo struct for DiscoveryInfo
...
type _DiscoveryInfo DiscoveryInfo
...
func NewDiscoveryInfo(campaign string, lastDiscoveryDate int64) *DiscoveryInfo {
	...
	this.LastDiscoveryDate = lastDiscoveryDate
	return &this
}
...
func (o *DiscoveryInfo) SetIdentifierNil() {
...
func (o *DiscoveryInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varDiscoveryInfo := _DiscoveryInfo{}

	err = json.Unmarshal(data, &varDiscoveryInfo)

	if err != nil {
		return err
	}

	*o = DiscoveryInfo(varDiscoveryInfo)
...
type NullableDiscoveryInfo struct {
	value *DiscoveryInfo
	isSet bool
}

func (v NullableDiscoveryInfo) Get() *DiscoveryInfo {
	return v.value
}

func (v *NullableDiscoveryInfo) Set(val *DiscoveryInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableDiscoveryInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableDiscoveryInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDiscoveryInfo(val *DiscoveryInfo) *NullableDiscoveryInfo {
	return &NullableDiscoveryInfo{value: val, isSet: true}
}

func (v NullableDiscoveryInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDiscoveryInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true

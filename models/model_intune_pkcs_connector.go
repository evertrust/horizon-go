...
func NewIntunePKCSConnector(credentials string, keyName string, name string, pubKey string, throttleDuration string, throttleParallelism int64, type_ string) *IntunePKCSConnector {
	...
	this.Type = type_
	var intendedPurpose string = "smimeEncryption"
	this.IntendedPurpose = *utils.NewNullableString(&intendedPurpose)
	var providerName string = "Microsoft Software Key Storage Provider"
	this.ProviderName = *utils.NewNullableString(&providerName)
	var searchFilter string = "users"
	this.SearchFilter = *utils.NewNullableString(&searchFilter)
	return &this
}
...
func (o *IntunePKCSConnector) GetAzureTenant() string {
...
func (o *IntunePKCSConnector) GetAzureTenantOk() (*string, bool) {
	if o == nil || utils.IsNil(o.AzureTenant) {
		return nil, false
	}
...
func (o *IntunePKCSConnector) HasAzureTenant() bool {
	if o != nil && !utils.IsNil(o.AzureTenant) {
		return true
	}
...
func (o *IntunePKCSConnector) SetAzureTenant(v string) {
	o.AzureTenant = &v
}

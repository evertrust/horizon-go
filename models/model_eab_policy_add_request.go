...
// checks if the EabPolicyAddRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EabPolicyAddRequest{}

// EabPolicyAddRequest struct for EabPolicyAddRequest
type EabPolicyAddRequest struct {
...
type _EabPolicyAddRequest EabPolicyAddRequest
...
func (o EabPolicyAddRequest) MarshalJSON() ([]byte, error) {
...
func (o EabPolicyAddRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EabPolicyAddRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEabPolicyAddRequest := _EabPolicyAddRequest{}

	err = json.Unmarshal(data, &varEabPolicyAddRequest)

	if err != nil {
		return err
	}

	*o = EabPolicyAddRequest(varEabPolicyAddRequest)
...
type NullableEabPolicyAddRequest struct {
	value *EabPolicyAddRequest
	isSet bool
}

func (v NullableEabPolicyAddRequest) Get() *EabPolicyAddRequest {
	return v.value
}

func (v *NullableEabPolicyAddRequest) Set(val *EabPolicyAddRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEabPolicyAddRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEabPolicyAddRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEabPolicyAddRequest(val *EabPolicyAddRequest) *NullableEabPolicyAddRequest {
	return &NullableEabPolicyAddRequest{value: val, isSet: true}
}

func (v NullableEabPolicyAddRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEabPolicyAddRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

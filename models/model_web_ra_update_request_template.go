...
// checks if the WebRAUpdateRequestTemplate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAUpdateRequestTemplate{}
...
type _WebRAUpdateRequestTemplate WebRAUpdateRequestTemplate
...
func (o *WebRAUpdateRequestTemplate) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *WebRAUpdateRequestTemplate) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o *WebRAUpdateRequestTemplate) UnmarshalJSON(data []byte) (err error) {
	varWebRAUpdateRequestTemplate := _WebRAUpdateRequestTemplate{}

	err = json.Unmarshal(data, &varWebRAUpdateRequestTemplate)

	if err != nil {
		return err
	}

	*o = WebRAUpdateRequestTemplate(varWebRAUpdateRequestTemplate)
...
type NullableWebRAUpdateRequestTemplate struct {
	value *WebRAUpdateRequestTemplate
	isSet bool
}

func (v NullableWebRAUpdateRequestTemplate) Get() *WebRAUpdateRequestTemplate {
	return v.value
}

func (v *NullableWebRAUpdateRequestTemplate) Set(val *WebRAUpdateRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAUpdateRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAUpdateRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAUpdateRequestTemplate(val *WebRAUpdateRequestTemplate) *NullableWebRAUpdateRequestTemplate {
	return &NullableWebRAUpdateRequestTemplate{value: val, isSet: true}
}

func (v NullableWebRAUpdateRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAUpdateRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

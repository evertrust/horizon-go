...
// GCPConnectorResponseAsPKIResponses is a convenience function that returns GCPConnectorResponse wrapped in PKIResponses
func GCPConnectorResponseAsPKIResponses(v *GCPConnectorResponse) PKIResponses {
	return PKIResponses{
		GCPConnectorResponse: v,
	}
}
...
func (dst *PKIResponses) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into GCPConnectorResponse
	err = utils.NewStrictDecoder(data).Decode(&dst.GCPConnectorResponse)
	if err == nil {
		jsonGCPConnectorResponse, _ := json.Marshal(dst.GCPConnectorResponse)
		if string(jsonGCPConnectorResponse) == "{}" { // empty struct
			dst.GCPConnectorResponse = nil
		} else {
			_ = validator.Validate(dst.GCPConnectorResponse)
			match++
		}
	} else {
		dst.GCPConnectorResponse = nil
...
func (src PKIResponses) MarshalJSON() ([]byte, error) {
	...
	if src.GCPConnectorResponse != nil {
		return json.Marshal(&src.GCPConnectorResponse)
	}
...
func (obj *PKIResponses) GetActualInstance() interface{} {
	...
	if obj.GCPConnectorResponse != nil {
		return obj.GCPConnectorResponse
	}

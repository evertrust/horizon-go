...
// checks if the ExplainedGradingRuleset type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ExplainedGradingRuleset{}

// ExplainedGradingRuleset struct for ExplainedGradingRuleset
type ExplainedGradingRuleset struct {
...
type _ExplainedGradingRuleset ExplainedGradingRuleset

// NewExplainedGradingRuleset instantiates a new ExplainedGradingRuleset object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewExplainedGradingRuleset(name string, apply bool) *ExplainedGradingRuleset {
	this := ExplainedGradingRuleset{}
	this.Name = name
	this.Apply = apply
	return &this
}
...
func (o *ExplainedGradingRuleset) SetCertificateNil() {
...
func (o *ExplainedGradingRuleset) SetScopeNil() {
	o.Scope.Set(nil)
}
...
func (o *ExplainedGradingRuleset) SetMaxNil() {
	o.Max.Set(nil)
}
...
func (o *ExplainedGradingRuleset) SetObtainedNil() {
	o.Obtained.Set(nil)
}
...
func (o *ExplainedGradingRuleset) SetScoreNil() {
	o.Score.Set(nil)
}
...
func (o ExplainedGradingRuleset) MarshalJSON() ([]byte, error) {
...
func (o ExplainedGradingRuleset) ToMap() (map[string]interface{}, error) {
...
func (o *ExplainedGradingRuleset) UnmarshalJSON(data []byte) (err error) {
	...
	varExplainedGradingRuleset := _ExplainedGradingRuleset{}

	err = json.Unmarshal(data, &varExplainedGradingRuleset)

	if err != nil {
		return err
	}

	*o = ExplainedGradingRuleset(varExplainedGradingRuleset)
...
type NullableExplainedGradingRuleset struct {
	value *ExplainedGradingRuleset
	isSet bool
}

func (v NullableExplainedGradingRuleset) Get() *ExplainedGradingRuleset {
	return v.value
}

func (v *NullableExplainedGradingRuleset) Set(val *ExplainedGradingRuleset) {
	v.value = val
	v.isSet = true
}

func (v NullableExplainedGradingRuleset) IsSet() bool {
	return v.isSet
}

func (v *NullableExplainedGradingRuleset) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExplainedGradingRuleset(val *ExplainedGradingRuleset) *NullableExplainedGradingRuleset {
	return &NullableExplainedGradingRuleset{value: val, isSet: true}
}

func (v NullableExplainedGradingRuleset) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExplainedGradingRuleset) UnmarshalJSON(src []byte) error {
	v.isSet = true

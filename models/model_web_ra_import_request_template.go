...
// checks if the WebRAImportRequestTemplate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestTemplate{}
...
type _WebRAImportRequestTemplate WebRAImportRequestTemplate
...
func (o *WebRAImportRequestTemplate) GetAutoRenew() CertificateAutoRenewElement {
...
func (o *WebRAImportRequestTemplate) GetAutoRenewOk() (*CertificateAutoRenewElement, bool) {
	if o == nil || utils.IsNil(o.AutoRenew) {
		return nil, false
	}
...
func (o *WebRAImportRequestTemplate) HasAutoRenew() bool {
	if o != nil && !utils.IsNil(o.AutoRenew) {
		return true
	}
...
func (o *WebRAImportRequestTemplate) SetAutoRenew(v CertificateAutoRenewElement) {
	o.AutoRenew = &v
}
...
func (o *WebRAImportRequestTemplate) SetContactEmailNil() {
...
func (o *WebRAImportRequestTemplate) SetDiscoveryInfoNil() {
...
func (o *WebRAImportRequestTemplate) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *WebRAImportRequestTemplate) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRAImportRequestTemplate) MarshalJSON() ([]byte, error) {
...
func (o *WebRAImportRequestTemplate) UnmarshalJSON(data []byte) (err error) {
	varWebRAImportRequestTemplate := _WebRAImportRequestTemplate{}

	err = json.Unmarshal(data, &varWebRAImportRequestTemplate)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestTemplate(varWebRAImportRequestTemplate)
...
type NullableWebRAImportRequestTemplate struct {
	value *WebRAImportRequestTemplate
	isSet bool
}

func (v NullableWebRAImportRequestTemplate) Get() *WebRAImportRequestTemplate {
	return v.value
}

func (v *NullableWebRAImportRequestTemplate) Set(val *WebRAImportRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestTemplate(val *WebRAImportRequestTemplate) *NullableWebRAImportRequestTemplate {
	return &NullableWebRAImportRequestTemplate{value: val, isSet: true}
}

func (v NullableWebRAImportRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ utils.MappedNullable = &LDAPConnector{}
...
type LDAPConnector struct {
	...
	// Create a new directory entry when no matching entry is found for the certificate, instead of failing the publish.
	CreateEntry utils.NullableBool `json:"createEntry,omitempty"`
...
func NewLDAPConnector(baseDn string, certificateAttribute string, credentials string, hostname string, name string, throttleDuration string, type_ string, userIdentifierAttribute string) *LDAPConnector {
	...
	var certAttr string = "userCertificate"
	this.CertAttr = *utils.NewNullableString(&certAttr)
	var createEntry bool = false
	this.CreateEntry = *utils.NewNullableBool(&createEntry)
	var filter string = "(objectclass=user)"
	this.Filter = *utils.NewNullableString(&filter)
	var followReferrals bool = false
	this.FollowReferrals = *utils.NewNullableBool(&followReferrals)
	var port int64 = 389
...
// GetCreateEntry returns the CreateEntry field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *LDAPConnector) GetCreateEntry() bool {
	if o == nil || utils.IsNil(o.CreateEntry.Get()) {
		var ret bool
		return ret
	}
	return *o.CreateEntry.Get()
}

// GetCreateEntryOk returns a tuple with the CreateEntry field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
...
// SetCreateEntry gets a reference to the given NullableBool and assigns it to the CreateEntry field.
func (o *LDAPConnector) SetCreateEntry(v bool) {
	o.CreateEntry.Set(&v)
}

// SetCreateEntryNil sets the value for CreateEntry to be an explicit nil
func (o *LDAPConnector) SetCreateEntryNil() {
	o.CreateEntry.Set(nil)
}
...
func (o *LDAPConnector) SetTlsInsecureNil() {
...
func (o LDAPConnector) ToMap() (map[string]interface{}, error) {
	...
	if o.CreateEntry.IsSet() {
		toSerialize["createEntry"] = o.CreateEntry.Get()
	}
...
func (o *LDAPConnector) UnmarshalJSON(data []byte) (err error) {
	...
	*o = LDAPConnector(varLDAPConnector)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "createEntry")

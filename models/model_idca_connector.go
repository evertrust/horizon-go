...
// checks if the IDCAConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &IDCAConnector{}

// IDCAConnector struct for IDCAConnector
type IDCAConnector struct {
...
type _IDCAConnector IDCAConnector

// NewIDCAConnector instantiates a new IDCAConnector object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewIDCAConnector(authenticationCredentials utils.NullableString, endPoint string, name string, profile string, type_ string) *IDCAConnector {
	this := IDCAConnector{}
...
func (o *IDCAConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *IDCAConnector) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o *IDCAConnector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o IDCAConnector) MarshalJSON() ([]byte, error) {
...
func (o IDCAConnector) ToMap() (map[string]interface{}, error) {
...
func (o *IDCAConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varIDCAConnector := _IDCAConnector{}

	err = json.Unmarshal(data, &varIDCAConnector)

	if err != nil {
		return err
	}

	*o = IDCAConnector(varIDCAConnector)
...
type NullableIDCAConnector struct {
	value *IDCAConnector
	isSet bool
}

func (v NullableIDCAConnector) Get() *IDCAConnector {
	return v.value
}

func (v *NullableIDCAConnector) Set(val *IDCAConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableIDCAConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableIDCAConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableIDCAConnector(val *IDCAConnector) *NullableIDCAConnector {
	return &NullableIDCAConnector{value: val, isSet: true}
}

func (v NullableIDCAConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableIDCAConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

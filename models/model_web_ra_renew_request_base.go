...
// checks if the WebRARenewRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARenewRequestBase{}
...
type _WebRARenewRequestBase WebRARenewRequestBase
...
func (o *WebRARenewRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRARenewRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRARenewRequestBase := _WebRARenewRequestBase{}

	err = json.Unmarshal(data, &varWebRARenewRequestBase)

	if err != nil {
		return err
	}

	*o = WebRARenewRequestBase(varWebRARenewRequestBase)
...
type NullableWebRARenewRequestBase struct {
	value *WebRARenewRequestBase
	isSet bool
}

func (v NullableWebRARenewRequestBase) Get() *WebRARenewRequestBase {
	return v.value
}

func (v *NullableWebRARenewRequestBase) Set(val *WebRARenewRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARenewRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARenewRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARenewRequestBase(val *WebRARenewRequestBase) *NullableWebRARenewRequestBase {
	return &NullableWebRARenewRequestBase{value: val, isSet: true}
}

func (v NullableWebRARenewRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARenewRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

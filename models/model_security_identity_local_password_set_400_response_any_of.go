...
// checks if the SecurityIdentityLocalPasswordSet400ResponseAnyOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecurityIdentityLocalPasswordSet400ResponseAnyOf{}

// SecurityIdentityLocalPasswordSet400ResponseAnyOf struct for SecurityIdentityLocalPasswordSet400ResponseAnyOf
type SecurityIdentityLocalPasswordSet400ResponseAnyOf struct {
...
type _SecurityIdentityLocalPasswordSet400ResponseAnyOf SecurityIdentityLocalPasswordSet400ResponseAnyOf
...
func NewSecurityIdentityLocalPasswordSet400ResponseAnyOf(status float32, error_ string, message string, title string) *SecurityIdentityLocalPasswordSet400ResponseAnyOf {
	this := SecurityIdentityLocalPasswordSet400ResponseAnyOf{}
	this.Error = error_
...
func (o *SecurityIdentityLocalPasswordSet400ResponseAnyOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecurityIdentityLocalPasswordSet400ResponseAnyOf) MarshalJSON() ([]byte, error) {
...
func (o SecurityIdentityLocalPasswordSet400ResponseAnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityIdentityLocalPasswordSet400ResponseAnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSecurityIdentityLocalPasswordSet400ResponseAnyOf := _SecurityIdentityLocalPasswordSet400ResponseAnyOf{}

	err = json.Unmarshal(data, &varSecurityIdentityLocalPasswordSet400ResponseAnyOf)

	if err != nil {
		return err
	}

	*o = SecurityIdentityLocalPasswordSet400ResponseAnyOf(varSecurityIdentityLocalPasswordSet400ResponseAnyOf)
...
type NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf struct {
	value *SecurityIdentityLocalPasswordSet400ResponseAnyOf
	isSet bool
}

func (v NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) Get() *SecurityIdentityLocalPasswordSet400ResponseAnyOf {
	return v.value
}

func (v *NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) Set(val *SecurityIdentityLocalPasswordSet400ResponseAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityIdentityLocalPasswordSet400ResponseAnyOf(val *SecurityIdentityLocalPasswordSet400ResponseAnyOf) *NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf {
	return &NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf{value: val, isSet: true}
}

func (v NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityIdentityLocalPasswordSet400ResponseAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

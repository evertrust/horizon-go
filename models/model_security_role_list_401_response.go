...
// SecurityRoleList401Response struct for SecurityRoleList401Response
type SecurityRoleList401Response struct {
...
func (dst *SecurityRoleList401Response) UnmarshalJSON(data []byte) error {
	var err error
	...
	return fmt.Errorf("data failed to match schemas in anyOf(SecurityRoleList401Response)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src SecurityRoleList401Response) MarshalJSON() ([]byte, error) {
...
type NullableSecurityRoleList401Response struct {
	value *SecurityRoleList401Response
	isSet bool
}

func (v NullableSecurityRoleList401Response) Get() *SecurityRoleList401Response {
	return v.value
}

func (v *NullableSecurityRoleList401Response) Set(val *SecurityRoleList401Response) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityRoleList401Response) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityRoleList401Response) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityRoleList401Response(val *SecurityRoleList401Response) *NullableSecurityRoleList401Response {
	return &NullableSecurityRoleList401Response{value: val, isSet: true}
}

func (v NullableSecurityRoleList401Response) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityRoleList401Response) UnmarshalJSON(src []byte) error {
	v.isSet = true

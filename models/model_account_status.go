...
// AccountStatus Status of an ACME account.  - **COMPROMISED_PENDING**: Transitional state. Triggers revocation of all linked certificates issued after the specified `compromisedAt` date, then transitions to COMPROMISED. - **COMPROMISED**: Final state. All certificates have been revoked. No further transitions possible. - **REVOKED**: Account has been revoked. - **DEACTIVATED**: Account has been deactivated. - **SUSPENDED**: Account has been temporarily suspended. - **VALID**: Account is active and operational.
type AccountStatus string

// List of AccountStatus
const (
	ACCOUNTSTATUS_VALID               AccountStatus = "valid"
	ACCOUNTSTATUS_DEACTIVATED         AccountStatus = "deactivated"
	ACCOUNTSTATUS_SUSPENDED           AccountStatus = "suspended"
	ACCOUNTSTATUS_REVOKED             AccountStatus = "revoked"
	ACCOUNTSTATUS_COMPROMISED         AccountStatus = "compromised"
	ACCOUNTSTATUS_COMPROMISED_PENDING AccountStatus = "compromised_pending"
)

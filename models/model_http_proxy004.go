...
// checks if the HttpProxy004 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &HttpProxy004{}

// HttpProxy004 Proxy already exists
type HttpProxy004 struct {
...
type _HttpProxy004 HttpProxy004
...
func (o *HttpProxy004) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o HttpProxy004) MarshalJSON() ([]byte, error) {
...
func (o HttpProxy004) ToMap() (map[string]interface{}, error) {
...
func (o *HttpProxy004) UnmarshalJSON(data []byte) (err error) {
	...
	varHttpProxy004 := _HttpProxy004{}

	err = json.Unmarshal(data, &varHttpProxy004)

	if err != nil {
		return err
	}

	*o = HttpProxy004(varHttpProxy004)
...
type NullableHttpProxy004 struct {
	value *HttpProxy004
	isSet bool
}

func (v NullableHttpProxy004) Get() *HttpProxy004 {
	return v.value
}

func (v *NullableHttpProxy004) Set(val *HttpProxy004) {
	v.value = val
	v.isSet = true
}

func (v NullableHttpProxy004) IsSet() bool {
	return v.isSet
}

func (v *NullableHttpProxy004) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHttpProxy004(val *HttpProxy004) *NullableHttpProxy004 {
	return &NullableHttpProxy004{value: val, isSet: true}
}

func (v NullableHttpProxy004) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHttpProxy004) UnmarshalJSON(src []byte) error {
	v.isSet = true

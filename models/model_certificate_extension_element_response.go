...
// checks if the CertificateExtensionElementResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateExtensionElementResponse{}

// CertificateExtensionElementResponse struct for CertificateExtensionElementResponse
type CertificateExtensionElementResponse struct {
...
type _CertificateExtensionElementResponse CertificateExtensionElementResponse
...
func NewCertificateExtensionElementResponse(type_ string) *CertificateExtensionElementResponse {
	this := CertificateExtensionElementResponse{}
	this.Type = type_
	return &this
}
...
func (o *CertificateExtensionElementResponse) SetComputationRuleNil() {
...
func (o *CertificateExtensionElementResponse) SetEditableNil() {
	o.Editable.Set(nil)
}
...
func (o *CertificateExtensionElementResponse) SetMandatoryNil() {
	o.Mandatory.Set(nil)
}
...
func (o *CertificateExtensionElementResponse) SetRegexNil() {
	o.Regex.Set(nil)
}
...
func (o *CertificateExtensionElementResponse) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o CertificateExtensionElementResponse) MarshalJSON() ([]byte, error) {
...
func (o CertificateExtensionElementResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateExtensionElementResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateExtensionElementResponse := _CertificateExtensionElementResponse{}

	err = json.Unmarshal(data, &varCertificateExtensionElementResponse)

	if err != nil {
		return err
	}

	*o = CertificateExtensionElementResponse(varCertificateExtensionElementResponse)
...
type NullableCertificateExtensionElementResponse struct {
	value *CertificateExtensionElementResponse
	isSet bool
}

func (v NullableCertificateExtensionElementResponse) Get() *CertificateExtensionElementResponse {
	return v.value
}

func (v *NullableCertificateExtensionElementResponse) Set(val *CertificateExtensionElementResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateExtensionElementResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateExtensionElementResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateExtensionElementResponse(val *CertificateExtensionElementResponse) *NullableCertificateExtensionElementResponse {
	return &NullableCertificateExtensionElementResponse{value: val, isSet: true}
}

func (v NullableCertificateExtensionElementResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateExtensionElementResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EstEnroll006 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnroll006{}

// EstEnroll006 Missing profile EST Enrollment Request Template
type EstEnroll006 struct {
...
type _EstEnroll006 EstEnroll006
...
func (o *EstEnroll006) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o EstEnroll006) MarshalJSON() ([]byte, error) {
...
func (o EstEnroll006) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnroll006) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnroll006 := _EstEnroll006{}

	err = json.Unmarshal(data, &varEstEnroll006)

	if err != nil {
		return err
	}

	*o = EstEnroll006(varEstEnroll006)
...
type NullableEstEnroll006 struct {
	value *EstEnroll006
	isSet bool
}

func (v NullableEstEnroll006) Get() *EstEnroll006 {
	return v.value
}

func (v *NullableEstEnroll006) Set(val *EstEnroll006) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnroll006) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnroll006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnroll006(val *EstEnroll006) *NullableEstEnroll006 {
	return &NullableEstEnroll006{value: val, isSet: true}
}

func (v NullableEstEnroll006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnroll006) UnmarshalJSON(src []byte) error {
	v.isSet = true

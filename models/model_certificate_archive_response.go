...
// checks if the CertificateArchiveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateArchiveResponse{}

// CertificateArchiveResponse struct for CertificateArchiveResponse
...
type _CertificateArchiveResponse CertificateArchiveResponse
...
func (o *CertificateArchiveResponse) SetCreatedAtNil() {
	o.CreatedAt.Set(nil)
}
...
func (o *CertificateArchiveResponse) SetPurgeAtNil() {
	o.PurgeAt.Set(nil)
}
...
func (o *CertificateArchiveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateArchiveResponse := _CertificateArchiveResponse{}

	err = json.Unmarshal(data, &varCertificateArchiveResponse)

	if err != nil {
		return err
	}

	*o = CertificateArchiveResponse(varCertificateArchiveResponse)
...
type NullableCertificateArchiveResponse struct {
	value *CertificateArchiveResponse
	isSet bool
}

func (v NullableCertificateArchiveResponse) Get() *CertificateArchiveResponse {
	return v.value
}

func (v *NullableCertificateArchiveResponse) Set(val *CertificateArchiveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateArchiveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateArchiveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateArchiveResponse(val *CertificateArchiveResponse) *NullableCertificateArchiveResponse {
	return &NullableCertificateArchiveResponse{value: val, isSet: true}
}

func (v NullableCertificateArchiveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateArchiveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

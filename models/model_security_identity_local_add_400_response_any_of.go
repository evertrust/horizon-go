...
// checks if the SecurityIdentityLocalAdd400ResponseAnyOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecurityIdentityLocalAdd400ResponseAnyOf{}

// SecurityIdentityLocalAdd400ResponseAnyOf struct for SecurityIdentityLocalAdd400ResponseAnyOf
type SecurityIdentityLocalAdd400ResponseAnyOf struct {
...
type _SecurityIdentityLocalAdd400ResponseAnyOf SecurityIdentityLocalAdd400ResponseAnyOf
...
func NewSecurityIdentityLocalAdd400ResponseAnyOf(status float32, error_ string, message string, title string) *SecurityIdentityLocalAdd400ResponseAnyOf {
	this := SecurityIdentityLocalAdd400ResponseAnyOf{}
	this.Error = error_
...
func (o *SecurityIdentityLocalAdd400ResponseAnyOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecurityIdentityLocalAdd400ResponseAnyOf) MarshalJSON() ([]byte, error) {
...
func (o SecurityIdentityLocalAdd400ResponseAnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityIdentityLocalAdd400ResponseAnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSecurityIdentityLocalAdd400ResponseAnyOf := _SecurityIdentityLocalAdd400ResponseAnyOf{}

	err = json.Unmarshal(data, &varSecurityIdentityLocalAdd400ResponseAnyOf)

	if err != nil {
		return err
	}

	*o = SecurityIdentityLocalAdd400ResponseAnyOf(varSecurityIdentityLocalAdd400ResponseAnyOf)
...
type NullableSecurityIdentityLocalAdd400ResponseAnyOf struct {
	value *SecurityIdentityLocalAdd400ResponseAnyOf
	isSet bool
}

func (v NullableSecurityIdentityLocalAdd400ResponseAnyOf) Get() *SecurityIdentityLocalAdd400ResponseAnyOf {
	return v.value
}

func (v *NullableSecurityIdentityLocalAdd400ResponseAnyOf) Set(val *SecurityIdentityLocalAdd400ResponseAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityIdentityLocalAdd400ResponseAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityIdentityLocalAdd400ResponseAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityIdentityLocalAdd400ResponseAnyOf(val *SecurityIdentityLocalAdd400ResponseAnyOf) *NullableSecurityIdentityLocalAdd400ResponseAnyOf {
	return &NullableSecurityIdentityLocalAdd400ResponseAnyOf{value: val, isSet: true}
}

func (v NullableSecurityIdentityLocalAdd400ResponseAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityIdentityLocalAdd400ResponseAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

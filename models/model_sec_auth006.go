...
// checks if the SecAuth006 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecAuth006{}

// SecAuth006 Principal not authenticated
type SecAuth006 struct {
...
func (o *SecAuth006) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecAuth006) MarshalJSON() ([]byte, error) {
...
func (o SecAuth006) ToMap() (map[string]interface{}, error) {
...
func (o *SecAuth006) UnmarshalJSON(data []byte) (err error) {
	...
	varSecAuth006 := _SecAuth006{}

	err = json.Unmarshal(data, &varSecAuth006)

	if err != nil {
		return err
	}

	*o = SecAuth006(varSecAuth006)
...
type NullableSecAuth006 struct {
	value *SecAuth006
	isSet bool
}

func (v NullableSecAuth006) Get() *SecAuth006 {
	return v.value
}

func (v *NullableSecAuth006) Set(val *SecAuth006) {
	v.value = val
	v.isSet = true
}

func (v NullableSecAuth006) IsSet() bool {
	return v.isSet
}

func (v *NullableSecAuth006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecAuth006(val *SecAuth006) *NullableSecAuth006 {
	return &NullableSecAuth006{value: val, isSet: true}
}

func (v NullableSecAuth006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecAuth006) UnmarshalJSON(src []byte) error {
	v.isSet = true

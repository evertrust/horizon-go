...
// checks if the EJBCARESTConnectorResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EJBCARESTConnectorResponse{}

// EJBCARESTConnectorResponse struct for EJBCARESTConnectorResponse
type EJBCARESTConnectorResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _EJBCARESTConnectorResponse EJBCARESTConnectorResponse
...
func NewEJBCARESTConnectorResponse(id string, authenticationCredentials string, caName string, endPoint string, name string, profile string, type_ string) *EJBCARESTConnectorResponse {
	this := EJBCARESTConnectorResponse{}
	this.Id = id
...
func (o *EJBCARESTConnectorResponse) SetEeProfileNil() {
	o.EeProfile.Set(nil)
}
...
func (o *EJBCARESTConnectorResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *EJBCARESTConnectorResponse) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o *EJBCARESTConnectorResponse) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o *EJBCARESTConnectorResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o EJBCARESTConnectorResponse) MarshalJSON() ([]byte, error) {
...
func (o EJBCARESTConnectorResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EJBCARESTConnectorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEJBCARESTConnectorResponse := _EJBCARESTConnectorResponse{}

	err = json.Unmarshal(data, &varEJBCARESTConnectorResponse)

	if err != nil {
		return err
	}

	*o = EJBCARESTConnectorResponse(varEJBCARESTConnectorResponse)
...
type NullableEJBCARESTConnectorResponse struct {
	value *EJBCARESTConnectorResponse
	isSet bool
}

func (v NullableEJBCARESTConnectorResponse) Get() *EJBCARESTConnectorResponse {
	return v.value
}

func (v *NullableEJBCARESTConnectorResponse) Set(val *EJBCARESTConnectorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEJBCARESTConnectorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEJBCARESTConnectorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEJBCARESTConnectorResponse(val *EJBCARESTConnectorResponse) *NullableEJBCARESTConnectorResponse {
	return &NullableEJBCARESTConnectorResponse{value: val, isSet: true}
}

func (v NullableEJBCARESTConnectorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEJBCARESTConnectorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

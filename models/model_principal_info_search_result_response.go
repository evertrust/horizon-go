...
// checks if the PrincipalInfoSearchResultResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PrincipalInfoSearchResultResponse{}
...
type _PrincipalInfoSearchResultResponse PrincipalInfoSearchResultResponse
...
func (o *PrincipalInfoSearchResultResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *PrincipalInfoSearchResultResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPrincipalInfoSearchResultResponse := _PrincipalInfoSearchResultResponse{}

	err = json.Unmarshal(data, &varPrincipalInfoSearchResultResponse)

	if err != nil {
		return err
	}

	*o = PrincipalInfoSearchResultResponse(varPrincipalInfoSearchResultResponse)
...
type NullablePrincipalInfoSearchResultResponse struct {
	value *PrincipalInfoSearchResultResponse
	isSet bool
}

func (v NullablePrincipalInfoSearchResultResponse) Get() *PrincipalInfoSearchResultResponse {
	return v.value
}

func (v *NullablePrincipalInfoSearchResultResponse) Set(val *PrincipalInfoSearchResultResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalInfoSearchResultResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalInfoSearchResultResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalInfoSearchResultResponse(val *PrincipalInfoSearchResultResponse) *NullablePrincipalInfoSearchResultResponse {
	return &NullablePrincipalInfoSearchResultResponse{value: val, isSet: true}
}

func (v NullablePrincipalInfoSearchResultResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalInfoSearchResultResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

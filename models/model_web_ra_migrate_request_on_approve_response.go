...
// checks if the WebRAMigrateRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAMigrateRequestOnApproveResponse{}

// WebRAMigrateRequestOnApproveResponse struct for WebRAMigrateRequestOnApproveResponse
type WebRAMigrateRequestOnApproveResponse struct {
...
type _WebRAMigrateRequestOnApproveResponse WebRAMigrateRequestOnApproveResponse
...
func NewWebRAMigrateRequestOnApproveResponse(module string, profile string, template WebRAMigrateRequestTemplate, workflow string, id string, lastModificationDate int64, registrationDate int64, removeAt int64, status RequestStatus) *WebRAMigrateRequestOnApproveResponse {
	this := WebRAMigrateRequestOnApproveResponse{}
	this.Module = module
...
func (o *WebRAMigrateRequestOnApproveResponse) SetCertificateNil() {
...
func (o *WebRAMigrateRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRAMigrateRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAMigrateRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *WebRAMigrateRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRAMigrateRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnApproveResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAMigrateRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAMigrateRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRAMigrateRequestOnApproveResponse) SetRequesterCommentNil() {
...
func (o *WebRAMigrateRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRAMigrateRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAMigrateRequestOnApproveResponse := _WebRAMigrateRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestOnApproveResponse(varWebRAMigrateRequestOnApproveResponse)
...
type NullableWebRAMigrateRequestOnApproveResponse struct {
	value *WebRAMigrateRequestOnApproveResponse
	isSet bool
}

func (v NullableWebRAMigrateRequestOnApproveResponse) Get() *WebRAMigrateRequestOnApproveResponse {
	return v.value
}

func (v *NullableWebRAMigrateRequestOnApproveResponse) Set(val *WebRAMigrateRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestOnApproveResponse(val *WebRAMigrateRequestOnApproveResponse) *NullableWebRAMigrateRequestOnApproveResponse {
	return &NullableWebRAMigrateRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

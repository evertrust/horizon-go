...
// checks if the TeamPolicy type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &TeamPolicy{}
...
func (o *TeamPolicy) SetComputationRuleNil() {
...
func (o *TeamPolicy) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamPolicy := _TeamPolicy{}

	err = json.Unmarshal(data, &varTeamPolicy)

	if err != nil {
		return err
	}

	*o = TeamPolicy(varTeamPolicy)
...
type NullableTeamPolicy struct {
	value *TeamPolicy
	isSet bool
}

func (v NullableTeamPolicy) Get() *TeamPolicy {
	return v.value
}

func (v *NullableTeamPolicy) Set(val *TeamPolicy) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamPolicy) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamPolicy) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamPolicy(val *TeamPolicy) *NullableTeamPolicy {
	return &NullableTeamPolicy{value: val, isSet: true}
}

func (v NullableTeamPolicy) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamPolicy) UnmarshalJSON(src []byte) error {
	v.isSet = true

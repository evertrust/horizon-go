...
// checks if the FortiManagerConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &FortiManagerConnector{}

// FortiManagerConnector struct for FortiManagerConnector
type FortiManagerConnector struct {
	...
	ManagedDevice      NullableFortiManagerConnectorManagedDevice `json:"managedDevice,omitempty"`
	Name               string                                     `json:"name"`
	// Certificate name prefix used when deploying certificates
	Prefix string               `json:"prefix"`
	Proxy  utils.NullableString `json:"proxy,omitempty"`
	// Selects what the connector deploys certificates to. Use `unit` to target the FortiManager unit's own certificate store, or `device` to target a FortiGate device managed by the FortiManager. When set to `device`, `managedDevice` must be provided; when set to `unit`, `managedDevice` must be omitted.
...
type _FortiManagerConnector FortiManagerConnector
...
func (o *FortiManagerConnector) GetManagedDevice() FortiManagerConnectorManagedDevice {
	if o == nil || utils.IsNil(o.ManagedDevice.Get()) {
		var ret FortiManagerConnectorManagedDevice
		return ret
	}
...
// SetManagedDevice gets a reference to the given NullableFortiManagerConnectorManagedDevice and assigns it to the ManagedDevice field.
...
func (o *FortiManagerConnector) SetManagedDeviceNil() {
...
func (o *FortiManagerConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *FortiManagerConnector) SetTlsInsecureNil() {
...
func (o FortiManagerConnector) MarshalJSON() ([]byte, error) {
...
func (o FortiManagerConnector) ToMap() (map[string]interface{}, error) {
...
func (o *FortiManagerConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varFortiManagerConnector := _FortiManagerConnector{}

	err = json.Unmarshal(data, &varFortiManagerConnector)

	if err != nil {
		return err
	}

	*o = FortiManagerConnector(varFortiManagerConnector)
...
type NullableFortiManagerConnector struct {
	value *FortiManagerConnector
	isSet bool
}

func (v NullableFortiManagerConnector) Get() *FortiManagerConnector {
	return v.value
}

func (v *NullableFortiManagerConnector) Set(val *FortiManagerConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableFortiManagerConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableFortiManagerConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableFortiManagerConnector(val *FortiManagerConnector) *NullableFortiManagerConnector {
	return &NullableFortiManagerConnector{value: val, isSet: true}
}

func (v NullableFortiManagerConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableFortiManagerConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

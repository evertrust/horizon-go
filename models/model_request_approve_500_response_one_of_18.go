...
// checks if the RequestApprove500ResponseOneOf18 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestApprove500ResponseOneOf18{}

// RequestApprove500ResponseOneOf18 struct for RequestApprove500ResponseOneOf18
type RequestApprove500ResponseOneOf18 struct {
...
type _RequestApprove500ResponseOneOf18 RequestApprove500ResponseOneOf18
...
func NewRequestApprove500ResponseOneOf18(status float32, error_ string, message string, title string) *RequestApprove500ResponseOneOf18 {
	this := RequestApprove500ResponseOneOf18{}
	this.Error = error_
...
func (o *RequestApprove500ResponseOneOf18) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestApprove500ResponseOneOf18) MarshalJSON() ([]byte, error) {
...
func (o RequestApprove500ResponseOneOf18) ToMap() (map[string]interface{}, error) {
...
func (o *RequestApprove500ResponseOneOf18) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestApprove500ResponseOneOf18 := _RequestApprove500ResponseOneOf18{}

	err = json.Unmarshal(data, &varRequestApprove500ResponseOneOf18)

	if err != nil {
		return err
	}

	*o = RequestApprove500ResponseOneOf18(varRequestApprove500ResponseOneOf18)
...
type NullableRequestApprove500ResponseOneOf18 struct {
	value *RequestApprove500ResponseOneOf18
	isSet bool
}

func (v NullableRequestApprove500ResponseOneOf18) Get() *RequestApprove500ResponseOneOf18 {
	return v.value
}

func (v *NullableRequestApprove500ResponseOneOf18) Set(val *RequestApprove500ResponseOneOf18) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestApprove500ResponseOneOf18) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestApprove500ResponseOneOf18) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestApprove500ResponseOneOf18(val *RequestApprove500ResponseOneOf18) *NullableRequestApprove500ResponseOneOf18 {
	return &NullableRequestApprove500ResponseOneOf18{value: val, isSet: true}
}

func (v NullableRequestApprove500ResponseOneOf18) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestApprove500ResponseOneOf18) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EJBCARESTConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EJBCARESTConnector{}

// EJBCARESTConnector struct for EJBCARESTConnector
type EJBCARESTConnector struct {
...
type _EJBCARESTConnector EJBCARESTConnector
...
func (o *EJBCARESTConnector) SetEeProfileNil() {
	o.EeProfile.Set(nil)
}
...
func (o *EJBCARESTConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *EJBCARESTConnector) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o *EJBCARESTConnector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o EJBCARESTConnector) MarshalJSON() ([]byte, error) {
...
func (o EJBCARESTConnector) ToMap() (map[string]interface{}, error) {
...
func (o *EJBCARESTConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varEJBCARESTConnector := _EJBCARESTConnector{}

	err = json.Unmarshal(data, &varEJBCARESTConnector)

	if err != nil {
		return err
	}

	*o = EJBCARESTConnector(varEJBCARESTConnector)
...
type NullableEJBCARESTConnector struct {
	value *EJBCARESTConnector
	isSet bool
}

func (v NullableEJBCARESTConnector) Get() *EJBCARESTConnector {
	return v.value
}

func (v *NullableEJBCARESTConnector) Set(val *EJBCARESTConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableEJBCARESTConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableEJBCARESTConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEJBCARESTConnector(val *EJBCARESTConnector) *NullableEJBCARESTConnector {
	return &NullableEJBCARESTConnector{value: val, isSet: true}
}

func (v NullableEJBCARESTConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEJBCARESTConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

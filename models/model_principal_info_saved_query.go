...
// checks if the PrincipalInfoSavedQuery type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PrincipalInfoSavedQuery{}
...
type _PrincipalInfoSavedQuery PrincipalInfoSavedQuery
...
func (o *PrincipalInfoSavedQuery) SetDescriptionNil() {
...
func (o *PrincipalInfoSavedQuery) UnmarshalJSON(data []byte) (err error) {
	...
	varPrincipalInfoSavedQuery := _PrincipalInfoSavedQuery{}

	err = json.Unmarshal(data, &varPrincipalInfoSavedQuery)

	if err != nil {
		return err
	}

	*o = PrincipalInfoSavedQuery(varPrincipalInfoSavedQuery)
...
type NullablePrincipalInfoSavedQuery struct {
	value *PrincipalInfoSavedQuery
	isSet bool
}

func (v NullablePrincipalInfoSavedQuery) Get() *PrincipalInfoSavedQuery {
	return v.value
}

func (v *NullablePrincipalInfoSavedQuery) Set(val *PrincipalInfoSavedQuery) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalInfoSavedQuery) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalInfoSavedQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalInfoSavedQuery(val *PrincipalInfoSavedQuery) *NullablePrincipalInfoSavedQuery {
	return &NullablePrincipalInfoSavedQuery{value: val, isSet: true}
}

func (v NullablePrincipalInfoSavedQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalInfoSavedQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true

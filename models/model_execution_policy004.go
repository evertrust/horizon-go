...
// checks if the ExecutionPolicy004 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ExecutionPolicy004{}

// ExecutionPolicy004 Execution Policy already exists
type ExecutionPolicy004 struct {
...
type _ExecutionPolicy004 ExecutionPolicy004
...
func (o *ExecutionPolicy004) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ExecutionPolicy004) MarshalJSON() ([]byte, error) {
...
func (o ExecutionPolicy004) ToMap() (map[string]interface{}, error) {
...
func (o *ExecutionPolicy004) UnmarshalJSON(data []byte) (err error) {
	...
	varExecutionPolicy004 := _ExecutionPolicy004{}

	err = json.Unmarshal(data, &varExecutionPolicy004)

	if err != nil {
		return err
	}

	*o = ExecutionPolicy004(varExecutionPolicy004)
...
type NullableExecutionPolicy004 struct {
	value *ExecutionPolicy004
	isSet bool
}

func (v NullableExecutionPolicy004) Get() *ExecutionPolicy004 {
	return v.value
}

func (v *NullableExecutionPolicy004) Set(val *ExecutionPolicy004) {
	v.value = val
	v.isSet = true
}

func (v NullableExecutionPolicy004) IsSet() bool {
	return v.isSet
}

func (v *NullableExecutionPolicy004) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExecutionPolicy004(val *ExecutionPolicy004) *NullableExecutionPolicy004 {
	return &NullableExecutionPolicy004{value: val, isSet: true}
}

func (v NullableExecutionPolicy004) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExecutionPolicy004) UnmarshalJSON(src []byte) error {
	v.isSet = true

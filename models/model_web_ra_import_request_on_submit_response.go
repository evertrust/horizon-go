...
// checks if the WebRAImportRequestOnSubmitResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestOnSubmitResponse{}
...
type _WebRAImportRequestOnSubmitResponse WebRAImportRequestOnSubmitResponse
...
func NewWebRAImportRequestOnSubmitResponse(certificate NullableCertificate, module Module, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRAImportRequestOnSubmitResponse {
...
func (o *WebRAImportRequestOnSubmitResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRAImportRequestOnSubmitResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRAImportRequestOnSubmitResponse) SetApproverCommentNil() {
...
func (o *WebRAImportRequestOnSubmitResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAImportRequestOnSubmitResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRAImportRequestOnSubmitResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAImportRequestOnSubmitResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAImportRequestOnSubmitResponse := _WebRAImportRequestOnSubmitResponse{}

	err = json.Unmarshal(data, &varWebRAImportRequestOnSubmitResponse)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestOnSubmitResponse(varWebRAImportRequestOnSubmitResponse)
...
type NullableWebRAImportRequestOnSubmitResponse struct {
	value *WebRAImportRequestOnSubmitResponse
	isSet bool
}

func (v NullableWebRAImportRequestOnSubmitResponse) Get() *WebRAImportRequestOnSubmitResponse {
	return v.value
}

func (v *NullableWebRAImportRequestOnSubmitResponse) Set(val *WebRAImportRequestOnSubmitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestOnSubmitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestOnSubmitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestOnSubmitResponse(val *WebRAImportRequestOnSubmitResponse) *NullableWebRAImportRequestOnSubmitResponse {
	return &NullableWebRAImportRequestOnSubmitResponse{value: val, isSet: true}
}

func (v NullableWebRAImportRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestOnSubmitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the GradingPolicy003 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GradingPolicy003{}

// GradingPolicy003 Grading Policy not found
type GradingPolicy003 struct {
...
type _GradingPolicy003 GradingPolicy003
...
func (o *GradingPolicy003) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o GradingPolicy003) MarshalJSON() ([]byte, error) {
...
func (o GradingPolicy003) ToMap() (map[string]interface{}, error) {
...
func (o *GradingPolicy003) UnmarshalJSON(data []byte) (err error) {
	...
	varGradingPolicy003 := _GradingPolicy003{}

	err = json.Unmarshal(data, &varGradingPolicy003)

	if err != nil {
		return err
	}

	*o = GradingPolicy003(varGradingPolicy003)
...
type NullableGradingPolicy003 struct {
	value *GradingPolicy003
	isSet bool
}

func (v NullableGradingPolicy003) Get() *GradingPolicy003 {
	return v.value
}

func (v *NullableGradingPolicy003) Set(val *GradingPolicy003) {
	v.value = val
	v.isSet = true
}

func (v NullableGradingPolicy003) IsSet() bool {
	return v.isSet
}

func (v *NullableGradingPolicy003) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGradingPolicy003(val *GradingPolicy003) *NullableGradingPolicy003 {
	return &NullableGradingPolicy003{value: val, isSet: true}
}

func (v NullableGradingPolicy003) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGradingPolicy003) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the EstEnrollRequestOnSubmit type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestOnSubmit{}
...
type _EstEnrollRequestOnSubmit EstEnrollRequestOnSubmit
...
func (o *EstEnrollRequestOnSubmit) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *EstEnrollRequestOnSubmit) SetRequesterCommentNil() {
...
func (o *EstEnrollRequestOnSubmit) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o EstEnrollRequestOnSubmit) MarshalJSON() ([]byte, error) {
...
func (o *EstEnrollRequestOnSubmit) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnrollRequestOnSubmit := _EstEnrollRequestOnSubmit{}

	err = json.Unmarshal(data, &varEstEnrollRequestOnSubmit)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestOnSubmit(varEstEnrollRequestOnSubmit)
...
type NullableEstEnrollRequestOnSubmit struct {
	value *EstEnrollRequestOnSubmit
	isSet bool
}

func (v NullableEstEnrollRequestOnSubmit) Get() *EstEnrollRequestOnSubmit {
	return v.value
}

func (v *NullableEstEnrollRequestOnSubmit) Set(val *EstEnrollRequestOnSubmit) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestOnSubmit) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestOnSubmit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestOnSubmit(val *EstEnrollRequestOnSubmit) *NullableEstEnrollRequestOnSubmit {
	return &NullableEstEnrollRequestOnSubmit{value: val, isSet: true}
}

func (v NullableEstEnrollRequestOnSubmit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestOnSubmit) UnmarshalJSON(src []byte) error {
	v.isSet = true

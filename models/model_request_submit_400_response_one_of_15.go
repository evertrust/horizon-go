...
// checks if the RequestSubmit400ResponseOneOf15 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestSubmit400ResponseOneOf15{}

// RequestSubmit400ResponseOneOf15 struct for RequestSubmit400ResponseOneOf15
type RequestSubmit400ResponseOneOf15 struct {
...
type _RequestSubmit400ResponseOneOf15 RequestSubmit400ResponseOneOf15
...
func NewRequestSubmit400ResponseOneOf15(error_ string, message string, title string, status float32) *RequestSubmit400ResponseOneOf15 {
	this := RequestSubmit400ResponseOneOf15{}
	this.Error = error_
...
func (o *RequestSubmit400ResponseOneOf15) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestSubmit400ResponseOneOf15) MarshalJSON() ([]byte, error) {
...
func (o RequestSubmit400ResponseOneOf15) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSubmit400ResponseOneOf15) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSubmit400ResponseOneOf15 := _RequestSubmit400ResponseOneOf15{}

	err = json.Unmarshal(data, &varRequestSubmit400ResponseOneOf15)

	if err != nil {
		return err
	}

	*o = RequestSubmit400ResponseOneOf15(varRequestSubmit400ResponseOneOf15)
...
type NullableRequestSubmit400ResponseOneOf15 struct {
	value *RequestSubmit400ResponseOneOf15
	isSet bool
}

func (v NullableRequestSubmit400ResponseOneOf15) Get() *RequestSubmit400ResponseOneOf15 {
	return v.value
}

func (v *NullableRequestSubmit400ResponseOneOf15) Set(val *RequestSubmit400ResponseOneOf15) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSubmit400ResponseOneOf15) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSubmit400ResponseOneOf15) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSubmit400ResponseOneOf15(val *RequestSubmit400ResponseOneOf15) *NullableRequestSubmit400ResponseOneOf15 {
	return &NullableRequestSubmit400ResponseOneOf15{value: val, isSet: true}
}

func (v NullableRequestSubmit400ResponseOneOf15) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSubmit400ResponseOneOf15) UnmarshalJSON(src []byte) error {
	v.isSet = true

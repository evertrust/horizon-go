...
// List of ChartType
const (
	CHARTTYPE_TABLE                  ChartType = "table"
	CHARTTYPE_DONUT                  ChartType = "donut"
	CHARTTYPE_BAR_HORIZONTAL         ChartType = "bar-horizontal"
	CHARTTYPE_BAR_VERTICAL           ChartType = "bar-vertical"
	CHARTTYPE_BAR_HORIZONTAL_STACKED ChartType = "bar-horizontal-stacked"
	CHARTTYPE_BAR_VERTICAL_STACKED   ChartType = "bar-vertical-stacked"
	CHARTTYPE_METRIC                 ChartType = "metric"
	CHARTTYPE_AREA                   ChartType = "area"
	CHARTTYPE_LINE                   ChartType = "line"
	CHARTTYPE_HEATMAP                ChartType = "heatmap"
	CHARTTYPE_PIE                    ChartType = "pie"
	CHARTTYPE_TREEMAP                ChartType = "treemap"
	CHARTTYPE_RADAR                  ChartType = "radar"
	CHARTTYPE_POLAR                  ChartType = "polar"
	CHARTTYPE_PYRAMID                ChartType = "pyramid"
)

...
// checks if the ScepEnrollRequestOnTemplateResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScepEnrollRequestOnTemplateResponse{}
...
type _ScepEnrollRequestOnTemplateResponse ScepEnrollRequestOnTemplateResponse
...
func (o ScepEnrollRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
...
func (o *ScepEnrollRequestOnTemplateResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScepEnrollRequestOnTemplateResponse := _ScepEnrollRequestOnTemplateResponse{}

	err = json.Unmarshal(data, &varScepEnrollRequestOnTemplateResponse)

	if err != nil {
		return err
	}

	*o = ScepEnrollRequestOnTemplateResponse(varScepEnrollRequestOnTemplateResponse)
...
type NullableScepEnrollRequestOnTemplateResponse struct {
	value *ScepEnrollRequestOnTemplateResponse
	isSet bool
}

func (v NullableScepEnrollRequestOnTemplateResponse) Get() *ScepEnrollRequestOnTemplateResponse {
	return v.value
}

func (v *NullableScepEnrollRequestOnTemplateResponse) Set(val *ScepEnrollRequestOnTemplateResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScepEnrollRequestOnTemplateResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScepEnrollRequestOnTemplateResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScepEnrollRequestOnTemplateResponse(val *ScepEnrollRequestOnTemplateResponse) *NullableScepEnrollRequestOnTemplateResponse {
	return &NullableScepEnrollRequestOnTemplateResponse{value: val, isSet: true}
}

func (v NullableScepEnrollRequestOnTemplateResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScepEnrollRequestOnTemplateResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

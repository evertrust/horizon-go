...
// checks if the EabStatusUpdateRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EabStatusUpdateRequest{}

// EabStatusUpdateRequest struct for EabStatusUpdateRequest
type EabStatusUpdateRequest struct {
	// Unix epoch time in milliseconds. Certificates issued after this date will be revoked.
...
type _EabStatusUpdateRequest EabStatusUpdateRequest
...
func (o *EabStatusUpdateRequest) SetCompromissionReasonNil() {
...
func (o EabStatusUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o EabStatusUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EabStatusUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEabStatusUpdateRequest := _EabStatusUpdateRequest{}

	err = json.Unmarshal(data, &varEabStatusUpdateRequest)

	if err != nil {
		return err
	}

	*o = EabStatusUpdateRequest(varEabStatusUpdateRequest)
...
type NullableEabStatusUpdateRequest struct {
	value *EabStatusUpdateRequest
	isSet bool
}

func (v NullableEabStatusUpdateRequest) Get() *EabStatusUpdateRequest {
	return v.value
}

func (v *NullableEabStatusUpdateRequest) Set(val *EabStatusUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEabStatusUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEabStatusUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEabStatusUpdateRequest(val *EabStatusUpdateRequest) *NullableEabStatusUpdateRequest {
	return &NullableEabStatusUpdateRequest{value: val, isSet: true}
}

func (v NullableEabStatusUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEabStatusUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

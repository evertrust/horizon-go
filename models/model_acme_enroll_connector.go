...
func NewAcmeEnrollConnector(name string, type_ string, endPoint string, timeout utils.NullableString, accountKeyType string, dnsChallengeProvider DnsChallengeProviders) *AcmeEnrollConnector {

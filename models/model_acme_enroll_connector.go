...
type AcmeEnrollConnector struct {
	...
	// The MAC algorithm to use for External Account Binding. Can only be set when `eab` is defined
	EabMacAlgorithm utils.NullableString `json:"eabMacAlgorithm,omitempty"`
	// The directory url of the ACME endpoint
	EndPoint string               `json:"endPoint"`
	Name     string               `json:"name"`
	Proxy    utils.NullableString `json:"proxy,omitempty"`
	Queue    utils.NullableString `json:"queue,omitempty"`
	// The interval between retries when polling for order completion
...
func NewAcmeEnrollConnector(accountKeyType string, dnsChallengeProvider DnsChallengeProviders, endPoint string, name string, timeout utils.NullableString, type_ string) *AcmeEnrollConnector {
	...
	this.Type = type_
	var retryInterval string = "6s"
	this.RetryInterval = *utils.NewNullableString(&retryInterval)
	return &this
}
...
// GetEabMacAlgorithm returns the EabMacAlgorithm field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AcmeEnrollConnector) GetEabMacAlgorithm() string {
	if o == nil || utils.IsNil(o.EabMacAlgorithm.Get()) {
		var ret string
		return ret
	}
	return *o.EabMacAlgorithm.Get()
}

// GetEabMacAlgorithmOk returns a tuple with the EabMacAlgorithm field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AcmeEnrollConnector) GetEabMacAlgorithmOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return o.EabMacAlgorithm.Get(), o.EabMacAlgorithm.IsSet()
}

// HasEabMacAlgorithm returns a boolean if a field has been set.
func (o *AcmeEnrollConnector) HasEabMacAlgorithm() bool {
	if o != nil && o.EabMacAlgorithm.IsSet() {
		return true
	}
...
// SetEabMacAlgorithm gets a reference to the given NullableString and assigns it to the EabMacAlgorithm field.
func (o *AcmeEnrollConnector) SetEabMacAlgorithm(v string) {
	o.EabMacAlgorithm.Set(&v)
}

// SetEabMacAlgorithmNil sets the value for EabMacAlgorithm to be an explicit nil
func (o *AcmeEnrollConnector) SetEabMacAlgorithmNil() {
	o.EabMacAlgorithm.Set(nil)
}

// UnsetEabMacAlgorithm ensures that no value is present for EabMacAlgorithm, not even an explicit nil
func (o *AcmeEnrollConnector) UnsetEabMacAlgorithm() {
	o.EabMacAlgorithm.Unset()
}
...
func (o *AcmeEnrollConnector) GetRetryInterval() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AcmeEnrollConnector) GetRetryIntervalOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AcmeEnrollConnector) HasRetryInterval() bool {
...
func (o AcmeEnrollConnector) ToMap() (map[string]interface{}, error) {
	...
	if o.EabMacAlgorithm.IsSet() {
		toSerialize["eabMacAlgorithm"] = o.EabMacAlgorithm.Get()
	}
...
func (o *AcmeEnrollConnector) UnmarshalJSON(data []byte) (err error) {
	...
	*o = AcmeEnrollConnector(varAcmeEnrollConnector)
	...
	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		...
		delete(additionalProperties, "eabMacAlgorithm")

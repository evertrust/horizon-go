...
// checks if the AccountSearchResults type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AccountSearchResults{}

// AccountSearchResults struct for AccountSearchResults
type AccountSearchResults struct {
	Count                *int64            `json:"count,omitempty"`
	HasMore              bool              `json:"hasMore"`
	PageIndex            int64             `json:"pageIndex"`
	PageSize             int64             `json:"pageSize"`
	Results              []AccountResponse `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _AccountSearchResults AccountSearchResults
...
func (o AccountSearchResults) MarshalJSON() ([]byte, error) {
...
func (o AccountSearchResults) ToMap() (map[string]interface{}, error) {
...
func (o *AccountSearchResults) UnmarshalJSON(data []byte) (err error) {
	...
	varAccountSearchResults := _AccountSearchResults{}

	err = json.Unmarshal(data, &varAccountSearchResults)

	if err != nil {
		return err
	}

	*o = AccountSearchResults(varAccountSearchResults)
...
type NullableAccountSearchResults struct {
	value *AccountSearchResults
	isSet bool
}

func (v NullableAccountSearchResults) Get() *AccountSearchResults {
	return v.value
}

func (v *NullableAccountSearchResults) Set(val *AccountSearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableAccountSearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableAccountSearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAccountSearchResults(val *AccountSearchResults) *NullableAccountSearchResults {
	return &NullableAccountSearchResults{value: val, isSet: true}
}

func (v NullableAccountSearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAccountSearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRAUpdateRequestOnApprove type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAUpdateRequestOnApprove{}

// WebRAUpdateRequestOnApprove struct for WebRAUpdateRequestOnApprove
type WebRAUpdateRequestOnApprove struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _WebRAUpdateRequestOnApprove WebRAUpdateRequestOnApprove
...
func (o *WebRAUpdateRequestOnApprove) SetApproverCommentNil() {
...
func (o *WebRAUpdateRequestOnApprove) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAUpdateRequestOnApprove) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAUpdateRequestOnApprove) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAUpdateRequestOnApprove := _WebRAUpdateRequestOnApprove{}

	err = json.Unmarshal(data, &varWebRAUpdateRequestOnApprove)

	if err != nil {
		return err
	}

	*o = WebRAUpdateRequestOnApprove(varWebRAUpdateRequestOnApprove)
...
type NullableWebRAUpdateRequestOnApprove struct {
	value *WebRAUpdateRequestOnApprove
	isSet bool
}

func (v NullableWebRAUpdateRequestOnApprove) Get() *WebRAUpdateRequestOnApprove {
	return v.value
}

func (v *NullableWebRAUpdateRequestOnApprove) Set(val *WebRAUpdateRequestOnApprove) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAUpdateRequestOnApprove) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAUpdateRequestOnApprove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAUpdateRequestOnApprove(val *WebRAUpdateRequestOnApprove) *NullableWebRAUpdateRequestOnApprove {
	return &NullableWebRAUpdateRequestOnApprove{value: val, isSet: true}
}

func (v NullableWebRAUpdateRequestOnApprove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAUpdateRequestOnApprove) UnmarshalJSON(src []byte) error {
	v.isSet = true

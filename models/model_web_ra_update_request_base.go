...
// checks if the WebRAUpdateRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAUpdateRequestBase{}

// WebRAUpdateRequestBase struct for WebRAUpdateRequestBase
type WebRAUpdateRequestBase struct {
...
type _WebRAUpdateRequestBase WebRAUpdateRequestBase
...
func (o *WebRAUpdateRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAUpdateRequestBase) MarshalJSON() ([]byte, error) {
...
func (o WebRAUpdateRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAUpdateRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRAUpdateRequestBase := _WebRAUpdateRequestBase{}

	err = json.Unmarshal(data, &varWebRAUpdateRequestBase)

	if err != nil {
		return err
	}

	*o = WebRAUpdateRequestBase(varWebRAUpdateRequestBase)
...
type NullableWebRAUpdateRequestBase struct {
	value *WebRAUpdateRequestBase
	isSet bool
}

func (v NullableWebRAUpdateRequestBase) Get() *WebRAUpdateRequestBase {
	return v.value
}

func (v *NullableWebRAUpdateRequestBase) Set(val *WebRAUpdateRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAUpdateRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAUpdateRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAUpdateRequestBase(val *WebRAUpdateRequestBase) *NullableWebRAUpdateRequestBase {
	return &NullableWebRAUpdateRequestBase{value: val, isSet: true}
}

func (v NullableWebRAUpdateRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAUpdateRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the DCVLifecycleEventSearchQuery type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DCVLifecycleEventSearchQuery{}

// DCVLifecycleEventSearchQuery struct for DCVLifecycleEventSearchQuery
type DCVLifecycleEventSearchQuery struct {
...
type _DCVLifecycleEventSearchQuery DCVLifecycleEventSearchQuery
...
func NewDCVLifecycleEventSearchQuery() *DCVLifecycleEventSearchQuery {
	this := DCVLifecycleEventSearchQuery{}
	return &this
}
...
func (o *DCVLifecycleEventSearchQuery) SetPageIndexNil() {
	o.PageIndex.Set(nil)
}
...
func (o *DCVLifecycleEventSearchQuery) SetPageSizeNil() {
	o.PageSize.Set(nil)
}
...
func (o *DCVLifecycleEventSearchQuery) SetWithCountNil() {
	o.WithCount.Set(nil)
}
...
func (o DCVLifecycleEventSearchQuery) MarshalJSON() ([]byte, error) {
...
func (o DCVLifecycleEventSearchQuery) ToMap() (map[string]interface{}, error) {
...
func (o *DCVLifecycleEventSearchQuery) UnmarshalJSON(data []byte) (err error) {
	varDCVLifecycleEventSearchQuery := _DCVLifecycleEventSearchQuery{}

	err = json.Unmarshal(data, &varDCVLifecycleEventSearchQuery)

	if err != nil {
		return err
	}

	*o = DCVLifecycleEventSearchQuery(varDCVLifecycleEventSearchQuery)
...
type NullableDCVLifecycleEventSearchQuery struct {
	value *DCVLifecycleEventSearchQuery
	isSet bool
}

func (v NullableDCVLifecycleEventSearchQuery) Get() *DCVLifecycleEventSearchQuery {
	return v.value
}

func (v *NullableDCVLifecycleEventSearchQuery) Set(val *DCVLifecycleEventSearchQuery) {
	v.value = val
	v.isSet = true
}

func (v NullableDCVLifecycleEventSearchQuery) IsSet() bool {
	return v.isSet
}

func (v *NullableDCVLifecycleEventSearchQuery) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDCVLifecycleEventSearchQuery(val *DCVLifecycleEventSearchQuery) *NullableDCVLifecycleEventSearchQuery {
	return &NullableDCVLifecycleEventSearchQuery{value: val, isSet: true}
}

func (v NullableDCVLifecycleEventSearchQuery) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDCVLifecycleEventSearchQuery) UnmarshalJSON(src []byte) error {
	v.isSet = true

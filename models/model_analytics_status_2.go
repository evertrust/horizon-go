...
// checks if the AnalyticsStatus2 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AnalyticsStatus2{}
...
type _AnalyticsStatus2 AnalyticsStatus2
...
func (o *AnalyticsStatus2) SetErrorNil() {
	o.Error.Set(nil)
}
...
func (o *AnalyticsStatus2) UnmarshalJSON(data []byte) (err error) {
	...
	varAnalyticsStatus2 := _AnalyticsStatus2{}

	err = json.Unmarshal(data, &varAnalyticsStatus2)

	if err != nil {
		return err
	}

	*o = AnalyticsStatus2(varAnalyticsStatus2)
...
type NullableAnalyticsStatus2 struct {
	value *AnalyticsStatus2
	isSet bool
}

func (v NullableAnalyticsStatus2) Get() *AnalyticsStatus2 {
	return v.value
}

func (v *NullableAnalyticsStatus2) Set(val *AnalyticsStatus2) {
	v.value = val
	v.isSet = true
}

func (v NullableAnalyticsStatus2) IsSet() bool {
	return v.isSet
}

func (v *NullableAnalyticsStatus2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAnalyticsStatus2(val *AnalyticsStatus2) *NullableAnalyticsStatus2 {
	return &NullableAnalyticsStatus2{value: val, isSet: true}
}

func (v NullableAnalyticsStatus2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAnalyticsStatus2) UnmarshalJSON(src []byte) error {
	v.isSet = true

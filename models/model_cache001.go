...
// checks if the Cache001 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Cache001{}

// Cache001 Unexpected error
type Cache001 struct {
...
func (o Cache001) MarshalJSON() ([]byte, error) {
...
func (o Cache001) ToMap() (map[string]interface{}, error) {
...
func (o *Cache001) UnmarshalJSON(data []byte) (err error) {
	...
	varCache001 := _Cache001{}

	err = json.Unmarshal(data, &varCache001)

	if err != nil {
		return err
	}

	*o = Cache001(varCache001)
...
type NullableCache001 struct {
	value *Cache001
	isSet bool
}

func (v NullableCache001) Get() *Cache001 {
	return v.value
}

func (v *NullableCache001) Set(val *Cache001) {
	v.value = val
	v.isSet = true
}

func (v NullableCache001) IsSet() bool {
	return v.isSet
}

func (v *NullableCache001) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCache001(val *Cache001) *NullableCache001 {
	return &NullableCache001{value: val, isSet: true}
}

func (v NullableCache001) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCache001) UnmarshalJSON(src []byte) error {
	v.isSet = true

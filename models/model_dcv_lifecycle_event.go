...
// checks if the DCVLifecycleEvent type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DCVLifecycleEvent{}

// DCVLifecycleEvent struct for DCVLifecycleEvent
type DCVLifecycleEvent struct {
	// Current retry attempt count
	Attempt *int64 `json:"attempt,omitempty"`
	// The domain
	Domain string `json:"domain"`
	// Error message from the previous attempt
	LastError utils.NullableString `json:"lastError,omitempty"`
...
type _DCVLifecycleEvent DCVLifecycleEvent
...
func (o *DCVLifecycleEvent) GetAttempt() int64 {
	if o == nil || utils.IsNil(o.Attempt) {
		var ret int64
		return ret
	}
	return *o.Attempt
...
func (o *DCVLifecycleEvent) GetLastError() string {
	if o == nil || utils.IsNil(o.LastError.Get()) {
		var ret string
		return ret
	}
...
func (o *DCVLifecycleEvent) SetLastErrorNil() {
	o.LastError.Set(nil)
}
...
func (o DCVLifecycleEvent) MarshalJSON() ([]byte, error) {
...
func (o DCVLifecycleEvent) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if !utils.IsNil(o.Attempt) {
...
func (o *DCVLifecycleEvent) UnmarshalJSON(data []byte) (err error) {
	...
	varDCVLifecycleEvent := _DCVLifecycleEvent{}

	err = json.Unmarshal(data, &varDCVLifecycleEvent)

	if err != nil {
		return err
	}

	*o = DCVLifecycleEvent(varDCVLifecycleEvent)
...
type NullableDCVLifecycleEvent struct {
	value *DCVLifecycleEvent
	isSet bool
}

func (v NullableDCVLifecycleEvent) Get() *DCVLifecycleEvent {
	return v.value
}

func (v *NullableDCVLifecycleEvent) Set(val *DCVLifecycleEvent) {
	v.value = val
	v.isSet = true
}

func (v NullableDCVLifecycleEvent) IsSet() bool {
	return v.isSet
}

func (v *NullableDCVLifecycleEvent) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDCVLifecycleEvent(val *DCVLifecycleEvent) *NullableDCVLifecycleEvent {
	return &NullableDCVLifecycleEvent{value: val, isSet: true}
}

func (v NullableDCVLifecycleEvent) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDCVLifecycleEvent) UnmarshalJSON(src []byte) error {
	v.isSet = true

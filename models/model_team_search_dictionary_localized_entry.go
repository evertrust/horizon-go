...
// checks if the TeamSearchDictionaryLocalizedEntry type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &TeamSearchDictionaryLocalizedEntry{}
...
type _TeamSearchDictionaryLocalizedEntry TeamSearchDictionaryLocalizedEntry
...
func (o *TeamSearchDictionaryLocalizedEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varTeamSearchDictionaryLocalizedEntry := _TeamSearchDictionaryLocalizedEntry{}

	err = json.Unmarshal(data, &varTeamSearchDictionaryLocalizedEntry)

	if err != nil {
		return err
	}

	*o = TeamSearchDictionaryLocalizedEntry(varTeamSearchDictionaryLocalizedEntry)
...
type NullableTeamSearchDictionaryLocalizedEntry struct {
	value *TeamSearchDictionaryLocalizedEntry
	isSet bool
}

func (v NullableTeamSearchDictionaryLocalizedEntry) Get() *TeamSearchDictionaryLocalizedEntry {
	return v.value
}

func (v *NullableTeamSearchDictionaryLocalizedEntry) Set(val *TeamSearchDictionaryLocalizedEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableTeamSearchDictionaryLocalizedEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableTeamSearchDictionaryLocalizedEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTeamSearchDictionaryLocalizedEntry(val *TeamSearchDictionaryLocalizedEntry) *NullableTeamSearchDictionaryLocalizedEntry {
	return &NullableTeamSearchDictionaryLocalizedEntry{value: val, isSet: true}
}

func (v NullableTeamSearchDictionaryLocalizedEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTeamSearchDictionaryLocalizedEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true

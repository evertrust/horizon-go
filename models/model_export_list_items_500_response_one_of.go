...
// checks if the ExportListItems500ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ExportListItems500ResponseOneOf{}

// ExportListItems500ResponseOneOf struct for ExportListItems500ResponseOneOf
type ExportListItems500ResponseOneOf struct {
...
type _ExportListItems500ResponseOneOf ExportListItems500ResponseOneOf
...
func NewExportListItems500ResponseOneOf(status float32, error_ string, message string, title string) *ExportListItems500ResponseOneOf {
	this := ExportListItems500ResponseOneOf{}
	this.Error = error_
...
func (o *ExportListItems500ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ExportListItems500ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o ExportListItems500ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *ExportListItems500ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varExportListItems500ResponseOneOf := _ExportListItems500ResponseOneOf{}

	err = json.Unmarshal(data, &varExportListItems500ResponseOneOf)

	if err != nil {
		return err
	}

	*o = ExportListItems500ResponseOneOf(varExportListItems500ResponseOneOf)
...
type NullableExportListItems500ResponseOneOf struct {
	value *ExportListItems500ResponseOneOf
	isSet bool
}

func (v NullableExportListItems500ResponseOneOf) Get() *ExportListItems500ResponseOneOf {
	return v.value
}

func (v *NullableExportListItems500ResponseOneOf) Set(val *ExportListItems500ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableExportListItems500ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableExportListItems500ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExportListItems500ResponseOneOf(val *ExportListItems500ResponseOneOf) *NullableExportListItems500ResponseOneOf {
	return &NullableExportListItems500ResponseOneOf{value: val, isSet: true}
}

func (v NullableExportListItems500ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExportListItems500ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

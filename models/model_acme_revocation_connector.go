...
// checks if the AcmeRevocationConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AcmeRevocationConnector{}
...
type _AcmeRevocationConnector AcmeRevocationConnector
...
func (o *AcmeRevocationConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *AcmeRevocationConnector) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o *AcmeRevocationConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varAcmeRevocationConnector := _AcmeRevocationConnector{}

	err = json.Unmarshal(data, &varAcmeRevocationConnector)

	if err != nil {
		return err
	}

	*o = AcmeRevocationConnector(varAcmeRevocationConnector)
...
type NullableAcmeRevocationConnector struct {
	value *AcmeRevocationConnector
	isSet bool
}

func (v NullableAcmeRevocationConnector) Get() *AcmeRevocationConnector {
	return v.value
}

func (v *NullableAcmeRevocationConnector) Set(val *AcmeRevocationConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableAcmeRevocationConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableAcmeRevocationConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcmeRevocationConnector(val *AcmeRevocationConnector) *NullableAcmeRevocationConnector {
	return &NullableAcmeRevocationConnector{value: val, isSet: true}
}

func (v NullableAcmeRevocationConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcmeRevocationConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

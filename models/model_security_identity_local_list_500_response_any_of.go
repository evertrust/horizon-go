...
// checks if the SecurityIdentityLocalList500ResponseAnyOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecurityIdentityLocalList500ResponseAnyOf{}

// SecurityIdentityLocalList500ResponseAnyOf struct for SecurityIdentityLocalList500ResponseAnyOf
type SecurityIdentityLocalList500ResponseAnyOf struct {
...
type _SecurityIdentityLocalList500ResponseAnyOf SecurityIdentityLocalList500ResponseAnyOf
...
func NewSecurityIdentityLocalList500ResponseAnyOf(status float32, error_ string, message string, title string) *SecurityIdentityLocalList500ResponseAnyOf {
	this := SecurityIdentityLocalList500ResponseAnyOf{}
	this.Error = error_
...
func (o *SecurityIdentityLocalList500ResponseAnyOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecurityIdentityLocalList500ResponseAnyOf) MarshalJSON() ([]byte, error) {
...
func (o SecurityIdentityLocalList500ResponseAnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityIdentityLocalList500ResponseAnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSecurityIdentityLocalList500ResponseAnyOf := _SecurityIdentityLocalList500ResponseAnyOf{}

	err = json.Unmarshal(data, &varSecurityIdentityLocalList500ResponseAnyOf)

	if err != nil {
		return err
	}

	*o = SecurityIdentityLocalList500ResponseAnyOf(varSecurityIdentityLocalList500ResponseAnyOf)
...
type NullableSecurityIdentityLocalList500ResponseAnyOf struct {
	value *SecurityIdentityLocalList500ResponseAnyOf
	isSet bool
}

func (v NullableSecurityIdentityLocalList500ResponseAnyOf) Get() *SecurityIdentityLocalList500ResponseAnyOf {
	return v.value
}

func (v *NullableSecurityIdentityLocalList500ResponseAnyOf) Set(val *SecurityIdentityLocalList500ResponseAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityIdentityLocalList500ResponseAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityIdentityLocalList500ResponseAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityIdentityLocalList500ResponseAnyOf(val *SecurityIdentityLocalList500ResponseAnyOf) *NullableSecurityIdentityLocalList500ResponseAnyOf {
	return &NullableSecurityIdentityLocalList500ResponseAnyOf{value: val, isSet: true}
}

func (v NullableSecurityIdentityLocalList500ResponseAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityIdentityLocalList500ResponseAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

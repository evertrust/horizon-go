...
// checks if the TriggerTestRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &TriggerTestRequest{}
...
type _TriggerTestRequest TriggerTestRequest
...
func (o *TriggerTestRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varTriggerTestRequest := _TriggerTestRequest{}

	err = json.Unmarshal(data, &varTriggerTestRequest)

	if err != nil {
		return err
	}

	*o = TriggerTestRequest(varTriggerTestRequest)
...
type NullableTriggerTestRequest struct {
	value *TriggerTestRequest
	isSet bool
}

func (v NullableTriggerTestRequest) Get() *TriggerTestRequest {
	return v.value
}

func (v *NullableTriggerTestRequest) Set(val *TriggerTestRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableTriggerTestRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableTriggerTestRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTriggerTestRequest(val *TriggerTestRequest) *NullableTriggerTestRequest {
	return &NullableTriggerTestRequest{value: val, isSet: true}
}

func (v NullableTriggerTestRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTriggerTestRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

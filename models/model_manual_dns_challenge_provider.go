...
// checks if the ManualDnsChallengeProvider type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ManualDnsChallengeProvider{}
...
type _ManualDnsChallengeProvider ManualDnsChallengeProvider
...
func (o *ManualDnsChallengeProvider) GetUnsetTriggers() []AcmeRestRequest {
	if o == nil || utils.IsNil(o.UnsetTriggers) {
		var ret []AcmeRestRequest
		return ret
	}
	return o.UnsetTriggers
}

// GetUnsetTriggersOk returns a tuple with the UnsetTriggers field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *ManualDnsChallengeProvider) GetUnsetTriggersOk() ([]AcmeRestRequest, bool) {
	if o == nil || utils.IsNil(o.UnsetTriggers) {
		return nil, false
	}
	return o.UnsetTriggers, true
}
...
// SetUnsetTriggers gets a reference to the given []AcmeRestRequest and assigns it to the UnsetTriggers field.
func (o *ManualDnsChallengeProvider) SetUnsetTriggers(v []AcmeRestRequest) {
	o.UnsetTriggers = v
}

func (o ManualDnsChallengeProvider) MarshalJSON() ([]byte, error) {
...
func (o *ManualDnsChallengeProvider) UnmarshalJSON(data []byte) (err error) {
	...
	varManualDnsChallengeProvider := _ManualDnsChallengeProvider{}

	err = json.Unmarshal(data, &varManualDnsChallengeProvider)

	if err != nil {
		return err
	}

	*o = ManualDnsChallengeProvider(varManualDnsChallengeProvider)
...
type NullableManualDnsChallengeProvider struct {
	value *ManualDnsChallengeProvider
	isSet bool
}

func (v NullableManualDnsChallengeProvider) Get() *ManualDnsChallengeProvider {
	return v.value
}

func (v *NullableManualDnsChallengeProvider) Set(val *ManualDnsChallengeProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableManualDnsChallengeProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableManualDnsChallengeProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableManualDnsChallengeProvider(val *ManualDnsChallengeProvider) *NullableManualDnsChallengeProvider {
	return &NullableManualDnsChallengeProvider{value: val, isSet: true}
}

func (v NullableManualDnsChallengeProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableManualDnsChallengeProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
var _ utils.MappedNullable = &LibraryInfo{}
...
func (o *LibraryInfo) GetVersion() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *LibraryInfo) GetVersionOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *LibraryInfo) SetVersion(v string) {
	o.Version = v
}
...
func (o *LibraryInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varLibraryInfo := _LibraryInfo{}

	err = json.Unmarshal(data, &varLibraryInfo)

	if err != nil {
		return err
	}

	*o = LibraryInfo(varLibraryInfo)

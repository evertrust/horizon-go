...
var _ utils.MappedNullable = &EventDetail{}
...
func NewEventDetail(key string, value string) *EventDetail {
	this := EventDetail{}
	this.Key = key
	this.Value = value
	return &this
...
func (o *EventDetail) GetKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *EventDetail) GetKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Key, true
...
func (o *EventDetail) SetKey(v string) {
	o.Key = v
}

// GetValue returns the Value field value
func (o *EventDetail) GetValue() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *EventDetail) GetValueOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Value, true
...
func (o *EventDetail) SetValue(v string) {
	o.Value = v
}
...
func (o *EventDetail) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varEventDetail)

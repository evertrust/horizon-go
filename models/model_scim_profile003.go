...
// checks if the ScimProfile003 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScimProfile003{}

// ScimProfile003 Scim Profile not found
type ScimProfile003 struct {
...
type _ScimProfile003 ScimProfile003
...
func (o *ScimProfile003) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ScimProfile003) MarshalJSON() ([]byte, error) {
...
func (o ScimProfile003) ToMap() (map[string]interface{}, error) {
...
func (o *ScimProfile003) UnmarshalJSON(data []byte) (err error) {
	...
	varScimProfile003 := _ScimProfile003{}

	err = json.Unmarshal(data, &varScimProfile003)

	if err != nil {
		return err
	}

	*o = ScimProfile003(varScimProfile003)
...
type NullableScimProfile003 struct {
	value *ScimProfile003
	isSet bool
}

func (v NullableScimProfile003) Get() *ScimProfile003 {
	return v.value
}

func (v *NullableScimProfile003) Set(val *ScimProfile003) {
	v.value = val
	v.isSet = true
}

func (v NullableScimProfile003) IsSet() bool {
	return v.isSet
}

func (v *NullableScimProfile003) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScimProfile003(val *ScimProfile003) *NullableScimProfile003 {
	return &NullableScimProfile003{value: val, isSet: true}
}

func (v NullableScimProfile003) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScimProfile003) UnmarshalJSON(src []byte) error {
	v.isSet = true

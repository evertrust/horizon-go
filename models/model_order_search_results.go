...
// checks if the OrderSearchResults type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &OrderSearchResults{}

// OrderSearchResults struct for OrderSearchResults
...
type _OrderSearchResults OrderSearchResults
...
func (o *OrderSearchResults) SetCountNil() {
	o.Count.Set(nil)
}
...
func (o OrderSearchResults) MarshalJSON() ([]byte, error) {
...
func (o OrderSearchResults) ToMap() (map[string]interface{}, error) {
...
func (o *OrderSearchResults) UnmarshalJSON(data []byte) (err error) {
	...
	varOrderSearchResults := _OrderSearchResults{}

	err = json.Unmarshal(data, &varOrderSearchResults)

	if err != nil {
		return err
	}

	*o = OrderSearchResults(varOrderSearchResults)
...
type NullableOrderSearchResults struct {
	value *OrderSearchResults
	isSet bool
}

func (v NullableOrderSearchResults) Get() *OrderSearchResults {
	return v.value
}

func (v *NullableOrderSearchResults) Set(val *OrderSearchResults) {
	v.value = val
	v.isSet = true
}

func (v NullableOrderSearchResults) IsSet() bool {
	return v.isSet
}

func (v *NullableOrderSearchResults) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableOrderSearchResults(val *OrderSearchResults) *NullableOrderSearchResults {
	return &NullableOrderSearchResults{value: val, isSet: true}
}

func (v NullableOrderSearchResults) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableOrderSearchResults) UnmarshalJSON(src []byte) error {
	v.isSet = true

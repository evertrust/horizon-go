...
// checks if the WebRAEnrollRequestOnApprove type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAEnrollRequestOnApprove{}

// WebRAEnrollRequestOnApprove struct for WebRAEnrollRequestOnApprove
type WebRAEnrollRequestOnApprove struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _WebRAEnrollRequestOnApprove WebRAEnrollRequestOnApprove
...
func NewWebRAEnrollRequestOnApprove(id string, module string, workflow string) *WebRAEnrollRequestOnApprove {
	this := WebRAEnrollRequestOnApprove{}
	this.Module = module
...
func (o *WebRAEnrollRequestOnApprove) SetApproverCommentNil() {
...
// SetTemplate gets a reference to the given WebRAEnrollRequestTemplate and assigns it to the Template field.
...
func (o *WebRAEnrollRequestOnApprove) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAEnrollRequestOnApprove) MarshalJSON() ([]byte, error) {
...
func (o WebRAEnrollRequestOnApprove) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAEnrollRequestOnApprove) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAEnrollRequestOnApprove := _WebRAEnrollRequestOnApprove{}

	err = json.Unmarshal(data, &varWebRAEnrollRequestOnApprove)

	if err != nil {
		return err
	}

	*o = WebRAEnrollRequestOnApprove(varWebRAEnrollRequestOnApprove)
...
type NullableWebRAEnrollRequestOnApprove struct {
	value *WebRAEnrollRequestOnApprove
	isSet bool
}

func (v NullableWebRAEnrollRequestOnApprove) Get() *WebRAEnrollRequestOnApprove {
	return v.value
}

func (v *NullableWebRAEnrollRequestOnApprove) Set(val *WebRAEnrollRequestOnApprove) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAEnrollRequestOnApprove) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAEnrollRequestOnApprove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAEnrollRequestOnApprove(val *WebRAEnrollRequestOnApprove) *NullableWebRAEnrollRequestOnApprove {
	return &NullableWebRAEnrollRequestOnApprove{value: val, isSet: true}
}

func (v NullableWebRAEnrollRequestOnApprove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAEnrollRequestOnApprove) UnmarshalJSON(src []byte) error {
	v.isSet = true

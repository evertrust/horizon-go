...
func (dst *RequestApprove500Response) UnmarshalJSON(data []byte) error {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf1)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf1) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf1)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf1 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf10)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf10) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf10)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf10 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf11)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf11) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf11)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf11 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf12)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf12) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf12)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf12 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf13)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf13) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf13)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf13 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf14)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf14) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf14)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf14 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf15)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf15) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf15)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf15 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf16)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf16) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf16)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf16 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf17)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf17) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf17)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf17 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf18)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf18) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf18)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf18 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf19)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf19) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf19)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf19 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf2)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf2) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf2)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf2 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf20)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf20) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf20)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf20 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf21)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf21) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf21)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf21 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf22)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf22) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf22)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf22 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf3)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf3) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf3)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf3 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf4)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf4) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf4)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf4 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf5)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf5) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf5)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf5 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf6)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf6) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf6)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf6 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf7)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf7) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf7)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf7 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf8)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf8) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf8)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf8 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestApprove500ResponseOneOf9)
	if err == nil {
		...
		if string(jsonRequestApprove500ResponseOneOf9) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestApprove500ResponseOneOf9)
			match++
		}
	} else {
		dst.RequestApprove500ResponseOneOf9 = nil
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.RequestCertificateProfile500ResponseOneOf)
	if err == nil {
		...
		if string(jsonRequestCertificateProfile500ResponseOneOf) == "{}" { // empty struct
			...
			_ = validator.Validate(dst.RequestCertificateProfile500ResponseOneOf)
			match++
		}
	} else {
		dst.RequestCertificateProfile500ResponseOneOf = nil

...
// checks if the PanOSFirewallTriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PanOSFirewallTriggerResponse{}

// PanOSFirewallTriggerResponse struct for PanOSFirewallTriggerResponse
type PanOSFirewallTriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _PanOSFirewallTriggerResponse PanOSFirewallTriggerResponse
...
func NewPanOSFirewallTriggerResponse(id string, connector string, events []TriggerEvent, name string, type_ string) *PanOSFirewallTriggerResponse {
	this := PanOSFirewallTriggerResponse{}
	this.Id = id
...
func (o *PanOSFirewallTriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o PanOSFirewallTriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o PanOSFirewallTriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PanOSFirewallTriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPanOSFirewallTriggerResponse := _PanOSFirewallTriggerResponse{}

	err = json.Unmarshal(data, &varPanOSFirewallTriggerResponse)

	if err != nil {
		return err
	}

	*o = PanOSFirewallTriggerResponse(varPanOSFirewallTriggerResponse)
...
type NullablePanOSFirewallTriggerResponse struct {
	value *PanOSFirewallTriggerResponse
	isSet bool
}

func (v NullablePanOSFirewallTriggerResponse) Get() *PanOSFirewallTriggerResponse {
	return v.value
}

func (v *NullablePanOSFirewallTriggerResponse) Set(val *PanOSFirewallTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePanOSFirewallTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePanOSFirewallTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePanOSFirewallTriggerResponse(val *PanOSFirewallTriggerResponse) *NullablePanOSFirewallTriggerResponse {
	return &NullablePanOSFirewallTriggerResponse{value: val, isSet: true}
}

func (v NullablePanOSFirewallTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePanOSFirewallTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
type ThirdPartyConnectors struct {
	...
	FortiGateConnector     *FortiGateConnector
	FortiManagerConnector  *FortiManagerConnector
	...
	PanOSFirewallConnector *PanOSFirewallConnector
...
// FortiGateConnectorAsThirdPartyConnectors is a convenience function that returns FortiGateConnector wrapped in ThirdPartyConnectors
func FortiGateConnectorAsThirdPartyConnectors(v *FortiGateConnector) ThirdPartyConnectors {
	return ThirdPartyConnectors{
		FortiGateConnector: v,
	}
}

// FortiManagerConnectorAsThirdPartyConnectors is a convenience function that returns FortiManagerConnector wrapped in ThirdPartyConnectors
func FortiManagerConnectorAsThirdPartyConnectors(v *FortiManagerConnector) ThirdPartyConnectors {
	return ThirdPartyConnectors{
		FortiManagerConnector: v,
	}
}
...
// PanOSFirewallConnectorAsThirdPartyConnectors is a convenience function that returns PanOSFirewallConnector wrapped in ThirdPartyConnectors
func PanOSFirewallConnectorAsThirdPartyConnectors(v *PanOSFirewallConnector) ThirdPartyConnectors {
	return ThirdPartyConnectors{
		PanOSFirewallConnector: v,
	}
}

// PanoramaConnectorAsThirdPartyConnectors is a convenience function that returns PanoramaConnector wrapped in ThirdPartyConnectors
func PanoramaConnectorAsThirdPartyConnectors(v *PanoramaConnector) ThirdPartyConnectors {
	return ThirdPartyConnectors{
		PanoramaConnector: v,
	}
}
...
func (dst *ThirdPartyConnectors) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into FortiGateConnector
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiGateConnector)
	if err == nil {
		jsonFortiGateConnector, _ := json.Marshal(dst.FortiGateConnector)
		if string(jsonFortiGateConnector) == "{}" { // empty struct
			dst.FortiGateConnector = nil
		} else {
			_ = validator.Validate(dst.FortiGateConnector)
			match++
		}
	} else {
		dst.FortiGateConnector = nil
	...
	// try to unmarshal data into FortiManagerConnector
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiManagerConnector)
	if err == nil {
		jsonFortiManagerConnector, _ := json.Marshal(dst.FortiManagerConnector)
		if string(jsonFortiManagerConnector) == "{}" { // empty struct
			dst.FortiManagerConnector = nil
		} else {
			_ = validator.Validate(dst.FortiManagerConnector)
			match++
		}
	} else {
		dst.FortiManagerConnector = nil
	...
	// try to unmarshal data into PanOSFirewallConnector
	err = utils.NewStrictDecoder(data).Decode(&dst.PanOSFirewallConnector)
	if err == nil {
		jsonPanOSFirewallConnector, _ := json.Marshal(dst.PanOSFirewallConnector)
		if string(jsonPanOSFirewallConnector) == "{}" { // empty struct
			dst.PanOSFirewallConnector = nil
		} else {
			_ = validator.Validate(dst.PanOSFirewallConnector)
			match++
		}
	} else {
		dst.PanOSFirewallConnector = nil
	...
	// try to unmarshal data into PanoramaConnector
	err = utils.NewStrictDecoder(data).Decode(&dst.PanoramaConnector)
	if err == nil {
		jsonPanoramaConnector, _ := json.Marshal(dst.PanoramaConnector)
		if string(jsonPanoramaConnector) == "{}" { // empty struct
			dst.PanoramaConnector = nil
		} else {
			_ = validator.Validate(dst.PanoramaConnector)
			match++
		}
	} else {
		dst.PanoramaConnector = nil
...
func (src ThirdPartyConnectors) MarshalJSON() ([]byte, error) {
	...
	if src.FortiGateConnector != nil {
		return json.Marshal(&src.FortiGateConnector)
	}

	if src.FortiManagerConnector != nil {
		return json.Marshal(&src.FortiManagerConnector)
	}
	...
	if src.PanOSFirewallConnector != nil {
		return json.Marshal(&src.PanOSFirewallConnector)
	}

	if src.PanoramaConnector != nil {
		return json.Marshal(&src.PanoramaConnector)
	}
...
func (obj *ThirdPartyConnectors) GetActualInstance() interface{} {
	...
	if obj.FortiGateConnector != nil {
		return obj.FortiGateConnector
	}

	if obj.FortiManagerConnector != nil {
		return obj.FortiManagerConnector
	}
	...
	if obj.PanOSFirewallConnector != nil {
		return obj.PanOSFirewallConnector
	}

	if obj.PanoramaConnector != nil {
		return obj.PanoramaConnector
	}

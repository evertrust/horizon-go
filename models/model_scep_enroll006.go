...
// checks if the ScepEnroll006 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScepEnroll006{}

// ScepEnroll006 Missing profile SCEP Enrollment Request Template
type ScepEnroll006 struct {
...
type _ScepEnroll006 ScepEnroll006
...
func (o *ScepEnroll006) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ScepEnroll006) MarshalJSON() ([]byte, error) {
...
func (o ScepEnroll006) ToMap() (map[string]interface{}, error) {
...
func (o *ScepEnroll006) UnmarshalJSON(data []byte) (err error) {
	...
	varScepEnroll006 := _ScepEnroll006{}

	err = json.Unmarshal(data, &varScepEnroll006)

	if err != nil {
		return err
	}

	*o = ScepEnroll006(varScepEnroll006)
...
type NullableScepEnroll006 struct {
	value *ScepEnroll006
	isSet bool
}

func (v NullableScepEnroll006) Get() *ScepEnroll006 {
	return v.value
}

func (v *NullableScepEnroll006) Set(val *ScepEnroll006) {
	v.value = val
	v.isSet = true
}

func (v NullableScepEnroll006) IsSet() bool {
	return v.isSet
}

func (v *NullableScepEnroll006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScepEnroll006(val *ScepEnroll006) *NullableScepEnroll006 {
	return &NullableScepEnroll006{value: val, isSet: true}
}

func (v NullableScepEnroll006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScepEnroll006) UnmarshalJSON(src []byte) error {
	v.isSet = true

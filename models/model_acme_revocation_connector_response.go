...
// checks if the AcmeRevocationConnectorResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AcmeRevocationConnectorResponse{}

// AcmeRevocationConnectorResponse Used to revoke certificate using the acme protocol on compatible public PKI
type AcmeRevocationConnectorResponse struct {
	// Object internal ID
	Id   string `json:"_id"`
...
type _AcmeRevocationConnectorResponse AcmeRevocationConnectorResponse
...
func NewAcmeRevocationConnectorResponse(id string, name string, type_ string, acmeDirectoryUrl string) *AcmeRevocationConnectorResponse {
	this := AcmeRevocationConnectorResponse{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
func (o *AcmeRevocationConnectorResponse) GetAcmeDirectoryUrl() string {
	...
	return o.AcmeDirectoryUrl
}

// GetAcmeDirectoryUrlOk returns a tuple with the AcmeDirectoryUrl field value
// and a boolean to check if the value has been set.
func (o *AcmeRevocationConnectorResponse) GetAcmeDirectoryUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.AcmeDirectoryUrl, true
}

// SetAcmeDirectoryUrl sets field value
...
func (o *AcmeRevocationConnectorResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *AcmeRevocationConnectorResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *AcmeRevocationConnectorResponse) SetQueueNil() {
	o.Queue.Set(nil)
}
...
func (o *AcmeRevocationConnectorResponse) SetStatusNil() {
	o.Status.Set(nil)
}
...
func (o AcmeRevocationConnectorResponse) MarshalJSON() ([]byte, error) {
...
func (o AcmeRevocationConnectorResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AcmeRevocationConnectorResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAcmeRevocationConnectorResponse := _AcmeRevocationConnectorResponse{}

	err = json.Unmarshal(data, &varAcmeRevocationConnectorResponse)

	if err != nil {
		return err
	}

	*o = AcmeRevocationConnectorResponse(varAcmeRevocationConnectorResponse)
...
type NullableAcmeRevocationConnectorResponse struct {
	value *AcmeRevocationConnectorResponse
	isSet bool
}

func (v NullableAcmeRevocationConnectorResponse) Get() *AcmeRevocationConnectorResponse {
	return v.value
}

func (v *NullableAcmeRevocationConnectorResponse) Set(val *AcmeRevocationConnectorResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAcmeRevocationConnectorResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAcmeRevocationConnectorResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAcmeRevocationConnectorResponse(val *AcmeRevocationConnectorResponse) *NullableAcmeRevocationConnectorResponse {
	return &NullableAcmeRevocationConnectorResponse{value: val, isSet: true}
}

func (v NullableAcmeRevocationConnectorResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAcmeRevocationConnectorResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

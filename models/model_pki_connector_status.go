...
// checks if the PKIConnectorStatus type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PKIConnectorStatus{}

// PKIConnectorStatus The status of a pki connector
...
type _PKIConnectorStatus PKIConnectorStatus
...
func (o *PKIConnectorStatus) SetMessageNil() {
	o.Message.Set(nil)
}
...
func (o *PKIConnectorStatus) UnmarshalJSON(data []byte) (err error) {
	...
	varPKIConnectorStatus := _PKIConnectorStatus{}

	err = json.Unmarshal(data, &varPKIConnectorStatus)

	if err != nil {
		return err
	}

	*o = PKIConnectorStatus(varPKIConnectorStatus)
...
type NullablePKIConnectorStatus struct {
	value *PKIConnectorStatus
	isSet bool
}

func (v NullablePKIConnectorStatus) Get() *PKIConnectorStatus {
	return v.value
}

func (v *NullablePKIConnectorStatus) Set(val *PKIConnectorStatus) {
	v.value = val
	v.isSet = true
}

func (v NullablePKIConnectorStatus) IsSet() bool {
	return v.isSet
}

func (v *NullablePKIConnectorStatus) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePKIConnectorStatus(val *PKIConnectorStatus) *NullablePKIConnectorStatus {
	return &NullablePKIConnectorStatus{value: val, isSet: true}
}

func (v NullablePKIConnectorStatus) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePKIConnectorStatus) UnmarshalJSON(src []byte) error {
	v.isSet = true

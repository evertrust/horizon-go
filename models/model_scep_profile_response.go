...
func (o *ScepProfileResponse) GetTermsOfService() string {
...
// and a boolean to check if the value has been set.
func (o *ScepProfileResponse) GetTermsOfServiceOk() (*string, bool) {
	if o == nil || utils.IsNil(o.TermsOfService) {
		return nil, false
	}
...
func (o *ScepProfileResponse) HasTermsOfService() bool {
	if o != nil && !utils.IsNil(o.TermsOfService) {
		return true
	}
...
func (o *ScepProfileResponse) SetTermsOfService(v string) {
	o.TermsOfService = &v
}

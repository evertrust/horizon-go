...
// checks if the F5AS3TriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &F5AS3TriggerResponse{}

// F5AS3TriggerResponse struct for F5AS3TriggerResponse
type F5AS3TriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _F5AS3TriggerResponse F5AS3TriggerResponse

// NewF5AS3TriggerResponse instantiates a new F5AS3TriggerResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewF5AS3TriggerResponse(id string, name string, type_ string, connector string) *F5AS3TriggerResponse {
	this := F5AS3TriggerResponse{}
	this.Id = id
	this.Name = name
	this.Type = type_
...
func (o *F5AS3TriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o F5AS3TriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o F5AS3TriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *F5AS3TriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varF5AS3TriggerResponse := _F5AS3TriggerResponse{}

	err = json.Unmarshal(data, &varF5AS3TriggerResponse)

	if err != nil {
		return err
	}

	*o = F5AS3TriggerResponse(varF5AS3TriggerResponse)
...
type NullableF5AS3TriggerResponse struct {
	value *F5AS3TriggerResponse
	isSet bool
}

func (v NullableF5AS3TriggerResponse) Get() *F5AS3TriggerResponse {
	return v.value
}

func (v *NullableF5AS3TriggerResponse) Set(val *F5AS3TriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableF5AS3TriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableF5AS3TriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableF5AS3TriggerResponse(val *F5AS3TriggerResponse) *NullableF5AS3TriggerResponse {
	return &NullableF5AS3TriggerResponse{value: val, isSet: true}
}

func (v NullableF5AS3TriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableF5AS3TriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

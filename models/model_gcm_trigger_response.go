...
// checks if the GCMTriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &GCMTriggerResponse{}

// GCMTriggerResponse struct for GCMTriggerResponse
type GCMTriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _GCMTriggerResponse GCMTriggerResponse

// NewGCMTriggerResponse instantiates a new GCMTriggerResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewGCMTriggerResponse(id string, connector string, events []TriggerEvent, name string, type_ string) *GCMTriggerResponse {
	this := GCMTriggerResponse{}
	this.Id = id
...
func (o *GCMTriggerResponse) GetEvents() []TriggerEvent {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GCMTriggerResponse) GetEventsOk() ([]TriggerEvent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GCMTriggerResponse) SetEvents(v []TriggerEvent) {
	o.Events = v
}
...
func (o *GCMTriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o GCMTriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o GCMTriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *GCMTriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGCMTriggerResponse := _GCMTriggerResponse{}

	err = json.Unmarshal(data, &varGCMTriggerResponse)

	if err != nil {
		return err
	}

	*o = GCMTriggerResponse(varGCMTriggerResponse)
...
type NullableGCMTriggerResponse struct {
	value *GCMTriggerResponse
	isSet bool
}

func (v NullableGCMTriggerResponse) Get() *GCMTriggerResponse {
	return v.value
}

func (v *NullableGCMTriggerResponse) Set(val *GCMTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableGCMTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableGCMTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableGCMTriggerResponse(val *GCMTriggerResponse) *NullableGCMTriggerResponse {
	return &NullableGCMTriggerResponse{value: val, isSet: true}
}

func (v NullableGCMTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableGCMTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

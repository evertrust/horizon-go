...
// checks if the LocalId009 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LocalId009{}

// LocalId009 Local Identity provider not found or disabled
type LocalId009 struct {
...
func (o *LocalId009) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o LocalId009) MarshalJSON() ([]byte, error) {
...
func (o LocalId009) ToMap() (map[string]interface{}, error) {
...
func (o *LocalId009) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalId009 := _LocalId009{}

	err = json.Unmarshal(data, &varLocalId009)

	if err != nil {
		return err
	}

	*o = LocalId009(varLocalId009)
...
type NullableLocalId009 struct {
	value *LocalId009
	isSet bool
}

func (v NullableLocalId009) Get() *LocalId009 {
	return v.value
}

func (v *NullableLocalId009) Set(val *LocalId009) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalId009) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalId009) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalId009(val *LocalId009) *NullableLocalId009 {
	return &NullableLocalId009{value: val, isSet: true}
}

func (v NullableLocalId009) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalId009) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ReportCsvError002 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ReportCsvError002{}

// ReportCsvError002 Report CSV not found
type ReportCsvError002 struct {
...
type _ReportCsvError002 ReportCsvError002
...
func (o *ReportCsvError002) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o ReportCsvError002) MarshalJSON() ([]byte, error) {
...
func (o ReportCsvError002) ToMap() (map[string]interface{}, error) {
...
func (o *ReportCsvError002) UnmarshalJSON(data []byte) (err error) {
	...
	varReportCsvError002 := _ReportCsvError002{}

	err = json.Unmarshal(data, &varReportCsvError002)

	if err != nil {
		return err
	}

	*o = ReportCsvError002(varReportCsvError002)
...
type NullableReportCsvError002 struct {
	value *ReportCsvError002
	isSet bool
}

func (v NullableReportCsvError002) Get() *ReportCsvError002 {
	return v.value
}

func (v *NullableReportCsvError002) Set(val *ReportCsvError002) {
	v.value = val
	v.isSet = true
}

func (v NullableReportCsvError002) IsSet() bool {
	return v.isSet
}

func (v *NullableReportCsvError002) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportCsvError002(val *ReportCsvError002) *NullableReportCsvError002 {
	return &NullableReportCsvError002{value: val, isSet: true}
}

func (v NullableReportCsvError002) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportCsvError002) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRARevokeRequestOnSubmitResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARevokeRequestOnSubmitResponse{}

// WebRARevokeRequestOnSubmitResponse struct for WebRARevokeRequestOnSubmitResponse
type WebRARevokeRequestOnSubmitResponse struct {
...
type _WebRARevokeRequestOnSubmitResponse WebRARevokeRequestOnSubmitResponse
...
func NewWebRARevokeRequestOnSubmitResponse(module Module, template WebRARevokeRequestTemplate, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *WebRARevokeRequestOnSubmitResponse {
	this := WebRARevokeRequestOnSubmitResponse{}
	this.Module = module
...
func (o *WebRARevokeRequestOnSubmitResponse) SetCertificateNil() {
...
func (o *WebRARevokeRequestOnSubmitResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *WebRARevokeRequestOnSubmitResponse) SetApproverCommentNil() {
...
func (o *WebRARevokeRequestOnSubmitResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *WebRARevokeRequestOnSubmitResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *WebRARevokeRequestOnSubmitResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRARevokeRequestOnSubmitResponse) HasHolderId() bool {
	if o != nil && !utils.IsNil(o.HolderId) {
		return true
	}
...
func (o *WebRARevokeRequestOnSubmitResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRARevokeRequestOnSubmitResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *WebRARevokeRequestOnSubmitResponse) SetRequesterCommentNil() {
...
func (o *WebRARevokeRequestOnSubmitResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o WebRARevokeRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRARevokeRequestOnSubmitResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARevokeRequestOnSubmitResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARevokeRequestOnSubmitResponse := _WebRARevokeRequestOnSubmitResponse{}

	err = json.Unmarshal(data, &varWebRARevokeRequestOnSubmitResponse)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestOnSubmitResponse(varWebRARevokeRequestOnSubmitResponse)
...
type NullableWebRARevokeRequestOnSubmitResponse struct {
	value *WebRARevokeRequestOnSubmitResponse
	isSet bool
}

func (v NullableWebRARevokeRequestOnSubmitResponse) Get() *WebRARevokeRequestOnSubmitResponse {
	return v.value
}

func (v *NullableWebRARevokeRequestOnSubmitResponse) Set(val *WebRARevokeRequestOnSubmitResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestOnSubmitResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestOnSubmitResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestOnSubmitResponse(val *WebRARevokeRequestOnSubmitResponse) *NullableWebRARevokeRequestOnSubmitResponse {
	return &NullableWebRARevokeRequestOnSubmitResponse{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestOnSubmitResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestOnSubmitResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

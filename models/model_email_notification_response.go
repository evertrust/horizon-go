...
func (o *EmailNotificationResponse) GetLicenceUsagePercent() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *EmailNotificationResponse) GetLicenceUsagePercentOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *EmailNotificationResponse) HasLicenceUsagePercent() bool {
...
func (o *EmailNotificationResponse) SetLicenceUsagePercent(v int64) {
	o.LicenceUsagePercent.Set(&v)
}

// SetLicenceUsagePercentNil sets the value for LicenceUsagePercent to be an explicit nil
func (o *EmailNotificationResponse) SetLicenceUsagePercentNil() {
...
func (o *EmailNotificationResponse) UnsetLicenceUsagePercent() {

...
// checks if the PanoramaTriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PanoramaTriggerResponse{}

// PanoramaTriggerResponse struct for PanoramaTriggerResponse
type PanoramaTriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _PanoramaTriggerResponse PanoramaTriggerResponse
...
func (o *PanoramaTriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o PanoramaTriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o PanoramaTriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PanoramaTriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPanoramaTriggerResponse := _PanoramaTriggerResponse{}

	err = json.Unmarshal(data, &varPanoramaTriggerResponse)

	if err != nil {
		return err
	}

	*o = PanoramaTriggerResponse(varPanoramaTriggerResponse)
...
type NullablePanoramaTriggerResponse struct {
	value *PanoramaTriggerResponse
	isSet bool
}

func (v NullablePanoramaTriggerResponse) Get() *PanoramaTriggerResponse {
	return v.value
}

func (v *NullablePanoramaTriggerResponse) Set(val *PanoramaTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePanoramaTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePanoramaTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePanoramaTriggerResponse(val *PanoramaTriggerResponse) *NullablePanoramaTriggerResponse {
	return &NullablePanoramaTriggerResponse{value: val, isSet: true}
}

func (v NullablePanoramaTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePanoramaTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

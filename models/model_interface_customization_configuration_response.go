...
var _ utils.MappedNullable = &InterfaceCustomizationConfigurationResponse{}
...
type InterfaceCustomizationConfigurationResponse struct {
	// Object internal ID
	Id string `json:"_id"`
	// Announcements to display to all users in the Horizon instance
	Announcements []InterfaceCustomizationConfigurationAnnouncementsInner `json:"announcements,omitempty"`
...
func (o *InterfaceCustomizationConfigurationResponse) GetAnnouncements() []InterfaceCustomizationConfigurationAnnouncementsInner {
	if o == nil || utils.IsNil(o.Announcements) {
		var ret []InterfaceCustomizationConfigurationAnnouncementsInner
		return ret
	}
...
// SetAnnouncements gets a reference to the given []InterfaceCustomizationConfigurationAnnouncementsInner and assigns it to the Announcements field.
...
func (o InterfaceCustomizationConfigurationResponse) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.Announcements) {

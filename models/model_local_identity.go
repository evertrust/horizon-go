...
// checks if the LocalIdentity type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LocalIdentity{}

// LocalIdentity struct for LocalIdentity
...
type _LocalIdentity LocalIdentity
...
func (o *LocalIdentity) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *LocalIdentity) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o LocalIdentity) MarshalJSON() ([]byte, error) {
...
func (o LocalIdentity) ToMap() (map[string]interface{}, error) {
...
func (o *LocalIdentity) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalIdentity := _LocalIdentity{}

	err = json.Unmarshal(data, &varLocalIdentity)

	if err != nil {
		return err
	}

	*o = LocalIdentity(varLocalIdentity)
...
type NullableLocalIdentity struct {
	value *LocalIdentity
	isSet bool
}

func (v NullableLocalIdentity) Get() *LocalIdentity {
	return v.value
}

func (v *NullableLocalIdentity) Set(val *LocalIdentity) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalIdentity) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalIdentity) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalIdentity(val *LocalIdentity) *NullableLocalIdentity {
	return &NullableLocalIdentity{value: val, isSet: true}
}

func (v NullableLocalIdentity) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalIdentity) UnmarshalJSON(src []byte) error {
	v.isSet = true

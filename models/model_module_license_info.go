...
// checks if the ModuleLicenseInfo type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ModuleLicenseInfo{}
...
type _ModuleLicenseInfo ModuleLicenseInfo
...
func (o *ModuleLicenseInfo) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *ModuleLicenseInfo) UnmarshalJSON(data []byte) (err error) {
	...
	varModuleLicenseInfo := _ModuleLicenseInfo{}

	err = json.Unmarshal(data, &varModuleLicenseInfo)

	if err != nil {
		return err
	}

	*o = ModuleLicenseInfo(varModuleLicenseInfo)
...
type NullableModuleLicenseInfo struct {
	value *ModuleLicenseInfo
	isSet bool
}

func (v NullableModuleLicenseInfo) Get() *ModuleLicenseInfo {
	return v.value
}

func (v *NullableModuleLicenseInfo) Set(val *ModuleLicenseInfo) {
	v.value = val
	v.isSet = true
}

func (v NullableModuleLicenseInfo) IsSet() bool {
	return v.isSet
}

func (v *NullableModuleLicenseInfo) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableModuleLicenseInfo(val *ModuleLicenseInfo) *NullableModuleLicenseInfo {
	return &NullableModuleLicenseInfo{value: val, isSet: true}
}

func (v NullableModuleLicenseInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableModuleLicenseInfo) UnmarshalJSON(src []byte) error {
	v.isSet = true

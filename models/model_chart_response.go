...
var _ utils.MappedNullable = &ChartResponse{}
...
type ChartResponse struct {
	...
	// The sort direction applied to the chart values
	...
	Having NullableHavingResponse `json:"having,omitempty"`
...
func (o *ChartResponse) SetDescriptionNil() {
...
func (o *ChartResponse) SetDirectionNil() {
	o.Direction.Set(nil)
}
...
// SetHaving gets a reference to the given NullableHavingResponse and assigns it to the Having field.
func (o *ChartResponse) SetHaving(v HavingResponse) {
	o.Having.Set(&v)
}

// SetHavingNil sets the value for Having to be an explicit nil
func (o *ChartResponse) SetHavingNil() {
	o.Having.Set(nil)
}
...
func (o *ChartResponse) SetLimitNil() {
	o.Limit.Set(nil)
}
...
func (o *ChartResponse) SetLocalQueryNil() {
...
func (o *ChartResponse) SetSortOrderNil() {
	o.SortOrder.Set(nil)
}

...
// StorageConfigurationAsSystemConfigurationUpsertRequest is a convenience function that returns StorageConfiguration wrapped in SystemConfigurationUpsertRequest
func StorageConfigurationAsSystemConfigurationUpsertRequest(v *StorageConfiguration) SystemConfigurationUpsertRequest {
	return SystemConfigurationUpsertRequest{
		StorageConfiguration: v,
	}
}
...
func (dst *SystemConfigurationUpsertRequest) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into StorageConfiguration
	err = utils.NewStrictDecoder(data).Decode(&dst.StorageConfiguration)
	if err == nil {
		jsonStorageConfiguration, _ := json.Marshal(dst.StorageConfiguration)
		if string(jsonStorageConfiguration) == "{}" { // empty struct
			dst.StorageConfiguration = nil
		} else {
			_ = validator.Validate(dst.StorageConfiguration)
			match++
		}
	} else {
		dst.StorageConfiguration = nil
...
func (src SystemConfigurationUpsertRequest) MarshalJSON() ([]byte, error) {
	...
	if src.StorageConfiguration != nil {
		return json.Marshal(&src.StorageConfiguration)
	}
...
func (obj *SystemConfigurationUpsertRequest) GetActualInstance() interface{} {
	...
	if obj.StorageConfiguration != nil {
		return obj.StorageConfiguration
	}

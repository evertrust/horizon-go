...
// checks if the CertLabel003 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertLabel003{}

// CertLabel003 Label not found
type CertLabel003 struct {
...
type _CertLabel003 CertLabel003
...
func (o *CertLabel003) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CertLabel003) MarshalJSON() ([]byte, error) {
...
func (o CertLabel003) ToMap() (map[string]interface{}, error) {
...
func (o *CertLabel003) UnmarshalJSON(data []byte) (err error) {
	...
	varCertLabel003 := _CertLabel003{}

	err = json.Unmarshal(data, &varCertLabel003)

	if err != nil {
		return err
	}

	*o = CertLabel003(varCertLabel003)
...
type NullableCertLabel003 struct {
	value *CertLabel003
	isSet bool
}

func (v NullableCertLabel003) Get() *CertLabel003 {
	return v.value
}

func (v *NullableCertLabel003) Set(val *CertLabel003) {
	v.value = val
	v.isSet = true
}

func (v NullableCertLabel003) IsSet() bool {
	return v.isSet
}

func (v *NullableCertLabel003) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertLabel003(val *CertLabel003) *NullableCertLabel003 {
	return &NullableCertLabel003{value: val, isSet: true}
}

func (v NullableCertLabel003) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertLabel003) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRARecoverRequestTemplate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRARecoverRequestTemplate{}

// WebRARecoverRequestTemplate struct for WebRARecoverRequestTemplate
type WebRARecoverRequestTemplate struct {
	// The password mode of the certificate
	PasswordMode utils.NullableString `json:"passwordMode,omitempty"`
...
type _WebRARecoverRequestTemplate WebRARecoverRequestTemplate
...
func NewWebRARecoverRequestTemplate() *WebRARecoverRequestTemplate {
	this := WebRARecoverRequestTemplate{}
	return &this
}
...
// GetPasswordMode returns the PasswordMode field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRARecoverRequestTemplate) GetPasswordMode() string {
	if o == nil || utils.IsNil(o.PasswordMode.Get()) {
		var ret string
		return ret
	}
	return *o.PasswordMode.Get()
}
...
// SetPasswordMode gets a reference to the given NullableString and assigns it to the PasswordMode field.
func (o *WebRARecoverRequestTemplate) SetPasswordMode(v string) {
	o.PasswordMode.Set(&v)
}

// SetPasswordModeNil sets the value for PasswordMode to be an explicit nil
func (o *WebRARecoverRequestTemplate) SetPasswordModeNil() {
	o.PasswordMode.Set(nil)
}
...
func (o *WebRARecoverRequestTemplate) SetPasswordPolicyNil() {
...
func (o WebRARecoverRequestTemplate) MarshalJSON() ([]byte, error) {
...
func (o WebRARecoverRequestTemplate) ToMap() (map[string]interface{}, error) {
	toSerialize := map[string]interface{}{}
	if o.PasswordMode.IsSet() {
		toSerialize["passwordMode"] = o.PasswordMode.Get()
	}
...
func (o *WebRARecoverRequestTemplate) UnmarshalJSON(data []byte) (err error) {
	varWebRARecoverRequestTemplate := _WebRARecoverRequestTemplate{}

	err = json.Unmarshal(data, &varWebRARecoverRequestTemplate)

	if err != nil {
		return err
	}

	*o = WebRARecoverRequestTemplate(varWebRARecoverRequestTemplate)

	additionalProperties := make(map[string]interface{})

	if err = json.Unmarshal(data, &additionalProperties); err == nil {
		delete(additionalProperties, "passwordMode")
...
type NullableWebRARecoverRequestTemplate struct {
	value *WebRARecoverRequestTemplate
	isSet bool
}

func (v NullableWebRARecoverRequestTemplate) Get() *WebRARecoverRequestTemplate {
	return v.value
}

func (v *NullableWebRARecoverRequestTemplate) Set(val *WebRARecoverRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARecoverRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARecoverRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARecoverRequestTemplate(val *WebRARecoverRequestTemplate) *NullableWebRARecoverRequestTemplate {
	return &NullableWebRARecoverRequestTemplate{value: val, isSet: true}
}

func (v NullableWebRARecoverRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARecoverRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

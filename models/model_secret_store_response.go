...
// checks if the SecretStoreResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecretStoreResponse{}
...
func NewSecretStoreResponse(certificate CFCertificateResponse) *SecretStoreResponse {
...
func (o *SecretStoreResponse) GetCertificate() CFCertificateResponse {
	if o == nil {
...
func (o *SecretStoreResponse) GetCertificateOk() (*CFCertificateResponse, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *SecretStoreResponse) SetCertificate(v CFCertificateResponse) {
	o.Certificate = v
}
...
func (o SecretStoreResponse) ToMap() (map[string]interface{}, error) {
...
func (o *SecretStoreResponse) UnmarshalJSON(data []byte) (err error) {
	...
	err = json.Unmarshal(data, &varSecretStoreResponse)

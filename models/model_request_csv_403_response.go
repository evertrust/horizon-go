...
func (dst *RequestCsv403Response) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal JSON data into AutomationPolicyLifecycleVerify403ResponseOneOf
	...
	if err == nil {
		...
		if string(jsonAutomationPolicyLifecycleVerify403ResponseOneOf) == "{}" { // empty struct
			...
			return nil // data stored in dst.AutomationPolicyLifecycleVerify403ResponseOneOf, return on the first match
		}
	} else {
		dst.AutomationPolicyLifecycleVerify403ResponseOneOf = nil
	}

	// try to unmarshal JSON data into AutomationPolicyLifecycleVerify403ResponseOneOf1
	...
	if err == nil {
		...
		if string(jsonAutomationPolicyLifecycleVerify403ResponseOneOf1) == "{}" { // empty struct
			...
			return nil // data stored in dst.AutomationPolicyLifecycleVerify403ResponseOneOf1, return on the first match
		}
	} else {
		dst.AutomationPolicyLifecycleVerify403ResponseOneOf1 = nil
	}

	// try to unmarshal JSON data into AutomationPolicyLifecycleVerify403ResponseOneOf2
	...
	if err == nil {
		...
		if string(jsonAutomationPolicyLifecycleVerify403ResponseOneOf2) == "{}" { // empty struct
			...
			return nil // data stored in dst.AutomationPolicyLifecycleVerify403ResponseOneOf2, return on the first match
		}
	} else {
		dst.AutomationPolicyLifecycleVerify403ResponseOneOf2 = nil
	}

	// try to unmarshal JSON data into AutomationPolicyLifecycleVerify403ResponseOneOf3
	...
	if err == nil {
		...
		if string(jsonAutomationPolicyLifecycleVerify403ResponseOneOf3) == "{}" { // empty struct
			...
			return nil // data stored in dst.AutomationPolicyLifecycleVerify403ResponseOneOf3, return on the first match
		}
	} else {
		dst.AutomationPolicyLifecycleVerify403ResponseOneOf3 = nil
	}

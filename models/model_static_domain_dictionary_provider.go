...
// checks if the StaticDomainDictionaryProvider type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &StaticDomainDictionaryProvider{}
...
type _StaticDomainDictionaryProvider StaticDomainDictionaryProvider
...
func (o *StaticDomainDictionaryProvider) UnmarshalJSON(data []byte) (err error) {
	...
	varStaticDomainDictionaryProvider := _StaticDomainDictionaryProvider{}

	err = json.Unmarshal(data, &varStaticDomainDictionaryProvider)

	if err != nil {
		return err
	}

	*o = StaticDomainDictionaryProvider(varStaticDomainDictionaryProvider)
...
type NullableStaticDomainDictionaryProvider struct {
	value *StaticDomainDictionaryProvider
	isSet bool
}

func (v NullableStaticDomainDictionaryProvider) Get() *StaticDomainDictionaryProvider {
	return v.value
}

func (v *NullableStaticDomainDictionaryProvider) Set(val *StaticDomainDictionaryProvider) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticDomainDictionaryProvider) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticDomainDictionaryProvider) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticDomainDictionaryProvider(val *StaticDomainDictionaryProvider) *NullableStaticDomainDictionaryProvider {
	return &NullableStaticDomainDictionaryProvider{value: val, isSet: true}
}

func (v NullableStaticDomainDictionaryProvider) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticDomainDictionaryProvider) UnmarshalJSON(src []byte) error {
	v.isSet = true

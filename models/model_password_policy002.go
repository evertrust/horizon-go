...
// checks if the PasswordPolicy002 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PasswordPolicy002{}

// PasswordPolicy002 Invalid password policy
type PasswordPolicy002 struct {
...
type _PasswordPolicy002 PasswordPolicy002
...
func (o *PasswordPolicy002) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o PasswordPolicy002) MarshalJSON() ([]byte, error) {
...
func (o PasswordPolicy002) ToMap() (map[string]interface{}, error) {
...
func (o *PasswordPolicy002) UnmarshalJSON(data []byte) (err error) {
	...
	varPasswordPolicy002 := _PasswordPolicy002{}

	err = json.Unmarshal(data, &varPasswordPolicy002)

	if err != nil {
		return err
	}

	*o = PasswordPolicy002(varPasswordPolicy002)
...
type NullablePasswordPolicy002 struct {
	value *PasswordPolicy002
	isSet bool
}

func (v NullablePasswordPolicy002) Get() *PasswordPolicy002 {
	return v.value
}

func (v *NullablePasswordPolicy002) Set(val *PasswordPolicy002) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordPolicy002) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordPolicy002) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordPolicy002(val *PasswordPolicy002) *NullablePasswordPolicy002 {
	return &NullablePasswordPolicy002{value: val, isSet: true}
}

func (v NullablePasswordPolicy002) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordPolicy002) UnmarshalJSON(src []byte) error {
	v.isSet = true

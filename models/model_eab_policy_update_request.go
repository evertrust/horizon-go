...
// checks if the EabPolicyUpdateRequest type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EabPolicyUpdateRequest{}

// EabPolicyUpdateRequest struct for EabPolicyUpdateRequest
type EabPolicyUpdateRequest struct {
...
type _EabPolicyUpdateRequest EabPolicyUpdateRequest
...
func (o EabPolicyUpdateRequest) MarshalJSON() ([]byte, error) {
...
func (o EabPolicyUpdateRequest) ToMap() (map[string]interface{}, error) {
...
func (o *EabPolicyUpdateRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEabPolicyUpdateRequest := _EabPolicyUpdateRequest{}

	err = json.Unmarshal(data, &varEabPolicyUpdateRequest)

	if err != nil {
		return err
	}

	*o = EabPolicyUpdateRequest(varEabPolicyUpdateRequest)
...
type NullableEabPolicyUpdateRequest struct {
	value *EabPolicyUpdateRequest
	isSet bool
}

func (v NullableEabPolicyUpdateRequest) Get() *EabPolicyUpdateRequest {
	return v.value
}

func (v *NullableEabPolicyUpdateRequest) Set(val *EabPolicyUpdateRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableEabPolicyUpdateRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableEabPolicyUpdateRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEabPolicyUpdateRequest(val *EabPolicyUpdateRequest) *NullableEabPolicyUpdateRequest {
	return &NullableEabPolicyUpdateRequest{value: val, isSet: true}
}

func (v NullableEabPolicyUpdateRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEabPolicyUpdateRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true

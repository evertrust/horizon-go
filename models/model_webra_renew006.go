...
// checks if the WebraRenew006 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebraRenew006{}

// WebraRenew006 Certificate status does not allow renewal
type WebraRenew006 struct {
...
type _WebraRenew006 WebraRenew006
...
func (o *WebraRenew006) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o WebraRenew006) MarshalJSON() ([]byte, error) {
...
func (o WebraRenew006) ToMap() (map[string]interface{}, error) {
...
func (o *WebraRenew006) UnmarshalJSON(data []byte) (err error) {
	...
	varWebraRenew006 := _WebraRenew006{}

	err = json.Unmarshal(data, &varWebraRenew006)

	if err != nil {
		return err
	}

	*o = WebraRenew006(varWebraRenew006)
...
type NullableWebraRenew006 struct {
	value *WebraRenew006
	isSet bool
}

func (v NullableWebraRenew006) Get() *WebraRenew006 {
	return v.value
}

func (v *NullableWebraRenew006) Set(val *WebraRenew006) {
	v.value = val
	v.isSet = true
}

func (v NullableWebraRenew006) IsSet() bool {
	return v.isSet
}

func (v *NullableWebraRenew006) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebraRenew006(val *WebraRenew006) *NullableWebraRenew006 {
	return &NullableWebraRenew006{value: val, isSet: true}
}

func (v NullableWebraRenew006) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebraRenew006) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the ScepEnrollRequestOnGetResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ScepEnrollRequestOnGetResponse{}

// ScepEnrollRequestOnGetResponse struct for ScepEnrollRequestOnGetResponse
type ScepEnrollRequestOnGetResponse struct {
	...
	Template *ScepEnrollRequestTemplateResponse `json:"template,omitempty"`
...
type _ScepEnrollRequestOnGetResponse ScepEnrollRequestOnGetResponse
...
func NewScepEnrollRequestOnGetResponse(module string, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *ScepEnrollRequestOnGetResponse {
	this := ScepEnrollRequestOnGetResponse{}
	this.Id = id
...
func (o *ScepEnrollRequestOnGetResponse) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *ScepEnrollRequestOnGetResponse) GetTemplate() ScepEnrollRequestTemplateResponse {
	if o == nil || utils.IsNil(o.Template) {
		var ret ScepEnrollRequestTemplateResponse
		return ret
	}
	return *o.Template
}
...
// SetTemplate gets a reference to the given ScepEnrollRequestTemplateResponse and assigns it to the Template field.
...
func (o *ScepEnrollRequestOnGetResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *ScepEnrollRequestOnGetResponse) SetApproverCommentNil() {
...
func (o *ScepEnrollRequestOnGetResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *ScepEnrollRequestOnGetResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *ScepEnrollRequestOnGetResponse) SetGlobalHolderIdCountNil() {
...
func (o *ScepEnrollRequestOnGetResponse) SetProfileHolderIdCountNil() {
...
func (o *ScepEnrollRequestOnGetResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *ScepEnrollRequestOnGetResponse) SetRequesterCommentNil() {
...
func (o *ScepEnrollRequestOnGetResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o ScepEnrollRequestOnGetResponse) MarshalJSON() ([]byte, error) {
...
func (o ScepEnrollRequestOnGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ScepEnrollRequestOnGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varScepEnrollRequestOnGetResponse := _ScepEnrollRequestOnGetResponse{}

	err = json.Unmarshal(data, &varScepEnrollRequestOnGetResponse)

	if err != nil {
		return err
	}

	*o = ScepEnrollRequestOnGetResponse(varScepEnrollRequestOnGetResponse)
...
type NullableScepEnrollRequestOnGetResponse struct {
	value *ScepEnrollRequestOnGetResponse
	isSet bool
}

func (v NullableScepEnrollRequestOnGetResponse) Get() *ScepEnrollRequestOnGetResponse {
	return v.value
}

func (v *NullableScepEnrollRequestOnGetResponse) Set(val *ScepEnrollRequestOnGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableScepEnrollRequestOnGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableScepEnrollRequestOnGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScepEnrollRequestOnGetResponse(val *ScepEnrollRequestOnGetResponse) *NullableScepEnrollRequestOnGetResponse {
	return &NullableScepEnrollRequestOnGetResponse{value: val, isSet: true}
}

func (v NullableScepEnrollRequestOnGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScepEnrollRequestOnGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the Archive007 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &Archive007{}

// Archive007 Archive cannot be canceled
type Archive007 struct {
...
func (o *Archive007) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o Archive007) MarshalJSON() ([]byte, error) {
...
func (o Archive007) ToMap() (map[string]interface{}, error) {
...
func (o *Archive007) UnmarshalJSON(data []byte) (err error) {
	...
	varArchive007 := _Archive007{}

	err = json.Unmarshal(data, &varArchive007)

	if err != nil {
		return err
	}

	*o = Archive007(varArchive007)
...
type NullableArchive007 struct {
	value *Archive007
	isSet bool
}

func (v NullableArchive007) Get() *Archive007 {
	return v.value
}

func (v *NullableArchive007) Set(val *Archive007) {
	v.value = val
	v.isSet = true
}

func (v NullableArchive007) IsSet() bool {
	return v.isSet
}

func (v *NullableArchive007) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableArchive007(val *Archive007) *NullableArchive007 {
	return &NullableArchive007{value: val, isSet: true}
}

func (v NullableArchive007) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableArchive007) UnmarshalJSON(src []byte) error {
	v.isSet = true

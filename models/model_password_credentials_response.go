...
// checks if the PasswordCredentialsResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PasswordCredentialsResponse{}

// PasswordCredentialsResponse struct for PasswordCredentialsResponse
type PasswordCredentialsResponse struct {
...
type _PasswordCredentialsResponse PasswordCredentialsResponse
...
func NewPasswordCredentialsResponse(type_ string, login string, password SecretString, id string, name string) *PasswordCredentialsResponse {
	this := PasswordCredentialsResponse{}
	this.Id = id
	this.Name = name
	this.Type = type_
	return &this
...
func (o *PasswordCredentialsResponse) SetDescriptionNil() {
...
func (o *PasswordCredentialsResponse) SetExpiresNil() {
	o.Expires.Set(nil)
}
...
func (o PasswordCredentialsResponse) MarshalJSON() ([]byte, error) {
...
func (o PasswordCredentialsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PasswordCredentialsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPasswordCredentialsResponse := _PasswordCredentialsResponse{}

	err = json.Unmarshal(data, &varPasswordCredentialsResponse)

	if err != nil {
		return err
	}

	*o = PasswordCredentialsResponse(varPasswordCredentialsResponse)
...
type NullablePasswordCredentialsResponse struct {
	value *PasswordCredentialsResponse
	isSet bool
}

func (v NullablePasswordCredentialsResponse) Get() *PasswordCredentialsResponse {
	return v.value
}

func (v *NullablePasswordCredentialsResponse) Set(val *PasswordCredentialsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePasswordCredentialsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePasswordCredentialsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePasswordCredentialsResponse(val *PasswordCredentialsResponse) *NullablePasswordCredentialsResponse {
	return &NullablePasswordCredentialsResponse{value: val, isSet: true}
}

func (v NullablePasswordCredentialsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePasswordCredentialsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

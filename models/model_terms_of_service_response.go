...
// checks if the TermsOfServiceResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &TermsOfServiceResponse{}

// TermsOfServiceResponse struct for TermsOfServiceResponse
type TermsOfServiceResponse struct {
	// Object internal ID
	Id string `json:"_id"`
	// Localized text content displayed to the requester
	Contents []LocalizedString `json:"contents"`
...
type _TermsOfServiceResponse TermsOfServiceResponse
...
func (o TermsOfServiceResponse) MarshalJSON() ([]byte, error) {
...
func (o TermsOfServiceResponse) ToMap() (map[string]interface{}, error) {
...
func (o *TermsOfServiceResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varTermsOfServiceResponse := _TermsOfServiceResponse{}

	err = json.Unmarshal(data, &varTermsOfServiceResponse)

	if err != nil {
		return err
	}

	*o = TermsOfServiceResponse(varTermsOfServiceResponse)
...
type NullableTermsOfServiceResponse struct {
	value *TermsOfServiceResponse
	isSet bool
}

func (v NullableTermsOfServiceResponse) Get() *TermsOfServiceResponse {
	return v.value
}

func (v *NullableTermsOfServiceResponse) Set(val *TermsOfServiceResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableTermsOfServiceResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableTermsOfServiceResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTermsOfServiceResponse(val *TermsOfServiceResponse) *NullableTermsOfServiceResponse {
	return &NullableTermsOfServiceResponse{value: val, isSet: true}
}

func (v NullableTermsOfServiceResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTermsOfServiceResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the SchedulerTaskAdd400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SchedulerTaskAdd400ResponseOneOf{}

// SchedulerTaskAdd400ResponseOneOf struct for SchedulerTaskAdd400ResponseOneOf
type SchedulerTaskAdd400ResponseOneOf struct {
...
type _SchedulerTaskAdd400ResponseOneOf SchedulerTaskAdd400ResponseOneOf
...
func NewSchedulerTaskAdd400ResponseOneOf(status float32, error_ string, message string, title string) *SchedulerTaskAdd400ResponseOneOf {
	this := SchedulerTaskAdd400ResponseOneOf{}
	this.Error = error_
...
func (o *SchedulerTaskAdd400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SchedulerTaskAdd400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o SchedulerTaskAdd400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *SchedulerTaskAdd400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSchedulerTaskAdd400ResponseOneOf := _SchedulerTaskAdd400ResponseOneOf{}

	err = json.Unmarshal(data, &varSchedulerTaskAdd400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = SchedulerTaskAdd400ResponseOneOf(varSchedulerTaskAdd400ResponseOneOf)
...
type NullableSchedulerTaskAdd400ResponseOneOf struct {
	value *SchedulerTaskAdd400ResponseOneOf
	isSet bool
}

func (v NullableSchedulerTaskAdd400ResponseOneOf) Get() *SchedulerTaskAdd400ResponseOneOf {
	return v.value
}

func (v *NullableSchedulerTaskAdd400ResponseOneOf) Set(val *SchedulerTaskAdd400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSchedulerTaskAdd400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSchedulerTaskAdd400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSchedulerTaskAdd400ResponseOneOf(val *SchedulerTaskAdd400ResponseOneOf) *NullableSchedulerTaskAdd400ResponseOneOf {
	return &NullableSchedulerTaskAdd400ResponseOneOf{value: val, isSet: true}
}

func (v NullableSchedulerTaskAdd400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSchedulerTaskAdd400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

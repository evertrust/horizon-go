...
// checks if the AWSTriggerResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AWSTriggerResponse{}

// AWSTriggerResponse struct for AWSTriggerResponse
type AWSTriggerResponse struct {
	// Object internal ID
	Id                   string              `json:"_id"`
...
type _AWSTriggerResponse AWSTriggerResponse

// NewAWSTriggerResponse instantiates a new AWSTriggerResponse object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAWSTriggerResponse(id string, connector string, events []TriggerEvent, name string, type_ string) *AWSTriggerResponse {
	this := AWSTriggerResponse{}
	this.Id = id
...
func (o *AWSTriggerResponse) GetEvents() []TriggerEvent {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AWSTriggerResponse) GetEventsOk() ([]TriggerEvent, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AWSTriggerResponse) SetEvents(v []TriggerEvent) {
	o.Events = v
}
...
func (o *AWSTriggerResponse) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o AWSTriggerResponse) MarshalJSON() ([]byte, error) {
...
func (o AWSTriggerResponse) ToMap() (map[string]interface{}, error) {
...
func (o *AWSTriggerResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varAWSTriggerResponse := _AWSTriggerResponse{}

	err = json.Unmarshal(data, &varAWSTriggerResponse)

	if err != nil {
		return err
	}

	*o = AWSTriggerResponse(varAWSTriggerResponse)
...
type NullableAWSTriggerResponse struct {
	value *AWSTriggerResponse
	isSet bool
}

func (v NullableAWSTriggerResponse) Get() *AWSTriggerResponse {
	return v.value
}

func (v *NullableAWSTriggerResponse) Set(val *AWSTriggerResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableAWSTriggerResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableAWSTriggerResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAWSTriggerResponse(val *AWSTriggerResponse) *NullableAWSTriggerResponse {
	return &NullableAWSTriggerResponse{value: val, isSet: true}
}

func (v NullableAWSTriggerResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAWSTriggerResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

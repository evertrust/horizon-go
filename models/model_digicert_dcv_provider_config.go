...
// checks if the DigicertDCVProviderConfig type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DigicertDCVProviderConfig{}

// DigicertDCVProviderConfig struct for DigicertDCVProviderConfig
type DigicertDCVProviderConfig struct {
...
type _DigicertDCVProviderConfig DigicertDCVProviderConfig
...
func NewDigicertDCVProviderConfig(credentials string, endpoint string, name string, type_ string) *DigicertDCVProviderConfig {
	this := DigicertDCVProviderConfig{}
...
func (o *DigicertDCVProviderConfig) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *DigicertDCVProviderConfig) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o DigicertDCVProviderConfig) MarshalJSON() ([]byte, error) {
...
func (o DigicertDCVProviderConfig) ToMap() (map[string]interface{}, error) {
...
func (o *DigicertDCVProviderConfig) UnmarshalJSON(data []byte) (err error) {
	...
	varDigicertDCVProviderConfig := _DigicertDCVProviderConfig{}

	err = json.Unmarshal(data, &varDigicertDCVProviderConfig)

	if err != nil {
		return err
	}

	*o = DigicertDCVProviderConfig(varDigicertDCVProviderConfig)
...
type NullableDigicertDCVProviderConfig struct {
	value *DigicertDCVProviderConfig
	isSet bool
}

func (v NullableDigicertDCVProviderConfig) Get() *DigicertDCVProviderConfig {
	return v.value
}

func (v *NullableDigicertDCVProviderConfig) Set(val *DigicertDCVProviderConfig) {
	v.value = val
	v.isSet = true
}

func (v NullableDigicertDCVProviderConfig) IsSet() bool {
	return v.isSet
}

func (v *NullableDigicertDCVProviderConfig) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDigicertDCVProviderConfig(val *DigicertDCVProviderConfig) *NullableDigicertDCVProviderConfig {
	return &NullableDigicertDCVProviderConfig{value: val, isSet: true}
}

func (v NullableDigicertDCVProviderConfig) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDigicertDCVProviderConfig) UnmarshalJSON(src []byte) error {
	v.isSet = true

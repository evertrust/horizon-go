...
var _ utils.MappedNullable = &DirectoryMeta{}
...
func (o *DirectoryMeta) GetTermsOfService() string {
	if o == nil || utils.IsNil(o.TermsOfService.Get()) {
		var ret string
		return ret
	}
...
func (o *DirectoryMeta) GetWebsite() string {
	if o == nil || utils.IsNil(o.Website.Get()) {
		var ret string
		return ret
	}
...
func (o *DirectoryMeta) GetCaaIdentitiesOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.CaaIdentities) {
		return nil, false
	}

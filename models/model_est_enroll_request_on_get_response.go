...
// checks if the EstEnrollRequestOnGetResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestOnGetResponse{}

// EstEnrollRequestOnGetResponse struct for EstEnrollRequestOnGetResponse
type EstEnrollRequestOnGetResponse struct {
	...
	Template *EstEnrollRequestTemplateResponse `json:"template,omitempty"`
...
type _EstEnrollRequestOnGetResponse EstEnrollRequestOnGetResponse
...
func NewEstEnrollRequestOnGetResponse(module string, workflow string, id string, lastModificationDate int64, profile string, registrationDate int64, removeAt int64, status RequestStatus) *EstEnrollRequestOnGetResponse {
	this := EstEnrollRequestOnGetResponse{}
	this.Id = id
...
func (o *EstEnrollRequestOnGetResponse) SetPasswordNil() {
	o.Password.Set(nil)
}
...
func (o *EstEnrollRequestOnGetResponse) GetTemplate() EstEnrollRequestTemplateResponse {
	if o == nil || utils.IsNil(o.Template) {
		var ret EstEnrollRequestTemplateResponse
		return ret
	}
	return *o.Template
}
...
// SetTemplate gets a reference to the given EstEnrollRequestTemplateResponse and assigns it to the Template field.
...
func (o *EstEnrollRequestOnGetResponse) SetApproverNil() {
	o.Approver.Set(nil)
}
...
func (o *EstEnrollRequestOnGetResponse) SetApproverCommentNil() {
...
func (o *EstEnrollRequestOnGetResponse) SetContactNil() {
	o.Contact.Set(nil)
}
...
func (o *EstEnrollRequestOnGetResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o *EstEnrollRequestOnGetResponse) SetGlobalHolderIdCountNil() {
...
func (o *EstEnrollRequestOnGetResponse) SetProfileHolderIdCountNil() {
...
func (o *EstEnrollRequestOnGetResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}
...
func (o *EstEnrollRequestOnGetResponse) SetRequesterCommentNil() {
...
func (o *EstEnrollRequestOnGetResponse) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o EstEnrollRequestOnGetResponse) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestOnGetResponse) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestOnGetResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEstEnrollRequestOnGetResponse := _EstEnrollRequestOnGetResponse{}

	err = json.Unmarshal(data, &varEstEnrollRequestOnGetResponse)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestOnGetResponse(varEstEnrollRequestOnGetResponse)
...
type NullableEstEnrollRequestOnGetResponse struct {
	value *EstEnrollRequestOnGetResponse
	isSet bool
}

func (v NullableEstEnrollRequestOnGetResponse) Get() *EstEnrollRequestOnGetResponse {
	return v.value
}

func (v *NullableEstEnrollRequestOnGetResponse) Set(val *EstEnrollRequestOnGetResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestOnGetResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestOnGetResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestOnGetResponse(val *EstEnrollRequestOnGetResponse) *NullableEstEnrollRequestOnGetResponse {
	return &NullableEstEnrollRequestOnGetResponse{value: val, isSet: true}
}

func (v NullableEstEnrollRequestOnGetResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestOnGetResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

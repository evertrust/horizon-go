...
// checks if the PrincipalInfoSearchResultsResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &PrincipalInfoSearchResultsResponse{}

// PrincipalInfoSearchResultsResponse struct for PrincipalInfoSearchResultsResponse
type PrincipalInfoSearchResultsResponse struct {
	// The total number of results (if _withCount_ was set to true in the query)
	...
	Results              []PrincipalInfo `json:"results"`
	AdditionalProperties map[string]interface{}
}

type _PrincipalInfoSearchResultsResponse PrincipalInfoSearchResultsResponse
...
func NewPrincipalInfoSearchResultsResponse(hasMore bool, pageIndex int64, pageSize int64, results []PrincipalInfo) *PrincipalInfoSearchResultsResponse {
	this := PrincipalInfoSearchResultsResponse{}
...
func (o *PrincipalInfoSearchResultsResponse) SetCountNil() {
	o.Count.Set(nil)
}
...
func (o PrincipalInfoSearchResultsResponse) MarshalJSON() ([]byte, error) {
...
func (o PrincipalInfoSearchResultsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *PrincipalInfoSearchResultsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varPrincipalInfoSearchResultsResponse := _PrincipalInfoSearchResultsResponse{}

	err = json.Unmarshal(data, &varPrincipalInfoSearchResultsResponse)

	if err != nil {
		return err
	}

	*o = PrincipalInfoSearchResultsResponse(varPrincipalInfoSearchResultsResponse)
...
type NullablePrincipalInfoSearchResultsResponse struct {
	value *PrincipalInfoSearchResultsResponse
	isSet bool
}

func (v NullablePrincipalInfoSearchResultsResponse) Get() *PrincipalInfoSearchResultsResponse {
	return v.value
}

func (v *NullablePrincipalInfoSearchResultsResponse) Set(val *PrincipalInfoSearchResultsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullablePrincipalInfoSearchResultsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullablePrincipalInfoSearchResultsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePrincipalInfoSearchResultsResponse(val *PrincipalInfoSearchResultsResponse) *NullablePrincipalInfoSearchResultsResponse {
	return &NullablePrincipalInfoSearchResultsResponse{value: val, isSet: true}
}

func (v NullablePrincipalInfoSearchResultsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePrincipalInfoSearchResultsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

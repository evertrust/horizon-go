...
// checks if the AzureKeyVaultTrigger type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &AzureKeyVaultTrigger{}
...
type _AzureKeyVaultTrigger AzureKeyVaultTrigger
...
func (o *AzureKeyVaultTrigger) SetRetriesNil() {
	o.Retries.Set(nil)
}
...
func (o *AzureKeyVaultTrigger) UnmarshalJSON(data []byte) (err error) {
	...
	varAzureKeyVaultTrigger := _AzureKeyVaultTrigger{}

	err = json.Unmarshal(data, &varAzureKeyVaultTrigger)

	if err != nil {
		return err
	}

	*o = AzureKeyVaultTrigger(varAzureKeyVaultTrigger)
...
type NullableAzureKeyVaultTrigger struct {
	value *AzureKeyVaultTrigger
	isSet bool
}

func (v NullableAzureKeyVaultTrigger) Get() *AzureKeyVaultTrigger {
	return v.value
}

func (v *NullableAzureKeyVaultTrigger) Set(val *AzureKeyVaultTrigger) {
	v.value = val
	v.isSet = true
}

func (v NullableAzureKeyVaultTrigger) IsSet() bool {
	return v.isSet
}

func (v *NullableAzureKeyVaultTrigger) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAzureKeyVaultTrigger(val *AzureKeyVaultTrigger) *NullableAzureKeyVaultTrigger {
	return &NullableAzureKeyVaultTrigger{value: val, isSet: true}
}

func (v NullableAzureKeyVaultTrigger) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAzureKeyVaultTrigger) UnmarshalJSON(src []byte) error {
	v.isSet = true

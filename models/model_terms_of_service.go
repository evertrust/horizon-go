...
var _ utils.MappedNullable = &TermsOfService{}
...
type _TermsOfService TermsOfService
...
func (o *TermsOfService) UnmarshalJSON(data []byte) (err error) {
	...
	varTermsOfService := _TermsOfService{}

	err = json.Unmarshal(data, &varTermsOfService)

	if err != nil {
		return err
	}

	*o = TermsOfService(varTermsOfService)

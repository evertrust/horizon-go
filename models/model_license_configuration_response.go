...
// checks if the LicenseConfigurationResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LicenseConfigurationResponse{}

// LicenseConfigurationResponse struct for LicenseConfigurationResponse
type LicenseConfigurationResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _LicenseConfigurationResponse LicenseConfigurationResponse
...
func NewLicenseConfigurationResponse(id string, type_ string) *LicenseConfigurationResponse {
	this := LicenseConfigurationResponse{}
	this.Id = id
	this.Type = type_
	return &this
}
...
func (o *LicenseConfigurationResponse) SetTriggersNil() {
	o.Triggers.Set(nil)
}
...
func (o LicenseConfigurationResponse) MarshalJSON() ([]byte, error) {
...
func (o LicenseConfigurationResponse) ToMap() (map[string]interface{}, error) {
...
func (o *LicenseConfigurationResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varLicenseConfigurationResponse := _LicenseConfigurationResponse{}

	err = json.Unmarshal(data, &varLicenseConfigurationResponse)

	if err != nil {
		return err
	}

	*o = LicenseConfigurationResponse(varLicenseConfigurationResponse)
...
type NullableLicenseConfigurationResponse struct {
	value *LicenseConfigurationResponse
	isSet bool
}

func (v NullableLicenseConfigurationResponse) Get() *LicenseConfigurationResponse {
	return v.value
}

func (v *NullableLicenseConfigurationResponse) Set(val *LicenseConfigurationResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableLicenseConfigurationResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableLicenseConfigurationResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLicenseConfigurationResponse(val *LicenseConfigurationResponse) *NullableLicenseConfigurationResponse {
	return &NullableLicenseConfigurationResponse{value: val, isSet: true}
}

func (v NullableLicenseConfigurationResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLicenseConfigurationResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the SecurityRoleAdd400ResponseAnyOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SecurityRoleAdd400ResponseAnyOf{}

// SecurityRoleAdd400ResponseAnyOf struct for SecurityRoleAdd400ResponseAnyOf
type SecurityRoleAdd400ResponseAnyOf struct {
...
type _SecurityRoleAdd400ResponseAnyOf SecurityRoleAdd400ResponseAnyOf
...
func NewSecurityRoleAdd400ResponseAnyOf(status float32, error_ string, message string, title string) *SecurityRoleAdd400ResponseAnyOf {
	this := SecurityRoleAdd400ResponseAnyOf{}
	this.Error = error_
...
func (o *SecurityRoleAdd400ResponseAnyOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o SecurityRoleAdd400ResponseAnyOf) MarshalJSON() ([]byte, error) {
...
func (o SecurityRoleAdd400ResponseAnyOf) ToMap() (map[string]interface{}, error) {
...
func (o *SecurityRoleAdd400ResponseAnyOf) UnmarshalJSON(data []byte) (err error) {
	...
	varSecurityRoleAdd400ResponseAnyOf := _SecurityRoleAdd400ResponseAnyOf{}

	err = json.Unmarshal(data, &varSecurityRoleAdd400ResponseAnyOf)

	if err != nil {
		return err
	}

	*o = SecurityRoleAdd400ResponseAnyOf(varSecurityRoleAdd400ResponseAnyOf)
...
type NullableSecurityRoleAdd400ResponseAnyOf struct {
	value *SecurityRoleAdd400ResponseAnyOf
	isSet bool
}

func (v NullableSecurityRoleAdd400ResponseAnyOf) Get() *SecurityRoleAdd400ResponseAnyOf {
	return v.value
}

func (v *NullableSecurityRoleAdd400ResponseAnyOf) Set(val *SecurityRoleAdd400ResponseAnyOf) {
	v.value = val
	v.isSet = true
}

func (v NullableSecurityRoleAdd400ResponseAnyOf) IsSet() bool {
	return v.isSet
}

func (v *NullableSecurityRoleAdd400ResponseAnyOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSecurityRoleAdd400ResponseAnyOf(val *SecurityRoleAdd400ResponseAnyOf) *NullableSecurityRoleAdd400ResponseAnyOf {
	return &NullableSecurityRoleAdd400ResponseAnyOf{value: val, isSet: true}
}

func (v NullableSecurityRoleAdd400ResponseAnyOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSecurityRoleAdd400ResponseAnyOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the StaticDomainDictionaryProviderDomainsInner type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &StaticDomainDictionaryProviderDomainsInner{}
...
type _StaticDomainDictionaryProviderDomainsInner StaticDomainDictionaryProviderDomainsInner
...
func (o *StaticDomainDictionaryProviderDomainsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varStaticDomainDictionaryProviderDomainsInner := _StaticDomainDictionaryProviderDomainsInner{}

	err = json.Unmarshal(data, &varStaticDomainDictionaryProviderDomainsInner)

	if err != nil {
		return err
	}

	*o = StaticDomainDictionaryProviderDomainsInner(varStaticDomainDictionaryProviderDomainsInner)
...
type NullableStaticDomainDictionaryProviderDomainsInner struct {
	value *StaticDomainDictionaryProviderDomainsInner
	isSet bool
}

func (v NullableStaticDomainDictionaryProviderDomainsInner) Get() *StaticDomainDictionaryProviderDomainsInner {
	return v.value
}

func (v *NullableStaticDomainDictionaryProviderDomainsInner) Set(val *StaticDomainDictionaryProviderDomainsInner) {
	v.value = val
	v.isSet = true
}

func (v NullableStaticDomainDictionaryProviderDomainsInner) IsSet() bool {
	return v.isSet
}

func (v *NullableStaticDomainDictionaryProviderDomainsInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableStaticDomainDictionaryProviderDomainsInner(val *StaticDomainDictionaryProviderDomainsInner) *NullableStaticDomainDictionaryProviderDomainsInner {
	return &NullableStaticDomainDictionaryProviderDomainsInner{value: val, isSet: true}
}

func (v NullableStaticDomainDictionaryProviderDomainsInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableStaticDomainDictionaryProviderDomainsInner) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the LocalIdentityOnAdd type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &LocalIdentityOnAdd{}

// LocalIdentityOnAdd struct for LocalIdentityOnAdd
type LocalIdentityOnAdd struct {
...
type _LocalIdentityOnAdd LocalIdentityOnAdd

// NewLocalIdentityOnAdd instantiates a new LocalIdentityOnAdd object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewLocalIdentityOnAdd(identifier string) *LocalIdentityOnAdd {
	this := LocalIdentityOnAdd{}
...
func (o *LocalIdentityOnAdd) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *LocalIdentityOnAdd) SetNameNil() {
	o.Name.Set(nil)
}
...
func (o *LocalIdentityOnAdd) HasPassword() bool {
	if o != nil && !utils.IsNil(o.Password) {
		return true
	}
...
func (o LocalIdentityOnAdd) MarshalJSON() ([]byte, error) {
...
func (o LocalIdentityOnAdd) ToMap() (map[string]interface{}, error) {
...
func (o *LocalIdentityOnAdd) UnmarshalJSON(data []byte) (err error) {
	...
	varLocalIdentityOnAdd := _LocalIdentityOnAdd{}

	err = json.Unmarshal(data, &varLocalIdentityOnAdd)

	if err != nil {
		return err
	}

	*o = LocalIdentityOnAdd(varLocalIdentityOnAdd)
...
type NullableLocalIdentityOnAdd struct {
	value *LocalIdentityOnAdd
	isSet bool
}

func (v NullableLocalIdentityOnAdd) Get() *LocalIdentityOnAdd {
	return v.value
}

func (v *NullableLocalIdentityOnAdd) Set(val *LocalIdentityOnAdd) {
	v.value = val
	v.isSet = true
}

func (v NullableLocalIdentityOnAdd) IsSet() bool {
	return v.isSet
}

func (v *NullableLocalIdentityOnAdd) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableLocalIdentityOnAdd(val *LocalIdentityOnAdd) *NullableLocalIdentityOnAdd {
	return &NullableLocalIdentityOnAdd{value: val, isSet: true}
}

func (v NullableLocalIdentityOnAdd) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableLocalIdentityOnAdd) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the WebRAMigrateRequestBase type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAMigrateRequestBase{}

// WebRAMigrateRequestBase struct for WebRAMigrateRequestBase
type WebRAMigrateRequestBase struct {
...
type _WebRAMigrateRequestBase WebRAMigrateRequestBase
...
func (o *WebRAMigrateRequestBase) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAMigrateRequestBase) MarshalJSON() ([]byte, error) {
...
func (o WebRAMigrateRequestBase) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAMigrateRequestBase) UnmarshalJSON(data []byte) (err error) {
	varWebRAMigrateRequestBase := _WebRAMigrateRequestBase{}

	err = json.Unmarshal(data, &varWebRAMigrateRequestBase)

	if err != nil {
		return err
	}

	*o = WebRAMigrateRequestBase(varWebRAMigrateRequestBase)
...
type NullableWebRAMigrateRequestBase struct {
	value *WebRAMigrateRequestBase
	isSet bool
}

func (v NullableWebRAMigrateRequestBase) Get() *WebRAMigrateRequestBase {
	return v.value
}

func (v *NullableWebRAMigrateRequestBase) Set(val *WebRAMigrateRequestBase) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAMigrateRequestBase) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAMigrateRequestBase) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAMigrateRequestBase(val *WebRAMigrateRequestBase) *NullableWebRAMigrateRequestBase {
	return &NullableWebRAMigrateRequestBase{value: val, isSet: true}
}

func (v NullableWebRAMigrateRequestBase) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAMigrateRequestBase) UnmarshalJSON(src []byte) error {
	v.isSet = true

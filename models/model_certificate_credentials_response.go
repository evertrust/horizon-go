...
// checks if the CertificateCredentialsResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateCredentialsResponse{}

// CertificateCredentialsResponse struct for CertificateCredentialsResponse
...
type _CertificateCredentialsResponse CertificateCredentialsResponse
...
func (o *CertificateCredentialsResponse) SetDescriptionNil() {
...
func (o CertificateCredentialsResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateCredentialsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateCredentialsResponse := _CertificateCredentialsResponse{}

	err = json.Unmarshal(data, &varCertificateCredentialsResponse)

	if err != nil {
		return err
	}

	*o = CertificateCredentialsResponse(varCertificateCredentialsResponse)
...
type NullableCertificateCredentialsResponse struct {
	value *CertificateCredentialsResponse
	isSet bool
}

func (v NullableCertificateCredentialsResponse) Get() *CertificateCredentialsResponse {
	return v.value
}

func (v *NullableCertificateCredentialsResponse) Set(val *CertificateCredentialsResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateCredentialsResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateCredentialsResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateCredentialsResponse(val *CertificateCredentialsResponse) *NullableCertificateCredentialsResponse {
	return &NullableCertificateCredentialsResponse{value: val, isSet: true}
}

func (v NullableCertificateCredentialsResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateCredentialsResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

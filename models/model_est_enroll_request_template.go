...
// checks if the EstEnrollRequestTemplate type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &EstEnrollRequestTemplate{}

// EstEnrollRequestTemplate struct for EstEnrollRequestTemplate
type EstEnrollRequestTemplate struct {
...
type _EstEnrollRequestTemplate EstEnrollRequestTemplate
...
func (o *EstEnrollRequestTemplate) SetContactEmailNil() {
...
func (o *EstEnrollRequestTemplate) SetOwnerNil() {
	o.Owner.Set(nil)
}
...
func (o *EstEnrollRequestTemplate) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o EstEnrollRequestTemplate) MarshalJSON() ([]byte, error) {
...
func (o EstEnrollRequestTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *EstEnrollRequestTemplate) UnmarshalJSON(data []byte) (err error) {
	varEstEnrollRequestTemplate := _EstEnrollRequestTemplate{}

	err = json.Unmarshal(data, &varEstEnrollRequestTemplate)

	if err != nil {
		return err
	}

	*o = EstEnrollRequestTemplate(varEstEnrollRequestTemplate)
...
type NullableEstEnrollRequestTemplate struct {
	value *EstEnrollRequestTemplate
	isSet bool
}

func (v NullableEstEnrollRequestTemplate) Get() *EstEnrollRequestTemplate {
	return v.value
}

func (v *NullableEstEnrollRequestTemplate) Set(val *EstEnrollRequestTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableEstEnrollRequestTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableEstEnrollRequestTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableEstEnrollRequestTemplate(val *EstEnrollRequestTemplate) *NullableEstEnrollRequestTemplate {
	return &NullableEstEnrollRequestTemplate{value: val, isSet: true}
}

func (v NullableEstEnrollRequestTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableEstEnrollRequestTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

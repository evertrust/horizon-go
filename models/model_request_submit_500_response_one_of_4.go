...
// checks if the RequestSubmit500ResponseOneOf4 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestSubmit500ResponseOneOf4{}

// RequestSubmit500ResponseOneOf4 struct for RequestSubmit500ResponseOneOf4
type RequestSubmit500ResponseOneOf4 struct {
...
type _RequestSubmit500ResponseOneOf4 RequestSubmit500ResponseOneOf4
...
func NewRequestSubmit500ResponseOneOf4(error_ string, message string, title string, status float32) *RequestSubmit500ResponseOneOf4 {
	this := RequestSubmit500ResponseOneOf4{}
	this.Error = error_
...
func (o *RequestSubmit500ResponseOneOf4) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestSubmit500ResponseOneOf4) MarshalJSON() ([]byte, error) {
...
func (o RequestSubmit500ResponseOneOf4) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSubmit500ResponseOneOf4) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSubmit500ResponseOneOf4 := _RequestSubmit500ResponseOneOf4{}

	err = json.Unmarshal(data, &varRequestSubmit500ResponseOneOf4)

	if err != nil {
		return err
	}

	*o = RequestSubmit500ResponseOneOf4(varRequestSubmit500ResponseOneOf4)
...
type NullableRequestSubmit500ResponseOneOf4 struct {
	value *RequestSubmit500ResponseOneOf4
	isSet bool
}

func (v NullableRequestSubmit500ResponseOneOf4) Get() *RequestSubmit500ResponseOneOf4 {
	return v.value
}

func (v *NullableRequestSubmit500ResponseOneOf4) Set(val *RequestSubmit500ResponseOneOf4) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSubmit500ResponseOneOf4) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSubmit500ResponseOneOf4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSubmit500ResponseOneOf4(val *RequestSubmit500ResponseOneOf4) *NullableRequestSubmit500ResponseOneOf4 {
	return &NullableRequestSubmit500ResponseOneOf4{value: val, isSet: true}
}

func (v NullableRequestSubmit500ResponseOneOf4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSubmit500ResponseOneOf4) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
// checks if the RequestSubmit500ResponseOneOf17 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestSubmit500ResponseOneOf17{}

// RequestSubmit500ResponseOneOf17 struct for RequestSubmit500ResponseOneOf17
type RequestSubmit500ResponseOneOf17 struct {
...
type _RequestSubmit500ResponseOneOf17 RequestSubmit500ResponseOneOf17
...
func NewRequestSubmit500ResponseOneOf17(error_ string, message string, title string, status float32) *RequestSubmit500ResponseOneOf17 {
	this := RequestSubmit500ResponseOneOf17{}
	this.Error = error_
...
func (o *RequestSubmit500ResponseOneOf17) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestSubmit500ResponseOneOf17) MarshalJSON() ([]byte, error) {
...
func (o RequestSubmit500ResponseOneOf17) ToMap() (map[string]interface{}, error) {
...
func (o *RequestSubmit500ResponseOneOf17) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestSubmit500ResponseOneOf17 := _RequestSubmit500ResponseOneOf17{}

	err = json.Unmarshal(data, &varRequestSubmit500ResponseOneOf17)

	if err != nil {
		return err
	}

	*o = RequestSubmit500ResponseOneOf17(varRequestSubmit500ResponseOneOf17)
...
type NullableRequestSubmit500ResponseOneOf17 struct {
	value *RequestSubmit500ResponseOneOf17
	isSet bool
}

func (v NullableRequestSubmit500ResponseOneOf17) Get() *RequestSubmit500ResponseOneOf17 {
	return v.value
}

func (v *NullableRequestSubmit500ResponseOneOf17) Set(val *RequestSubmit500ResponseOneOf17) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestSubmit500ResponseOneOf17) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestSubmit500ResponseOneOf17) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestSubmit500ResponseOneOf17(val *RequestSubmit500ResponseOneOf17) *NullableRequestSubmit500ResponseOneOf17 {
	return &NullableRequestSubmit500ResponseOneOf17{value: val, isSet: true}
}

func (v NullableRequestSubmit500ResponseOneOf17) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestSubmit500ResponseOneOf17) UnmarshalJSON(src []byte) error {
	v.isSet = true

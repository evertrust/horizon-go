...
// checks if the SwissSignConnector type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &SwissSignConnector{}
...
type _SwissSignConnector SwissSignConnector
...
func (o *SwissSignConnector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *SwissSignConnector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *SwissSignConnector) UnmarshalJSON(data []byte) (err error) {
	...
	varSwissSignConnector := _SwissSignConnector{}

	err = json.Unmarshal(data, &varSwissSignConnector)

	if err != nil {
		return err
	}

	*o = SwissSignConnector(varSwissSignConnector)
...
type NullableSwissSignConnector struct {
	value *SwissSignConnector
	isSet bool
}

func (v NullableSwissSignConnector) Get() *SwissSignConnector {
	return v.value
}

func (v *NullableSwissSignConnector) Set(val *SwissSignConnector) {
	v.value = val
	v.isSet = true
}

func (v NullableSwissSignConnector) IsSet() bool {
	return v.isSet
}

func (v *NullableSwissSignConnector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSwissSignConnector(val *SwissSignConnector) *NullableSwissSignConnector {
	return &NullableSwissSignConnector{value: val, isSet: true}
}

func (v NullableSwissSignConnector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSwissSignConnector) UnmarshalJSON(src []byte) error {
	v.isSet = true

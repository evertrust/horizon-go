...
type ThirdPartyConnectorResponses struct {
	...
	FortiGateConnectorResponse     *FortiGateConnectorResponse
	FortiManagerConnectorResponse  *FortiManagerConnectorResponse
	...
	PanOSFirewallConnectorResponse *PanOSFirewallConnectorResponse
	PanoramaConnectorResponse      *PanoramaConnectorResponse
}
...
// FortiGateConnectorResponseAsThirdPartyConnectorResponses is a convenience function that returns FortiGateConnectorResponse wrapped in ThirdPartyConnectorResponses
func FortiGateConnectorResponseAsThirdPartyConnectorResponses(v *FortiGateConnectorResponse) ThirdPartyConnectorResponses {
	return ThirdPartyConnectorResponses{
		FortiGateConnectorResponse: v,
	}
}

// FortiManagerConnectorResponseAsThirdPartyConnectorResponses is a convenience function that returns FortiManagerConnectorResponse wrapped in ThirdPartyConnectorResponses
func FortiManagerConnectorResponseAsThirdPartyConnectorResponses(v *FortiManagerConnectorResponse) ThirdPartyConnectorResponses {
	return ThirdPartyConnectorResponses{
		FortiManagerConnectorResponse: v,
	}
}
...
// PanOSFirewallConnectorResponseAsThirdPartyConnectorResponses is a convenience function that returns PanOSFirewallConnectorResponse wrapped in ThirdPartyConnectorResponses
func PanOSFirewallConnectorResponseAsThirdPartyConnectorResponses(v *PanOSFirewallConnectorResponse) ThirdPartyConnectorResponses {
	return ThirdPartyConnectorResponses{
		PanOSFirewallConnectorResponse: v,
	}
}

// PanoramaConnectorResponseAsThirdPartyConnectorResponses is a convenience function that returns PanoramaConnectorResponse wrapped in ThirdPartyConnectorResponses
func PanoramaConnectorResponseAsThirdPartyConnectorResponses(v *PanoramaConnectorResponse) ThirdPartyConnectorResponses {
	return ThirdPartyConnectorResponses{
		PanoramaConnectorResponse: v,
	}
}
...
func (dst *ThirdPartyConnectorResponses) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into FortiGateConnectorResponse
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiGateConnectorResponse)
	if err == nil {
		jsonFortiGateConnectorResponse, _ := json.Marshal(dst.FortiGateConnectorResponse)
		if string(jsonFortiGateConnectorResponse) == "{}" { // empty struct
			dst.FortiGateConnectorResponse = nil
		} else {
			_ = validator.Validate(dst.FortiGateConnectorResponse)
			match++
		}
	} else {
		dst.FortiGateConnectorResponse = nil
	...
	// try to unmarshal data into FortiManagerConnectorResponse
	err = utils.NewStrictDecoder(data).Decode(&dst.FortiManagerConnectorResponse)
	if err == nil {
		jsonFortiManagerConnectorResponse, _ := json.Marshal(dst.FortiManagerConnectorResponse)
		if string(jsonFortiManagerConnectorResponse) == "{}" { // empty struct
			dst.FortiManagerConnectorResponse = nil
		} else {
			_ = validator.Validate(dst.FortiManagerConnectorResponse)
			match++
		}
	} else {
		dst.FortiManagerConnectorResponse = nil
	...
	// try to unmarshal data into PanOSFirewallConnectorResponse
	err = utils.NewStrictDecoder(data).Decode(&dst.PanOSFirewallConnectorResponse)
	if err == nil {
		jsonPanOSFirewallConnectorResponse, _ := json.Marshal(dst.PanOSFirewallConnectorResponse)
		if string(jsonPanOSFirewallConnectorResponse) == "{}" { // empty struct
			dst.PanOSFirewallConnectorResponse = nil
		} else {
			_ = validator.Validate(dst.PanOSFirewallConnectorResponse)
			match++
		}
	} else {
		dst.PanOSFirewallConnectorResponse = nil
	...
	// try to unmarshal data into PanoramaConnectorResponse
	err = utils.NewStrictDecoder(data).Decode(&dst.PanoramaConnectorResponse)
	if err == nil {
		jsonPanoramaConnectorResponse, _ := json.Marshal(dst.PanoramaConnectorResponse)
		if string(jsonPanoramaConnectorResponse) == "{}" { // empty struct
			dst.PanoramaConnectorResponse = nil
		} else {
			_ = validator.Validate(dst.PanoramaConnectorResponse)
			match++
		}
	} else {
		dst.PanoramaConnectorResponse = nil
...
func (src ThirdPartyConnectorResponses) MarshalJSON() ([]byte, error) {
	...
	if src.FortiGateConnectorResponse != nil {
		return json.Marshal(&src.FortiGateConnectorResponse)
	}

	if src.FortiManagerConnectorResponse != nil {
		return json.Marshal(&src.FortiManagerConnectorResponse)
	}
	...
	if src.PanOSFirewallConnectorResponse != nil {
		return json.Marshal(&src.PanOSFirewallConnectorResponse)
	}

	if src.PanoramaConnectorResponse != nil {
		return json.Marshal(&src.PanoramaConnectorResponse)
	}
...
func (obj *ThirdPartyConnectorResponses) GetActualInstance() interface{} {
	...
	if obj.FortiGateConnectorResponse != nil {
		return obj.FortiGateConnectorResponse
	}

	if obj.FortiManagerConnectorResponse != nil {
		return obj.FortiManagerConnectorResponse
	}
	...
	if obj.PanOSFirewallConnectorResponse != nil {
		return obj.PanOSFirewallConnectorResponse
	}

	if obj.PanoramaConnectorResponse != nil {
		return obj.PanoramaConnectorResponse
	}

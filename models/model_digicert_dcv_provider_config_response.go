...
// checks if the DigicertDCVProviderConfigResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DigicertDCVProviderConfigResponse{}

// DigicertDCVProviderConfigResponse struct for DigicertDCVProviderConfigResponse
type DigicertDCVProviderConfigResponse struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _DigicertDCVProviderConfigResponse DigicertDCVProviderConfigResponse
...
func NewDigicertDCVProviderConfigResponse(id string, credentials string, endpoint string, name string, type_ string) *DigicertDCVProviderConfigResponse {
	this := DigicertDCVProviderConfigResponse{}
	this.Id = id
...
func (o *DigicertDCVProviderConfigResponse) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *DigicertDCVProviderConfigResponse) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o DigicertDCVProviderConfigResponse) MarshalJSON() ([]byte, error) {
...
func (o DigicertDCVProviderConfigResponse) ToMap() (map[string]interface{}, error) {
...
func (o *DigicertDCVProviderConfigResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varDigicertDCVProviderConfigResponse := _DigicertDCVProviderConfigResponse{}

	err = json.Unmarshal(data, &varDigicertDCVProviderConfigResponse)

	if err != nil {
		return err
	}

	*o = DigicertDCVProviderConfigResponse(varDigicertDCVProviderConfigResponse)
...
type NullableDigicertDCVProviderConfigResponse struct {
	value *DigicertDCVProviderConfigResponse
	isSet bool
}

func (v NullableDigicertDCVProviderConfigResponse) Get() *DigicertDCVProviderConfigResponse {
	return v.value
}

func (v *NullableDigicertDCVProviderConfigResponse) Set(val *DigicertDCVProviderConfigResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableDigicertDCVProviderConfigResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableDigicertDCVProviderConfigResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDigicertDCVProviderConfigResponse(val *DigicertDCVProviderConfigResponse) *NullableDigicertDCVProviderConfigResponse {
	return &NullableDigicertDCVProviderConfigResponse{value: val, isSet: true}
}

func (v NullableDigicertDCVProviderConfigResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDigicertDCVProviderConfigResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

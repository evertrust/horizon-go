...
// checks if the ReportRecipient type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ReportRecipient{}
...
type _ReportRecipient ReportRecipient
...
func (o *ReportRecipient) SetEmailNil() {
	o.Email.Set(nil)
}
...
func (o *ReportRecipient) SetTeamNil() {
	o.Team.Set(nil)
}
...
func (o *ReportRecipient) UnmarshalJSON(data []byte) (err error) {
	...
	varReportRecipient := _ReportRecipient{}

	err = json.Unmarshal(data, &varReportRecipient)

	if err != nil {
		return err
	}

	*o = ReportRecipient(varReportRecipient)
...
type NullableReportRecipient struct {
	value *ReportRecipient
	isSet bool
}

func (v NullableReportRecipient) Get() *ReportRecipient {
	return v.value
}

func (v *NullableReportRecipient) Set(val *ReportRecipient) {
	v.value = val
	v.isSet = true
}

func (v NullableReportRecipient) IsSet() bool {
	return v.isSet
}

func (v *NullableReportRecipient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableReportRecipient(val *ReportRecipient) *NullableReportRecipient {
	return &NullableReportRecipient{value: val, isSet: true}
}

func (v NullableReportRecipient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableReportRecipient) UnmarshalJSON(src []byte) error {
	v.isSet = true

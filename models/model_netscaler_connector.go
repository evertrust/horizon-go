...
type NetscalerConnector struct {
	CertificateStorePath utils.NullableString `json:"certificateStorePath,omitempty"`
...
func NewNetscalerConnector(credentials string, hostname string, name string, throttleDuration string, throttleParallelism int64, type_ string) *NetscalerConnector {
	...
	this.Type = type_
	var certificateStorePath string = "/nsconfig/ssl"
	this.CertificateStorePath = *utils.NewNullableString(&certificateStorePath)
...
// GetCertificateStorePath returns the CertificateStorePath field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *NetscalerConnector) GetCertificateStorePath() string {
	if o == nil || utils.IsNil(o.CertificateStorePath.Get()) {
		var ret string
		return ret
	}
	return *o.CertificateStorePath.Get()
}

// GetCertificateStorePathOk returns a tuple with the CertificateStorePath field value if set, nil otherwise
...
// SetCertificateStorePath gets a reference to the given NullableString and assigns it to the CertificateStorePath field.
func (o *NetscalerConnector) SetCertificateStorePath(v string) {
	o.CertificateStorePath.Set(&v)
}

// SetCertificateStorePathNil sets the value for CertificateStorePath to be an explicit nil
func (o *NetscalerConnector) SetCertificateStorePathNil() {
	o.CertificateStorePath.Set(nil)
}
...
func (o NetscalerConnector) ToMap() (map[string]interface{}, error) {
	...
	if o.CertificateStorePath.IsSet() {
		toSerialize["certificateStorePath"] = o.CertificateStorePath.Get()
	}

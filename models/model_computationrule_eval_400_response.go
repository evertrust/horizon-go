...
func (dst *ComputationruleEval400Response) UnmarshalJSON(data []byte) error {
	...
	err = json.Unmarshal(data, &dst.ComputationruleEval400ResponseOneOf)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ComputationruleEval400ResponseOneOf1)
	if err == nil {
	...
	err = json.Unmarshal(data, &dst.ComputationruleEval400ResponseOneOf2)
	if err == nil {

...
func (dst *ComputationruleEval400Response) UnmarshalJSON(data []byte) error {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.ComputationruleEval400ResponseOneOf)
	if err == nil {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.ComputationruleEval400ResponseOneOf1)
	if err == nil {
	...
	err = utils.NewStrictDecoder(data).Decode(&dst.ComputationruleEval400ResponseOneOf2)
	if err == nil {

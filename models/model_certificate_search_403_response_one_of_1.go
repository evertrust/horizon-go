...
// checks if the CertificateSearch403ResponseOneOf1 type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateSearch403ResponseOneOf1{}

// CertificateSearch403ResponseOneOf1 struct for CertificateSearch403ResponseOneOf1
type CertificateSearch403ResponseOneOf1 struct {
...
type _CertificateSearch403ResponseOneOf1 CertificateSearch403ResponseOneOf1
...
func NewCertificateSearch403ResponseOneOf1(error_ string, message string, title string, status float32) *CertificateSearch403ResponseOneOf1 {
	this := CertificateSearch403ResponseOneOf1{}
	this.Error = error_
...
func (o *CertificateSearch403ResponseOneOf1) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o CertificateSearch403ResponseOneOf1) MarshalJSON() ([]byte, error) {
...
func (o CertificateSearch403ResponseOneOf1) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateSearch403ResponseOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varCertificateSearch403ResponseOneOf1 := _CertificateSearch403ResponseOneOf1{}

	err = json.Unmarshal(data, &varCertificateSearch403ResponseOneOf1)

	if err != nil {
		return err
	}

	*o = CertificateSearch403ResponseOneOf1(varCertificateSearch403ResponseOneOf1)
...
type NullableCertificateSearch403ResponseOneOf1 struct {
	value *CertificateSearch403ResponseOneOf1
	isSet bool
}

func (v NullableCertificateSearch403ResponseOneOf1) Get() *CertificateSearch403ResponseOneOf1 {
	return v.value
}

func (v *NullableCertificateSearch403ResponseOneOf1) Set(val *CertificateSearch403ResponseOneOf1) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateSearch403ResponseOneOf1) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateSearch403ResponseOneOf1) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateSearch403ResponseOneOf1(val *CertificateSearch403ResponseOneOf1) *NullableCertificateSearch403ResponseOneOf1 {
	return &NullableCertificateSearch403ResponseOneOf1{value: val, isSet: true}
}

func (v NullableCertificateSearch403ResponseOneOf1) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateSearch403ResponseOneOf1) UnmarshalJSON(src []byte) error {
	v.isSet = true

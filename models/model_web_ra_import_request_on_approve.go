...
// checks if the WebRAImportRequestOnApprove type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestOnApprove{}

// WebRAImportRequestOnApprove struct for WebRAImportRequestOnApprove
type WebRAImportRequestOnApprove struct {
	// Object internal ID
	Id string `json:"_id"`
...
type _WebRAImportRequestOnApprove WebRAImportRequestOnApprove
...
func NewWebRAImportRequestOnApprove(id string, module string, workflow string) *WebRAImportRequestOnApprove {
	this := WebRAImportRequestOnApprove{}
...
func (o *WebRAImportRequestOnApprove) SetApproverCommentNil() {
...
func (o *WebRAImportRequestOnApprove) SetDryRunNil() {
	o.DryRun.Set(nil)
}
...
func (o WebRAImportRequestOnApprove) MarshalJSON() ([]byte, error) {
...
func (o WebRAImportRequestOnApprove) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAImportRequestOnApprove) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAImportRequestOnApprove := _WebRAImportRequestOnApprove{}

	err = json.Unmarshal(data, &varWebRAImportRequestOnApprove)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestOnApprove(varWebRAImportRequestOnApprove)
...
type NullableWebRAImportRequestOnApprove struct {
	value *WebRAImportRequestOnApprove
	isSet bool
}

func (v NullableWebRAImportRequestOnApprove) Get() *WebRAImportRequestOnApprove {
	return v.value
}

func (v *NullableWebRAImportRequestOnApprove) Set(val *WebRAImportRequestOnApprove) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestOnApprove) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestOnApprove) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestOnApprove(val *WebRAImportRequestOnApprove) *NullableWebRAImportRequestOnApprove {
	return &NullableWebRAImportRequestOnApprove{value: val, isSet: true}
}

func (v NullableWebRAImportRequestOnApprove) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestOnApprove) UnmarshalJSON(src []byte) error {
	v.isSet = true

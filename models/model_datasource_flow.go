...
// checks if the DatasourceFlow type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &DatasourceFlow{}
...
type _DatasourceFlow DatasourceFlow
...
func (o *DatasourceFlow) UnmarshalJSON(data []byte) (err error) {
	varDatasourceFlow := _DatasourceFlow{}

	err = json.Unmarshal(data, &varDatasourceFlow)

	if err != nil {
		return err
	}

	*o = DatasourceFlow(varDatasourceFlow)
...
type NullableDatasourceFlow struct {
	value *DatasourceFlow
	isSet bool
}

func (v NullableDatasourceFlow) Get() *DatasourceFlow {
	return v.value
}

func (v *NullableDatasourceFlow) Set(val *DatasourceFlow) {
	v.value = val
	v.isSet = true
}

func (v NullableDatasourceFlow) IsSet() bool {
	return v.isSet
}

func (v *NullableDatasourceFlow) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDatasourceFlow(val *DatasourceFlow) *NullableDatasourceFlow {
	return &NullableDatasourceFlow{value: val, isSet: true}
}

func (v NullableDatasourceFlow) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDatasourceFlow) UnmarshalJSON(src []byte) error {
	v.isSet = true

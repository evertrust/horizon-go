...
// checks if the RequestCancel400ResponseOneOf type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &RequestCancel400ResponseOneOf{}

// RequestCancel400ResponseOneOf struct for RequestCancel400ResponseOneOf
type RequestCancel400ResponseOneOf struct {
...
type _RequestCancel400ResponseOneOf RequestCancel400ResponseOneOf
...
func NewRequestCancel400ResponseOneOf(status float32, error_ string, message string, title string) *RequestCancel400ResponseOneOf {
	this := RequestCancel400ResponseOneOf{}
	this.Error = error_
...
func (o *RequestCancel400ResponseOneOf) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestCancel400ResponseOneOf) MarshalJSON() ([]byte, error) {
...
func (o RequestCancel400ResponseOneOf) ToMap() (map[string]interface{}, error) {
...
func (o *RequestCancel400ResponseOneOf) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestCancel400ResponseOneOf := _RequestCancel400ResponseOneOf{}

	err = json.Unmarshal(data, &varRequestCancel400ResponseOneOf)

	if err != nil {
		return err
	}

	*o = RequestCancel400ResponseOneOf(varRequestCancel400ResponseOneOf)
...
type NullableRequestCancel400ResponseOneOf struct {
	value *RequestCancel400ResponseOneOf
	isSet bool
}

func (v NullableRequestCancel400ResponseOneOf) Get() *RequestCancel400ResponseOneOf {
	return v.value
}

func (v *NullableRequestCancel400ResponseOneOf) Set(val *RequestCancel400ResponseOneOf) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestCancel400ResponseOneOf) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestCancel400ResponseOneOf) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestCancel400ResponseOneOf(val *RequestCancel400ResponseOneOf) *NullableRequestCancel400ResponseOneOf {
	return &NullableRequestCancel400ResponseOneOf{value: val, isSet: true}
}

func (v NullableRequestCancel400ResponseOneOf) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestCancel400ResponseOneOf) UnmarshalJSON(src []byte) error {
	v.isSet = true

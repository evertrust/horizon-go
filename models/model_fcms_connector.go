...
type FCMSConnector struct {
	...
	AuthenticationDomainId *int64               `json:"authenticationDomainId,omitempty"`
...
func NewFCMSConnector(apiCredentials string, defaultOwner string, deleteOnRevoke bool, endPoint string, name string, templateId int64, type_ string) *FCMSConnector {
	this := FCMSConnector{}
...
// GetAuthenticationDomainId returns the AuthenticationDomainId field value if set, zero value otherwise.
func (o *FCMSConnector) GetAuthenticationDomainId() int64 {
	if o == nil || utils.IsNil(o.AuthenticationDomainId) {
		var ret int64
		return ret
	}
...
// GetAuthenticationDomainIdOk returns a tuple with the AuthenticationDomainId field value if set, nil otherwise
// and a boolean to check if the value has been set.
...
func (o *FCMSConnector) HasAuthenticationDomainId() bool {
	if o != nil && !utils.IsNil(o.AuthenticationDomainId) {
		return true
	}
...
// SetAuthenticationDomainId gets a reference to the given int64 and assigns it to the AuthenticationDomainId field.
...
func (o FCMSConnector) ToMap() (map[string]interface{}, error) {
	...
	if !utils.IsNil(o.AuthenticationDomainId) {

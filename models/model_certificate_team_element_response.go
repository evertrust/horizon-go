...
// checks if the CertificateTeamElementResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &CertificateTeamElementResponse{}

// CertificateTeamElementResponse struct for CertificateTeamElementResponse
type CertificateTeamElementResponse struct {
...
type _CertificateTeamElementResponse CertificateTeamElementResponse
...
func NewCertificateTeamElementResponse() *CertificateTeamElementResponse {
	this := CertificateTeamElementResponse{}
	return &this
}
...
func (o *CertificateTeamElementResponse) GetAuthorizedOk() ([]string, bool) {
	if o == nil || utils.IsNil(o.Authorized) {
		return nil, false
	}
...
func (o *CertificateTeamElementResponse) SetComputationRuleNil() {
...
func (o *CertificateTeamElementResponse) SetEditableNil() {
	o.Editable.Set(nil)
}
...
func (o *CertificateTeamElementResponse) SetMandatoryNil() {
	o.Mandatory.Set(nil)
}
...
func (o *CertificateTeamElementResponse) SetValueNil() {
	o.Value.Set(nil)
}
...
func (o CertificateTeamElementResponse) MarshalJSON() ([]byte, error) {
...
func (o CertificateTeamElementResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CertificateTeamElementResponse) UnmarshalJSON(data []byte) (err error) {
	varCertificateTeamElementResponse := _CertificateTeamElementResponse{}

	err = json.Unmarshal(data, &varCertificateTeamElementResponse)

	if err != nil {
		return err
	}

	*o = CertificateTeamElementResponse(varCertificateTeamElementResponse)
...
type NullableCertificateTeamElementResponse struct {
	value *CertificateTeamElementResponse
	isSet bool
}

func (v NullableCertificateTeamElementResponse) Get() *CertificateTeamElementResponse {
	return v.value
}

func (v *NullableCertificateTeamElementResponse) Set(val *CertificateTeamElementResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableCertificateTeamElementResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableCertificateTeamElementResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCertificateTeamElementResponse(val *CertificateTeamElementResponse) *NullableCertificateTeamElementResponse {
	return &NullableCertificateTeamElementResponse{value: val, isSet: true}
}

func (v NullableCertificateTeamElementResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCertificateTeamElementResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

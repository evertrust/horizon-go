...
// checks if the WebRAImportRequestOnApproveResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &WebRAImportRequestOnApproveResponse{}

// WebRAImportRequestOnApproveResponse struct for WebRAImportRequestOnApproveResponse
type WebRAImportRequestOnApproveResponse struct {
...
type _WebRAImportRequestOnApproveResponse WebRAImportRequestOnApproveResponse
...
func NewWebRAImportRequestOnApproveResponse(module string, workflow string, certificate NullableCertificate, id string, status RequestStatus, profile string, registrationDate int64, lastModificationDate int64, removeAt int64, holderId string) *WebRAImportRequestOnApproveResponse {
...
// NewWebRAImportRequestOnApproveResponseWithDefaults instantiates a new WebRAImportRequestOnApproveResponse object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewWebRAImportRequestOnApproveResponseWithDefaults() *WebRAImportRequestOnApproveResponse {
	this := WebRAImportRequestOnApproveResponse{}
	var dryRun bool = false
	this.DryRun = *utils.NewNullableBool(&dryRun)
	return &this
...
func (o *WebRAImportRequestOnApproveResponse) GetModule() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *WebRAImportRequestOnApproveResponse) GetModuleOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetModule(v string) {
	o.Module = v
}

// GetWorkflow returns the Workflow field value
func (o *WebRAImportRequestOnApproveResponse) GetWorkflow() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetWorkflowOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetWorkflow(v string) {
	o.Workflow = v
}

// GetTemplate returns the Template field value if set, zero value otherwise.
func (o *WebRAImportRequestOnApproveResponse) GetTemplate() WebRAImportRequestTemplate {
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetTemplateOk() (*WebRAImportRequestTemplate, bool) {
	if o == nil || utils.IsNil(o.Template) {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasTemplate() bool {
	if o != nil && !utils.IsNil(o.Template) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetTemplate(v WebRAImportRequestTemplate) {
	o.Template = &v
}

// GetCertificate returns the Certificate field value
// If the value is explicit nil, the zero value for Certificate will be returned
func (o *WebRAImportRequestOnApproveResponse) GetCertificate() Certificate {
...
func (o *WebRAImportRequestOnApproveResponse) GetCertificateOk() (*Certificate, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetCertificate(v Certificate) {
	o.Certificate.Set(&v)
}

// GetDryRun returns the DryRun field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetDryRun() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetDryRunOk() (*bool, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasDryRun() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetDryRun(v bool) {
	o.DryRun.Set(&v)
}

// SetDryRunNil sets the value for DryRun to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetDryRunNil() {
	o.DryRun.Set(nil)
}

// UnsetDryRun ensures that no value is present for DryRun, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetDryRun() {
	o.DryRun.Unset()
}

// GetId returns the Id field value
func (o *WebRAImportRequestOnApproveResponse) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *WebRAImportRequestOnApproveResponse) SetId(v string) {
	o.Id = v
}

// GetStatus returns the Status field value
func (o *WebRAImportRequestOnApproveResponse) GetStatus() RequestStatus {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetStatusOk() (*RequestStatus, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetStatus(v RequestStatus) {
	o.Status = v
}

// GetProfile returns the Profile field value
func (o *WebRAImportRequestOnApproveResponse) GetProfile() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetProfileOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetProfile(v string) {
	o.Profile = v
}

// GetDn returns the Dn field value if set, zero value otherwise.
func (o *WebRAImportRequestOnApproveResponse) GetDn() string {
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetDnOk() (*string, bool) {
	if o == nil || utils.IsNil(o.Dn) {
		return nil, false
	}
	return o.Dn, true
...
func (o *WebRAImportRequestOnApproveResponse) HasDn() bool {
	if o != nil && !utils.IsNil(o.Dn) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetDn(v string) {
	o.Dn = &v
}

// GetRequester returns the Requester field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetRequester() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetRequesterOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasRequester() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetRequester(v string) {
	o.Requester.Set(&v)
}

// SetRequesterNil sets the value for Requester to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetRequesterNil() {
	o.Requester.Set(nil)
}

// UnsetRequester ensures that no value is present for Requester, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetRequester() {
	o.Requester.Unset()
}

// GetTeam returns the Team field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetTeam() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetTeamOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasTeam() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetTeam(v string) {
	o.Team.Set(&v)
}

// SetTeamNil sets the value for Team to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetTeamNil() {
	o.Team.Set(nil)
}

// UnsetTeam ensures that no value is present for Team, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetTeam() {
	o.Team.Unset()
}

// GetApprover returns the Approver field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetApprover() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetApproverOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasApprover() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetApprover(v string) {
	o.Approver.Set(&v)
}

// SetApproverNil sets the value for Approver to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetApproverNil() {
	o.Approver.Set(nil)
}

// UnsetApprover ensures that no value is present for Approver, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetApprover() {
	o.Approver.Unset()
}

// GetContact returns the Contact field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetContact() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetContactOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasContact() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetContact(v string) {
	o.Contact.Set(&v)
}

// SetContactNil sets the value for Contact to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetContactNil() {
	o.Contact.Set(nil)
}

// UnsetContact ensures that no value is present for Contact, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetContact() {
	o.Contact.Unset()
}
...
func (o *WebRAImportRequestOnApproveResponse) GetRequesterComment() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetRequesterCommentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasRequesterComment() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetRequesterComment(v string) {
	o.RequesterComment.Set(&v)
}

// SetRequesterCommentNil sets the value for RequesterComment to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetRequesterCommentNil() {
	o.RequesterComment.Set(nil)
}

// UnsetRequesterComment ensures that no value is present for RequesterComment, not even an explicit nil
func (o *WebRAImportRequestOnApproveResponse) UnsetRequesterComment() {
...
func (o *WebRAImportRequestOnApproveResponse) GetApproverComment() string {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetApproverCommentOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasApproverComment() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetApproverComment(v string) {
	o.ApproverComment.Set(&v)
}

// SetApproverCommentNil sets the value for ApproverComment to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetApproverCommentNil() {
...
func (o *WebRAImportRequestOnApproveResponse) UnsetApproverComment() {
	o.ApproverComment.Unset()
}

// GetRegistrationDate returns the RegistrationDate field value
func (o *WebRAImportRequestOnApproveResponse) GetRegistrationDate() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetRegistrationDateOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetRegistrationDate(v int64) {
	o.RegistrationDate = v
}

// GetLastModificationDate returns the LastModificationDate field value
func (o *WebRAImportRequestOnApproveResponse) GetLastModificationDate() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetLastModificationDateOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetLastModificationDate(v int64) {
	o.LastModificationDate = v
}

// GetExpirationDate returns the ExpirationDate field value if set, zero value otherwise.
func (o *WebRAImportRequestOnApproveResponse) GetExpirationDate() int64 {
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetExpirationDateOk() (*int64, bool) {
	if o == nil || utils.IsNil(o.ExpirationDate) {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasExpirationDate() bool {
	if o != nil && !utils.IsNil(o.ExpirationDate) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetExpirationDate(v int64) {
	o.ExpirationDate = &v
}

// GetRemoveAt returns the RemoveAt field value
func (o *WebRAImportRequestOnApproveResponse) GetRemoveAt() int64 {
	if o == nil {
		var ret int64
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *WebRAImportRequestOnApproveResponse) GetRemoveAtOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetRemoveAt(v int64) {
	o.RemoveAt = v
}
...
func (o *WebRAImportRequestOnApproveResponse) GetTriggerResults() []TriggerResult {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetTriggerResultsOk() ([]TriggerResult, bool) {
...
func (o *WebRAImportRequestOnApproveResponse) HasTriggerResults() bool {
	if o != nil && !utils.IsNil(o.TriggerResults) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetTriggerResults(v []TriggerResult) {
	o.TriggerResults = v
}
...
func (o *WebRAImportRequestOnApproveResponse) GetGlobalHolderIdCount() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetGlobalHolderIdCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasGlobalHolderIdCount() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetGlobalHolderIdCount(v int64) {
	o.GlobalHolderIdCount.Set(&v)
}

// SetGlobalHolderIdCountNil sets the value for GlobalHolderIdCount to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetGlobalHolderIdCountNil() {
...
func (o *WebRAImportRequestOnApproveResponse) UnsetGlobalHolderIdCount() {
...
func (o *WebRAImportRequestOnApproveResponse) GetProfileHolderIdCount() int64 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetProfileHolderIdCountOk() (*int64, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAImportRequestOnApproveResponse) HasProfileHolderIdCount() bool {
...
func (o *WebRAImportRequestOnApproveResponse) SetProfileHolderIdCount(v int64) {
	o.ProfileHolderIdCount.Set(&v)
}

// SetProfileHolderIdCountNil sets the value for ProfileHolderIdCount to be an explicit nil
func (o *WebRAImportRequestOnApproveResponse) SetProfileHolderIdCountNil() {
...
func (o *WebRAImportRequestOnApproveResponse) UnsetProfileHolderIdCount() {
	o.ProfileHolderIdCount.Unset()
}

// GetLabels returns the Labels field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetLabels() []LabelData {
	if o == nil {
		var ret []LabelData
		return ret
	}
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetLabelsOk() ([]LabelData, bool) {
...
func (o *WebRAImportRequestOnApproveResponse) HasLabels() bool {
	if o != nil && !utils.IsNil(o.Labels) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetLabels(v []LabelData) {
	o.Labels = v
}

// GetMetadata returns the Metadata field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *WebRAImportRequestOnApproveResponse) GetMetadata() []CertificateMetadata {
	if o == nil {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *WebRAImportRequestOnApproveResponse) GetMetadataOk() ([]CertificateMetadata, bool) {
...
func (o *WebRAImportRequestOnApproveResponse) HasMetadata() bool {
	if o != nil && !utils.IsNil(o.Metadata) {
		return true
	}
...
func (o *WebRAImportRequestOnApproveResponse) SetMetadata(v []CertificateMetadata) {
	o.Metadata = v
}

func (o WebRAImportRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
...
func (o WebRAImportRequestOnApproveResponse) ToMap() (map[string]interface{}, error) {
...
func (o *WebRAImportRequestOnApproveResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAImportRequestOnApproveResponse := _WebRAImportRequestOnApproveResponse{}

	err = json.Unmarshal(data, &varWebRAImportRequestOnApproveResponse)

	if err != nil {
		return err
	}

	*o = WebRAImportRequestOnApproveResponse(varWebRAImportRequestOnApproveResponse)
...
type NullableWebRAImportRequestOnApproveResponse struct {
	value *WebRAImportRequestOnApproveResponse
	isSet bool
}

func (v NullableWebRAImportRequestOnApproveResponse) Get() *WebRAImportRequestOnApproveResponse {
	return v.value
}

func (v *NullableWebRAImportRequestOnApproveResponse) Set(val *WebRAImportRequestOnApproveResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAImportRequestOnApproveResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAImportRequestOnApproveResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAImportRequestOnApproveResponse(val *WebRAImportRequestOnApproveResponse) *NullableWebRAImportRequestOnApproveResponse {
	return &NullableWebRAImportRequestOnApproveResponse{value: val, isSet: true}
}

func (v NullableWebRAImportRequestOnApproveResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAImportRequestOnApproveResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

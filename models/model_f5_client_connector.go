...
type F5ClientConnector struct {
	...
	// Name of the F5 BIG-IP authentication provider to use for login (e.g. `tmos`). Defaults to the device's default provider when unset.
...
func NewF5ClientConnector(bigIPHostname string, credentials string, name string, throttleDuration string, throttleParallelism int64, type_ string) *F5ClientConnector {
	...
	this.Type = type_
	var overrideProfileConfiguration bool = true
	...
	this.SslParent = *utils.NewNullableString(&sslParent)
...
func (o *F5ClientConnector) SetLoginProviderNil() {
...
// GetOverrideProfileConfiguration returns the OverrideProfileConfiguration field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *F5ClientConnector) GetOverrideProfileConfiguration() bool {
	if o == nil || utils.IsNil(o.OverrideProfileConfiguration.Get()) {
		var ret bool
		return ret
	}
	return *o.OverrideProfileConfiguration.Get()
}

// GetOverrideProfileConfigurationOk returns a tuple with the OverrideProfileConfiguration field value if set, nil otherwise
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *F5ClientConnector) GetOverrideProfileConfigurationOk() (*bool, bool) {
	...
	return o.OverrideProfileConfiguration.Get(), o.OverrideProfileConfiguration.IsSet()
}
...
func (o *F5ClientConnector) HasOverrideProfileConfiguration() bool {
	if o != nil && o.OverrideProfileConfiguration.IsSet() {
		return true
	}
...
// SetOverrideProfileConfiguration gets a reference to the given NullableBool and assigns it to the OverrideProfileConfiguration field.
func (o *F5ClientConnector) SetOverrideProfileConfiguration(v bool) {
	o.OverrideProfileConfiguration.Set(&v)
}

// SetOverrideProfileConfigurationNil sets the value for OverrideProfileConfiguration to be an explicit nil
func (o *F5ClientConnector) SetOverrideProfileConfigurationNil() {
	o.OverrideProfileConfiguration.Set(nil)
}
...
func (o *F5ClientConnector) UnsetOverrideProfileConfiguration() {
	o.OverrideProfileConfiguration.Unset()
}
...
func (o F5ClientConnector) ToMap() (map[string]interface{}, error) {
	...
	if o.OverrideProfileConfiguration.IsSet() {
		toSerialize["overrideProfileConfiguration"] = o.OverrideProfileConfiguration.Get()
	}

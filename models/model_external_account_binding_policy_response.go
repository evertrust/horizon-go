...
// checks if the ExternalAccountBindingPolicyResponse type satisfies the MappedNullable interface at compile time
var _ utils.MappedNullable = &ExternalAccountBindingPolicyResponse{}

// ExternalAccountBindingPolicyResponse struct for ExternalAccountBindingPolicyResponse
type ExternalAccountBindingPolicyResponse struct {
	// Object internal ID
	Id                   string                  `json:"_id"`
...
type _ExternalAccountBindingPolicyResponse ExternalAccountBindingPolicyResponse
...
func NewExternalAccountBindingPolicyResponse(id string, allowedProfiles []string, name string, validationMethods []AcmeAuthorizationType) *ExternalAccountBindingPolicyResponse {
	this := ExternalAccountBindingPolicyResponse{}
	this.Id = id
...
func (o ExternalAccountBindingPolicyResponse) MarshalJSON() ([]byte, error) {
...
func (o ExternalAccountBindingPolicyResponse) ToMap() (map[string]interface{}, error) {
...
func (o *ExternalAccountBindingPolicyResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varExternalAccountBindingPolicyResponse := _ExternalAccountBindingPolicyResponse{}

	err = json.Unmarshal(data, &varExternalAccountBindingPolicyResponse)

	if err != nil {
		return err
	}

	*o = ExternalAccountBindingPolicyResponse(varExternalAccountBindingPolicyResponse)
...
type NullableExternalAccountBindingPolicyResponse struct {
	value *ExternalAccountBindingPolicyResponse
	isSet bool
}

func (v NullableExternalAccountBindingPolicyResponse) Get() *ExternalAccountBindingPolicyResponse {
	return v.value
}

func (v *NullableExternalAccountBindingPolicyResponse) Set(val *ExternalAccountBindingPolicyResponse) {
	v.value = val
	v.isSet = true
}

func (v NullableExternalAccountBindingPolicyResponse) IsSet() bool {
	return v.isSet
}

func (v *NullableExternalAccountBindingPolicyResponse) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableExternalAccountBindingPolicyResponse(val *ExternalAccountBindingPolicyResponse) *NullableExternalAccountBindingPolicyResponse {
	return &NullableExternalAccountBindingPolicyResponse{value: val, isSet: true}
}

func (v NullableExternalAccountBindingPolicyResponse) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableExternalAccountBindingPolicyResponse) UnmarshalJSON(src []byte) error {
	v.isSet = true

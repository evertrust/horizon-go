...
func (a *SecurityPrincipalinfoAPIService) ScurityPrincipalInfoGetExecute(r SecurityPrincipalinfoAPIScurityPrincipalInfoGetRequest) (*models.PrincipalInfoResponse, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v models.SecurityPrincipalInfoUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v models.SecurityPrincipalInfoUpdate500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
SecurityPrincipalInfoAdd Create a new principal
...
func (a *SecurityPrincipalinfoAPIService) SecurityPrincipalInfoAddExecute(r SecurityPrincipalinfoAPISecurityPrincipalInfoAddRequest) (*models.PrincipalInfoResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/security/principalinfos"
	...
	// body params
	localVarPostBody = r.principalInfo
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.SecurityPrincipalInfoAdd400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (r SecurityPrincipalinfoAPISecurityPrincipalInfoDeleteRequest) Execute() (*http.Response, error) {
	return r.ApiService.SecurityPrincipalInfoDeleteExecute(r)
}

/*
SecurityPrincipalInfoDelete Delete a principal
...
/*
SecurityPrincipalInfoSearch Search for principal information
...
func (a *SecurityPrincipalinfoAPIService) SecurityPrincipalInfoSearchExecute(r SecurityPrincipalinfoAPISecurityPrincipalInfoSearchRequest) (*models.PrincipalInfoSearchResultsResponse, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/v1/security/principalinfos/search"
	...
	// body params
	localVarPostBody = r.principalInfoSearchQuery
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.SecurityPrincipalInfoSearch400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
/*
SecurityPrincipalInfoUpdate Update a principal's information
...
func (a *SecurityPrincipalinfoAPIService) SecurityPrincipalInfoUpdateExecute(r SecurityPrincipalinfoAPISecurityPrincipalInfoUpdateRequest) (*models.PrincipalInfoResponse, *http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v models.SecurityPrincipalInfoUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

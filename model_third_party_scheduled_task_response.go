...
var _ MappedNullable = &ThirdPartyScheduledTaskResponse{}
...
func NewThirdPartyScheduledTaskResponse(id string, type_ string, cron string, dryRun bool, enabled bool, module string, profile string, connector string, enroll bool, revoke bool, renew bool) *ThirdPartyScheduledTaskResponse {
...
func (o *ThirdPartyScheduledTaskResponse) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o *ThirdPartyScheduledTaskResponse) GetResults() ThirdPartyConnectorSynchronizationResult {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ThirdPartyScheduledTaskResponse) GetResultsOk() (*ThirdPartyConnectorSynchronizationResult, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ThirdPartyScheduledTaskResponse) HasResults() bool {
...
func (o *ThirdPartyScheduledTaskResponse) SetResults(v ThirdPartyConnectorSynchronizationResult) {
	o.Results.Set(&v)
}
// SetResultsNil sets the value for Results to be an explicit nil
func (o *ThirdPartyScheduledTaskResponse) SetResultsNil() {
	o.Results.Set(nil)
}

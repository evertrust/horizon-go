...
var _ MappedNullable = &CertificateSearchResult{}
...
type CertificateSearchResult struct {
	...
	SelfSigned NullableBool `json:"selfSigned,omitempty"`
	...
	NotBefore NullableInt64 `json:"notBefore,omitempty"`
	NotAfter NullableInt64 `json:"notAfter,omitempty"`
	...
	HolderId NullableString `json:"holderId,omitempty"`
...
func (o *CertificateSearchResult) GetSelfSigned() bool {
	if o == nil || IsNil(o.SelfSigned.Get()) {
		var ret bool
		return ret
	}
...
func (o *CertificateSearchResult) GetSubjectAlternateNamesOk() ([]SubjectAlternateName, bool) {
	if o == nil || IsNil(o.SubjectAlternateNames) {
		return nil, false
	}

...
var _ MappedNullable = &AcmeExternalProfile{}
...
func NewAcmeExternalProfile(module string, name string, enabled bool, authorizationMethods []string, pkiConnector string, requireEAB bool, authorizedCas []string, authorizationLevels CertificateProfileAuthorizationLevels, requestsPolicy RequestsPolicy, selfPermissions CertificateProfileSelfPermissions, cryptoPolicy CertificateProfileCryptoPolicy) *AcmeExternalProfile {
...
func (o *AcmeExternalProfile) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *AcmeExternalProfile) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AcmeExternalProfile) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}

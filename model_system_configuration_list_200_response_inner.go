...
func (dst *SystemConfigurationList200ResponseInner) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.InterfaceCustomizationConfigurationResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.InternalMonitorConfigurationResponse)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.LicenseConfigurationResponse)
	if err == nil {

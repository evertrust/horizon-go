...
var _ MappedNullable = &IntuneProfileResponse{}
...
func (o *IntuneProfileResponse) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IntuneProfileResponse) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IntuneProfileResponse) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}

...
var _ MappedNullable = &WebRAProfile{}
...
func NewWebRAProfile(module string, name string, authorizationMode string, enabled bool, pkiConnector string, authorizationLevels CertificateProfileAuthorizationLevels, requestsPolicy RequestsPolicy, cryptoPolicy CertificateProfileCryptoPolicy, selfPermissions CertificateProfileSelfPermissions) *WebRAProfile {
	this := WebRAProfile{}
	this.Module = module
	this.Name = name
...
func (o *WebRAProfile) GetCryptoPolicy() CertificateProfileCryptoPolicy {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *WebRAProfile) GetCryptoPolicyOk() (*CertificateProfileCryptoPolicy, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *WebRAProfile) SetCryptoPolicy(v CertificateProfileCryptoPolicy) {
	o.CryptoPolicy = v
}
...
func (o *WebRAProfile) GetValidationRuleset() ValidationRuleset {
	if o == nil || IsNil(o.ValidationRuleset.Get()) {

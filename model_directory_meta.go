...
// checks if the DirectoryMeta type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &DirectoryMeta{}
...
type DirectoryMeta struct {
	...
	ExternalAccountRequired NullableBool `json:"externalAccountRequired,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _DirectoryMeta DirectoryMeta

// NewDirectoryMeta instantiates a new DirectoryMeta object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewDirectoryMeta() *DirectoryMeta {
	this := DirectoryMeta{}
	return &this
}

// NewDirectoryMetaWithDefaults instantiates a new DirectoryMeta object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewDirectoryMetaWithDefaults() *DirectoryMeta {
	this := DirectoryMeta{}
	return &this
}
...
func (o *DirectoryMeta) SetTermsOfServiceNil() {
...
func (o *DirectoryMeta) SetWebsiteNil() {
	o.Website.Set(nil)
}
...
// GetCaaIdentities returns the CaaIdentities field value if set, zero value otherwise (both if not set or set to explicit null).
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *DirectoryMeta) GetCaaIdentitiesOk() ([]string, bool) {
...
func (o *DirectoryMeta) HasCaaIdentities() bool {
	if o != nil && !IsNil(o.CaaIdentities) {
		return true
	}
...
func (o *DirectoryMeta) GetExternalAccountRequired() bool {
	if o == nil || IsNil(o.ExternalAccountRequired.Get()) {
		var ret bool
		return ret
	}
...
func (o DirectoryMeta) MarshalJSON() ([]byte, error) {
...
func (o DirectoryMeta) ToMap() (map[string]interface{}, error) {
...
func (o *DirectoryMeta) UnmarshalJSON(data []byte) (err error) {
	varDirectoryMeta := _DirectoryMeta{}

	err = json.Unmarshal(data, &varDirectoryMeta)

	if err != nil {
		return err
	}

	*o = DirectoryMeta(varDirectoryMeta)
...
type NullableDirectoryMeta struct {
	value *DirectoryMeta
	isSet bool
}

func (v NullableDirectoryMeta) Get() *DirectoryMeta {
	return v.value
}

func (v *NullableDirectoryMeta) Set(val *DirectoryMeta) {
	v.value = val
	v.isSet = true
}

func (v NullableDirectoryMeta) IsSet() bool {
	return v.isSet
}

func (v *NullableDirectoryMeta) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableDirectoryMeta(val *DirectoryMeta) *NullableDirectoryMeta {
	return &NullableDirectoryMeta{value: val, isSet: true}
}

func (v NullableDirectoryMeta) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableDirectoryMeta) UnmarshalJSON(src []byte) error {
	v.isSet = true

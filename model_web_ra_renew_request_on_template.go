...
// checks if the WebRARenewRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRARenewRequestOnTemplate{}

// WebRARenewRequestOnTemplate struct for WebRARenewRequestOnTemplate
type WebRARenewRequestOnTemplate struct {
...
type _WebRARenewRequestOnTemplate WebRARenewRequestOnTemplate
...
func NewWebRARenewRequestOnTemplate(module string, workflow string) *WebRARenewRequestOnTemplate {
	this := WebRARenewRequestOnTemplate{}
	this.Module = module
...
func (o *WebRARenewRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRARenewRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRARenewRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o WebRARenewRequestOnTemplate) ToMap() (map[string]interface{}, error) {
...
func (o *WebRARenewRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARenewRequestOnTemplate := _WebRARenewRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRARenewRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRARenewRequestOnTemplate(varWebRARenewRequestOnTemplate)
...
type NullableWebRARenewRequestOnTemplate struct {
	value *WebRARenewRequestOnTemplate
	isSet bool
}

func (v NullableWebRARenewRequestOnTemplate) Get() *WebRARenewRequestOnTemplate {
	return v.value
}

func (v *NullableWebRARenewRequestOnTemplate) Set(val *WebRARenewRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARenewRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARenewRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARenewRequestOnTemplate(val *WebRARenewRequestOnTemplate) *NullableWebRARenewRequestOnTemplate {
	return &NullableWebRARenewRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRARenewRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARenewRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

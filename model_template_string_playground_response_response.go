...
var _ MappedNullable = &TemplateStringPlaygroundResponseResponse{}
...
type TemplateStringPlaygroundResponseResponse struct {
	...
	ComputedValueSingle NullableString `json:"computedValueSingle,omitempty"`
...
func (o *TemplateStringPlaygroundResponseResponse) GetComputedValueSingle() string {
	if o == nil || IsNil(o.ComputedValueSingle.Get()) {
		var ret string
		return ret
	}
...
func (o *TemplateStringPlaygroundResponseResponse) GetComputedValueMultiOk() ([]string, bool) {
	if o == nil || IsNil(o.ComputedValueMulti) {
		return nil, false
	}

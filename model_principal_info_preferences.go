...
var _ MappedNullable = &PrincipalInfoPreferences{}
...
type PrincipalInfoPreferences struct {
	...
	DarkMode NullableBool `json:"darkMode,omitempty"`
...
func NewPrincipalInfoPreferences() *PrincipalInfoPreferences {
	...
	this.DarkMode = *NewNullableBool(&darkMode)
...
func (o *PrincipalInfoPreferences) GetCertificateFieldsOk() ([]string, bool) {
	if o == nil || IsNil(o.CertificateFields) {
		return nil, false
	}
...
func (o *PrincipalInfoPreferences) GetRequestFieldsOk() ([]string, bool) {
	if o == nil || IsNil(o.RequestFields) {
		return nil, false
	}

...
// checks if the WebRAUpdateRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRAUpdateRequestOnTemplate{}
...
type _WebRAUpdateRequestOnTemplate WebRAUpdateRequestOnTemplate
...
func (o *WebRAUpdateRequestOnTemplate) SetProfileNil() {
	o.Profile.Set(nil)
}
...
func (o *WebRAUpdateRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRAUpdateRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRAUpdateRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o *WebRAUpdateRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRAUpdateRequestOnTemplate := _WebRAUpdateRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRAUpdateRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRAUpdateRequestOnTemplate(varWebRAUpdateRequestOnTemplate)
...
type NullableWebRAUpdateRequestOnTemplate struct {
	value *WebRAUpdateRequestOnTemplate
	isSet bool
}

func (v NullableWebRAUpdateRequestOnTemplate) Get() *WebRAUpdateRequestOnTemplate {
	return v.value
}

func (v *NullableWebRAUpdateRequestOnTemplate) Set(val *WebRAUpdateRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRAUpdateRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRAUpdateRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRAUpdateRequestOnTemplate(val *WebRAUpdateRequestOnTemplate) *NullableWebRAUpdateRequestOnTemplate {
	return &NullableWebRAUpdateRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRAUpdateRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRAUpdateRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

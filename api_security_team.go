...
// Team to register
func (r SecurityTeamAPISecurityTeamAddRequest) Team(team Team) SecurityTeamAPISecurityTeamAddRequest {
	r.team = &team
	return r
}

func (r SecurityTeamAPISecurityTeamAddRequest) Execute() (*TeamResponse, *http.Response, error) {
...
//  @return TeamResponse
func (a *SecurityTeamAPIService) SecurityTeamAddExecute(r SecurityTeamAPISecurityTeamAddRequest) (*TeamResponse, *http.Response, error) {
	var (
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityTeamAdd400Response
		...
		if localVarHTTPResponse.StatusCode == 500 {
			var v SecurityTeamList500Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *SecurityTeamAPIService) SecurityTeamDeleteExecute(r SecurityTeamAPISecurityTeamDeleteRequest) (*http.Response, error) {
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 404 {
			var v SecurityTeamUpdate404Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarHTTPResponse, newErr
...
func (r SecurityTeamAPISecurityTeamGetRequest) Execute() (*TeamResponse, *http.Response, error) {
...
// Execute executes the request
//  @return TeamResponse
func (a *SecurityTeamAPIService) SecurityTeamGetExecute(r SecurityTeamAPISecurityTeamGetRequest) (*TeamResponse, *http.Response, error) {
	var (
...
func (r SecurityTeamAPISecurityTeamListRequest) Execute() ([]TeamResponse, *http.Response, error) {
...
// Execute executes the request
//  @return []TeamResponse
func (a *SecurityTeamAPIService) SecurityTeamListExecute(r SecurityTeamAPISecurityTeamListRequest) ([]TeamResponse, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
type SecurityTeamAPISecurityTeamUpdateRequest struct {
	ctx context.Context
	ApiService *SecurityTeamAPIService
	securityTeamUpdateRequest *SecurityTeamUpdateRequest
}

// The team to update
func (r SecurityTeamAPISecurityTeamUpdateRequest) SecurityTeamUpdateRequest(securityTeamUpdateRequest SecurityTeamUpdateRequest) SecurityTeamAPISecurityTeamUpdateRequest {
	r.securityTeamUpdateRequest = &securityTeamUpdateRequest
	return r
}

func (r SecurityTeamAPISecurityTeamUpdateRequest) Execute() (*TeamResponse, *http.Response, error) {
...
// Execute executes the request
//  @return TeamResponse
func (a *SecurityTeamAPIService) SecurityTeamUpdateExecute(r SecurityTeamAPISecurityTeamUpdateRequest) (*TeamResponse, *http.Response, error) {
	var (
	...
	if r.securityTeamUpdateRequest == nil {
		return localVarReturnValue, nil, reportError("securityTeamUpdateRequest is required and must be specified")
	}
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		...
		if localVarHTTPResponse.StatusCode == 400 {
			var v SecurityTeamUpdate400Response
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr

...
var _ MappedNullable = &PasswordCredentialsResponse{}
...
func NewPasswordCredentialsResponse(type_ string, login string, password SecretString, name string) *PasswordCredentialsResponse {

...
func (dst *RequestSubmit403Response) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf1)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf2)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf3)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf4)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.CertificateSearch403ResponseOneOf5)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.RequestSubmit403ResponseOneOf)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.RequestSubmit403ResponseOneOf1)
	if err == nil {

...
var _ MappedNullable = &RESTResponse{}
...
func NewRESTResponse(type_ string, method string, url string, authenticationType string, expectedHttpCodes []int64, timeout string, name string, events []string) *RESTResponse {
	this := RESTResponse{}
	this.Name = name
	this.Type = type_
	this.Events = events

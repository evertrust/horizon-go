...
// checks if the WebRARevokeRequestOnTemplate type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &WebRARevokeRequestOnTemplate{}
...
type _WebRARevokeRequestOnTemplate WebRARevokeRequestOnTemplate
...
func (o *WebRARevokeRequestOnTemplate) SetCertificateIdNil() {
...
func (o *WebRARevokeRequestOnTemplate) SetCertificatePemNil() {
...
func (o WebRARevokeRequestOnTemplate) MarshalJSON() ([]byte, error) {
...
func (o *WebRARevokeRequestOnTemplate) UnmarshalJSON(data []byte) (err error) {
	...
	varWebRARevokeRequestOnTemplate := _WebRARevokeRequestOnTemplate{}

	err = json.Unmarshal(data, &varWebRARevokeRequestOnTemplate)

	if err != nil {
		return err
	}

	*o = WebRARevokeRequestOnTemplate(varWebRARevokeRequestOnTemplate)
...
type NullableWebRARevokeRequestOnTemplate struct {
	value *WebRARevokeRequestOnTemplate
	isSet bool
}

func (v NullableWebRARevokeRequestOnTemplate) Get() *WebRARevokeRequestOnTemplate {
	return v.value
}

func (v *NullableWebRARevokeRequestOnTemplate) Set(val *WebRARevokeRequestOnTemplate) {
	v.value = val
	v.isSet = true
}

func (v NullableWebRARevokeRequestOnTemplate) IsSet() bool {
	return v.isSet
}

func (v *NullableWebRARevokeRequestOnTemplate) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableWebRARevokeRequestOnTemplate(val *WebRARevokeRequestOnTemplate) *NullableWebRARevokeRequestOnTemplate {
	return &NullableWebRARevokeRequestOnTemplate{value: val, isSet: true}
}

func (v NullableWebRARevokeRequestOnTemplate) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableWebRARevokeRequestOnTemplate) UnmarshalJSON(src []byte) error {
	v.isSet = true

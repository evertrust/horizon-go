...
var _ MappedNullable = &EntrustConnectorResponse{}
...
type EntrustConnectorResponse struct {
	...
	RequesterPhone NullableString `json:"requesterPhone,omitempty"`
	CertLifetime NullableString `json:"certLifetime,omitempty" validate:"regexp=^([0-9]+) *(ms|millisecond|milliseconds|s|second|seconds|m|minute|minutes|h|hour|hours|d|day|days)$"`
	ClientId NullableInt64 `json:"clientId,omitempty"`
...
func (o *EntrustConnectorResponse) GetRequesterPhone() string {
	if o == nil || IsNil(o.RequesterPhone.Get()) {
		var ret string
		return ret
	}
...
func (o *EntrustConnectorResponse) GetCertLifetime() string {
	if o == nil || IsNil(o.CertLifetime.Get()) {
		var ret string
		return ret
	}

...
var _ MappedNullable = &GSMSSLConnectorResponse{}
...
type GSMSSLConnectorResponse struct {
	...
	CertificateValidity NullableInt64 `json:"certificateValidity,omitempty"`
...
func (o *GSMSSLConnectorResponse) GetCertificateValidity() int64 {
	if o == nil || IsNil(o.CertificateValidity.Get()) {
		var ret int64
		return ret
	}

...
var _ MappedNullable = &OidcIdentityProvider{}
...
type OidcIdentityProvider struct {
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the client ID  and secret to use to authenticate Horizon against the identity provider
...
func NewOidcIdentityProvider(name string, type_ string, enabled bool, enabledOnUI bool, providerMetadataUrl string, clientCredentials string, scope string, trustSystemCAs bool, identifierClaim string, emailClaim string, nameClaim string) *OidcIdentityProvider {

...
func (dst *RequestApproveRequest) UnmarshalJSON(data []byte) error {
	...
	err = newStrictDecoder(data).Decode(&dst.EstEnrollRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.ScepEnrollRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAEnrollRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAImportRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAMigrateRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARecoverRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARenewRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRARevokeRequestOnApprove)
	if err == nil {
	...
	err = newStrictDecoder(data).Decode(&dst.WebRAUpdateRequestOnApprove)
	if err == nil {

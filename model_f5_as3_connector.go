...
// checks if the F5AS3Connector type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &F5AS3Connector{}

// F5AS3Connector struct for F5AS3Connector
type F5AS3Connector struct {
	...
	// Any of `rsa-2048`, `rsa-3072`, `rsa-4096`, `rsa-8192`, `ec-secp256r1`, `ec-secp384r1`, `ec-secp521r1`, `ed-448`, `ed-25519`, `mldsa-44`, `mldsa-65`, `mldsa-87` or `<primary key type>+<alternate key type>`
	KeyType NullableString `json:"keyType,omitempty" validate:"regexp=(rsa-2048|rsa-3072|rsa-4096|rsa-8192|ec-secp256r1|ec-secp384r1|ec-secp521r1|ed-448|ed-25519|mldsa-44|mldsa-65|mldsa-87)(\\\\\\\\+(rsa-2048|rsa-3072|rsa-4096|rsa-8192|ec-secp256r1|ec-secp384r1|ec-secp521r1|ed-448|ed-25519|mldsa-44|mldsa-65|mldsa-87))?"`
	...
	// Name of the `password` [credentials](#tag/api.security.credentials) containing the account to authenticate on F5
	Credentials string `json:"credentials"`
	LoginProvider NullableString `json:"loginProvider,omitempty"`
	AdditionalProperties map[string]interface{}
}

type _F5AS3Connector F5AS3Connector
...
func (o *F5AS3Connector) SetKeyTypeNil() {
	o.KeyType.Set(nil)
}
...
func (o *F5AS3Connector) SetRenewalPeriodNil() {
...
func (o *F5AS3Connector) SetTimeoutNil() {
	o.Timeout.Set(nil)
}
...
func (o *F5AS3Connector) SetProxyNil() {
	o.Proxy.Set(nil)
}
...
func (o *F5AS3Connector) SetLoginProviderNil() {
...
func (o F5AS3Connector) MarshalJSON() ([]byte, error) {
...
func (o F5AS3Connector) ToMap() (map[string]interface{}, error) {
...
func (o *F5AS3Connector) UnmarshalJSON(data []byte) (err error) {
	...
	varF5AS3Connector := _F5AS3Connector{}

	err = json.Unmarshal(data, &varF5AS3Connector)

	if err != nil {
		return err
	}

	*o = F5AS3Connector(varF5AS3Connector)
...
type NullableF5AS3Connector struct {
	value *F5AS3Connector
	isSet bool
}

func (v NullableF5AS3Connector) Get() *F5AS3Connector {
	return v.value
}

func (v *NullableF5AS3Connector) Set(val *F5AS3Connector) {
	v.value = val
	v.isSet = true
}

func (v NullableF5AS3Connector) IsSet() bool {
	return v.isSet
}

func (v *NullableF5AS3Connector) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableF5AS3Connector(val *F5AS3Connector) *NullableF5AS3Connector {
	return &NullableF5AS3Connector{value: val, isSet: true}
}

func (v NullableF5AS3Connector) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableF5AS3Connector) UnmarshalJSON(src []byte) error {
	v.isSet = true

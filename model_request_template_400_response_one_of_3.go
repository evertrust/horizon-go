...
// checks if the RequestTemplate400ResponseOneOf3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RequestTemplate400ResponseOneOf3{}

// RequestTemplate400ResponseOneOf3 struct for RequestTemplate400ResponseOneOf3
type RequestTemplate400ResponseOneOf3 struct {
...
type _RequestTemplate400ResponseOneOf3 RequestTemplate400ResponseOneOf3
...
func NewRequestTemplate400ResponseOneOf3(status float32, error_ string, message string, title string) *RequestTemplate400ResponseOneOf3 {
	this := RequestTemplate400ResponseOneOf3{}
	this.Error = error_
...
func (o *RequestTemplate400ResponseOneOf3) SetDetailNil() {
	o.Detail.Set(nil)
}
...
func (o RequestTemplate400ResponseOneOf3) MarshalJSON() ([]byte, error) {
...
func (o RequestTemplate400ResponseOneOf3) ToMap() (map[string]interface{}, error) {
...
func (o *RequestTemplate400ResponseOneOf3) UnmarshalJSON(data []byte) (err error) {
	...
	varRequestTemplate400ResponseOneOf3 := _RequestTemplate400ResponseOneOf3{}

	err = json.Unmarshal(data, &varRequestTemplate400ResponseOneOf3)

	if err != nil {
		return err
	}

	*o = RequestTemplate400ResponseOneOf3(varRequestTemplate400ResponseOneOf3)
...
type NullableRequestTemplate400ResponseOneOf3 struct {
	value *RequestTemplate400ResponseOneOf3
	isSet bool
}

func (v NullableRequestTemplate400ResponseOneOf3) Get() *RequestTemplate400ResponseOneOf3 {
	return v.value
}

func (v *NullableRequestTemplate400ResponseOneOf3) Set(val *RequestTemplate400ResponseOneOf3) {
	v.value = val
	v.isSet = true
}

func (v NullableRequestTemplate400ResponseOneOf3) IsSet() bool {
	return v.isSet
}

func (v *NullableRequestTemplate400ResponseOneOf3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRequestTemplate400ResponseOneOf3(val *RequestTemplate400ResponseOneOf3) *NullableRequestTemplate400ResponseOneOf3 {
	return &NullableRequestTemplate400ResponseOneOf3{value: val, isSet: true}
}

func (v NullableRequestTemplate400ResponseOneOf3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRequestTemplate400ResponseOneOf3) UnmarshalJSON(src []byte) error {
	v.isSet = true
